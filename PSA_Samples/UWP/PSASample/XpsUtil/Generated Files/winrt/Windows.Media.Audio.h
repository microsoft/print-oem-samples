...
namespace winrt::impl
{
    ...
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Media::Audio::IAudioEffectsPackConfiguration)->get_DeviceId(&value));
    ...
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Media::Audio::IAudioEffectsPackConfiguration)->get_EffectsPackId(&value));
        return hstring{ value, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Media::Audio::AudioEffectsPackStatus) consume_Windows_Media_Audio_IAudioEffectsPackConfiguration<D>::Status() const
    {
        Windows::Media::Audio::AudioEffectsPackStatus value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Media::Audio::IAudioEffectsPackConfiguration)->get_Status(reinterpret_cast<int32_t*>(&value)));
        return value;
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::event_token) consume_Windows_Media_Audio_IAudioEffectsPackConfiguration<D>::StatusChanged(Windows::Foundation::TypedEventHandler<Windows::Media::Audio::AudioEffectsPackConfiguration, Windows::Foundation::IInspectable> const& handler) const
    {
        winrt::event_token token{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Media::Audio::IAudioEffectsPackConfiguration)->add_StatusChanged(*(void**)(&handler), put_abi(token)));
        return token;
    }
    template <typename D> typename consume_Windows_Media_Audio_IAudioEffectsPackConfiguration<D>::StatusChanged_revoker consume_Windows_Media_Audio_IAudioEffectsPackConfiguration<D>::StatusChanged(auto_revoke_t, Windows::Foundation::TypedEventHandler<Windows::Media::Audio::AudioEffectsPackConfiguration, Windows::Foundation::IInspectable> const& handler) const
    {
    ...
    {
        WINRT_VERIFY_(0, WINRT_IMPL_SHIM(Windows::Media::Audio::IAudioEffectsPackConfiguration)->remove_StatusChanged(impl::bind_in(token)));
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Media::Audio::AudioEffectsPackConfiguration) consume_Windows_Media_Audio_IAudioEffectsPackConfigurationStatics<D>::GetForDeviceId(param::hstring const& effectsPackId, param::hstring const& deviceId) const
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Media::Audio::IAudioEffectsPackConfigurationStatics)->GetForDeviceId(*(void**)(&effectsPackId), *(void**)(&deviceId), &result));
        return Windows::Media::Audio::AudioEffectsPackConfiguration{ result, take_ownership_from_abi };
    }
    ...
    {
        bool result{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Media::Audio::IAudioEffectsPackConfigurationStatics)->IsDeviceIdSupported(*(void**)(&effectsPackId), *(void**)(&deviceId), &result));
        return result;
    }
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, Windows::Media::Audio::IAudioEffectsPackConfiguration> : produce_base<D, Windows::Media::Audio::IAudioEffectsPackConfiguration>
    {
        ...
        {
            typename D::abi_guard guard(this->shim());
            *value = detach_from<Windows::Media::Audio::AudioEffectsPackStatus>(this->shim().Status());
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall add_StatusChanged(void* handler, winrt::event_token* token) noexcept final try
        {
            ...
            typename D::abi_guard guard(this->shim());
            *token = detach_from<winrt::event_token>(this->shim().StatusChanged(*reinterpret_cast<Windows::Foundation::TypedEventHandler<Windows::Media::Audio::AudioEffectsPackConfiguration, Windows::Foundation::IInspectable> const*>(&handler)));
            return 0;
        }
        catch (...) { return to_hresult(); }
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, Windows::Media::Audio::IAudioEffectsPackConfigurationStatics> : produce_base<D, Windows::Media::Audio::IAudioEffectsPackConfigurationStatics>
    {
        int32_t __stdcall GetForDeviceId(void* effectsPackId, void* deviceId, void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
            *result = detach_from<Windows::Media::Audio::AudioEffectsPackConfiguration>(this->shim().GetForDeviceId(*reinterpret_cast<hstring const*>(&effectsPackId), *reinterpret_cast<hstring const*>(&deviceId)));
            return 0;
        }
        catch (...) { return to_hresult(); }

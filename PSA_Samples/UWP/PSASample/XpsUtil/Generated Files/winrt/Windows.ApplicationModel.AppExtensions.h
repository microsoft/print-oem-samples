...
namespace winrt::impl
{
    ...
    template <typename D> WINRT_IMPL_AUTO(Windows::Foundation::Collections::IPropertySet) consume_Windows_ApplicationModel_AppExtensions_IAppExtension3<D>::GetExtensionProperties() const
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(Windows::ApplicationModel::AppExtensions::IAppExtension3)->GetExtensionProperties(&result));
    ...
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(Windows::ApplicationModel::AppExtensions::IAppExtension3)->GetPublicPath(&result));
        return hstring{ result, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Storage::StorageFolder) consume_Windows_ApplicationModel_AppExtensions_IAppExtension3<D>::GetPublicFolder() const
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(Windows::ApplicationModel::AppExtensions::IAppExtension3)->GetPublicFolder(&result));
    ...
    template <typename D> WINRT_IMPL_AUTO(Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::AppExtensions::AppExtension>) consume_Windows_ApplicationModel_AppExtensions_IAppExtensionCatalog2<D>::FindAll() const
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(Windows::ApplicationModel::AppExtensions::IAppExtensionCatalog2)->FindAll(&result));
        return Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::AppExtensions::AppExtension>{ result, take_ownership_from_abi };
    }
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, Windows::ApplicationModel::AppExtensions::IAppExtension3> : produce_base<D, Windows::ApplicationModel::AppExtensions::IAppExtension3>
    {
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, Windows::ApplicationModel::AppExtensions::IAppExtensionCatalog2> : produce_base<D, Windows::ApplicationModel::AppExtensions::IAppExtensionCatalog2>
    {
        int32_t __stdcall FindAll(void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
            *result = detach_from<Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::AppExtensions::AppExtension>>(this->shim().FindAll());
            return 0;
        }
        catch (...) { return to_hresult(); }
    };

...
namespace winrt::impl
{
    ...
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_Networking_Vpn_IVpnPlugInReconnectTransport<D>::ReconnectTransport(Windows::Networking::Vpn::VpnChannel const& channel, Windows::Foundation::IInspectable const& context) const
    {
        check_hresult(WINRT_IMPL_SHIM(Windows::Networking::Vpn::IVpnPlugInReconnectTransport)->ReconnectTransport(*(void**)(&channel), *(void**)(&context)));
    }
...
#endif
    template <typename D>
    struct produce<D, Windows::Networking::Vpn::IVpnPlugInReconnectTransport> : produce_base<D, Windows::Networking::Vpn::IVpnPlugInReconnectTransport>
    {
        int32_t __stdcall ReconnectTransport(void* channel, void* context) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            this->shim().ReconnectTransport(*reinterpret_cast<Windows::Networking::Vpn::VpnChannel const*>(&channel), *reinterpret_cast<Windows::Foundation::IInspectable const*>(&context));
            return 0;
        }
        catch (...) { return to_hresult(); }
    };

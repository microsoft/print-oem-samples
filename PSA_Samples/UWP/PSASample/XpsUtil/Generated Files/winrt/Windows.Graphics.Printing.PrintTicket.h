...
namespace winrt::impl
{
    ...
    template <typename D> WINRT_IMPL_AUTO(Windows::Graphics::Printing::PrintTicket::WorkflowPrintTicket) consume_Windows_Graphics_Printing_PrintTicket_IWorkflowPrintTicketFactory<D>::CreateInstance(param::hstring const& printerName, Windows::Storage::Streams::IInputStream const& printTicketStream) const
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Graphics::Printing::PrintTicket::IWorkflowPrintTicketFactory)->CreateInstance(*(void**)(&printerName), *(void**)(&printTicketStream), &value));
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, Windows::Graphics::Printing::PrintTicket::IWorkflowPrintTicketFactory> : produce_base<D, Windows::Graphics::Printing::PrintTicket::IWorkflowPrintTicketFactory>
    {
        int32_t __stdcall CreateInstance(void* printerName, void* printTicketStream, void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
            *value = detach_from<Windows::Graphics::Printing::PrintTicket::WorkflowPrintTicket>(this->shim().CreateInstance(*reinterpret_cast<hstring const*>(&printerName), *reinterpret_cast<Windows::Storage::Streams::IInputStream const*>(&printTicketStream)));
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
...
{
    inline WorkflowPrintTicket::WorkflowPrintTicket(param::hstring const& printerName, Windows::Storage::Streams::IInputStream const& printTicketStream) :

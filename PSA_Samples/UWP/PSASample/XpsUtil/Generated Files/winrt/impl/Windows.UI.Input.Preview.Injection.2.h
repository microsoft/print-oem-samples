...
WINRT_EXPORT namespace winrt::Windows::UI::Input::Preview::Injection
{
    ...
    struct __declspec(empty_bases) InjectedInputGamepadInfo : Windows::UI::Input::Preview::Injection::IInjectedInputGamepadInfo
    {
        ...
        InjectedInputGamepadInfo(InjectedInputGamepadInfo const&) noexcept = default;
        InjectedInputGamepadInfo(InjectedInputGamepadInfo&&) noexcept = default;
        InjectedInputGamepadInfo& operator=(InjectedInputGamepadInfo const&) & noexcept = default;
        InjectedInputGamepadInfo& operator=(InjectedInputGamepadInfo&&) & noexcept = default;
    };
    struct __declspec(empty_bases) InjectedInputKeyboardInfo : Windows::UI::Input::Preview::Injection::IInjectedInputKeyboardInfo
    {
        ...
        InjectedInputKeyboardInfo(InjectedInputKeyboardInfo const&) noexcept = default;
        InjectedInputKeyboardInfo(InjectedInputKeyboardInfo&&) noexcept = default;
        InjectedInputKeyboardInfo& operator=(InjectedInputKeyboardInfo const&) & noexcept = default;
        InjectedInputKeyboardInfo& operator=(InjectedInputKeyboardInfo&&) & noexcept = default;
    };
    struct __declspec(empty_bases) InjectedInputMouseInfo : Windows::UI::Input::Preview::Injection::IInjectedInputMouseInfo
    {
        ...
        InjectedInputMouseInfo(InjectedInputMouseInfo const&) noexcept = default;
        InjectedInputMouseInfo(InjectedInputMouseInfo&&) noexcept = default;
        InjectedInputMouseInfo& operator=(InjectedInputMouseInfo const&) & noexcept = default;
        InjectedInputMouseInfo& operator=(InjectedInputMouseInfo&&) & noexcept = default;
    };
    struct __declspec(empty_bases) InjectedInputPenInfo : Windows::UI::Input::Preview::Injection::IInjectedInputPenInfo
    {
        ...
        InjectedInputPenInfo(InjectedInputPenInfo const&) noexcept = default;
        InjectedInputPenInfo(InjectedInputPenInfo&&) noexcept = default;
        InjectedInputPenInfo& operator=(InjectedInputPenInfo const&) & noexcept = default;
        InjectedInputPenInfo& operator=(InjectedInputPenInfo&&) & noexcept = default;
    };
    struct __declspec(empty_bases) InjectedInputTouchInfo : Windows::UI::Input::Preview::Injection::IInjectedInputTouchInfo
    {
        ...
        InjectedInputTouchInfo(InjectedInputTouchInfo const&) noexcept = default;
        InjectedInputTouchInfo(InjectedInputTouchInfo&&) noexcept = default;
        InjectedInputTouchInfo& operator=(InjectedInputTouchInfo const&) & noexcept = default;
        InjectedInputTouchInfo& operator=(InjectedInputTouchInfo&&) & noexcept = default;
    };
        ...
        impl::require<InputInjector, Windows::UI::Input::Preview::Injection::IInputInjector2>
    {
        ...
        InputInjector(InputInjector const&) noexcept = default;
        InputInjector(InputInjector&&) noexcept = default;
        InputInjector& operator=(InputInjector const&) & noexcept = default;
        InputInjector& operator=(InputInjector&&) & noexcept = default;

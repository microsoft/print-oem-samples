...
WINRT_EXPORT namespace winrt::Windows::Media::Editing
{
    struct __declspec(empty_bases) BackgroundAudioTrack : Windows::Media::Editing::IBackgroundAudioTrack
    {
        ...
        BackgroundAudioTrack(BackgroundAudioTrack const&) noexcept = default;
        BackgroundAudioTrack(BackgroundAudioTrack&&) noexcept = default;
        BackgroundAudioTrack& operator=(BackgroundAudioTrack const&) & noexcept = default;
        BackgroundAudioTrack& operator=(BackgroundAudioTrack&&) & noexcept = default;
    ...
    struct __declspec(empty_bases) EmbeddedAudioTrack : Windows::Media::Editing::IEmbeddedAudioTrack
    {
        ...
        EmbeddedAudioTrack(EmbeddedAudioTrack const&) noexcept = default;
        EmbeddedAudioTrack(EmbeddedAudioTrack&&) noexcept = default;
        EmbeddedAudioTrack& operator=(EmbeddedAudioTrack const&) & noexcept = default;
        EmbeddedAudioTrack& operator=(EmbeddedAudioTrack&&) & noexcept = default;
    };
    struct __declspec(empty_bases) MediaClip : Windows::Media::Editing::IMediaClip
    {
        ...
        MediaClip(MediaClip const&) noexcept = default;
        MediaClip(MediaClip&&) noexcept = default;
        MediaClip& operator=(MediaClip const&) & noexcept = default;
        MediaClip& operator=(MediaClip&&) & noexcept = default;
        ...
        impl::require<MediaComposition, Windows::Media::Editing::IMediaComposition2>
    {
        ...
        MediaComposition();
        MediaComposition(MediaComposition const&) noexcept = default;
        MediaComposition(MediaComposition&&) noexcept = default;
        MediaComposition& operator=(MediaComposition const&) & noexcept = default;
        MediaComposition& operator=(MediaComposition&&) & noexcept = default;
    ...
    struct __declspec(empty_bases) MediaOverlay : Windows::Media::Editing::IMediaOverlay
    {
        ...
        MediaOverlay(MediaOverlay const&) noexcept = default;
        MediaOverlay(MediaOverlay&&) noexcept = default;
        MediaOverlay& operator=(MediaOverlay const&) & noexcept = default;
        MediaOverlay& operator=(MediaOverlay&&) & noexcept = default;
    };
    struct __declspec(empty_bases) MediaOverlayLayer : Windows::Media::Editing::IMediaOverlayLayer
    {
        ...
        MediaOverlayLayer(MediaOverlayLayer const&) noexcept = default;
        MediaOverlayLayer(MediaOverlayLayer&&) noexcept = default;
        MediaOverlayLayer& operator=(MediaOverlayLayer const&) & noexcept = default;
        MediaOverlayLayer& operator=(MediaOverlayLayer&&) & noexcept = default;
    };
}
#endif

...
WINRT_EXPORT namespace winrt::Windows::Devices::Input
{
        ...
        impl::consume_t<IPenDevice2>
    {
        ...
        IPenDevice2(IPenDevice2 const&) noexcept = default;
        IPenDevice2(IPenDevice2&&) noexcept = default;
        IPenDevice2& operator=(IPenDevice2 const&) & noexcept = default;
        IPenDevice2& operator=(IPenDevice2&&) & noexcept = default;
    };

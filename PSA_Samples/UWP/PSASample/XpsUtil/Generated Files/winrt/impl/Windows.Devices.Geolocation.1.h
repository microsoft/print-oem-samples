...
WINRT_EXPORT namespace winrt::Windows::Devices::Geolocation
{
        ...
        impl::consume_t<IGeocoordinateWithRemoteSource>
    {
        ...
        IGeocoordinateWithRemoteSource(void* ptr, take_ownership_from_abi_t) noexcept : Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
        IGeocoordinateWithRemoteSource(IGeocoordinateWithRemoteSource const&) noexcept = default;
        IGeocoordinateWithRemoteSource(IGeocoordinateWithRemoteSource&&) noexcept = default;
        IGeocoordinateWithRemoteSource& operator=(IGeocoordinateWithRemoteSource const&) & noexcept = default;
        IGeocoordinateWithRemoteSource& operator=(IGeocoordinateWithRemoteSource&&) & noexcept = default;
    };

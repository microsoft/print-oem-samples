...
namespace winrt::impl
{
    ...
    template <> struct category<Windows::System::RemoteDesktop::Input::IRemoteTextConnection2>{ using type = interface_category; };
    template <> struct category<Windows::System::RemoteDesktop::Input::IRemoteTextConnectionFactory>{ using type = interface_category; };
    template <> struct category<Windows::System::RemoteDesktop::Input::IRemoteTextConnectionFactory2>{ using type = interface_category; };
    template <> struct category<Windows::System::RemoteDesktop::Input::RemoteTextConnection>{ using type = class_category; };
    template <> struct category<Windows::System::RemoteDesktop::Input::RemoteKeyEventAttributes>{ using type = enum_category; };
    template <> struct category<Windows::System::RemoteDesktop::Input::RemoteTextConnectionOptions>{ using type = enum_category; };
    ...
    template <> inline constexpr auto& name_v<Windows::System::RemoteDesktop::Input::RemoteKeyEventAttributes> = L"Windows.System.RemoteDesktop.Input.RemoteKeyEventAttributes";
    template <> inline constexpr auto& name_v<Windows::System::RemoteDesktop::Input::RemoteTextConnectionOptions> = L"Windows.System.RemoteDesktop.Input.RemoteTextConnectionOptions";
    ...
    template <> inline constexpr auto& name_v<Windows::System::RemoteDesktop::Input::IRemoteTextConnection2> = L"Windows.System.RemoteDesktop.Input.IRemoteTextConnection2";
    ...
    template <> inline constexpr auto& name_v<Windows::System::RemoteDesktop::Input::IRemoteTextConnectionFactory2> = L"Windows.System.RemoteDesktop.Input.IRemoteTextConnectionFactory2";
    ...
    template <> inline constexpr guid guid_v<Windows::System::RemoteDesktop::Input::IRemoteTextConnection2>{ 0x05F99345,0x84C8,0x56C5,{ 0x93,0x4F,0x73,0xEA,0x00,0xF8,0xC2,0xD5 } }; // 05F99345-84C8-56C5-934F-73EA00F8C2D5
    ...
    template <> inline constexpr guid guid_v<Windows::System::RemoteDesktop::Input::IRemoteTextConnectionFactory2>{ 0x9425C7D9,0xED9B,0x5D00,{ 0x99,0xCC,0xB0,0xB8,0xDC,0x9E,0x4C,0x60 } }; // 9425C7D9-ED9B-5D00-99CC-B0B8DC9E4C60
    ...
    template <> struct abi<Windows::System::RemoteDesktop::Input::IRemoteTextConnection2>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::System::RemoteDesktop::Input::IRemoteTextConnectionFactory2>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    {
        WINRT_IMPL_AUTO(void) ReportPredictedKeyEvent(uint16_t scanCode, Windows::System::RemoteDesktop::Input::RemoteKeyEventAttributes const& attributes) const;
    };
    template <> struct consume<Windows::System::RemoteDesktop::Input::IRemoteTextConnection2>
    {
    ...
    {
        WINRT_IMPL_AUTO(Windows::System::RemoteDesktop::Input::RemoteTextConnection) CreateInstance(winrt::guid const& connectionId, Windows::System::RemoteDesktop::Input::RemoteTextConnectionDataHandler const& pduForwarder, Windows::System::RemoteDesktop::Input::RemoteTextConnectionOptions const& options) const;
    };
    template <> struct consume<Windows::System::RemoteDesktop::Input::IRemoteTextConnectionFactory2>
    {

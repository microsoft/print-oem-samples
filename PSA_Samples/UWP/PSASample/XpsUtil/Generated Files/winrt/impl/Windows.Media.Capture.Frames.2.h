...
WINRT_EXPORT namespace winrt::Windows::Media::Capture::Frames
{
    ...
    struct __declspec(empty_bases) MediaFrameSourceInfo : Windows::Media::Capture::Frames::IMediaFrameSourceInfo,
        impl::require<MediaFrameSourceInfo, Windows::Media::Capture::Frames::IMediaFrameSourceInfo2, Windows::Media::Capture::Frames::IMediaFrameSourceInfo3, Windows::Media::Capture::Frames::IMediaFrameSourceInfo4>
    {

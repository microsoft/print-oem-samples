...
namespace winrt::impl
{
    ...
    template <> struct category<Windows::ApplicationModel::AppExtensions::IAppExtension2>{ using type = interface_category; };
    template <> struct category<Windows::ApplicationModel::AppExtensions::IAppExtension3>{ using type = interface_category; };
    template <> struct category<Windows::ApplicationModel::AppExtensions::IAppExtensionCatalog>{ using type = interface_category; };
    template <> struct category<Windows::ApplicationModel::AppExtensions::IAppExtensionCatalog2>{ using type = interface_category; };
    ...
    template <> inline constexpr auto& name_v<Windows::ApplicationModel::AppExtensions::IAppExtension2> = L"Windows.ApplicationModel.AppExtensions.IAppExtension2";
    template <> inline constexpr auto& name_v<Windows::ApplicationModel::AppExtensions::IAppExtension3> = L"Windows.ApplicationModel.AppExtensions.IAppExtension3";
    ...
    template <> inline constexpr auto& name_v<Windows::ApplicationModel::AppExtensions::IAppExtensionCatalog2> = L"Windows.ApplicationModel.AppExtensions.IAppExtensionCatalog2";
    ...
    template <> inline constexpr guid guid_v<Windows::ApplicationModel::AppExtensions::IAppExtension2>{ 0xAB3B15F0,0x14F9,0x4B9F,{ 0x94,0x19,0xA3,0x49,0xA2,0x42,0xEF,0x38 } }; // AB3B15F0-14F9-4B9F-9419-A349A242EF38
    template <> inline constexpr guid guid_v<Windows::ApplicationModel::AppExtensions::IAppExtension3>{ 0x5923C101,0xAA38,0x4009,{ 0x84,0xD9,0x5B,0x54,0xA0,0xDF,0x30,0xAE } }; // 5923C101-AA38-4009-84D9-5B54A0DF30AE
    ...
    template <> inline constexpr guid guid_v<Windows::ApplicationModel::AppExtensions::IAppExtensionCatalog2>{ 0x50056EBA,0x58B6,0x4147,{ 0xB5,0xA5,0x8F,0xEC,0xA6,0xDF,0xB4,0x9D } }; // 50056EBA-58B6-4147-B5A5-8FECA6DFB49D
    ...
    template <> struct abi<Windows::ApplicationModel::AppExtensions::IAppExtension2>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::ApplicationModel::AppExtensions::IAppExtension3>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::ApplicationModel::AppExtensions::IAppExtensionCatalog2>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct consume<Windows::ApplicationModel::AppExtensions::IAppExtension2>
    {
    ...
    template <> struct consume<Windows::ApplicationModel::AppExtensions::IAppExtension3>
    {
    ...
    {
        WINRT_IMPL_AUTO(Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::AppExtensions::AppExtension>) FindAll() const;
    };
    template <> struct consume<Windows::ApplicationModel::AppExtensions::IAppExtensionCatalog2>
    {

...
WINRT_EXPORT namespace winrt::Windows::ApplicationModel::Store::Preview
{
    struct __declspec(empty_bases) DeliveryOptimizationSettings : Windows::ApplicationModel::Store::Preview::IDeliveryOptimizationSettings
    {
        ...
        DeliveryOptimizationSettings(DeliveryOptimizationSettings const&) noexcept = default;
        DeliveryOptimizationSettings(DeliveryOptimizationSettings&&) noexcept = default;
        DeliveryOptimizationSettings& operator=(DeliveryOptimizationSettings const&) & noexcept = default;
        DeliveryOptimizationSettings& operator=(DeliveryOptimizationSettings&&) & noexcept = default;
    ...
    struct __declspec(empty_bases) StoreHardwareManufacturerInfo : Windows::ApplicationModel::Store::Preview::IStoreHardwareManufacturerInfo
    {
        ...
        StoreHardwareManufacturerInfo(StoreHardwareManufacturerInfo const&) noexcept = default;
        StoreHardwareManufacturerInfo(StoreHardwareManufacturerInfo&&) noexcept = default;
        StoreHardwareManufacturerInfo& operator=(StoreHardwareManufacturerInfo const&) & noexcept = default;
        StoreHardwareManufacturerInfo& operator=(StoreHardwareManufacturerInfo&&) & noexcept = default;
    };
    struct StorePreview
    {
        StorePreview() = delete;
    ...
    struct __declspec(empty_bases) StorePreviewProductInfo : Windows::ApplicationModel::Store::Preview::IStorePreviewProductInfo
    {
        ...
        StorePreviewProductInfo(StorePreviewProductInfo const&) noexcept = default;
        StorePreviewProductInfo(StorePreviewProductInfo&&) noexcept = default;
        StorePreviewProductInfo& operator=(StorePreviewProductInfo const&) & noexcept = default;
        StorePreviewProductInfo& operator=(StorePreviewProductInfo&&) & noexcept = default;
    };
    struct __declspec(empty_bases) StorePreviewPurchaseResults : Windows::ApplicationModel::Store::Preview::IStorePreviewPurchaseResults
    {
        ...
        StorePreviewPurchaseResults(StorePreviewPurchaseResults const&) noexcept = default;
        StorePreviewPurchaseResults(StorePreviewPurchaseResults&&) noexcept = default;
        StorePreviewPurchaseResults& operator=(StorePreviewPurchaseResults const&) & noexcept = default;
        StorePreviewPurchaseResults& operator=(StorePreviewPurchaseResults&&) & noexcept = default;
    };
    struct __declspec(empty_bases) StorePreviewSkuInfo : Windows::ApplicationModel::Store::Preview::IStorePreviewSkuInfo
    {
        ...
        StorePreviewSkuInfo(StorePreviewSkuInfo const&) noexcept = default;
        StorePreviewSkuInfo(StorePreviewSkuInfo&&) noexcept = default;
        StorePreviewSkuInfo& operator=(StorePreviewSkuInfo const&) & noexcept = default;
        StorePreviewSkuInfo& operator=(StorePreviewSkuInfo&&) & noexcept = default;
    };

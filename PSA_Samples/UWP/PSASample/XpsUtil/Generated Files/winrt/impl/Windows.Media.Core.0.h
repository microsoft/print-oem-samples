...
namespace winrt::impl
{
    ...
    template <> struct category<Windows::Media::Core::ITimedTextBouten>{ using type = interface_category; };
    ...
    template <> struct category<Windows::Media::Core::ITimedTextRuby>{ using type = interface_category; };
    ...
    template <> struct category<Windows::Media::Core::ITimedTextStyle3>{ using type = interface_category; };
    ...
    template <> struct category<Windows::Media::Core::TimedTextBouten>{ using type = class_category; };
    ...
    template <> struct category<Windows::Media::Core::TimedTextRuby>{ using type = class_category; };
    ...
    template <> struct category<Windows::Media::Core::TimedTextBoutenPosition>{ using type = enum_category; };
    template <> struct category<Windows::Media::Core::TimedTextBoutenType>{ using type = enum_category; };
    ...
    template <> struct category<Windows::Media::Core::TimedTextRubyAlign>{ using type = enum_category; };
    template <> struct category<Windows::Media::Core::TimedTextRubyPosition>{ using type = enum_category; };
    template <> struct category<Windows::Media::Core::TimedTextRubyReserve>{ using type = enum_category; };
    ...
    template <> inline constexpr auto& name_v<Windows::Media::Core::TimedTextBouten> = L"Windows.Media.Core.TimedTextBouten";
    ...
    template <> inline constexpr auto& name_v<Windows::Media::Core::TimedTextRuby> = L"Windows.Media.Core.TimedTextRuby";
    ...
    template <> inline constexpr auto& name_v<Windows::Media::Core::TimedTextBoutenPosition> = L"Windows.Media.Core.TimedTextBoutenPosition";
    template <> inline constexpr auto& name_v<Windows::Media::Core::TimedTextBoutenType> = L"Windows.Media.Core.TimedTextBoutenType";
    ...
    template <> inline constexpr auto& name_v<Windows::Media::Core::TimedTextRubyAlign> = L"Windows.Media.Core.TimedTextRubyAlign";
    template <> inline constexpr auto& name_v<Windows::Media::Core::TimedTextRubyPosition> = L"Windows.Media.Core.TimedTextRubyPosition";
    template <> inline constexpr auto& name_v<Windows::Media::Core::TimedTextRubyReserve> = L"Windows.Media.Core.TimedTextRubyReserve";
    ...
    template <> inline constexpr auto& name_v<Windows::Media::Core::ITimedTextBouten> = L"Windows.Media.Core.ITimedTextBouten";
    ...
    template <> inline constexpr auto& name_v<Windows::Media::Core::ITimedTextRuby> = L"Windows.Media.Core.ITimedTextRuby";
    ...
    template <> inline constexpr auto& name_v<Windows::Media::Core::ITimedTextStyle3> = L"Windows.Media.Core.ITimedTextStyle3";
    ...
    template <> inline constexpr guid guid_v<Windows::Media::Core::IAudioStreamDescriptor>{ 0x1E3692E4,0x4027,0x4847,{ 0xA7,0x0B,0xDF,0x1D,0x9A,0x2A,0x7B,0x04 } }; // 1E3692E4-4027-4847-A70B-DF1D9A2A7B04
    template <> inline constexpr guid guid_v<Windows::Media::Core::IAudioStreamDescriptor2>{ 0x2E68F1F6,0xA448,0x497B,{ 0x88,0x40,0x85,0x08,0x26,0x65,0xAC,0xF9 } }; // 2E68F1F6-A448-497B-8840-85082665ACF9
    template <> inline constexpr guid guid_v<Windows::Media::Core::IAudioStreamDescriptor3>{ 0x4D220DA1,0x8E83,0x44EF,{ 0x89,0x73,0x2F,0x63,0xE9,0x93,0xF3,0x6B } }; // 4D220DA1-8E83-44EF-8973-2F63E993F36B
    template <> inline constexpr guid guid_v<Windows::Media::Core::IAudioStreamDescriptorFactory>{ 0x4A86CE9E,0x4CB1,0x4380,{ 0x8E,0x0C,0x83,0x50,0x4B,0x7F,0x5B,0xF3 } }; // 4A86CE9E-4CB1-4380-8E0C-83504B7F5BF3
    template <> inline constexpr guid guid_v<Windows::Media::Core::IAudioTrack>{ 0xF23B6E77,0x3EF7,0x40DE,{ 0xB9,0x43,0x06,0x8B,0x13,0x21,0x70,0x1D } }; // F23B6E77-3EF7-40DE-B943-068B1321701D
    template <> inline constexpr guid guid_v<Windows::Media::Core::IAudioTrackOpenFailedEventArgs>{ 0xEEDDB9B9,0xBB7C,0x4112,{ 0xBF,0x76,0x93,0x84,0x67,0x6F,0x82,0x4B } }; // EEDDB9B9-BB7C-4112-BF76-9384676F824B
    template <> inline constexpr guid guid_v<Windows::Media::Core::IAudioTrackSupportInfo>{ 0x178BEFF7,0xCC39,0x44A6,{ 0xB9,0x51,0x4A,0x56,0x53,0xF0,0x73,0xFA } }; // 178BEFF7-CC39-44A6-B951-4A5653F073FA
    template <> inline constexpr guid guid_v<Windows::Media::Core::IChapterCue>{ 0x72A98001,0xD38A,0x4C0A,{ 0x8F,0xA6,0x75,0xCD,0xDA,0xF4,0x66,0x4C } }; // 72A98001-D38A-4C0A-8FA6-75CDDAF4664C
    template <> inline constexpr guid guid_v<Windows::Media::Core::ICodecInfo>{ 0x51E89F85,0xEA97,0x499C,{ 0x86,0xAC,0x4C,0xE5,0xE7,0x3F,0x3A,0x42 } }; // 51E89F85-EA97-499C-86AC-4CE5E73F3A42
    template <> inline constexpr guid guid_v<Windows::Media::Core::ICodecQuery>{ 0x222A953A,0xAF61,0x4E04,{ 0x80,0x8A,0xA4,0x63,0x4E,0x2F,0x3A,0xC4 } }; // 222A953A-AF61-4E04-808A-A4634E2F3AC4
    template <> inline constexpr guid guid_v<Windows::Media::Core::ICodecSubtypesStatics>{ 0xA66AC4F2,0x888B,0x4224,{ 0x8C,0xF6,0x2A,0x8D,0x4E,0xB0,0x23,0x82 } }; // A66AC4F2-888B-4224-8CF6-2A8D4EB02382
    template <> inline constexpr guid guid_v<Windows::Media::Core::IDataCue>{ 0x7C7F676D,0x1FBC,0x4E2D,{ 0x9A,0x87,0xEE,0x38,0xBD,0x1D,0xC6,0x37 } }; // 7C7F676D-1FBC-4E2D-9A87-EE38BD1DC637
    template <> inline constexpr guid guid_v<Windows::Media::Core::IDataCue2>{ 0xBC561B15,0x95F2,0x49E8,{ 0x96,0xF1,0x8D,0xD5,0xDA,0xC6,0x8D,0x93 } }; // BC561B15-95F2-49E8-96F1-8DD5DAC68D93
    template <> inline constexpr guid guid_v<Windows::Media::Core::IFaceDetectedEventArgs>{ 0x19918426,0xC65B,0x46BA,{ 0x85,0xF8,0x13,0x88,0x05,0x76,0xC9,0x0A } }; // 19918426-C65B-46BA-85F8-13880576C90A
    template <> inline constexpr guid guid_v<Windows::Media::Core::IFaceDetectionEffect>{ 0xAE15EBD2,0x0542,0x42A9,{ 0xBC,0x90,0xF2,0x83,0xA2,0x9F,0x46,0xC1 } }; // AE15EBD2-0542-42A9-BC90-F283A29F46C1
    template <> inline constexpr guid guid_v<Windows::Media::Core::IFaceDetectionEffectDefinition>{ 0x43DCA081,0xB848,0x4F33,{ 0xB7,0x02,0x1F,0xD2,0x62,0x4F,0xB0,0x16 } }; // 43DCA081-B848-4F33-B702-1FD2624FB016
    template <> inline constexpr guid guid_v<Windows::Media::Core::IFaceDetectionEffectFrame>{ 0x8AB08993,0x5DC8,0x447B,{ 0xA2,0x47,0x52,0x70,0xBD,0x80,0x2E,0xCE } }; // 8AB08993-5DC8-447B-A247-5270BD802ECE
    template <> inline constexpr guid guid_v<Windows::Media::Core::IHighDynamicRangeControl>{ 0x55F1A7AE,0xD957,0x4DC9,{ 0x9D,0x1C,0x85,0x53,0xA8,0x2A,0x7D,0x99 } }; // 55F1A7AE-D957-4DC9-9D1C-8553A82A7D99
    template <> inline constexpr guid guid_v<Windows::Media::Core::IHighDynamicRangeOutput>{ 0x0F57806B,0x253B,0x4119,{ 0xBB,0x40,0x3A,0x90,0xE5,0x13,0x84,0xF7 } }; // 0F57806B-253B-4119-BB40-3A90E51384F7
    template <> inline constexpr guid guid_v<Windows::Media::Core::IImageCue>{ 0x52828282,0x367B,0x440B,{ 0x91,0x16,0x3C,0x84,0x57,0x0D,0xD2,0x70 } }; // 52828282-367B-440B-9116-3C84570DD270
    template <> inline constexpr guid guid_v<Windows::Media::Core::IInitializeMediaStreamSourceRequestedEventArgs>{ 0x25BC45E1,0x9B08,0x4C2E,{ 0xA8,0x55,0x45,0x42,0xF1,0xA7,0x5D,0xEB } }; // 25BC45E1-9B08-4C2E-A855-4542F1A75DEB
    template <> inline constexpr guid guid_v<Windows::Media::Core::ILowLightFusionResult>{ 0x78EDBE35,0x27A0,0x42E0,{ 0x9C,0xD3,0x73,0x8D,0x20,0x89,0xDE,0x9C } }; // 78EDBE35-27A0-42E0-9CD3-738D2089DE9C
    template <> inline constexpr guid guid_v<Windows::Media::Core::ILowLightFusionStatics>{ 0x5305016D,0xC29E,0x40E2,{ 0x87,0xA9,0x9E,0x1F,0xD2,0xF1,0x92,0xF5 } }; // 5305016D-C29E-40E2-87A9-9E1FD2F192F5
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMediaBinder>{ 0x2B7E40AA,0xDE07,0x424F,{ 0x83,0xF1,0xF1,0xDE,0x46,0xC4,0xFA,0x2E } }; // 2B7E40AA-DE07-424F-83F1-F1DE46C4FA2E
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMediaBindingEventArgs>{ 0xB61CB25A,0x1B6D,0x4630,{ 0xA8,0x6D,0x2F,0x08,0x37,0xF7,0x12,0xE5 } }; // B61CB25A-1B6D-4630-A86D-2F0837F712E5
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMediaBindingEventArgs2>{ 0x0464CCEB,0xBB5A,0x482F,{ 0xB8,0xBA,0xF0,0x28,0x4C,0x69,0x65,0x67 } }; // 0464CCEB-BB5A-482F-B8BA-F0284C696567
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMediaBindingEventArgs3>{ 0xF8EB475E,0x19BE,0x44FC,{ 0xA5,0xED,0x7A,0xBA,0x31,0x50,0x37,0xF9 } }; // F8EB475E-19BE-44FC-A5ED-7ABA315037F9
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMediaCue>{ 0xC7D15E5D,0x59DC,0x431F,{ 0xA0,0xEE,0x27,0x74,0x43,0x23,0xB3,0x6D } }; // C7D15E5D-59DC-431F-A0EE-27744323B36D
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMediaCueEventArgs>{ 0xD12F47F7,0x5FA4,0x4E68,{ 0x9F,0xE5,0x32,0x16,0x0D,0xCE,0xE5,0x7E } }; // D12F47F7-5FA4-4E68-9FE5-32160DCEE57E
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMediaSource>{ 0xE7BFB599,0xA09D,0x4C21,{ 0xBC,0xDF,0x20,0xAF,0x4F,0x86,0xB3,0xD9 } }; // E7BFB599-A09D-4C21-BCDF-20AF4F86B3D9
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMediaSource2>{ 0x2EB61048,0x655F,0x4C37,{ 0xB8,0x13,0xB4,0xE4,0x5D,0xFA,0x0A,0xBE } }; // 2EB61048-655F-4C37-B813-B4E45DFA0ABE
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMediaSource3>{ 0xB59F0D9B,0x4B6E,0x41ED,{ 0xBB,0xB4,0x7C,0x75,0x09,0xA9,0x94,0xAD } }; // B59F0D9B-4B6E-41ED-BBB4-7C7509A994AD
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMediaSource4>{ 0xBDAFAD57,0x8EFF,0x4C63,{ 0x85,0xA6,0x84,0xDE,0x0A,0xE3,0xE4,0xF2 } }; // BDAFAD57-8EFF-4C63-85A6-84DE0AE3E4F2
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMediaSource5>{ 0x331A22AE,0xED2E,0x4A22,{ 0x94,0xC8,0xB7,0x43,0xA9,0x2B,0x30,0x22 } }; // 331A22AE-ED2E-4A22-94C8-B743A92B3022
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMediaSourceAppServiceConnection>{ 0x61E1EA97,0x1916,0x4810,{ 0xB7,0xF4,0xB6,0x42,0xBE,0x82,0x95,0x96 } }; // 61E1EA97-1916-4810-B7F4-B642BE829596
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMediaSourceAppServiceConnectionFactory>{ 0x65B912EB,0x80B9,0x44F9,{ 0x9C,0x1E,0xE1,0x20,0xF6,0xD9,0x28,0x38 } }; // 65B912EB-80B9-44F9-9C1E-E120F6D92838
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMediaSourceError>{ 0x5C0A8965,0x37C5,0x4E9D,{ 0x8D,0x21,0x1C,0xDE,0xE9,0x0C,0xEC,0xC6 } }; // 5C0A8965-37C5-4E9D-8D21-1CDEE90CECC6
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMediaSourceOpenOperationCompletedEventArgs>{ 0xFC682CEB,0xE281,0x477C,{ 0xA8,0xE0,0x1A,0xCD,0x65,0x41,0x14,0xC8 } }; // FC682CEB-E281-477C-A8E0-1ACD654114C8
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMediaSourceStateChangedEventArgs>{ 0x0A30AF82,0x9071,0x4BAC,{ 0xBC,0x39,0xCA,0x2A,0x93,0xB7,0x17,0xA9 } }; // 0A30AF82-9071-4BAC-BC39-CA2A93B717A9
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMediaSourceStatics>{ 0xF77D6FA4,0x4652,0x410E,{ 0xB1,0xD8,0xE9,0xA5,0xE2,0x45,0xA4,0x5C } }; // F77D6FA4-4652-410E-B1D8-E9A5E245A45C
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMediaSourceStatics2>{ 0xEEE161A4,0x7F13,0x4896,{ 0xB8,0xCB,0xDF,0x0D,0xE5,0xBC,0xB9,0xF1 } }; // EEE161A4-7F13-4896-B8CB-DF0DE5BCB9F1
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMediaSourceStatics3>{ 0x453A30D6,0x2BEA,0x4122,{ 0x9F,0x73,0xEA,0xCE,0x04,0x52,0x6E,0x35 } }; // 453A30D6-2BEA-4122-9F73-EACE04526E35
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMediaSourceStatics4>{ 0x281B3BFC,0xE50A,0x4428,{ 0xA5,0x00,0x9C,0x4E,0xD9,0x18,0xD3,0xF0 } }; // 281B3BFC-E50A-4428-A500-9C4ED918D3F0
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMediaStreamDescriptor>{ 0x80F16E6E,0x92F7,0x451E,{ 0x97,0xD2,0xAF,0xD8,0x07,0x42,0xDA,0x70 } }; // 80F16E6E-92F7-451E-97D2-AFD80742DA70
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMediaStreamDescriptor2>{ 0x5073010F,0xE8B2,0x4071,{ 0xB0,0x0B,0xEB,0xF3,0x37,0xA7,0x6B,0x58 } }; // 5073010F-E8B2-4071-B00B-EBF337A76B58
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMediaStreamSample>{ 0x5C8DB627,0x4B80,0x4361,{ 0x98,0x37,0x6C,0xB7,0x48,0x1A,0xD9,0xD6 } }; // 5C8DB627-4B80-4361-9837-6CB7481AD9D6
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMediaStreamSample2>{ 0x45078691,0xFCE8,0x4746,{ 0xA1,0xC8,0x10,0xC2,0x5D,0x3D,0x7C,0xD3 } }; // 45078691-FCE8-4746-A1C8-10C25D3D7CD3
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMediaStreamSampleProtectionProperties>{ 0x4EB88292,0xECDF,0x493E,{ 0x84,0x1D,0xDD,0x4A,0xDD,0x7C,0xAC,0xA2 } }; // 4EB88292-ECDF-493E-841D-DD4ADD7CACA2
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMediaStreamSampleStatics>{ 0xDFDF218F,0xA6CF,0x4579,{ 0xBE,0x41,0x73,0xDD,0x94,0x1A,0xD9,0x72 } }; // DFDF218F-A6CF-4579-BE41-73DD941AD972
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMediaStreamSampleStatics2>{ 0x9EFE9521,0x6D46,0x494C,{ 0xA2,0xF8,0xD6,0x62,0x92,0x2E,0x2D,0xD7 } }; // 9EFE9521-6D46-494C-A2F8-D662922E2DD7
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMediaStreamSource>{ 0x3712D543,0x45EB,0x4138,{ 0xAA,0x62,0xC0,0x1E,0x26,0xF3,0x84,0x3F } }; // 3712D543-45EB-4138-AA62-C01E26F3843F
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMediaStreamSource2>{ 0xEC55D0AD,0x2E6A,0x4F74,{ 0xAD,0xBB,0xB5,0x62,0xD1,0x53,0x38,0x49 } }; // EC55D0AD-2E6A-4F74-ADBB-B562D1533849
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMediaStreamSource3>{ 0x6A2A2746,0x3DDD,0x4DDF,{ 0xA1,0x21,0x94,0x04,0x5E,0xCF,0x94,0x40 } }; // 6A2A2746-3DDD-4DDF-A121-94045ECF9440
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMediaStreamSource4>{ 0x1D0CFCAB,0x830D,0x417C,{ 0xA3,0xA9,0x24,0x54,0xFD,0x64,0x15,0xC7 } }; // 1D0CFCAB-830D-417C-A3A9-2454FD6415C7
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMediaStreamSourceClosedEventArgs>{ 0xCD8C7EB2,0x4816,0x4E24,{ 0x88,0xF0,0x49,0x1E,0xF7,0x38,0x64,0x06 } }; // CD8C7EB2-4816-4E24-88F0-491EF7386406
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMediaStreamSourceClosedRequest>{ 0x907C00E9,0x18A3,0x4951,{ 0x88,0x7A,0x2C,0x1E,0xEB,0xD5,0xC6,0x9E } }; // 907C00E9-18A3-4951-887A-2C1EEBD5C69E
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMediaStreamSourceFactory>{ 0xEF77E0D9,0xD158,0x4B7A,{ 0x86,0x3F,0x20,0x33,0x42,0xFB,0xFD,0x41 } }; // EF77E0D9-D158-4B7A-863F-203342FBFD41
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMediaStreamSourceSampleRenderedEventArgs>{ 0x9D697B05,0xD4F2,0x4C7A,{ 0x9D,0xFE,0x8D,0x6C,0xD0,0xB3,0xEE,0x84 } }; // 9D697B05-D4F2-4C7A-9DFE-8D6CD0B3EE84
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMediaStreamSourceSampleRequest>{ 0x4DB341A9,0x3501,0x4D9B,{ 0x83,0xF9,0x8F,0x23,0x5C,0x82,0x25,0x32 } }; // 4DB341A9-3501-4D9B-83F9-8F235C822532
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMediaStreamSourceSampleRequestDeferral>{ 0x7895CC02,0xF982,0x43C8,{ 0x9D,0x16,0xC6,0x2D,0x99,0x93,0x19,0xBE } }; // 7895CC02-F982-43C8-9D16-C62D999319BE
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMediaStreamSourceSampleRequestedEventArgs>{ 0x10F9BB9E,0x71C5,0x492F,{ 0x84,0x7F,0x0D,0xA1,0xF3,0x5E,0x81,0xF8 } }; // 10F9BB9E-71C5-492F-847F-0DA1F35E81F8
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMediaStreamSourceStartingEventArgs>{ 0xF41468F2,0xC274,0x4940,{ 0xA5,0xBB,0x28,0xA5,0x72,0x45,0x2F,0xA7 } }; // F41468F2-C274-4940-A5BB-28A572452FA7
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMediaStreamSourceStartingRequest>{ 0x2A9093E4,0x35C4,0x4B1B,{ 0xA7,0x91,0x0D,0x99,0xDB,0x56,0xDD,0x1D } }; // 2A9093E4-35C4-4B1B-A791-0D99DB56DD1D
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMediaStreamSourceStartingRequestDeferral>{ 0x3F1356A5,0x6340,0x4DC4,{ 0x99,0x10,0x06,0x8E,0xD9,0xF5,0x98,0xF8 } }; // 3F1356A5-6340-4DC4-9910-068ED9F598F8
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMediaStreamSourceSwitchStreamsRequest>{ 0x41B8808E,0x38A9,0x4EC3,{ 0x9B,0xA0,0xB6,0x9B,0x85,0x50,0x1E,0x90 } }; // 41B8808E-38A9-4EC3-9BA0-B69B85501E90
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMediaStreamSourceSwitchStreamsRequestDeferral>{ 0xBEE3D835,0xA505,0x4F9A,{ 0xB9,0x43,0x2B,0x8C,0xB1,0xB4,0xBB,0xD9 } }; // BEE3D835-A505-4F9A-B943-2B8CB1B4BBD9
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMediaStreamSourceSwitchStreamsRequestedEventArgs>{ 0x42202B72,0x6EA1,0x4677,{ 0x98,0x1E,0x35,0x0A,0x0D,0xA4,0x12,0xAA } }; // 42202B72-6EA1-4677-981E-350A0DA412AA
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMediaTrack>{ 0x03E1FAFC,0xC931,0x491A,{ 0xB4,0x6B,0xC1,0x0E,0xE8,0xC2,0x56,0xB7 } }; // 03E1FAFC-C931-491A-B46B-C10EE8C256B7
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMseSourceBuffer>{ 0x0C1AA3E3,0xDF8D,0x4079,{ 0xA3,0xFE,0x68,0x49,0x18,0x4B,0x4E,0x2F } }; // 0C1AA3E3-DF8D-4079-A3FE-6849184B4E2F
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMseSourceBufferList>{ 0x95FAE8E7,0xA8E7,0x4EBF,{ 0x89,0x27,0x14,0x5E,0x94,0x0B,0xA5,0x11 } }; // 95FAE8E7-A8E7-4EBF-8927-145E940BA511
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMseStreamSource>{ 0xB0B4198D,0x02F4,0x4923,{ 0x88,0xDD,0x81,0xBC,0x3F,0x36,0x0F,0xFA } }; // B0B4198D-02F4-4923-88DD-81BC3F360FFA
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMseStreamSource2>{ 0x66F57D37,0xF9E7,0x418A,{ 0x9C,0xDE,0xA0,0x20,0xE9,0x56,0x55,0x2B } }; // 66F57D37-F9E7-418A-9CDE-A020E956552B
    template <> inline constexpr guid guid_v<Windows::Media::Core::IMseStreamSourceStatics>{ 0x465C679D,0xD570,0x43CE,{ 0xBA,0x21,0x0B,0xFF,0x5F,0x3F,0xBD,0x0A } }; // 465C679D-D570-43CE-BA21-0BFF5F3FBD0A
    template <> inline constexpr guid guid_v<Windows::Media::Core::ISceneAnalysisEffect>{ 0xC04BA319,0xCA41,0x4813,{ 0xBF,0xFD,0x7B,0x08,0xB0,0xED,0x25,0x57 } }; // C04BA319-CA41-4813-BFFD-7B08B0ED2557
    template <> inline constexpr guid guid_v<Windows::Media::Core::ISceneAnalysisEffectFrame>{ 0xD8B10E4C,0x7FD9,0x42E1,{ 0x85,0xEB,0x65,0x72,0xC2,0x97,0xC9,0x87 } }; // D8B10E4C-7FD9-42E1-85EB-6572C297C987
    template <> inline constexpr guid guid_v<Windows::Media::Core::ISceneAnalysisEffectFrame2>{ 0x2D4E29BE,0x061F,0x47AE,{ 0x99,0x15,0x02,0x52,0x4B,0x5F,0x9A,0x5F } }; // 2D4E29BE-061F-47AE-9915-02524B5F9A5F
    template <> inline constexpr guid guid_v<Windows::Media::Core::ISceneAnalyzedEventArgs>{ 0x146B9588,0x2851,0x45E4,{ 0xAD,0x55,0x44,0xCF,0x8D,0xF8,0xDB,0x4D } }; // 146B9588-2851-45E4-AD55-44CF8DF8DB4D
    template <> inline constexpr guid guid_v<Windows::Media::Core::ISingleSelectMediaTrackList>{ 0x77206F1F,0xC34F,0x494F,{ 0x80,0x77,0x2B,0xAD,0x9F,0xF4,0xEC,0xF1 } }; // 77206F1F-C34F-494F-8077-2BAD9FF4ECF1
    template <> inline constexpr guid guid_v<Windows::Media::Core::ISpeechCue>{ 0xAEE254DC,0x1725,0x4BAD,{ 0x80,0x43,0xA9,0x84,0x99,0xB0,0x17,0xA2 } }; // AEE254DC-1725-4BAD-8043-A98499B017A2
    template <> inline constexpr guid guid_v<Windows::Media::Core::ITimedMetadataStreamDescriptor>{ 0x133336BF,0x296A,0x463E,{ 0x9F,0xF9,0x01,0xCD,0x25,0x69,0x14,0x08 } }; // 133336BF-296A-463E-9FF9-01CD25691408
    template <> inline constexpr guid guid_v<Windows::Media::Core::ITimedMetadataStreamDescriptorFactory>{ 0xC027DE30,0x7362,0x4FF9,{ 0x98,0xB1,0x2D,0xFD,0x0B,0x8D,0x1C,0xAE } }; // C027DE30-7362-4FF9-98B1-2DFD0B8D1CAE
    template <> inline constexpr guid guid_v<Windows::Media::Core::ITimedMetadataTrack>{ 0x9E6AED9E,0xF67A,0x49A9,{ 0xB3,0x30,0xCF,0x03,0xB0,0xE9,0xCF,0x07 } }; // 9E6AED9E-F67A-49A9-B330-CF03B0E9CF07
    template <> inline constexpr guid guid_v<Windows::Media::Core::ITimedMetadataTrack2>{ 0x21B4B648,0x9F9D,0x40BA,{ 0xA8,0xF3,0x1A,0x92,0x75,0x3A,0xEF,0x0B } }; // 21B4B648-9F9D-40BA-A8F3-1A92753AEF0B
    template <> inline constexpr guid guid_v<Windows::Media::Core::ITimedMetadataTrackError>{ 0xB3767915,0x4114,0x4819,{ 0xB9,0xD9,0xDD,0x76,0x08,0x9E,0x72,0xF8 } }; // B3767915-4114-4819-B9D9-DD76089E72F8
    template <> inline constexpr guid guid_v<Windows::Media::Core::ITimedMetadataTrackFactory>{ 0x8DD57611,0x97B3,0x4E1F,{ 0x85,0x2C,0x0F,0x48,0x2C,0x81,0xAD,0x26 } }; // 8DD57611-97B3-4E1F-852C-0F482C81AD26
    template <> inline constexpr guid guid_v<Windows::Media::Core::ITimedMetadataTrackFailedEventArgs>{ 0xA57FC9D1,0x6789,0x4D4D,{ 0xB0,0x7F,0x84,0xB4,0xF3,0x1A,0xCB,0x70 } }; // A57FC9D1-6789-4D4D-B07F-84B4F31ACB70
    template <> inline constexpr guid guid_v<Windows::Media::Core::ITimedMetadataTrackProvider>{ 0x3B7F2024,0xF74E,0x4ADE,{ 0x93,0xC5,0x21,0x9D,0xA0,0x5B,0x68,0x56 } }; // 3B7F2024-F74E-4ADE-93C5-219DA05B6856
    template <> inline constexpr guid guid_v<Windows::Media::Core::ITimedTextBouten>{ 0xD9062783,0x5597,0x5092,{ 0x82,0x0C,0x8F,0x73,0x8E,0x0F,0x77,0x4A } }; // D9062783-5597-5092-820C-8F738E0F774A
    template <> inline constexpr guid guid_v<Windows::Media::Core::ITimedTextCue>{ 0x51C79E51,0x3B86,0x494D,{ 0xB3,0x59,0xBB,0x2E,0xA7,0xAC,0xA9,0xA9 } }; // 51C79E51-3B86-494D-B359-BB2EA7ACA9A9
    template <> inline constexpr guid guid_v<Windows::Media::Core::ITimedTextLine>{ 0x978D7CE2,0x7308,0x4C66,{ 0xBE,0x50,0x65,0x77,0x72,0x89,0xF5,0xDF } }; // 978D7CE2-7308-4C66-BE50-65777289F5DF
    template <> inline constexpr guid guid_v<Windows::Media::Core::ITimedTextRegion>{ 0x1ED0881F,0x8A06,0x4222,{ 0x9F,0x59,0xB2,0x1B,0xF4,0x01,0x24,0xB4 } }; // 1ED0881F-8A06-4222-9F59-B21BF40124B4
    template <> inline constexpr guid guid_v<Windows::Media::Core::ITimedTextRuby>{ 0x10335C29,0x5B3C,0x5693,{ 0x99,0x59,0xD0,0x5A,0x0B,0xD2,0x46,0x28 } }; // 10335C29-5B3C-5693-9959-D05A0BD24628
    template <> inline constexpr guid guid_v<Windows::Media::Core::ITimedTextSource>{ 0xC4ED9BA6,0x101F,0x404D,{ 0xA9,0x49,0x82,0xF3,0x3F,0xCD,0x93,0xB7 } }; // C4ED9BA6-101F-404D-A949-82F33FCD93B7
    template <> inline constexpr guid guid_v<Windows::Media::Core::ITimedTextSourceResolveResultEventArgs>{ 0x48907C9C,0xDCD8,0x4C33,{ 0x9A,0xD3,0x6C,0xDC,0xE7,0xB1,0xC5,0x66 } }; // 48907C9C-DCD8-4C33-9AD3-6CDCE7B1C566
    template <> inline constexpr guid guid_v<Windows::Media::Core::ITimedTextSourceStatics>{ 0x7E311853,0x9ABA,0x4AC4,{ 0xBB,0x98,0x2F,0xB1,0x76,0xC3,0xBF,0xDD } }; // 7E311853-9ABA-4AC4-BB98-2FB176C3BFDD
    template <> inline constexpr guid guid_v<Windows::Media::Core::ITimedTextSourceStatics2>{ 0xB66B7602,0x923E,0x43FA,{ 0x96,0x33,0x58,0x70,0x75,0x81,0x2D,0xB5 } }; // B66B7602-923E-43FA-9633-587075812DB5
    template <> inline constexpr guid guid_v<Windows::Media::Core::ITimedTextStyle>{ 0x1BB2384D,0xA825,0x40C2,{ 0xA7,0xF5,0x28,0x1E,0xAE,0xDF,0x3B,0x55 } }; // 1BB2384D-A825-40C2-A7F5-281EAEDF3B55
    template <> inline constexpr guid guid_v<Windows::Media::Core::ITimedTextStyle2>{ 0x655F492D,0x6111,0x4787,{ 0x89,0xCC,0x68,0x6F,0xEC,0xE5,0x7E,0x14 } }; // 655F492D-6111-4787-89CC-686FECE57E14
    template <> inline constexpr guid guid_v<Windows::Media::Core::ITimedTextStyle3>{ 0xF803F93B,0x3E99,0x595E,{ 0xBB,0xB7,0x78,0xA2,0xFA,0x13,0xC2,0x70 } }; // F803F93B-3E99-595E-BBB7-78A2FA13C270
    template <> inline constexpr guid guid_v<Windows::Media::Core::ITimedTextSubformat>{ 0xD713502F,0x3261,0x4722,{ 0xA0,0xC2,0xB9,0x37,0xB2,0x39,0x0F,0x14 } }; // D713502F-3261-4722-A0C2-B937B2390F14
    template <> inline constexpr guid guid_v<Windows::Media::Core::IVideoStabilizationEffect>{ 0x0808A650,0x9698,0x4E57,{ 0x87,0x7B,0xBD,0x7C,0xB2,0xEE,0x0F,0x8A } }; // 0808A650-9698-4E57-877B-BD7CB2EE0F8A
    template <> inline constexpr guid guid_v<Windows::Media::Core::IVideoStabilizationEffectEnabledChangedEventArgs>{ 0x187EFF28,0x67BB,0x4713,{ 0xB9,0x00,0x41,0x68,0xDA,0x16,0x45,0x29 } }; // 187EFF28-67BB-4713-B900-4168DA164529
    template <> inline constexpr guid guid_v<Windows::Media::Core::IVideoStreamDescriptor>{ 0x12EE0D55,0x9C2B,0x4440,{ 0x80,0x57,0x2C,0x7A,0x90,0xF0,0xCB,0xEC } }; // 12EE0D55-9C2B-4440-8057-2C7A90F0CBEC
    template <> inline constexpr guid guid_v<Windows::Media::Core::IVideoStreamDescriptor2>{ 0x8B306E10,0x453E,0x4088,{ 0x83,0x2D,0xC3,0x6F,0xA4,0xF9,0x4A,0xF3 } }; // 8B306E10-453E-4088-832D-C36FA4F94AF3
    template <> inline constexpr guid guid_v<Windows::Media::Core::IVideoStreamDescriptorFactory>{ 0x494EF6D1,0xBB75,0x43D2,{ 0x9E,0x5E,0x7B,0x79,0xA3,0xAF,0xCE,0xD4 } }; // 494EF6D1-BB75-43D2-9E5E-7B79A3AFCED4
    template <> inline constexpr guid guid_v<Windows::Media::Core::IVideoTrack>{ 0x99F3B7F3,0xE298,0x4396,{ 0xBB,0x6A,0xA5,0x1B,0xE6,0xA2,0xA2,0x0A } }; // 99F3B7F3-E298-4396-BB6A-A51BE6A2A20A
    template <> inline constexpr guid guid_v<Windows::Media::Core::IVideoTrackOpenFailedEventArgs>{ 0x7679E231,0x04F9,0x4C82,{ 0xA4,0xEE,0x86,0x02,0xC8,0xBB,0x47,0x54 } }; // 7679E231-04F9-4C82-A4EE-8602C8BB4754
    template <> inline constexpr guid guid_v<Windows::Media::Core::IVideoTrackSupportInfo>{ 0x4BB534A0,0xFC5F,0x450D,{ 0x8F,0xF0,0x77,0x8D,0x59,0x04,0x86,0xDE } }; // 4BB534A0-FC5F-450D-8FF0-778D590486DE
    ...
    template <> struct default_interface<Windows::Media::Core::TimedTextBouten>{ using type = Windows::Media::Core::ITimedTextBouten; };
    ...
    template <> struct default_interface<Windows::Media::Core::TimedTextRuby>{ using type = Windows::Media::Core::ITimedTextRuby; };
    ...
    template <> struct abi<Windows::Media::Core::ITimedTextBouten>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::Media::Core::ITimedTextRuby>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
            virtual int32_t __stdcall get_Text(void**) noexcept = 0;
    ...
    template <> struct abi<Windows::Media::Core::ITimedTextStyle3>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Media::Core::TimedTextBoutenType) Type() const;
        WINRT_IMPL_AUTO(void) Type(Windows::Media::Core::TimedTextBoutenType const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::UI::Color) Color() const;
        WINRT_IMPL_AUTO(void) Color(Windows::UI::Color const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Media::Core::TimedTextBoutenPosition) Position() const;
        WINRT_IMPL_AUTO(void) Position(Windows::Media::Core::TimedTextBoutenPosition const& value) const;
    };
    template <> struct consume<Windows::Media::Core::ITimedTextBouten>
    {
    ...
    struct consume_Windows_Media_Core_ITimedTextRuby
    {
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) Text() const;
        WINRT_IMPL_AUTO(void) Text(param::hstring const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Media::Core::TimedTextRubyPosition) Position() const;
        WINRT_IMPL_AUTO(void) Position(Windows::Media::Core::TimedTextRubyPosition const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Media::Core::TimedTextRubyAlign) Align() const;
        WINRT_IMPL_AUTO(void) Align(Windows::Media::Core::TimedTextRubyAlign const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Media::Core::TimedTextRubyReserve) Reserve() const;
        WINRT_IMPL_AUTO(void) Reserve(Windows::Media::Core::TimedTextRubyReserve const& value) const;
    };
    template <> struct consume<Windows::Media::Core::ITimedTextRuby>
    {
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Media::Core::TimedTextRuby) Ruby() const;
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Media::Core::TimedTextBouten) Bouten() const;
    ...
    template <> struct consume<Windows::Media::Core::ITimedTextStyle3>
    {

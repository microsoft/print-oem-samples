...
{
    template <> struct category<Windows::Media::Effects::IAcousticEchoCancellationConfiguration>{ using type = interface_category; };
    ...
    template <> struct category<Windows::Media::Effects::IAudioEffect2>{ using type = interface_category; };
    ...
    template <> struct category<Windows::Media::Effects::AcousticEchoCancellationConfiguration>{ using type = class_category; };
    ...
    template <> struct category<Windows::Media::Effects::AudioEffectState>{ using type = enum_category; };
    ...
    template <> inline constexpr auto& name_v<Windows::Media::Effects::AcousticEchoCancellationConfiguration> = L"Windows.Media.Effects.AcousticEchoCancellationConfiguration";
    ...
    template <> inline constexpr auto& name_v<Windows::Media::Effects::AudioEffectState> = L"Windows.Media.Effects.AudioEffectState";
    ...
    template <> inline constexpr auto& name_v<Windows::Media::Effects::IAcousticEchoCancellationConfiguration> = L"Windows.Media.Effects.IAcousticEchoCancellationConfiguration";
    ...
    template <> inline constexpr auto& name_v<Windows::Media::Effects::IAudioEffect2> = L"Windows.Media.Effects.IAudioEffect2";
    ...
    template <> inline constexpr guid guid_v<Windows::Media::Effects::IAcousticEchoCancellationConfiguration>{ 0x587E735B,0x175B,0x5177,{ 0xA4,0x07,0x2E,0x33,0xBA,0xFE,0x33,0xA5 } }; // 587E735B-175B-5177-A407-2E33BAFE33A5
    ...
    template <> inline constexpr guid guid_v<Windows::Media::Effects::IAudioEffect2>{ 0x06703CB0,0x757E,0x5757,{ 0x8A,0xF0,0x6B,0xA5,0x8A,0x8B,0x29,0x90 } }; // 06703CB0-757E-5757-8AF0-6BA58A8B2990
    ...
    template <> struct default_interface<Windows::Media::Effects::AcousticEchoCancellationConfiguration>{ using type = Windows::Media::Effects::IAcousticEchoCancellationConfiguration; };
    ...
    template <> struct abi<Windows::Media::Effects::IAcousticEchoCancellationConfiguration>
    {
    ...
    template <> struct abi<Windows::Media::Effects::IAudioEffect2>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct consume<Windows::Media::Effects::IAcousticEchoCancellationConfiguration>
    {
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Media::Effects::AcousticEchoCancellationConfiguration) AcousticEchoCancellationConfiguration() const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) CanSetState() const;
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Media::Effects::AudioEffectState) State() const;
        WINRT_IMPL_AUTO(void) SetState(Windows::Media::Effects::AudioEffectState const& newState) const;
    };
    template <> struct consume<Windows::Media::Effects::IAudioEffect2>
    {

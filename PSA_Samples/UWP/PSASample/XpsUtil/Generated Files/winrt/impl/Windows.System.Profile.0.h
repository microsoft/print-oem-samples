...
namespace winrt::impl
{
    ...
    template <> struct category<Windows::System::Profile::IAnalyticsVersionInfo2>{ using type = interface_category; };
    ...
    template <> struct category<Windows::System::Profile::ISmartAppControlPolicyStatics>{ using type = interface_category; };
    ...
    template <> struct category<Windows::System::Profile::SmartAppControlPolicy>{ using type = class_category; };
    ...
    template <> inline constexpr auto& name_v<Windows::System::Profile::SmartAppControlPolicy> = L"Windows.System.Profile.SmartAppControlPolicy";
    ...
    template <> inline constexpr auto& name_v<Windows::System::Profile::IAnalyticsVersionInfo2> = L"Windows.System.Profile.IAnalyticsVersionInfo2";
    ...
    template <> inline constexpr auto& name_v<Windows::System::Profile::ISmartAppControlPolicyStatics> = L"Windows.System.Profile.ISmartAppControlPolicyStatics";
    ...
    template <> inline constexpr guid guid_v<Windows::System::Profile::ISmartAppControlPolicyStatics>{ 0x5FF8C75B,0x073E,0x5015,{ 0x8D,0x98,0x5F,0xF2,0x24,0x18,0x0A,0x0B } }; // 5FF8C75B-073E-5015-8D98-5FF224180A0B
    ...
    template <> inline constexpr guid guid_v<Windows::System::Profile::ISystemSetupInfoStatics>{ 0xB8366A4B,0xFB6A,0x4571,{ 0xBE,0x0A,0x9A,0x0F,0x67,0x95,0x41,0x23 } }; // B8366A4B-FB6A-4571-BE0A-9A0F67954123
    ...
    template <> struct abi<Windows::System::Profile::IAnalyticsVersionInfo2>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::System::Profile::ISmartAppControlPolicyStatics>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
            virtual int32_t __stdcall get_IsEnabled(bool*) noexcept = 0;
    ...
    template <> struct consume<Windows::System::Profile::IAnalyticsVersionInfo2>
    {
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(bool) IsEnabled() const;
        WINRT_IMPL_AUTO(winrt::event_token) Changed(Windows::Foundation::EventHandler<Windows::Foundation::IInspectable> const& handler) const;
        using Changed_revoker = impl::event_revoker<Windows::System::Profile::ISmartAppControlPolicyStatics, &impl::abi_t<Windows::System::Profile::ISmartAppControlPolicyStatics>::remove_Changed>;
        [[nodiscard]] Changed_revoker Changed(auto_revoke_t, Windows::Foundation::EventHandler<Windows::Foundation::IInspectable> const& handler) const;
        WINRT_IMPL_AUTO(void) Changed(winrt::event_token const& token) const noexcept;
    };
    template <> struct consume<Windows::System::Profile::ISmartAppControlPolicyStatics>
    {

...
WINRT_EXPORT namespace winrt::Windows::Networking::PushNotifications
{
    ...
    struct __declspec(empty_bases) PushNotificationChannelsRevokedEventArgs : Windows::Networking::PushNotifications::IPushNotificationChannelsRevokedEventArgs
    {
        ...
        PushNotificationChannelsRevokedEventArgs(PushNotificationChannelsRevokedEventArgs const&) noexcept = default;
        PushNotificationChannelsRevokedEventArgs(PushNotificationChannelsRevokedEventArgs&&) noexcept = default;
        PushNotificationChannelsRevokedEventArgs& operator=(PushNotificationChannelsRevokedEventArgs const&) & noexcept = default;
        PushNotificationChannelsRevokedEventArgs& operator=(PushNotificationChannelsRevokedEventArgs&&) & noexcept = default;
    };

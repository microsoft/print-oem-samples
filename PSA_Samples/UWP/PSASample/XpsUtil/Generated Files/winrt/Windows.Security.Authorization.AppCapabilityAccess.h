...
namespace winrt::impl
{
    ...
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Security::Authorization::AppCapabilityAccess::IAppCapability2)->get_DisplayMessage(&value));
        return hstring{ value, take_ownership_from_abi };
    }
    ...
    {
        check_hresult(WINRT_IMPL_SHIM(Windows::Security::Authorization::AppCapabilityAccess::IAppCapability2)->put_DisplayMessage(*(void**)(&value)));
    }
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, Windows::Security::Authorization::AppCapabilityAccess::IAppCapability2> : produce_base<D, Windows::Security::Authorization::AppCapabilityAccess::IAppCapability2>
    {

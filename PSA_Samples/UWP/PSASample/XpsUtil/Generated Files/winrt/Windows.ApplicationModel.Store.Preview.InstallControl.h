...
namespace winrt::impl
{
    ...
    {
        bool value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::ApplicationModel::Store::Preview::InstallControl::IGetEntitlementResult2)->get_IsAlreadyOwned(&value));
        return value;
    }
    ...
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::ApplicationModel::Store::Preview::InstallControl::IGetEntitlementResult2)->get_OrderId(&value));
        return hstring{ value, take_ownership_from_abi };
    }
    ...
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::ApplicationModel::Store::Preview::InstallControl::IGetEntitlementResult2)->get_SkuId(&value));
        return hstring{ value, take_ownership_from_abi };
    }
    ...
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::ApplicationModel::Store::Preview::InstallControl::IGetEntitlementResult2)->get_AvailabilityId(&value));
        return hstring{ value, take_ownership_from_abi };
    }
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, Windows::ApplicationModel::Store::Preview::InstallControl::IGetEntitlementResult2> : produce_base<D, Windows::ApplicationModel::Store::Preview::InstallControl::IGetEntitlementResult2>
    {

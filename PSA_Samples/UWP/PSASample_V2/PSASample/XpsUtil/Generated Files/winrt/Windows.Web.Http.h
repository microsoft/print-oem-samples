...
namespace winrt::impl
{
    ...
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Web::Http::IHttpClient3)->get_DefaultPrivacyAnnotation(&value));
    ...
    {
        check_hresult(WINRT_IMPL_SHIM(Windows::Web::Http::IHttpClient3)->put_DefaultPrivacyAnnotation(*(void**)(&value)));
    }
    ...
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Web::Http::IHttpRequestMessage2)->get_PrivacyAnnotation(&value));
        return hstring{ value, take_ownership_from_abi };
    }
    ...
    {
        check_hresult(WINRT_IMPL_SHIM(Windows::Web::Http::IHttpRequestMessage2)->put_PrivacyAnnotation(*(void**)(&value)));
    }
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, Windows::Web::Http::IHttpClient3> : produce_base<D, Windows::Web::Http::IHttpClient3>
    {
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, Windows::Web::Http::IHttpRequestMessage2> : produce_base<D, Windows::Web::Http::IHttpRequestMessage2>
    {

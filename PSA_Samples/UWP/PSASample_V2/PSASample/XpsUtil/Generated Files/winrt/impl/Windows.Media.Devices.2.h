...
WINRT_EXPORT namespace winrt::Windows::Media::Devices
{
    ...
    struct __declspec(empty_bases) AudioDeviceController : Windows::Media::Devices::IAudioDeviceController,
        impl::require<AudioDeviceController, Windows::Media::Devices::IAudioDeviceController2>
    {
    ...
    struct __declspec(empty_bases) CameraOcclusionInfo : Windows::Media::Devices::ICameraOcclusionInfo
    {
        ...
        CameraOcclusionInfo(CameraOcclusionInfo const&) noexcept = default;
        CameraOcclusionInfo(CameraOcclusionInfo&&) noexcept = default;
        CameraOcclusionInfo& operator=(CameraOcclusionInfo const&) & noexcept = default;
        CameraOcclusionInfo& operator=(CameraOcclusionInfo&&) & noexcept = default;
    };
    struct __declspec(empty_bases) CameraOcclusionState : Windows::Media::Devices::ICameraOcclusionState
    {
        ...
        CameraOcclusionState(CameraOcclusionState const&) noexcept = default;
        CameraOcclusionState(CameraOcclusionState&&) noexcept = default;
        CameraOcclusionState& operator=(CameraOcclusionState const&) & noexcept = default;
        CameraOcclusionState& operator=(CameraOcclusionState&&) & noexcept = default;
    };
    struct __declspec(empty_bases) CameraOcclusionStateChangedEventArgs : Windows::Media::Devices::ICameraOcclusionStateChangedEventArgs
    {
        ...
        CameraOcclusionStateChangedEventArgs(CameraOcclusionStateChangedEventArgs const&) noexcept = default;
        CameraOcclusionStateChangedEventArgs(CameraOcclusionStateChangedEventArgs&&) noexcept = default;
        CameraOcclusionStateChangedEventArgs& operator=(CameraOcclusionStateChangedEventArgs const&) & noexcept = default;
        CameraOcclusionStateChangedEventArgs& operator=(CameraOcclusionStateChangedEventArgs&&) & noexcept = default;
    };

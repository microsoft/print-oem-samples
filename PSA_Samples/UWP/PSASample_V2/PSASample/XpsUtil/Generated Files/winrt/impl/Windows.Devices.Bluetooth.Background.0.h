...
namespace winrt::impl
{
    ...
    template <> struct category<Windows::Devices::Bluetooth::Background::IBluetoothLEAdvertisementPublisherTriggerDetails2>{ using type = interface_category; };
    ...
    template <> struct category<Windows::Devices::Bluetooth::Background::IGattServiceProviderConnection2>{ using type = interface_category; };
    ...
    template <> inline constexpr auto& name_v<Windows::Devices::Bluetooth::Background::IGattServiceProviderConnection2> = L"Windows.Devices.Bluetooth.Background.IGattServiceProviderConnection2";
    ...
    template <> inline constexpr guid guid_v<Windows::Devices::Bluetooth::Background::IGattServiceProviderConnection2>{ 0x90D12BE0,0xEBC0,0x484F,{ 0xAE,0x0A,0x7E,0xB8,0xB6,0x26,0x6B,0xAC } }; // 90D12BE0-EBC0-484F-AE0A-7EB8B6266BAC
    ...
    template <> struct abi<Windows::Devices::Bluetooth::Background::IGattServiceProviderConnection2>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct consume<Windows::Devices::Bluetooth::Background::IGattServiceProviderConnection2>
    {

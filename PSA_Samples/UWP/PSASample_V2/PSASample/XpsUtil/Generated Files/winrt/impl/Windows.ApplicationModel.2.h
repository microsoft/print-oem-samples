...
WINRT_EXPORT namespace winrt::Windows::ApplicationModel
{
    ...
    struct __declspec(empty_bases) FindRelatedPackagesOptions : Windows::ApplicationModel::IFindRelatedPackagesOptions
    {
        FindRelatedPackagesOptions(std::nullptr_t) noexcept {}
        FindRelatedPackagesOptions(void* ptr, take_ownership_from_abi_t) noexcept : Windows::ApplicationModel::IFindRelatedPackagesOptions(ptr, take_ownership_from_abi) {}
        explicit FindRelatedPackagesOptions(Windows::ApplicationModel::PackageRelationship const& Relationship);
        FindRelatedPackagesOptions(FindRelatedPackagesOptions const&) noexcept = default;
        FindRelatedPackagesOptions(FindRelatedPackagesOptions&&) noexcept = default;
        FindRelatedPackagesOptions& operator=(FindRelatedPackagesOptions const&) & noexcept = default;
        FindRelatedPackagesOptions& operator=(FindRelatedPackagesOptions&&) & noexcept = default;
    };
        ...
        impl::require<PackageCatalog, Windows::ApplicationModel::IPackageCatalog2, Windows::ApplicationModel::IPackageCatalog3, Windows::ApplicationModel::IPackageCatalog4>
    {
        ...
        static auto OpenForPackage(Windows::ApplicationModel::Package const& package);
    };

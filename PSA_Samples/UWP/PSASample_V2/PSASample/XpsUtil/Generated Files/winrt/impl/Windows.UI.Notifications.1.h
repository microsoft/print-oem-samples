...
WINRT_EXPORT namespace winrt::Windows::UI::Notifications
{
        ...
        impl::consume_t<IToastNotificationManagerForUser3>
    {
        ...
        IToastNotificationManagerForUser3(IToastNotificationManagerForUser3 const&) noexcept = default;
        IToastNotificationManagerForUser3(IToastNotificationManagerForUser3&&) noexcept = default;
        IToastNotificationManagerForUser3& operator=(IToastNotificationManagerForUser3 const&) & noexcept = default;
        IToastNotificationManagerForUser3& operator=(IToastNotificationManagerForUser3&&) & noexcept = default;
    };

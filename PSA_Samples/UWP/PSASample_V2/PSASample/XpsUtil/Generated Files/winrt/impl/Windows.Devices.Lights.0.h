...
namespace winrt::impl
{
    ...
    template <> struct category<Windows::Devices::Lights::ILampArray2>{ using type = interface_category; };
    ...
    template <> inline constexpr auto& name_v<Windows::Devices::Lights::ILampArray2> = L"Windows.Devices.Lights.ILampArray2";
    ...
    template <> inline constexpr guid guid_v<Windows::Devices::Lights::ILampArray2>{ 0x050C181F,0x60A8,0x4711,{ 0xA1,0xAF,0x1B,0x1B,0x4C,0x65,0x8E,0xA2 } }; // 050C181F-60A8-4711-A1AF-1B1B4C658EA2
    ...
    template <> struct abi<Windows::Devices::Lights::ILampArray2>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    struct consume_Windows_Devices_Lights_ILampArray2
    {
        ...
        WINRT_IMPL_AUTO(winrt::event_token) AvailabilityChanged(Windows::Foundation::TypedEventHandler<Windows::Devices::Lights::LampArray, Windows::Foundation::IInspectable> const& handler) const;
        using AvailabilityChanged_revoker = impl::event_revoker<Windows::Devices::Lights::ILampArray2, &impl::abi_t<Windows::Devices::Lights::ILampArray2>::remove_AvailabilityChanged>;
        [[nodiscard]] AvailabilityChanged_revoker AvailabilityChanged(auto_revoke_t, Windows::Foundation::TypedEventHandler<Windows::Devices::Lights::LampArray, Windows::Foundation::IInspectable> const& handler) const;
        WINRT_IMPL_AUTO(void) AvailabilityChanged(winrt::event_token const& token) const noexcept;
    };
    template <> struct consume<Windows::Devices::Lights::ILampArray2>
    {

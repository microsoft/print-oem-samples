...
WINRT_EXPORT namespace winrt::Windows::System::Profile
{
    ...
    struct SmartAppControlPolicy
    {
        ...
        [[nodiscard]] static auto IsEnabled();
        static auto Changed(Windows::Foundation::EventHandler<Windows::Foundation::IInspectable> const& handler);
        using Changed_revoker = impl::factory_event_revoker<Windows::System::Profile::ISmartAppControlPolicyStatics, &impl::abi_t<Windows::System::Profile::ISmartAppControlPolicyStatics>::remove_Changed>;
        [[nodiscard]] static Changed_revoker Changed(auto_revoke_t, Windows::Foundation::EventHandler<Windows::Foundation::IInspectable> const& handler);

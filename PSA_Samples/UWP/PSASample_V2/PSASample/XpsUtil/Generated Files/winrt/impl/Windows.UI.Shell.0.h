...
namespace winrt::impl
{
    ...
    template <> struct category<Windows::UI::Shell::IFocusSession>{ using type = interface_category; };
    template <> struct category<Windows::UI::Shell::IFocusSessionManager>{ using type = interface_category; };
    template <> struct category<Windows::UI::Shell::IFocusSessionManagerStatics>{ using type = interface_category; };
    template <> struct category<Windows::UI::Shell::IShareWindowCommandEventArgs>{ using type = interface_category; };
    template <> struct category<Windows::UI::Shell::IShareWindowCommandSource>{ using type = interface_category; };
    template <> struct category<Windows::UI::Shell::IShareWindowCommandSourceStatics>{ using type = interface_category; };
    ...
    template <> struct category<Windows::UI::Shell::ITaskbarManagerDesktopAppSupportStatics>{ using type = interface_category; };
    ...
    template <> struct category<Windows::UI::Shell::FocusSession>{ using type = class_category; };
    template <> struct category<Windows::UI::Shell::FocusSessionManager>{ using type = class_category; };
    template <> struct category<Windows::UI::Shell::ShareWindowCommandEventArgs>{ using type = class_category; };
    template <> struct category<Windows::UI::Shell::ShareWindowCommandSource>{ using type = class_category; };
    template <> struct category<Windows::UI::Shell::TaskbarManager>{ using type = class_category; };
    template <> struct category<Windows::UI::Shell::ShareWindowCommand>{ using type = enum_category; };
    template <> inline constexpr auto& name_v<Windows::UI::Shell::AdaptiveCardBuilder> = L"Windows.UI.Shell.AdaptiveCardBuilder";
    template <> inline constexpr auto& name_v<Windows::UI::Shell::FocusSession> = L"Windows.UI.Shell.FocusSession";
    template <> inline constexpr auto& name_v<Windows::UI::Shell::FocusSessionManager> = L"Windows.UI.Shell.FocusSessionManager";
    template <> inline constexpr auto& name_v<Windows::UI::Shell::ShareWindowCommandEventArgs> = L"Windows.UI.Shell.ShareWindowCommandEventArgs";
    template <> inline constexpr auto& name_v<Windows::UI::Shell::ShareWindowCommandSource> = L"Windows.UI.Shell.ShareWindowCommandSource";
    template <> inline constexpr auto& name_v<Windows::UI::Shell::TaskbarManager> = L"Windows.UI.Shell.TaskbarManager";
    template <> inline constexpr auto& name_v<Windows::UI::Shell::ShareWindowCommand> = L"Windows.UI.Shell.ShareWindowCommand";
    ...
    template <> inline constexpr auto& name_v<Windows::UI::Shell::IFocusSession> = L"Windows.UI.Shell.IFocusSession";
    template <> inline constexpr auto& name_v<Windows::UI::Shell::IFocusSessionManager> = L"Windows.UI.Shell.IFocusSessionManager";
    template <> inline constexpr auto& name_v<Windows::UI::Shell::IFocusSessionManagerStatics> = L"Windows.UI.Shell.IFocusSessionManagerStatics";
    template <> inline constexpr auto& name_v<Windows::UI::Shell::IShareWindowCommandEventArgs> = L"Windows.UI.Shell.IShareWindowCommandEventArgs";
    template <> inline constexpr auto& name_v<Windows::UI::Shell::IShareWindowCommandSource> = L"Windows.UI.Shell.IShareWindowCommandSource";
    template <> inline constexpr auto& name_v<Windows::UI::Shell::IShareWindowCommandSourceStatics> = L"Windows.UI.Shell.IShareWindowCommandSourceStatics";
    ...
    template <> inline constexpr auto& name_v<Windows::UI::Shell::ITaskbarManagerDesktopAppSupportStatics> = L"Windows.UI.Shell.ITaskbarManagerDesktopAppSupportStatics";
    ...
    template <> inline constexpr guid guid_v<Windows::UI::Shell::IFocusSession>{ 0x069FBAB8,0x0E84,0x5F2F,{ 0x86,0x14,0x9B,0x65,0x44,0x32,0x62,0x77 } }; // 069FBAB8-0E84-5F2F-8614-9B6544326277
    template <> inline constexpr guid guid_v<Windows::UI::Shell::IFocusSessionManager>{ 0xE7FFBAA9,0xD8BE,0x5DBF,{ 0xBA,0xC6,0x49,0x36,0x48,0x42,0xE3,0x7E } }; // E7FFBAA9-D8BE-5DBF-BAC6-49364842E37E
    template <> inline constexpr guid guid_v<Windows::UI::Shell::IFocusSessionManagerStatics>{ 0x834DF764,0xCB9A,0x5D0A,{ 0xAA,0x9F,0x73,0xDF,0x4F,0x24,0x93,0x95 } }; // 834DF764-CB9A-5D0A-AA9F-73DF4F249395
    template <> inline constexpr guid guid_v<Windows::UI::Shell::IShareWindowCommandEventArgs>{ 0x4578DC09,0xA523,0x5756,{ 0xA9,0x95,0xE4,0xFE,0xB9,0x91,0xFF,0xF0 } }; // 4578DC09-A523-5756-A995-E4FEB991FFF0
    template <> inline constexpr guid guid_v<Windows::UI::Shell::IShareWindowCommandSource>{ 0xCB3B7AE3,0x6B9C,0x561E,{ 0xBC,0xCC,0x61,0xE6,0x8E,0x0A,0xBF,0xEF } }; // CB3B7AE3-6B9C-561E-BCCC-61E68E0ABFEF
    template <> inline constexpr guid guid_v<Windows::UI::Shell::IShareWindowCommandSourceStatics>{ 0xB0EB6656,0x9CAC,0x517C,{ 0xB6,0xC7,0x8E,0xF7,0x15,0x08,0x42,0x95 } }; // B0EB6656-9CAC-517C-B6C7-8EF715084295
    ...
    template <> inline constexpr guid guid_v<Windows::UI::Shell::ITaskbarManagerDesktopAppSupportStatics>{ 0xCDFEFD63,0xE879,0x4134,{ 0xB9,0xA7,0x82,0x83,0xF0,0x5F,0x94,0x80 } }; // CDFEFD63-E879-4134-B9A7-8283F05F9480
    ...
    template <> struct default_interface<Windows::UI::Shell::FocusSession>{ using type = Windows::UI::Shell::IFocusSession; };
    template <> struct default_interface<Windows::UI::Shell::FocusSessionManager>{ using type = Windows::UI::Shell::IFocusSessionManager; };
    template <> struct default_interface<Windows::UI::Shell::ShareWindowCommandEventArgs>{ using type = Windows::UI::Shell::IShareWindowCommandEventArgs; };
    template <> struct default_interface<Windows::UI::Shell::ShareWindowCommandSource>{ using type = Windows::UI::Shell::IShareWindowCommandSource; };
    ...
    template <> struct abi<Windows::UI::Shell::IFocusSession>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::UI::Shell::IFocusSessionManager>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::UI::Shell::IFocusSessionManagerStatics>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::UI::Shell::IShareWindowCommandEventArgs>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::UI::Shell::IShareWindowCommandSource>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::UI::Shell::IShareWindowCommandSourceStatics>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct consume<Windows::UI::Shell::IFocusSession>
    {
    ...
    struct consume_Windows_UI_Shell_IFocusSessionManager
    {
        ...
        WINRT_IMPL_AUTO(Windows::UI::Shell::FocusSession) GetSession(param::hstring const& id) const;
        WINRT_IMPL_AUTO(Windows::UI::Shell::FocusSession) TryStartFocusSession() const;
        WINRT_IMPL_AUTO(Windows::UI::Shell::FocusSession) TryStartFocusSession(Windows::Foundation::DateTime const& endTime) const;
        WINRT_IMPL_AUTO(void) DeactivateFocus() const;
        WINRT_IMPL_AUTO(winrt::event_token) IsFocusActiveChanged(Windows::Foundation::TypedEventHandler<Windows::UI::Shell::FocusSessionManager, Windows::Foundation::IInspectable> const& handler) const;
        using IsFocusActiveChanged_revoker = impl::event_revoker<Windows::UI::Shell::IFocusSessionManager, &impl::abi_t<Windows::UI::Shell::IFocusSessionManager>::remove_IsFocusActiveChanged>;
        [[nodiscard]] IsFocusActiveChanged_revoker IsFocusActiveChanged(auto_revoke_t, Windows::Foundation::TypedEventHandler<Windows::UI::Shell::FocusSessionManager, Windows::Foundation::IInspectable> const& handler) const;
        WINRT_IMPL_AUTO(void) IsFocusActiveChanged(winrt::event_token const& token) const noexcept;
    };
    template <> struct consume<Windows::UI::Shell::IFocusSessionManager>
    {
    ...
    {
        WINRT_IMPL_AUTO(Windows::UI::Shell::FocusSessionManager) GetDefault() const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) IsSupported() const;
    };
    template <> struct consume<Windows::UI::Shell::IFocusSessionManagerStatics>
    {
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::UI::WindowId) WindowId() const;
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::UI::Shell::ShareWindowCommand) Command() const;
        WINRT_IMPL_AUTO(void) Command(Windows::UI::Shell::ShareWindowCommand const& value) const;
    };
    template <> struct consume<Windows::UI::Shell::IShareWindowCommandEventArgs>
    {
    ...
    struct consume_Windows_UI_Shell_IShareWindowCommandSource
    {
        ...
        WINRT_IMPL_AUTO(winrt::event_token) CommandRequested(Windows::Foundation::TypedEventHandler<Windows::UI::Shell::ShareWindowCommandSource, Windows::UI::Shell::ShareWindowCommandEventArgs> const& handler) const;
        using CommandRequested_revoker = impl::event_revoker<Windows::UI::Shell::IShareWindowCommandSource, &impl::abi_t<Windows::UI::Shell::IShareWindowCommandSource>::remove_CommandRequested>;
        [[nodiscard]] CommandRequested_revoker CommandRequested(auto_revoke_t, Windows::Foundation::TypedEventHandler<Windows::UI::Shell::ShareWindowCommandSource, Windows::UI::Shell::ShareWindowCommandEventArgs> const& handler) const;
        WINRT_IMPL_AUTO(void) CommandRequested(winrt::event_token const& token) const noexcept;
        WINRT_IMPL_AUTO(winrt::event_token) CommandInvoked(Windows::Foundation::TypedEventHandler<Windows::UI::Shell::ShareWindowCommandSource, Windows::UI::Shell::ShareWindowCommandEventArgs> const& handler) const;
        using CommandInvoked_revoker = impl::event_revoker<Windows::UI::Shell::IShareWindowCommandSource, &impl::abi_t<Windows::UI::Shell::IShareWindowCommandSource>::remove_CommandInvoked>;
        [[nodiscard]] CommandInvoked_revoker CommandInvoked(auto_revoke_t, Windows::Foundation::TypedEventHandler<Windows::UI::Shell::ShareWindowCommandSource, Windows::UI::Shell::ShareWindowCommandEventArgs> const& handler) const;
        WINRT_IMPL_AUTO(void) CommandInvoked(winrt::event_token const& token) const noexcept;
    };
    template <> struct consume<Windows::UI::Shell::IShareWindowCommandSource>
    {
    ...
    {
        WINRT_IMPL_AUTO(Windows::UI::Shell::ShareWindowCommandSource) GetForCurrentView() const;
    };
    template <> struct consume<Windows::UI::Shell::IShareWindowCommandSourceStatics>
    {

...
WINRT_EXPORT namespace winrt::Windows::Graphics::Display::Core
{
    ...
    struct __declspec(empty_bases) HdmiDisplayInformation : Windows::Graphics::Display::Core::IHdmiDisplayInformation
    {
        ...
        HdmiDisplayInformation(HdmiDisplayInformation const&) noexcept = default;
        HdmiDisplayInformation(HdmiDisplayInformation&&) noexcept = default;
        HdmiDisplayInformation& operator=(HdmiDisplayInformation const&) & noexcept = default;
        HdmiDisplayInformation& operator=(HdmiDisplayInformation&&) & noexcept = default;
        ...
        impl::require<HdmiDisplayMode, Windows::Graphics::Display::Core::IHdmiDisplayMode2>
    {
        ...
        HdmiDisplayMode(HdmiDisplayMode const&) noexcept = default;
        HdmiDisplayMode(HdmiDisplayMode&&) noexcept = default;
        HdmiDisplayMode& operator=(HdmiDisplayMode const&) & noexcept = default;
        HdmiDisplayMode& operator=(HdmiDisplayMode&&) & noexcept = default;
    };
}
#endif

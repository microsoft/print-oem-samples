...
WINRT_EXPORT namespace winrt::Windows::Security::Cryptography::Core
{
        ...
        impl::require<AsymmetricKeyAlgorithmProvider, Windows::Security::Cryptography::Core::IAsymmetricKeyAlgorithmProvider2>
    {
        ...
        AsymmetricKeyAlgorithmProvider(AsymmetricKeyAlgorithmProvider const&) noexcept = default;
        AsymmetricKeyAlgorithmProvider(AsymmetricKeyAlgorithmProvider&&) noexcept = default;
        AsymmetricKeyAlgorithmProvider& operator=(AsymmetricKeyAlgorithmProvider const&) & noexcept = default;
        AsymmetricKeyAlgorithmProvider& operator=(AsymmetricKeyAlgorithmProvider&&) & noexcept = default;
    ...
    struct __declspec(empty_bases) CryptographicHash : Windows::Security::Cryptography::Core::IHashComputation
    {
        ...
        CryptographicHash(CryptographicHash const&) noexcept = default;
        CryptographicHash(CryptographicHash&&) noexcept = default;
        CryptographicHash& operator=(CryptographicHash const&) & noexcept = default;
        CryptographicHash& operator=(CryptographicHash&&) & noexcept = default;
    };
    struct __declspec(empty_bases) CryptographicKey : Windows::Security::Cryptography::Core::ICryptographicKey
    {
        ...
        CryptographicKey(CryptographicKey const&) noexcept = default;
        CryptographicKey(CryptographicKey&&) noexcept = default;
        CryptographicKey& operator=(CryptographicKey const&) & noexcept = default;
        CryptographicKey& operator=(CryptographicKey&&) & noexcept = default;
    };
    ...
    struct __declspec(empty_bases) EncryptedAndAuthenticatedData : Windows::Security::Cryptography::Core::IEncryptedAndAuthenticatedData
    {
        ...
        EncryptedAndAuthenticatedData(EncryptedAndAuthenticatedData const&) noexcept = default;
        EncryptedAndAuthenticatedData(EncryptedAndAuthenticatedData&&) noexcept = default;
        EncryptedAndAuthenticatedData& operator=(EncryptedAndAuthenticatedData const&) & noexcept = default;
        EncryptedAndAuthenticatedData& operator=(EncryptedAndAuthenticatedData&&) & noexcept = default;
    };
    ...
    struct __declspec(empty_bases) HashAlgorithmProvider : Windows::Security::Cryptography::Core::IHashAlgorithmProvider
    {
        ...
        HashAlgorithmProvider(HashAlgorithmProvider const&) noexcept = default;
        HashAlgorithmProvider(HashAlgorithmProvider&&) noexcept = default;
        HashAlgorithmProvider& operator=(HashAlgorithmProvider const&) & noexcept = default;
        HashAlgorithmProvider& operator=(HashAlgorithmProvider&&) & noexcept = default;
        static auto OpenAlgorithm(param::hstring const& algorithm);
    };
    ...
    struct __declspec(empty_bases) KeyDerivationAlgorithmProvider : Windows::Security::Cryptography::Core::IKeyDerivationAlgorithmProvider
    {
        ...
        KeyDerivationAlgorithmProvider(KeyDerivationAlgorithmProvider const&) noexcept = default;
        KeyDerivationAlgorithmProvider(KeyDerivationAlgorithmProvider&&) noexcept = default;
        KeyDerivationAlgorithmProvider& operator=(KeyDerivationAlgorithmProvider const&) & noexcept = default;
        KeyDerivationAlgorithmProvider& operator=(KeyDerivationAlgorithmProvider&&) & noexcept = default;
        static auto OpenAlgorithm(param::hstring const& algorithm);
    };
        ...
        impl::require<KeyDerivationParameters, Windows::Security::Cryptography::Core::IKeyDerivationParameters2>
    {
        ...
        KeyDerivationParameters(KeyDerivationParameters const&) noexcept = default;
        KeyDerivationParameters(KeyDerivationParameters&&) noexcept = default;
        KeyDerivationParameters& operator=(KeyDerivationParameters const&) & noexcept = default;
        KeyDerivationParameters& operator=(KeyDerivationParameters&&) & noexcept = default;
        ...
        impl::require<MacAlgorithmProvider, Windows::Security::Cryptography::Core::IMacAlgorithmProvider2>
    {
        ...
        MacAlgorithmProvider(MacAlgorithmProvider const&) noexcept = default;
        MacAlgorithmProvider(MacAlgorithmProvider&&) noexcept = default;
        MacAlgorithmProvider& operator=(MacAlgorithmProvider const&) & noexcept = default;
        MacAlgorithmProvider& operator=(MacAlgorithmProvider&&) & noexcept = default;
        static auto OpenAlgorithm(param::hstring const& algorithm);
    };
    ...
    struct __declspec(empty_bases) SymmetricKeyAlgorithmProvider : Windows::Security::Cryptography::Core::ISymmetricKeyAlgorithmProvider
    {
        ...
        SymmetricKeyAlgorithmProvider(SymmetricKeyAlgorithmProvider const&) noexcept = default;
        SymmetricKeyAlgorithmProvider(SymmetricKeyAlgorithmProvider&&) noexcept = default;
        SymmetricKeyAlgorithmProvider& operator=(SymmetricKeyAlgorithmProvider const&) & noexcept = default;
        SymmetricKeyAlgorithmProvider& operator=(SymmetricKeyAlgorithmProvider&&) & noexcept = default;
        static auto OpenAlgorithm(param::hstring const& algorithm);
    };
}
#endif

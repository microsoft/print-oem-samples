...
WINRT_EXPORT namespace winrt::Windows::ApplicationModel::Wallet::System
{
        ...
        impl::consume_t<IWalletItemSystemStore>
    {
        ...
        IWalletItemSystemStore(IWalletItemSystemStore const&) noexcept = default;
        IWalletItemSystemStore(IWalletItemSystemStore&&) noexcept = default;
        IWalletItemSystemStore& operator=(IWalletItemSystemStore const&) & noexcept = default;
        IWalletItemSystemStore& operator=(IWalletItemSystemStore&&) & noexcept = default;
    };
        ...
        impl::consume_t<IWalletItemSystemStore2>
    {
        ...
        IWalletItemSystemStore2(IWalletItemSystemStore2 const&) noexcept = default;
        IWalletItemSystemStore2(IWalletItemSystemStore2&&) noexcept = default;
        IWalletItemSystemStore2& operator=(IWalletItemSystemStore2 const&) & noexcept = default;
        IWalletItemSystemStore2& operator=(IWalletItemSystemStore2&&) & noexcept = default;
    };
        ...
        impl::consume_t<IWalletManagerSystemStatics>
    {
        ...
        IWalletManagerSystemStatics(IWalletManagerSystemStatics const&) noexcept = default;
        IWalletManagerSystemStatics(IWalletManagerSystemStatics&&) noexcept = default;
        IWalletManagerSystemStatics& operator=(IWalletManagerSystemStatics const&) & noexcept = default;
        IWalletManagerSystemStatics& operator=(IWalletManagerSystemStatics&&) & noexcept = default;
    };
}
#endif

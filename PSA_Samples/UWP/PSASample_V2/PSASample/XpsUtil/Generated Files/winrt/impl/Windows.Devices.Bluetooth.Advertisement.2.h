...
WINRT_EXPORT namespace winrt::Windows::Devices::Bluetooth::Advertisement
{
    ...
    struct __declspec(empty_bases) BluetoothLEAdvertisementPublisher : Windows::Devices::Bluetooth::Advertisement::IBluetoothLEAdvertisementPublisher,
        impl::require<BluetoothLEAdvertisementPublisher, Windows::Devices::Bluetooth::Advertisement::IBluetoothLEAdvertisementPublisher2, Windows::Devices::Bluetooth::Advertisement::IBluetoothLEAdvertisementPublisher3>
    {
    ...
    struct __declspec(empty_bases) BluetoothLEAdvertisementReceivedEventArgs : Windows::Devices::Bluetooth::Advertisement::IBluetoothLEAdvertisementReceivedEventArgs,
        impl::require<BluetoothLEAdvertisementReceivedEventArgs, Windows::Devices::Bluetooth::Advertisement::IBluetoothLEAdvertisementReceivedEventArgs2, Windows::Devices::Bluetooth::Advertisement::IBluetoothLEAdvertisementReceivedEventArgs3>
    {
    ...
    struct __declspec(empty_bases) BluetoothLEAdvertisementScanParameters : Windows::Devices::Bluetooth::Advertisement::IBluetoothLEAdvertisementScanParameters
    {
        BluetoothLEAdvertisementScanParameters(std::nullptr_t) noexcept {}
        BluetoothLEAdvertisementScanParameters(void* ptr, take_ownership_from_abi_t) noexcept : Windows::Devices::Bluetooth::Advertisement::IBluetoothLEAdvertisementScanParameters(ptr, take_ownership_from_abi) {}
        BluetoothLEAdvertisementScanParameters(BluetoothLEAdvertisementScanParameters const&) noexcept = default;
        BluetoothLEAdvertisementScanParameters(BluetoothLEAdvertisementScanParameters&&) noexcept = default;
        BluetoothLEAdvertisementScanParameters& operator=(BluetoothLEAdvertisementScanParameters const&) & noexcept = default;
        BluetoothLEAdvertisementScanParameters& operator=(BluetoothLEAdvertisementScanParameters&&) & noexcept = default;
    ...
    struct __declspec(empty_bases) BluetoothLEAdvertisementWatcher : Windows::Devices::Bluetooth::Advertisement::IBluetoothLEAdvertisementWatcher,
        impl::require<BluetoothLEAdvertisementWatcher, Windows::Devices::Bluetooth::Advertisement::IBluetoothLEAdvertisementWatcher2, Windows::Devices::Bluetooth::Advertisement::IBluetoothLEAdvertisementWatcher3>
    {

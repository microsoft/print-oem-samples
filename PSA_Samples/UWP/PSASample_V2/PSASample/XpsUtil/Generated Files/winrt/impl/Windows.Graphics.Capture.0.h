...
namespace winrt::impl
{
    ...
    template <> struct category<Windows::Graphics::Capture::IDirect3D11CaptureFrame2>{ using type = interface_category; };
    ...
    template <> struct category<Windows::Graphics::Capture::IGraphicsCaptureSession3>{ using type = interface_category; };
    template <> struct category<Windows::Graphics::Capture::IGraphicsCaptureSession4>{ using type = interface_category; };
    template <> struct category<Windows::Graphics::Capture::IGraphicsCaptureSession5>{ using type = interface_category; };
    template <> struct category<Windows::Graphics::Capture::IGraphicsCaptureSession6>{ using type = interface_category; };
    ...
    template <> struct category<Windows::Graphics::Capture::GraphicsCaptureAccess>{ using type = class_category; };
    ...
    template <> struct category<Windows::Graphics::Capture::GraphicsCaptureAccessKind>{ using type = enum_category; };
    template <> struct category<Windows::Graphics::Capture::GraphicsCaptureDirtyRegionMode>{ using type = enum_category; };
    ...
    template <> inline constexpr auto& name_v<Windows::Graphics::Capture::GraphicsCaptureAccess> = L"Windows.Graphics.Capture.GraphicsCaptureAccess";
    ...
    template <> inline constexpr auto& name_v<Windows::Graphics::Capture::GraphicsCaptureAccessKind> = L"Windows.Graphics.Capture.GraphicsCaptureAccessKind";
    template <> inline constexpr auto& name_v<Windows::Graphics::Capture::GraphicsCaptureDirtyRegionMode> = L"Windows.Graphics.Capture.GraphicsCaptureDirtyRegionMode";
    ...
    template <> inline constexpr auto& name_v<Windows::Graphics::Capture::IDirect3D11CaptureFrame2> = L"Windows.Graphics.Capture.IDirect3D11CaptureFrame2";
    ...
    template <> inline constexpr auto& name_v<Windows::Graphics::Capture::IGraphicsCaptureSession3> = L"Windows.Graphics.Capture.IGraphicsCaptureSession3";
    template <> inline constexpr auto& name_v<Windows::Graphics::Capture::IGraphicsCaptureSession4> = L"Windows.Graphics.Capture.IGraphicsCaptureSession4";
    template <> inline constexpr auto& name_v<Windows::Graphics::Capture::IGraphicsCaptureSession5> = L"Windows.Graphics.Capture.IGraphicsCaptureSession5";
    template <> inline constexpr auto& name_v<Windows::Graphics::Capture::IGraphicsCaptureSession6> = L"Windows.Graphics.Capture.IGraphicsCaptureSession6";
    ...
    template <> inline constexpr guid guid_v<Windows::Graphics::Capture::IDirect3D11CaptureFrame2>{ 0x37869CFA,0x2B48,0x5EBF,{ 0x9A,0xFB,0xDF,0xFD,0x80,0x5D,0xEF,0xDB } }; // 37869CFA-2B48-5EBF-9AFB-DFFD805DEFDB
    ...
    template <> inline constexpr guid guid_v<Windows::Graphics::Capture::IGraphicsCaptureItemStatics2>{ 0x3B92ACC9,0xE584,0x5862,{ 0xBF,0x5C,0x9C,0x31,0x6C,0x6D,0x2D,0xBB } }; // 3B92ACC9-E584-5862-BF5C-9C316C6D2DBB
    ...
    template <> inline constexpr guid guid_v<Windows::Graphics::Capture::IGraphicsCaptureSession3>{ 0xF2CDD966,0x22AE,0x5EA1,{ 0x95,0x96,0x3A,0x28,0x93,0x44,0xC3,0xBE } }; // F2CDD966-22AE-5EA1-9596-3A289344C3BE
    template <> inline constexpr guid guid_v<Windows::Graphics::Capture::IGraphicsCaptureSession4>{ 0xAE99813C,0xC257,0x5759,{ 0x8E,0xD0,0x66,0x8C,0x9B,0x55,0x7E,0xD4 } }; // AE99813C-C257-5759-8ED0-668C9B557ED4
    template <> inline constexpr guid guid_v<Windows::Graphics::Capture::IGraphicsCaptureSession5>{ 0x67C0EA62,0x1F85,0x5061,{ 0x92,0x5A,0x23,0x9B,0xE0,0xAC,0x09,0xCB } }; // 67C0EA62-1F85-5061-925A-239BE0AC09CB
    template <> inline constexpr guid guid_v<Windows::Graphics::Capture::IGraphicsCaptureSession6>{ 0xD7419236,0xBE20,0x5E9F,{ 0xBC,0xD6,0xC4,0xE9,0x8F,0xD6,0xAF,0xDC } }; // D7419236-BE20-5E9F-BCD6-C4E98FD6AFDC
    ...
    template <> struct abi<Windows::Graphics::Capture::IDirect3D11CaptureFrame2>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::Graphics::Capture::IGraphicsCaptureAccessStatics>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::Graphics::Capture::IGraphicsCaptureSession3>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::Graphics::Capture::IGraphicsCaptureSession4>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
            virtual int32_t __stdcall get_DirtyRegionMode(int32_t*) noexcept = 0;
    ...
    template <> struct abi<Windows::Graphics::Capture::IGraphicsCaptureSession5>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::Graphics::Capture::IGraphicsCaptureSession6>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Foundation::Collections::IVectorView<Windows::Graphics::RectInt32>) DirtyRegions() const;
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Graphics::Capture::GraphicsCaptureDirtyRegionMode) DirtyRegionMode() const;
    };
    template <> struct consume<Windows::Graphics::Capture::IDirect3D11CaptureFrame2>
    {
    ...
    {
        WINRT_IMPL_AUTO(Windows::Foundation::IAsyncOperation<Windows::Security::Authorization::AppCapabilityAccess::AppCapabilityAccessStatus>) RequestAccessAsync(Windows::Graphics::Capture::GraphicsCaptureAccessKind const& request) const;
    };
    template <> struct consume<Windows::Graphics::Capture::IGraphicsCaptureAccessStatics>
    {
    ...
    {
        WINRT_IMPL_AUTO(Windows::Graphics::Capture::GraphicsCaptureItem) TryCreateFromWindowId(Windows::UI::WindowId const& windowId) const;
        WINRT_IMPL_AUTO(Windows::Graphics::Capture::GraphicsCaptureItem) TryCreateFromDisplayId(Windows::Graphics::DisplayId const& displayId) const;
    };
    ...
    template <> struct consume<Windows::Graphics::Capture::IGraphicsCaptureSession3>
    {
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Graphics::Capture::GraphicsCaptureDirtyRegionMode) DirtyRegionMode() const;
        WINRT_IMPL_AUTO(void) DirtyRegionMode(Windows::Graphics::Capture::GraphicsCaptureDirtyRegionMode const& value) const;
    };
    template <> struct consume<Windows::Graphics::Capture::IGraphicsCaptureSession4>
    {
    ...
    struct consume_Windows_Graphics_Capture_IGraphicsCaptureSession5
    {
        ...
        WINRT_IMPL_AUTO(void) MinUpdateInterval(Windows::Foundation::TimeSpan const& value) const;
    };
    template <> struct consume<Windows::Graphics::Capture::IGraphicsCaptureSession5>
    {
    ...
    template <> struct consume<Windows::Graphics::Capture::IGraphicsCaptureSession6>
    {

...
WINRT_EXPORT namespace winrt::Windows::Media::Capture::Frames
{
        ...
        impl::consume_t<IMediaFrameSourceInfo4>
    {
        ...
        IMediaFrameSourceInfo4(void* ptr, take_ownership_from_abi_t) noexcept : Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
        IMediaFrameSourceInfo4(IMediaFrameSourceInfo4 const&) noexcept = default;
        IMediaFrameSourceInfo4(IMediaFrameSourceInfo4&&) noexcept = default;
        IMediaFrameSourceInfo4& operator=(IMediaFrameSourceInfo4 const&) & noexcept = default;
        IMediaFrameSourceInfo4& operator=(IMediaFrameSourceInfo4&&) & noexcept = default;
    };

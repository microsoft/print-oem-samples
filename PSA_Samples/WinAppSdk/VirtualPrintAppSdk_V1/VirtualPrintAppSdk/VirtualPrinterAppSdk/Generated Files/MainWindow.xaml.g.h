...
namespace winrt::VirtualPrinterAppSdk::implementation
{
    ...
    struct MainWindowT : public ::winrt::VirtualPrinterAppSdk::implementation::MainWindow_base<D,
        ...
        I...>
    {
        ...
        void rootFrame(::winrt::Microsoft::UI::Xaml::Controls::Frame value)
        {
            _rootFrame = value;
        }
    ...
    private:
        ...
        ::winrt::Microsoft::UI::Xaml::Controls::Frame _rootFrame{nullptr};
    };
}

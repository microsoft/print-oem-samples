...
namespace winrt::VirtualPrinterAppSdk::implementation
{
    ...
    struct WatermarkPreviewControlT : public ::winrt::VirtualPrinterAppSdk::implementation::WatermarkPreviewControl_base<D,
        ::winrt::Microsoft::UI::Xaml::Markup::IComponentConnector,
        I...>
    {
        using base_type = typename WatermarkPreviewControlT::base_type;
        using base_type::base_type;
        using class_type = typename WatermarkPreviewControlT::class_type;
        ...
        ::winrt::Microsoft::UI::Xaml::Controls::Image WatermarkPreview()
        {
            return _WatermarkPreview;
        }
        void WatermarkPreview(::winrt::Microsoft::UI::Xaml::Controls::Image value)
        {
    ...
    private:
        struct WatermarkPreviewControl_obj1_Bindings;

        ::winrt::Microsoft::UI::Xaml::Controls::Image _WatermarkPreview{nullptr};
    };
}

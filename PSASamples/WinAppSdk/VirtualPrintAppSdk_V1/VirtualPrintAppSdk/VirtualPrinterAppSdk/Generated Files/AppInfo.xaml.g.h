...
namespace winrt::VirtualPrinterAppSdk::implementation
{
    ...
    struct AppInfoT : public ::winrt::VirtualPrinterAppSdk::implementation::AppInfo_base<D,
        ::winrt::Microsoft::UI::Xaml::Markup::IComponentConnector,
        I...>
    {
        using base_type = typename AppInfoT::base_type;
        using base_type::base_type;
        using class_type = typename AppInfoT::class_type;
        ...
        ::winrt::Microsoft::UI::Xaml::Controls::TextBox PackageFamilyNameTextBox()
        {
            return _PackageFamilyNameTextBox;
        }
        void PackageFamilyNameTextBox(::winrt::Microsoft::UI::Xaml::Controls::TextBox value)
        {
            _PackageFamilyNameTextBox = value;
        }
    ...
    private:
        struct AppInfo_obj1_Bindings;

        ::winrt::Microsoft::UI::Xaml::Controls::TextBox _PackageFamilyNameTextBox{nullptr};
    };
}

...
namespace winrt::VirtualPrinterAppSdk::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES JobActivationMainPage_base : implements<D, VirtualPrinterAppSdk::JobActivationMainPage, composing, winrt::Microsoft::UI::Xaml::Controls::IPageOverrides, winrt::Microsoft::UI::Xaml::Controls::IControlOverrides, winrt::Microsoft::UI::Xaml::IFrameworkElementOverrides, winrt::Microsoft::UI::Xaml::IUIElementOverrides, I...>,
    ...
    {
        using base_type = JobActivationMainPage_base;
        using class_type = VirtualPrinterAppSdk::JobActivationMainPage;
        using implements_type = typename JobActivationMainPage_base::implements_type;
        ...
        {
            return L"VirtualPrinterAppSdk.JobActivationMainPage";
        }
        JobActivationMainPage_base()
        {
...
namespace winrt::VirtualPrinterAppSdk::factory_implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES JobActivationMainPageT : implements<D, winrt::Windows::Foundation::IActivationFactory, I...>
    {
        using instance_type = VirtualPrinterAppSdk::JobActivationMainPage;
...
#if defined(WINRT_FORCE_INCLUDE_JOBACTIVATIONMAINPAGE_XAML_G_H) || __has_include("JobActivationMainPage.xaml.g.h")

#include "JobActivationMainPage.xaml.g.h"
...
{
    template <typename D, typename... I>
    using JobActivationMainPageT = JobActivationMainPage_base<D, I...>;
}

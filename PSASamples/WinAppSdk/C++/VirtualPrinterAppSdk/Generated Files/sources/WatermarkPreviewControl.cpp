#include "pch.h"
#include "WatermarkPreviewControl.h"
...
namespace winrt::VirtualPrinterAppSdk::implementation
{
    ...
    void WatermarkPreviewControl::WatermarkPreviewTapped(winrt::event_token const& token) noexcept
    {
        throw hresult_not_implemented();
    }
    void WatermarkPreviewControl::PreviewPage(winrt::XpsUtil::XpsPageWrapper const& pageWrapper)
    {
        throw hresult_not_implemented();
    }

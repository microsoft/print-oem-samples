...
namespace winrt::VirtualPrinterAppSdk::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES UserLaunchMainPage_base : implements<D, VirtualPrinterAppSdk::UserLaunchMainPage, composing, winrt::Microsoft::UI::Xaml::Controls::IPageOverrides, winrt::Microsoft::UI::Xaml::Controls::IControlOverrides, winrt::Microsoft::UI::Xaml::IFrameworkElementOverrides, winrt::Microsoft::UI::Xaml::IUIElementOverrides, I...>,
    ...
    {
        using base_type = UserLaunchMainPage_base;
        using class_type = VirtualPrinterAppSdk::UserLaunchMainPage;
        using implements_type = typename UserLaunchMainPage_base::implements_type;
        ...
        {
            return L"VirtualPrinterAppSdk.UserLaunchMainPage";
        }
        UserLaunchMainPage_base()
        {
...
namespace winrt::VirtualPrinterAppSdk::factory_implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES UserLaunchMainPageT : implements<D, winrt::Windows::Foundation::IActivationFactory, I...>
    {
        using instance_type = VirtualPrinterAppSdk::UserLaunchMainPage;
...
#if defined(WINRT_FORCE_INCLUDE_USERLAUNCHMAINPAGE_XAML_G_H) || __has_include("UserLaunchMainPage.xaml.g.h")

#include "UserLaunchMainPage.xaml.g.h"
...
{
    template <typename D, typename... I>
    using UserLaunchMainPageT = UserLaunchMainPage_base<D, I...>;
}

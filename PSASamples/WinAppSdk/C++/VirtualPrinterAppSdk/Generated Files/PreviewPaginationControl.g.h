...
namespace winrt::VirtualPrinterAppSdk::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES PreviewPaginationControl_base : implements<D, VirtualPrinterAppSdk::PreviewPaginationControl, composing, winrt::Microsoft::UI::Xaml::Controls::IControlOverrides, winrt::Microsoft::UI::Xaml::IFrameworkElementOverrides, winrt::Microsoft::UI::Xaml::IUIElementOverrides, I...>,
        impl::require<D, winrt::Microsoft::UI::Xaml::Controls::IUserControl, winrt::Microsoft::UI::Xaml::Controls::IControl, winrt::Microsoft::UI::Xaml::IFrameworkElement, winrt::Microsoft::UI::Xaml::IUIElement, winrt::Microsoft::UI::Composition::IAnimationObject, winrt::Microsoft::UI::Composition::IVisualElement, winrt::Microsoft::UI::Composition::IVisualElement2, winrt::Microsoft::UI::Xaml::IDependencyObject>,
    ...
    {
        using base_type = PreviewPaginationControl_base;
        using class_type = VirtualPrinterAppSdk::PreviewPaginationControl;
        using implements_type = typename PreviewPaginationControl_base::implements_type;
        ...
        {
            return L"VirtualPrinterAppSdk.PreviewPaginationControl";
        }
        PreviewPaginationControl_base()
        {
...
namespace winrt::VirtualPrinterAppSdk::factory_implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES PreviewPaginationControlT : implements<D, winrt::Windows::Foundation::IActivationFactory, I...>
    {
        using instance_type = VirtualPrinterAppSdk::PreviewPaginationControl;
...
#if defined(WINRT_FORCE_INCLUDE_PREVIEWPAGINATIONCONTROL_XAML_G_H) || __has_include("PreviewPaginationControl.xaml.g.h")

#include "PreviewPaginationControl.xaml.g.h"
...
{
    template <typename D, typename... I>
    using PreviewPaginationControlT = PreviewPaginationControl_base<D, I...>;
}

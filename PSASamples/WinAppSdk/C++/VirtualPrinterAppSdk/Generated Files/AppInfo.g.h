...
namespace winrt::VirtualPrinterAppSdk::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES AppInfo_base : implements<D, VirtualPrinterAppSdk::AppInfo, composing, winrt::Microsoft::UI::Xaml::Controls::IPageOverrides, winrt::Microsoft::UI::Xaml::Controls::IControlOverrides, winrt::Microsoft::UI::Xaml::IFrameworkElementOverrides, winrt::Microsoft::UI::Xaml::IUIElementOverrides, I...>,
    ...
    {
        using base_type = AppInfo_base;
        using class_type = VirtualPrinterAppSdk::AppInfo;
        using implements_type = typename AppInfo_base::implements_type;
        ...
        {
            return L"VirtualPrinterAppSdk.AppInfo";
        }
        AppInfo_base()
        {
...
namespace winrt::VirtualPrinterAppSdk::factory_implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES AppInfoT : implements<D, winrt::Windows::Foundation::IActivationFactory, I...>
    {
        using instance_type = VirtualPrinterAppSdk::AppInfo;
...
#if defined(WINRT_FORCE_INCLUDE_APPINFO_XAML_G_H) || __has_include("AppInfo.xaml.g.h")

#include "AppInfo.xaml.g.h"
...
{
    template <typename D, typename... I>
    using AppInfoT = AppInfo_base<D, I...>;
}

...
namespace winrt::VirtualPrinterAppSdk::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES WorkflowWatermarkSample_base : implements<D, VirtualPrinterAppSdk::WorkflowWatermarkSample, composing, winrt::Microsoft::UI::Xaml::Controls::IPageOverrides, winrt::Microsoft::UI::Xaml::Controls::IControlOverrides, winrt::Microsoft::UI::Xaml::IFrameworkElementOverrides, winrt::Microsoft::UI::Xaml::IUIElementOverrides, I...>,
    ...
    {
        using base_type = WorkflowWatermarkSample_base;
        using class_type = VirtualPrinterAppSdk::WorkflowWatermarkSample;
        using implements_type = typename WorkflowWatermarkSample_base::implements_type;
        ...
        {
            return L"VirtualPrinterAppSdk.WorkflowWatermarkSample";
        }
        WorkflowWatermarkSample_base()
        {
...
namespace winrt::VirtualPrinterAppSdk::factory_implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES WorkflowWatermarkSampleT : implements<D, winrt::Windows::Foundation::IActivationFactory, I...>
    {
        using instance_type = VirtualPrinterAppSdk::WorkflowWatermarkSample;
...
#if defined(WINRT_FORCE_INCLUDE_WORKFLOWWATERMARKSAMPLE_XAML_G_H) || __has_include("WorkflowWatermarkSample.xaml.g.h")

#include "WorkflowWatermarkSample.xaml.g.h"
...
{
    template <typename D, typename... I>
    using WorkflowWatermarkSampleT = WorkflowWatermarkSample_base<D, I...>;
}

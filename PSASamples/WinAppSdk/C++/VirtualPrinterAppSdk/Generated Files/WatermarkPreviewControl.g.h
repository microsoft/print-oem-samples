...
namespace winrt::VirtualPrinterAppSdk::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES WatermarkPreviewControl_base : implements<D, VirtualPrinterAppSdk::WatermarkPreviewControl, composing, winrt::Microsoft::UI::Xaml::Controls::IControlOverrides, winrt::Microsoft::UI::Xaml::IFrameworkElementOverrides, winrt::Microsoft::UI::Xaml::IUIElementOverrides, I...>,
    ...
    {
        using base_type = WatermarkPreviewControl_base;
        using class_type = VirtualPrinterAppSdk::WatermarkPreviewControl;
        using implements_type = typename WatermarkPreviewControl_base::implements_type;
        ...
        {
            return L"VirtualPrinterAppSdk.WatermarkPreviewControl";
        }
        WatermarkPreviewControl_base()
        {
...
namespace winrt::VirtualPrinterAppSdk::factory_implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES WatermarkPreviewControlT : implements<D, winrt::Windows::Foundation::IActivationFactory, I...>
    {
        using instance_type = VirtualPrinterAppSdk::WatermarkPreviewControl;
...
#if defined(WINRT_FORCE_INCLUDE_WATERMARKPREVIEWCONTROL_XAML_G_H) || __has_include("WatermarkPreviewControl.xaml.g.h")

#include "WatermarkPreviewControl.xaml.g.h"
...
{
    template <typename D, typename... I>
    using WatermarkPreviewControlT = WatermarkPreviewControl_base<D, I...>;
}

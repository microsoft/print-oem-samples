...
namespace winrt::impl
{
    ...
    template <> struct category<winrt::Microsoft::UI::Xaml::Hosting::IWindowsXamlManager2>{ using type = interface_category; };
    template <> struct category<winrt::Microsoft::UI::Xaml::Hosting::IWindowsXamlManagerStatics>{ using type = interface_category; };
    template <> struct category<winrt::Microsoft::UI::Xaml::Hosting::IWindowsXamlManagerStatics2>{ using type = interface_category; };
    template <> struct category<winrt::Microsoft::UI::Xaml::Hosting::IXamlShutdownCompletedOnThreadEventArgs>{ using type = interface_category; };
    ...
    template <> struct category<winrt::Microsoft::UI::Xaml::Hosting::XamlShutdownCompletedOnThreadEventArgs>{ using type = class_category; };
    ...
    template <> inline constexpr auto& name_v<winrt::Microsoft::UI::Xaml::Hosting::XamlShutdownCompletedOnThreadEventArgs> = L"Microsoft.UI.Xaml.Hosting.XamlShutdownCompletedOnThreadEventArgs";
    ...
    template <> inline constexpr auto& name_v<winrt::Microsoft::UI::Xaml::Hosting::IWindowsXamlManager2> = L"Microsoft.UI.Xaml.Hosting.IWindowsXamlManager2";
    ...
    template <> inline constexpr auto& name_v<winrt::Microsoft::UI::Xaml::Hosting::IWindowsXamlManagerStatics2> = L"Microsoft.UI.Xaml.Hosting.IWindowsXamlManagerStatics2";
    template <> inline constexpr auto& name_v<winrt::Microsoft::UI::Xaml::Hosting::IXamlShutdownCompletedOnThreadEventArgs> = L"Microsoft.UI.Xaml.Hosting.IXamlShutdownCompletedOnThreadEventArgs";
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Xaml::Hosting::IWindowsXamlManager2>{ 0xBD67CFF5,0xB887,0x56DA,{ 0xB0,0xA2,0xDA,0xD1,0x0A,0x65,0x20,0xE9 } }; // BD67CFF5-B887-56DA-B0A2-DAD10A6520E9
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Xaml::Hosting::IWindowsXamlManagerStatics2>{ 0x1062430E,0x0898,0x5240,{ 0xBA,0x52,0x89,0xD9,0x22,0x5E,0x7E,0x58 } }; // 1062430E-0898-5240-BA52-89D9225E7E58
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Xaml::Hosting::IXamlShutdownCompletedOnThreadEventArgs>{ 0xACCD20E5,0x3576,0x5262,{ 0xA3,0xDD,0x99,0x06,0x57,0x68,0x1F,0x1F } }; // ACCD20E5-3576-5262-A3DD-990657681F1F
    ...
    template <> struct default_interface<winrt::Microsoft::UI::Xaml::Hosting::XamlShutdownCompletedOnThreadEventArgs>{ using type = winrt::Microsoft::UI::Xaml::Hosting::IXamlShutdownCompletedOnThreadEventArgs; };
    ...
    template <> struct abi<winrt::Microsoft::UI::Xaml::Hosting::IWindowsXamlManager2>
    {
        struct WINRT_IMPL_NOVTABLE type : inspectable_abi
        {
            virtual int32_t __stdcall add_XamlShutdownCompletedOnThread(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t __stdcall remove_XamlShutdownCompletedOnThread(winrt::event_token) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Microsoft::UI::Xaml::Hosting::IWindowsXamlManagerStatics2>
    {
        struct WINRT_IMPL_NOVTABLE type : inspectable_abi
        {
    ...
    template <> struct abi<winrt::Microsoft::UI::Xaml::Hosting::IXamlShutdownCompletedOnThreadEventArgs>
    {
        struct WINRT_IMPL_NOVTABLE type : inspectable_abi
        {
    ...
    {
        auto XamlShutdownCompletedOnThread(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Xaml::Hosting::WindowsXamlManager, winrt::Microsoft::UI::Xaml::Hosting::XamlShutdownCompletedOnThreadEventArgs> const& handler) const;
        using XamlShutdownCompletedOnThread_revoker = impl::event_revoker<winrt::Microsoft::UI::Xaml::Hosting::IWindowsXamlManager2, &impl::abi_t<winrt::Microsoft::UI::Xaml::Hosting::IWindowsXamlManager2>::remove_XamlShutdownCompletedOnThread>;
        [[nodiscard]] auto XamlShutdownCompletedOnThread(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Xaml::Hosting::WindowsXamlManager, winrt::Microsoft::UI::Xaml::Hosting::XamlShutdownCompletedOnThreadEventArgs> const& handler) const;
        auto XamlShutdownCompletedOnThread(winrt::event_token const& token) const noexcept;
    };
    template <> struct consume<winrt::Microsoft::UI::Xaml::Hosting::IWindowsXamlManager2>
    {
        template <typename D> using type = consume_Microsoft_UI_Xaml_Hosting_IWindowsXamlManager2<D>;
    };
    template <typename D>
    ...
    template <> struct consume<winrt::Microsoft::UI::Xaml::Hosting::IWindowsXamlManagerStatics2>
    {
        template <typename D> using type = consume_Microsoft_UI_Xaml_Hosting_IWindowsXamlManagerStatics2<D>;
    };
    template <typename D>
    struct consume_Microsoft_UI_Xaml_Hosting_IXamlShutdownCompletedOnThreadEventArgs
    {
        auto GetDispatcherQueueDeferral() const;
    };
    template <> struct consume<winrt::Microsoft::UI::Xaml::Hosting::IXamlShutdownCompletedOnThreadEventArgs>
    {
        template <typename D> using type = consume_Microsoft_UI_Xaml_Hosting_IXamlShutdownCompletedOnThreadEventArgs<D>;
    };
    template <typename D>

...
#pragma once
#ifndef WINRT_Microsoft_Graphics_DirectX_0_H
#define WINRT_Microsoft_Graphics_DirectX_0_H
...
{
    template <> struct category<winrt::Microsoft::Graphics::DirectX::DirectXAlphaMode>{ using type = enum_category; };
    template <> struct category<winrt::Microsoft::Graphics::DirectX::DirectXColorSpace>{ using type = enum_category; };
    template <> struct category<winrt::Microsoft::Graphics::DirectX::DirectXPixelFormat>{ using type = enum_category; };
    template <> struct category<winrt::Microsoft::Graphics::DirectX::DirectXPrimitiveTopology>{ using type = enum_category; };
    template <> inline constexpr auto& name_v<winrt::Microsoft::Graphics::DirectX::DirectXAlphaMode> = L"Microsoft.Graphics.DirectX.DirectXAlphaMode";
    template <> inline constexpr auto& name_v<winrt::Microsoft::Graphics::DirectX::DirectXColorSpace> = L"Microsoft.Graphics.DirectX.DirectXColorSpace";
    template <> inline constexpr auto& name_v<winrt::Microsoft::Graphics::DirectX::DirectXPixelFormat> = L"Microsoft.Graphics.DirectX.DirectXPixelFormat";
    template <> inline constexpr auto& name_v<winrt::Microsoft::Graphics::DirectX::DirectXPrimitiveTopology> = L"Microsoft.Graphics.DirectX.DirectXPrimitiveTopology";
}
#endif

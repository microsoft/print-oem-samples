...
{
    struct WINRT_IMPL_EMPTY_BASES Task : winrt::Microsoft::Windows::ApplicationModel::Background::UniversalBGTask::ITask,
        impl::require<Task, winrt::Windows::ApplicationModel::Background::IBackgroundTask>
    {

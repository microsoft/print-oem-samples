...
namespace winrt::impl
{
    ...
    template <> struct category<winrt::Microsoft::Windows::AI::Imaging::IImageObjectRemover>{ using type = interface_category; };
    template <> struct category<winrt::Microsoft::Windows::AI::Imaging::IImageObjectRemoverStatics>{ using type = interface_category; };
    ...
    template <> struct category<winrt::Microsoft::Windows::AI::Imaging::ImageObjectRemover>{ using type = class_category; };
    ...
    template <> inline constexpr auto& name_v<winrt::Microsoft::Windows::AI::Imaging::ImageObjectRemover> = L"Microsoft.Windows.AI.Imaging.ImageObjectRemover";
    ...
    template <> inline constexpr auto& name_v<winrt::Microsoft::Windows::AI::Imaging::IImageObjectRemover> = L"Microsoft.Windows.AI.Imaging.IImageObjectRemover";
    template <> inline constexpr auto& name_v<winrt::Microsoft::Windows::AI::Imaging::IImageObjectRemoverStatics> = L"Microsoft.Windows.AI.Imaging.IImageObjectRemoverStatics";
    ...
    template <> inline constexpr auto& name_v<winrt::Microsoft::Windows::AI::Imaging::ImageObjectRemoverContract> = L"Microsoft.Windows.AI.Imaging.ImageObjectRemoverContract";
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::Windows::AI::Imaging::IImageObjectRemover>{ 0xCFA20FAF,0x5AE1,0x5B8C,{ 0xB0,0xD8,0xE7,0xC6,0x4D,0xB5,0x9D,0x26 } }; // CFA20FAF-5AE1-5B8C-B0D8-E7C64DB59D26
    template <> inline constexpr guid guid_v<winrt::Microsoft::Windows::AI::Imaging::IImageObjectRemoverStatics>{ 0xCBCBD7E1,0x5B81,0x503F,{ 0x8F,0xCB,0x66,0xAE,0x1D,0x6E,0x5B,0x9C } }; // CBCBD7E1-5B81-503F-8FCB-66AE1D6E5B9C
    ...
    template <> struct default_interface<winrt::Microsoft::Windows::AI::Imaging::ImageObjectRemover>{ using type = winrt::Microsoft::Windows::AI::Imaging::IImageObjectRemover; };
    ...
    template <> struct abi<winrt::Microsoft::Windows::AI::Imaging::IImageObjectRemover>
    {
        struct WINRT_IMPL_NOVTABLE type : inspectable_abi
        {
            virtual int32_t __stdcall RemoveFromSoftwareBitmap(void*, void*, void**) noexcept = 0;
            virtual int32_t __stdcall RemoveFromImageBuffer(void*, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::AI::Imaging::IImageObjectRemoverStatics>
    {
        struct WINRT_IMPL_NOVTABLE type : inspectable_abi
        {
            virtual int32_t __stdcall GetReadyState(int32_t*) noexcept = 0;
    ...
    {
        auto RemoveFromSoftwareBitmap(winrt::Windows::Graphics::Imaging::SoftwareBitmap const& softwareBitmap, winrt::Windows::Graphics::Imaging::SoftwareBitmap const& softwareBitmapMask) const;
        auto RemoveFromImageBuffer(winrt::Microsoft::Graphics::Imaging::ImageBuffer const& imageBuffer, winrt::Microsoft::Graphics::Imaging::ImageBuffer const& imageBufferMask) const;
    };
    template <> struct consume<winrt::Microsoft::Windows::AI::Imaging::IImageObjectRemover>
    {
        template <typename D> using type = consume_Microsoft_Windows_AI_Imaging_IImageObjectRemover<D>;
    };
    template <typename D>
    ...
    template <> struct consume<winrt::Microsoft::Windows::AI::Imaging::IImageObjectRemoverStatics>
    {
        template <typename D> using type = consume_Microsoft_Windows_AI_Imaging_IImageObjectRemoverStatics<D>;
    };
    template <typename D>

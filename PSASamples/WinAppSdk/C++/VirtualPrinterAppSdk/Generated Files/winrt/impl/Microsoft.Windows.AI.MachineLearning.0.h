...
namespace winrt::impl
{
    ...
    template <> struct category<winrt::Microsoft::Windows::AI::MachineLearning::IModelCatalog>{ using type = interface_category; };
    template <> struct category<winrt::Microsoft::Windows::AI::MachineLearning::IModelCatalogFactory>{ using type = interface_category; };
    template <> struct category<winrt::Microsoft::Windows::AI::MachineLearning::IModelCatalogSource>{ using type = interface_category; };
    template <> struct category<winrt::Microsoft::Windows::AI::MachineLearning::IModelCatalogSourceStatics>{ using type = interface_category; };
    ...
    template <> struct category<winrt::Microsoft::Windows::AI::MachineLearning::ModelCatalog>{ using type = class_category; };
    template <> struct category<winrt::Microsoft::Windows::AI::MachineLearning::ModelCatalogSource>{ using type = class_category; };
    template <> struct category<winrt::Microsoft::Windows::AI::MachineLearning::CatalogModelInstanceStatus>{ using type = enum_category; };
    ...
    template <> inline constexpr auto& name_v<winrt::Microsoft::Windows::AI::MachineLearning::ModelCatalog> = L"Microsoft.Windows.AI.MachineLearning.ModelCatalog";
    template <> inline constexpr auto& name_v<winrt::Microsoft::Windows::AI::MachineLearning::ModelCatalogSource> = L"Microsoft.Windows.AI.MachineLearning.ModelCatalogSource";
    template <> inline constexpr auto& name_v<winrt::Microsoft::Windows::AI::MachineLearning::CatalogModelInstanceStatus> = L"Microsoft.Windows.AI.MachineLearning.CatalogModelInstanceStatus";
    ...
    template <> inline constexpr auto& name_v<winrt::Microsoft::Windows::AI::MachineLearning::IModelCatalog> = L"Microsoft.Windows.AI.MachineLearning.IModelCatalog";
    template <> inline constexpr auto& name_v<winrt::Microsoft::Windows::AI::MachineLearning::IModelCatalogFactory> = L"Microsoft.Windows.AI.MachineLearning.IModelCatalogFactory";
    template <> inline constexpr auto& name_v<winrt::Microsoft::Windows::AI::MachineLearning::IModelCatalogSource> = L"Microsoft.Windows.AI.MachineLearning.IModelCatalogSource";
    template <> inline constexpr auto& name_v<winrt::Microsoft::Windows::AI::MachineLearning::IModelCatalogSourceStatics> = L"Microsoft.Windows.AI.MachineLearning.IModelCatalogSourceStatics";
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::Windows::AI::MachineLearning::ICatalogModelInfo>{ 0x62057FAA,0x3DEF,0x509F,{ 0x9E,0xD2,0xAE,0xF1,0xE0,0xDE,0x21,0xA4 } }; // 62057FAA-3DEF-509F-9ED2-AEF1E0DE21A4
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::Windows::AI::MachineLearning::ICatalogModelInstanceResult>{ 0xB3701B71,0x61FA,0x5185,{ 0xA2,0xCE,0x8D,0xF6,0xE6,0xA5,0xC6,0x6D } }; // B3701B71-61FA-5185-A2CE-8DF6E6A5C66D
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::Windows::AI::MachineLearning::IModelCatalog>{ 0x8CAE018C,0x49F5,0x5080,{ 0xAB,0xB8,0xEF,0x4A,0x1D,0xF3,0x56,0xDA } }; // 8CAE018C-49F5-5080-ABB8-EF4A1DF356DA
    template <> inline constexpr guid guid_v<winrt::Microsoft::Windows::AI::MachineLearning::IModelCatalogFactory>{ 0x2942D7BD,0x6243,0x511F,{ 0xA1,0x2C,0x42,0xCB,0x15,0x1B,0x62,0x5F } }; // 2942D7BD-6243-511F-A12C-42CB151B625F
    template <> inline constexpr guid guid_v<winrt::Microsoft::Windows::AI::MachineLearning::IModelCatalogSource>{ 0x3117952C,0x8DC3,0x54C9,{ 0x94,0xFA,0xBF,0x6F,0x38,0xCB,0xFC,0xE9 } }; // 3117952C-8DC3-54C9-94FA-BF6F38CBFCE9
    template <> inline constexpr guid guid_v<winrt::Microsoft::Windows::AI::MachineLearning::IModelCatalogSourceStatics>{ 0xDEBA0A9B,0x6EDA,0x571A,{ 0x9A,0x05,0x5A,0x7E,0x2A,0x05,0x31,0xEF } }; // DEBA0A9B-6EDA-571A-9A05-5A7E2A0531EF
    ...
    template <> struct default_interface<winrt::Microsoft::Windows::AI::MachineLearning::ModelCatalog>{ using type = winrt::Microsoft::Windows::AI::MachineLearning::IModelCatalog; };
    template <> struct default_interface<winrt::Microsoft::Windows::AI::MachineLearning::ModelCatalogSource>{ using type = winrt::Microsoft::Windows::AI::MachineLearning::IModelCatalogSource; };
    ...
    template <> struct abi<winrt::Microsoft::Windows::AI::MachineLearning::IModelCatalog>
    {
        struct WINRT_IMPL_NOVTABLE type : inspectable_abi
        {
    ...
    template <> struct abi<winrt::Microsoft::Windows::AI::MachineLearning::IModelCatalogFactory>
    {
        struct WINRT_IMPL_NOVTABLE type : inspectable_abi
        {
    ...
    template <> struct abi<winrt::Microsoft::Windows::AI::MachineLearning::IModelCatalogSource>
    {
        struct WINRT_IMPL_NOVTABLE type : inspectable_abi
        {
            virtual int32_t __stdcall get_Id(void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Microsoft::Windows::AI::MachineLearning::IModelCatalogSourceStatics>
    {
        struct WINRT_IMPL_NOVTABLE type : inspectable_abi
        {
            virtual int32_t __stdcall CreateFromUriAsync(void*, void**) noexcept = 0;
            virtual int32_t __stdcall CreateFromUriAsync2(void*, void*, void**) noexcept = 0;
        };
    };
    template <typename D>
    struct consume_Microsoft_Windows_AI_MachineLearning_ICatalogModelInfo
    {
        ...
        auto GetInstanceAsync(param::async_iterable<winrt::Windows::Foundation::Collections::IKeyValuePair<hstring, hstring>> const& additionalHeaders) const;
    };
    ...
    template <> struct consume<winrt::Microsoft::Windows::AI::MachineLearning::IModelCatalog>
    {
        template <typename D> using type = consume_Microsoft_Windows_AI_MachineLearning_IModelCatalog<D>;
    };
    template <typename D>
    struct consume_Microsoft_Windows_AI_MachineLearning_IModelCatalogFactory
    {
        auto CreateInstance(array_view<winrt::Microsoft::Windows::AI::MachineLearning::ModelCatalogSource const> sources) const;
    };
    template <> struct consume<winrt::Microsoft::Windows::AI::MachineLearning::IModelCatalogFactory>
    {
        template <typename D> using type = consume_Microsoft_Windows_AI_MachineLearning_IModelCatalogFactory<D>;
    };
    template <typename D>
    ...
    template <> struct consume<winrt::Microsoft::Windows::AI::MachineLearning::IModelCatalogSource>
    {
        template <typename D> using type = consume_Microsoft_Windows_AI_MachineLearning_IModelCatalogSource<D>;
    };
    template <typename D>
    struct consume_Microsoft_Windows_AI_MachineLearning_IModelCatalogSourceStatics
    {
        auto CreateFromUriAsync(winrt::Windows::Foundation::Uri const& location) const;
        auto CreateFromUriAsync(winrt::Windows::Foundation::Uri const& location, param::async_iterable<winrt::Windows::Foundation::Collections::IKeyValuePair<hstring, hstring>> const& additionalHeaders) const;
    };
    template <> struct consume<winrt::Microsoft::Windows::AI::MachineLearning::IModelCatalogSourceStatics>
    {
        template <typename D> using type = consume_Microsoft_Windows_AI_MachineLearning_IModelCatalogSourceStatics<D>;
    };
}
#endif

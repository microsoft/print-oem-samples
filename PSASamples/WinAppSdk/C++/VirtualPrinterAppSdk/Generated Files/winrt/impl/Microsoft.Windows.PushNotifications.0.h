...
namespace winrt::impl
{
    ...
    template <> inline constexpr auto& name_v<winrt::Microsoft::Windows::PushNotifications::PushNotificationsContract> = L"Microsoft.Windows.PushNotifications.PushNotificationsContract";
    ...
    struct consume_Microsoft_Windows_PushNotifications_IPushNotificationManager
    {
        ...
        auto PushReceived(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Windows::PushNotifications::PushNotificationManager, winrt::Microsoft::Windows::PushNotifications::PushNotificationReceivedEventArgs> const& handler) const;
        ...
        [[nodiscard]] auto PushReceived(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Windows::PushNotifications::PushNotificationManager, winrt::Microsoft::Windows::PushNotifications::PushNotificationReceivedEventArgs> const& handler) const;
    ...
    struct consume_Microsoft_Windows_PushNotifications_IPushNotificationReceivedEventArgs
    {
        ...
        auto Canceled(winrt::Windows::ApplicationModel::Background::BackgroundTaskCanceledEventHandler const& handler) const;
        ...
        [[nodiscard]] auto Canceled(auto_revoke_t, winrt::Windows::ApplicationModel::Background::BackgroundTaskCanceledEventHandler const& handler) const;

...
namespace winrt::impl
{
    ...
    template <> inline constexpr auto& name_v<winrt::Microsoft::Windows::Storage::Pickers::StoragePickersContract> = L"Microsoft.Windows.Storage.Pickers.StoragePickersContract";
    template <> inline constexpr guid guid_v<winrt::Microsoft::Windows::Storage::Pickers::IFileOpenPicker>{ 0x9D00F175,0xC783,0x51BD,{ 0x8C,0x93,0xFB,0x63,0x69,0x5D,0x3A,0xBC } }; // 9D00F175-C783-51BD-8C93-FB63695D3ABC
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::Windows::Storage::Pickers::IFileSavePicker>{ 0x79F1F4DF,0x741B,0x59B2,{ 0xAA,0x06,0xFE,0x9A,0xC8,0x17,0xB7,0xDD } }; // 79F1F4DF-741B-59B2-AA06-FE9AC817B7DD
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::Windows::Storage::Pickers::IFolderPicker>{ 0x3EF0D1CA,0x97C6,0x5873,{ 0x8E,0xA2,0x02,0xC4,0x50,0x17,0x42,0x90 } }; // 3EF0D1CA-97C6-5873-8EA2-02C450174290

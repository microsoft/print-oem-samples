...
WINRT_EXPORT namespace winrt::Microsoft::Windows::AppNotifications::Builder
{
    ...
    struct WINRT_IMPL_EMPTY_BASES AppNotificationComboBox : winrt::Microsoft::Windows::AppNotifications::Builder::IAppNotificationComboBox
    {
    ...
    struct WINRT_IMPL_EMPTY_BASES AppNotificationProgressBar : winrt::Microsoft::Windows::AppNotifications::Builder::IAppNotificationProgressBar
    {
    ...
    struct WINRT_IMPL_EMPTY_BASES AppNotificationTextProperties : winrt::Microsoft::Windows::AppNotifications::Builder::IAppNotificationTextProperties
    {

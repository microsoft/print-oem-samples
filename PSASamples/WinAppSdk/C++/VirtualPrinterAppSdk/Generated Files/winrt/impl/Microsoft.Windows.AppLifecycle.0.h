...
namespace winrt::impl
{
    ...
    template <> inline constexpr auto& name_v<winrt::Microsoft::Windows::AppLifecycle::AppLifecycleContract> = L"Microsoft.Windows.AppLifecycle.AppLifecycleContract";
    ...
    {
        auto RegisterForFileTypeActivation(array_view<hstring const> supportedFileTypes, param::hstring const& logo, param::hstring const& displayName, array_view<hstring const> supportedVerbs, param::hstring const& exePath) const;
        auto RegisterForProtocolActivation(param::hstring const& scheme, param::hstring const& logo, param::hstring const& displayName, param::hstring const& exePath) const;
        auto RegisterForStartupActivation(param::hstring const& taskId, param::hstring const& exePath) const;
        auto UnregisterForFileTypeActivation(array_view<hstring const> fileTypes, param::hstring const& exePath) const;
        auto UnregisterForProtocolActivation(param::hstring const& scheme, param::hstring const& exePath) const;
    ...
    struct consume_Microsoft_Windows_AppLifecycle_IAppInstance
    {
        ...
        auto RedirectActivationToAsync(winrt::Microsoft::Windows::AppLifecycle::AppActivationArguments const& args) const;
        auto GetActivatedEventArgs() const;
        auto Activated(winrt::Windows::Foundation::EventHandler<winrt::Microsoft::Windows::AppLifecycle::AppActivationArguments> const& handler) const;
        ...
        [[nodiscard]] auto Activated(auto_revoke_t, winrt::Windows::Foundation::EventHandler<winrt::Microsoft::Windows::AppLifecycle::AppActivationArguments> const& handler) const;

...
namespace winrt::impl
{
    ...
    template <> struct category<winrt::Microsoft::Windows::AI::Text::ITextSummarizer4>{ using type = interface_category; };
    ...
    template <> inline constexpr auto& name_v<winrt::Microsoft::Windows::AI::Text::ITextSummarizer4> = L"Microsoft.Windows.AI.Text.ITextSummarizer4";
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::Windows::AI::Text::ITextSummarizer4>{ 0x5B7A28C0,0x7777,0x52E5,{ 0x99,0x34,0xB9,0x5B,0x51,0x4C,0xF5,0x35 } }; // 5B7A28C0-7777-52E5-9934-B95B514CF535
    ...
    template <> struct abi<winrt::Microsoft::Windows::AI::Text::ITextSummarizer4>
    {
        struct WINRT_IMPL_NOVTABLE type : inspectable_abi
        {
            virtual int32_t __stdcall IsPromptLargerThanContext(void*, uint64_t*, bool*) noexcept = 0;
        };
    };
    ...
    {
        auto RewriteAsync(param::hstring const& text, winrt::Microsoft::Windows::AI::Text::TextRewriteTone const& tone) const;
    };
    ...
    {
        auto IsPromptLargerThanContext(param::hstring const& text, uint64_t& cutoffPosition) const;
    };
    template <> struct consume<winrt::Microsoft::Windows::AI::Text::ITextSummarizer4>
    {
        template <typename D> using type = consume_Microsoft_Windows_AI_Text_ITextSummarizer4<D>;
    };
    template <typename D>

...
WINRT_EXPORT namespace winrt::Microsoft::UI
{
    struct ClosableNotifierHandler : winrt::Windows::Foundation::IUnknown
    {
        ...
        ClosableNotifierHandler(void* ptr, take_ownership_from_abi_t) noexcept : winrt::Windows::Foundation::IUnknown(ptr, take_ownership_from_abi) {}
        template <typename L> ClosableNotifierHandler(L lambda);
        template <typename F> ClosableNotifierHandler(F* function);
        template <typename O, typename M> ClosableNotifierHandler(O* object, M method);
        template <typename O, typename M> ClosableNotifierHandler(com_ptr<O>&& object, M method);
        template <typename O, typename LM> ClosableNotifierHandler(weak_ref<O>&& object, LM&& lambda_or_method);
        template <typename O, typename M> ClosableNotifierHandler(std::shared_ptr<O>&& object, M method);
        template <typename O, typename LM> ClosableNotifierHandler(std::weak_ptr<O>&& object, LM&& lambda_or_method);
        auto operator()() const;
    };
    struct DisplayId
    {
    ...
    struct WINRT_IMPL_EMPTY_BASES ColorHelper : winrt::Microsoft::UI::IColorHelper
    {
    ...
    struct WINRT_IMPL_EMPTY_BASES Colors : winrt::Microsoft::UI::IColors
    {
        ...
        Colors(void* ptr, take_ownership_from_abi_t) noexcept : winrt::Microsoft::UI::IColors(ptr, take_ownership_from_abi) {}

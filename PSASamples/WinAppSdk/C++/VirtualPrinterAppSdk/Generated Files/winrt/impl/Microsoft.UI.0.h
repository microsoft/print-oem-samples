...
namespace winrt::impl
{
    ...
    struct consume_Microsoft_UI_IClosableNotifier
    {
        ...
        auto Closed(winrt::Microsoft::UI::ClosableNotifierHandler const& handler) const;
        ...
        [[nodiscard]] auto Closed(auto_revoke_t, winrt::Microsoft::UI::ClosableNotifierHandler const& handler) const;
        auto Closed(winrt::event_token const& token) const noexcept;
        auto FrameworkClosed(winrt::Microsoft::UI::ClosableNotifierHandler const& handler) const;
        ...
        [[nodiscard]] auto FrameworkClosed(auto_revoke_t, winrt::Microsoft::UI::ClosableNotifierHandler const& handler) const;
        auto FrameworkClosed(winrt::event_token const& token) const noexcept;
    };

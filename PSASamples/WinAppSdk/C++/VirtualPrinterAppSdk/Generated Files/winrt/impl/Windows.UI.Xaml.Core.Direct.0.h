...
namespace winrt::impl
{
    ...
    template <> inline constexpr auto& name_v<winrt::Windows::UI::Xaml::Core::Direct::XamlDirectContract> = L"Windows.UI.Xaml.Core.Direct.XamlDirectContract";

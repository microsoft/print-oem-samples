...
namespace winrt::impl
{
    ...
    template <> struct category<winrt::Microsoft::Windows::AppNotifications::Builder::IAppNotificationComboBoxFactory>{ using type = interface_category; };
    template <> struct category<winrt::Microsoft::Windows::AppNotifications::Builder::IAppNotificationProgressBar>{ using type = interface_category; };
    template <> struct category<winrt::Microsoft::Windows::AppNotifications::Builder::IAppNotificationTextProperties>{ using type = interface_category; };
    template <> struct category<winrt::Microsoft::Windows::AppNotifications::Builder::AppNotificationBuilder>{ using type = class_category; };
    template <> struct category<winrt::Microsoft::Windows::AppNotifications::Builder::AppNotificationButton>{ using type = class_category; };
    template <> struct category<winrt::Microsoft::Windows::AppNotifications::Builder::AppNotificationComboBox>{ using type = class_category; };
    ...
    template <> struct category<winrt::Microsoft::Windows::AppNotifications::Builder::AppNotificationScenario>{ using type = enum_category; };
    template <> struct category<winrt::Microsoft::Windows::AppNotifications::Builder::AppNotificationSoundEvent>{ using type = enum_category; };
    template <> inline constexpr auto& name_v<winrt::Microsoft::Windows::AppNotifications::Builder::AppNotificationBuilder> = L"Microsoft.Windows.AppNotifications.Builder.AppNotificationBuilder";
    template <> inline constexpr auto& name_v<winrt::Microsoft::Windows::AppNotifications::Builder::AppNotificationButton> = L"Microsoft.Windows.AppNotifications.Builder.AppNotificationButton";
    template <> inline constexpr auto& name_v<winrt::Microsoft::Windows::AppNotifications::Builder::AppNotificationComboBox> = L"Microsoft.Windows.AppNotifications.Builder.AppNotificationComboBox";
    ...
    template <> inline constexpr auto& name_v<winrt::Microsoft::Windows::AppNotifications::Builder::IAppNotificationComboBoxFactory> = L"Microsoft.Windows.AppNotifications.Builder.IAppNotificationComboBoxFactory";
    template <> inline constexpr auto& name_v<winrt::Microsoft::Windows::AppNotifications::Builder::IAppNotificationProgressBar> = L"Microsoft.Windows.AppNotifications.Builder.IAppNotificationProgressBar";
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::Windows::AppNotifications::Builder::IAppNotificationComboBoxFactory>{ 0x1B31B5B0,0x9D86,0x59ED,{ 0x86,0x29,0xA7,0x94,0x98,0xAB,0x5D,0x4B } }; // 1B31B5B0-9D86-59ED-8629-A79498AB5D4B
    template <> inline constexpr guid guid_v<winrt::Microsoft::Windows::AppNotifications::Builder::IAppNotificationProgressBar>{ 0xFCED62F2,0x2074,0x5641,{ 0x86,0x30,0x87,0xA1,0x43,0x15,0xAC,0x86 } }; // FCED62F2-2074-5641-8630-87A14315AC86
    template <> inline constexpr guid guid_v<winrt::Microsoft::Windows::AppNotifications::Builder::IAppNotificationTextProperties>{ 0x23A30D0B,0x5258,0x5853,{ 0x93,0x2E,0x95,0x21,0xA3,0x64,0x2A,0xFB } }; // 23A30D0B-5258-5853-932E-9521A3642AFB
    template <> struct default_interface<winrt::Microsoft::Windows::AppNotifications::Builder::AppNotificationBuilder>{ using type = winrt::Microsoft::Windows::AppNotifications::Builder::IAppNotificationBuilder; };
    template <> struct default_interface<winrt::Microsoft::Windows::AppNotifications::Builder::AppNotificationButton>{ using type = winrt::Microsoft::Windows::AppNotifications::Builder::IAppNotificationButton; };
    template <> struct default_interface<winrt::Microsoft::Windows::AppNotifications::Builder::AppNotificationComboBox>{ using type = winrt::Microsoft::Windows::AppNotifications::Builder::IAppNotificationComboBox; };
    template <> struct default_interface<winrt::Microsoft::Windows::AppNotifications::Builder::AppNotificationProgressBar>{ using type = winrt::Microsoft::Windows::AppNotifications::Builder::IAppNotificationProgressBar; };
    template <> struct default_interface<winrt::Microsoft::Windows::AppNotifications::Builder::AppNotificationTextProperties>{ using type = winrt::Microsoft::Windows::AppNotifications::Builder::IAppNotificationTextProperties; };
    template <> struct abi<winrt::Microsoft::Windows::AppNotifications::Builder::IAppNotificationBuilder>
    {
        struct WINRT_IMPL_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t __stdcall SetAttributionText2(void*, void*, void**) noexcept = 0;
            virtual int32_t __stdcall SetInlineImage(void*, void**) noexcept = 0;
            virtual int32_t __stdcall SetInlineImage2(void*, int32_t, void**) noexcept = 0;
            virtual int32_t __stdcall SetInlineImage3(void*, int32_t, void*, void**) noexcept = 0;
            virtual int32_t __stdcall SetAppLogoOverride(void*, void**) noexcept = 0;
            virtual int32_t __stdcall SetAppLogoOverride2(void*, int32_t, void**) noexcept = 0;
            virtual int32_t __stdcall SetAppLogoOverride3(void*, int32_t, void*, void**) noexcept = 0;
            ...
            virtual int32_t __stdcall SetAudioEvent2(int32_t, int32_t, void**) noexcept = 0;
            virtual int32_t __stdcall MuteAudio(void**) noexcept = 0;
            virtual int32_t __stdcall AddTextBox(void*, void**) noexcept = 0;
            virtual int32_t __stdcall AddTextBox2(void*, void*, void*, void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Microsoft::Windows::AppNotifications::Builder::IAppNotificationButton>
    {
        struct WINRT_IMPL_NOVTABLE type : inspectable_abi
        {
    ...
    template <> struct abi<winrt::Microsoft::Windows::AppNotifications::Builder::IAppNotificationButtonStatics>
    {
        struct WINRT_IMPL_NOVTABLE type : inspectable_abi
        {
    ...
    template <> struct abi<winrt::Microsoft::Windows::AppNotifications::Builder::IAppNotificationComboBox>
    {
        struct WINRT_IMPL_NOVTABLE type : inspectable_abi
        {
    ...
    template <> struct abi<winrt::Microsoft::Windows::AppNotifications::Builder::IAppNotificationComboBoxFactory>
    {
        struct WINRT_IMPL_NOVTABLE type : inspectable_abi
        {
            virtual int32_t __stdcall CreateInstance(void*, void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Microsoft::Windows::AppNotifications::Builder::IAppNotificationProgressBar>
    {
        struct WINRT_IMPL_NOVTABLE type : inspectable_abi
        {
            virtual int32_t __stdcall get_Title(void**) noexcept = 0;
            ...
            virtual int32_t __stdcall SetValueStringOverride(void*, void**) noexcept = 0;
            virtual int32_t __stdcall BindValueStringOverride(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::AppNotifications::Builder::IAppNotificationTextProperties>
    {
        struct WINRT_IMPL_NOVTABLE type : inspectable_abi
        {
    ...
    template <typename D>
    struct consume_Microsoft_Windows_AppNotifications_Builder_IAppNotificationBuilder
    {
        auto AddArgument(param::hstring const& key, param::hstring const& value) const;
        auto SetTimeStamp(winrt::Windows::Foundation::DateTime const& value) const;
        auto SetDuration(winrt::Microsoft::Windows::AppNotifications::Builder::AppNotificationDuration const& duration) const;
        auto SetScenario(winrt::Microsoft::Windows::AppNotifications::Builder::AppNotificationScenario const& value) const;
        auto AddText(param::hstring const& text) const;
        auto AddText(param::hstring const& text, winrt::Microsoft::Windows::AppNotifications::Builder::AppNotificationTextProperties const& properties) const;
        auto SetAttributionText(param::hstring const& text) const;
        auto SetAttributionText(param::hstring const& text, param::hstring const& language) const;
        auto SetInlineImage(winrt::Windows::Foundation::Uri const& imageUri) const;
        auto SetInlineImage(winrt::Windows::Foundation::Uri const& imageUri, winrt::Microsoft::Windows::AppNotifications::Builder::AppNotificationImageCrop const& imageCrop) const;
        auto SetInlineImage(winrt::Windows::Foundation::Uri const& imageUri, winrt::Microsoft::Windows::AppNotifications::Builder::AppNotificationImageCrop const& imagecrop, param::hstring const& alternateText) const;
        auto SetAppLogoOverride(winrt::Windows::Foundation::Uri const& imageUri) const;
        auto SetAppLogoOverride(winrt::Windows::Foundation::Uri const& imageUri, winrt::Microsoft::Windows::AppNotifications::Builder::AppNotificationImageCrop const& imageCrop) const;
        auto SetAppLogoOverride(winrt::Windows::Foundation::Uri const& imageUri, winrt::Microsoft::Windows::AppNotifications::Builder::AppNotificationImageCrop const& imageCrop, param::hstring const& alternateText) const;
        auto SetHeroImage(winrt::Windows::Foundation::Uri const& imageUri) const;
        auto SetHeroImage(winrt::Windows::Foundation::Uri const& imageUri, param::hstring const& alternateText) const;
        auto SetAudioUri(winrt::Windows::Foundation::Uri const& audioUri) const;
        auto SetAudioUri(winrt::Windows::Foundation::Uri const& audioUri, winrt::Microsoft::Windows::AppNotifications::Builder::AppNotificationAudioLooping const& loop) const;
        auto SetAudioEvent(winrt::Microsoft::Windows::AppNotifications::Builder::AppNotificationSoundEvent const& appNotificationSoundEvent) const;
        auto SetAudioEvent(winrt::Microsoft::Windows::AppNotifications::Builder::AppNotificationSoundEvent const& appNotificationSoundEvent, winrt::Microsoft::Windows::AppNotifications::Builder::AppNotificationAudioLooping const& loop) const;
        auto MuteAudio() const;
        auto AddTextBox(param::hstring const& id) const;
        auto AddTextBox(param::hstring const& id, param::hstring const& placeHolderText, param::hstring const& title) const;
        auto AddButton(winrt::Microsoft::Windows::AppNotifications::Builder::AppNotificationButton const& value) const;
        auto AddComboBox(winrt::Microsoft::Windows::AppNotifications::Builder::AppNotificationComboBox const& value) const;
        auto AddProgressBar(winrt::Microsoft::Windows::AppNotifications::Builder::AppNotificationProgressBar const& value) const;
        auto BuildNotification() const;
        auto SetTag(param::hstring const& value) const;
        auto SetGroup(param::hstring const& group) const;
    };
    template <> struct consume<winrt::Microsoft::Windows::AppNotifications::Builder::IAppNotificationBuilder>
    {
    ...
    template <> struct consume<winrt::Microsoft::Windows::AppNotifications::Builder::IAppNotificationBuilderStatics>
    {
        template <typename D> using type = consume_Microsoft_Windows_AppNotifications_Builder_IAppNotificationBuilderStatics<D>;
    };
    template <typename D>
    struct consume_Microsoft_Windows_AppNotifications_Builder_IAppNotificationButton
    {
        ...
        auto ButtonStyle(winrt::Microsoft::Windows::AppNotifications::Builder::AppNotificationButtonStyle const& value) const;
        ...
        auto SetButtonStyle(winrt::Microsoft::Windows::AppNotifications::Builder::AppNotificationButtonStyle const& value) const;
        auto SetInputId(param::hstring const& value) const;
        auto SetInvokeUri(winrt::Windows::Foundation::Uri const& protocolUri) const;
        auto SetInvokeUri(winrt::Windows::Foundation::Uri const& protocolUri, param::hstring const& targetAppId) const;
    };
    ...
    template <> struct consume<winrt::Microsoft::Windows::AppNotifications::Builder::IAppNotificationButtonFactory>
    {
        template <typename D> using type = consume_Microsoft_Windows_AppNotifications_Builder_IAppNotificationButtonFactory<D>;
    };
    template <typename D>
    struct consume_Microsoft_Windows_AppNotifications_Builder_IAppNotificationButtonStatics
    {
        auto IsToolTipSupported() const;
        auto IsButtonStyleSupported() const;
    };
    template <> struct consume<winrt::Microsoft::Windows::AppNotifications::Builder::IAppNotificationButtonStatics>
    {
        template <typename D> using type = consume_Microsoft_Windows_AppNotifications_Builder_IAppNotificationButtonStatics<D>;
    };
    template <typename D>
    struct consume_Microsoft_Windows_AppNotifications_Builder_IAppNotificationComboBox
    {
    ...
    template <> struct consume<winrt::Microsoft::Windows::AppNotifications::Builder::IAppNotificationComboBox>
    {
        template <typename D> using type = consume_Microsoft_Windows_AppNotifications_Builder_IAppNotificationComboBox<D>;
    };
    template <typename D>
    struct consume_Microsoft_Windows_AppNotifications_Builder_IAppNotificationComboBoxFactory
    {
        auto CreateInstance(param::hstring const& id) const;
    };
    template <> struct consume<winrt::Microsoft::Windows::AppNotifications::Builder::IAppNotificationComboBoxFactory>
    {
        template <typename D> using type = consume_Microsoft_Windows_AppNotifications_Builder_IAppNotificationComboBoxFactory<D>;
    };
    template <typename D>
    struct consume_Microsoft_Windows_AppNotifications_Builder_IAppNotificationProgressBar
    {
        [[nodiscard]] auto Title() const;
        auto Title(param::hstring const& value) const;
    ...
    template <> struct consume<winrt::Microsoft::Windows::AppNotifications::Builder::IAppNotificationProgressBar>
    {
        template <typename D> using type = consume_Microsoft_Windows_AppNotifications_Builder_IAppNotificationProgressBar<D>;
    };
    template <typename D>
    struct consume_Microsoft_Windows_AppNotifications_Builder_IAppNotificationTextProperties
    {
    ...
    template <> struct consume<winrt::Microsoft::Windows::AppNotifications::Builder::IAppNotificationTextProperties>
    {
        template <typename D> using type = consume_Microsoft_Windows_AppNotifications_Builder_IAppNotificationTextProperties<D>;
    };
}
#endif

...
namespace winrt::impl
{
    ...
    {
        int32_t value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::Windows::Widgets::Providers::IWidgetInfo3)->get_Rank(&value));
        return value;
    }
    ...
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::Windows::Widgets::Providers::IWidgetUpdateRequestOptions3)->get_Rank(&value));
    ...
    {
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::Windows::Widgets::Providers::IWidgetUpdateRequestOptions3)->put_Rank(*(void**)(&value)));
    }

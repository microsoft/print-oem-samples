...
namespace winrt::impl
{
    ...
    {
        int32_t value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::Graphics::Imaging::IImageBuffer)->get_PixelHeight(&value));
        return value;
    }
    template <typename D> auto consume_Microsoft_Graphics_Imaging_IImageBuffer<D>::PixelWidth() const
    {
        int32_t value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::Graphics::Imaging::IImageBuffer)->get_PixelWidth(&value));
        return value;
    }
    template <typename D> auto consume_Microsoft_Graphics_Imaging_IImageBuffer<D>::RowStride() const
    {
        int32_t value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::Graphics::Imaging::IImageBuffer)->get_RowStride(&value));
        return value;
    }
    ...
    {
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::Graphics::Imaging::IImageBuffer)->CopyToByteArray(values.size(), put_abi(values)));
    }
    template <typename D> auto consume_Microsoft_Graphics_Imaging_IImageBuffer<D>::CopyToSoftwareBitmap() const
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::Graphics::Imaging::IImageBuffer)->CopyToSoftwareBitmap(&result));
    ...
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::Graphics::Imaging::IImageBufferStatics)->CreateForBuffer(*(void**)(&buffer), static_cast<int32_t>(pixelFormat), width, height, rowStride, &result));
    ...
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::Graphics::Imaging::IImageBufferStatics)->CreateForSoftwareBitmap(*(void**)(&softwareBitmap), &result));
        return winrt::Microsoft::Graphics::Imaging::ImageBuffer{ result, take_ownership_from_abi };
    }

...
struct WINRT_IMPL_EMPTY_BASES produce_dispatch_to_overridable<T, D, winrt::Windows::UI::Xaml::IApplicationOverrides>
...
template <typename T, typename D>
struct WINRT_IMPL_EMPTY_BASES produce_dispatch_to_overridable<T, D, winrt::Windows::UI::Xaml::IApplicationOverrides2>
...
template <typename T, typename D>
struct WINRT_IMPL_EMPTY_BASES produce_dispatch_to_overridable<T, D, winrt::Windows::UI::Xaml::IFrameworkElementOverrides>
...
template <typename T, typename D>
struct WINRT_IMPL_EMPTY_BASES produce_dispatch_to_overridable<T, D, winrt::Windows::UI::Xaml::IFrameworkElementOverrides2>
...
template <typename T, typename D>
struct WINRT_IMPL_EMPTY_BASES produce_dispatch_to_overridable<T, D, winrt::Windows::UI::Xaml::IUIElementOverrides>
...
template <typename T, typename D>
struct WINRT_IMPL_EMPTY_BASES produce_dispatch_to_overridable<T, D, winrt::Windows::UI::Xaml::IUIElementOverrides7>
...
template <typename T, typename D>
struct WINRT_IMPL_EMPTY_BASES produce_dispatch_to_overridable<T, D, winrt::Windows::UI::Xaml::IUIElementOverrides8>
...
template <typename T, typename D>
struct WINRT_IMPL_EMPTY_BASES produce_dispatch_to_overridable<T, D, winrt::Windows::UI::Xaml::IUIElementOverrides9>
...
template <typename T, typename D>
struct WINRT_IMPL_EMPTY_BASES produce_dispatch_to_overridable<T, D, winrt::Windows::UI::Xaml::IVisualStateManagerOverrides>
...
WINRT_EXPORT namespace winrt::Windows::UI::Xaml
{
    ...
    template <typename O, typename LM> WindowActivatedEventHandler::WindowActivatedEventHandler(weak_ref<O>&& object, LM&& lambda_or_method) :
        WindowActivatedEventHandler([o = std::move(object), lm = std::forward<LM>(lambda_or_method)](auto&&... args) { if (auto s = o.get()) {
            if constexpr (std::is_member_function_pointer_v<LM>) ((*s).*(lm))(args...);
            else lm(args...);
        } })
    {
    }
    template <typename O, typename M> WindowActivatedEventHandler::WindowActivatedEventHandler(std::shared_ptr<O>&& object, M method) :
        WindowActivatedEventHandler([o = std::move(object), method](auto&&... args) { return ((*o).*(method))(args...); })
    {
    }
    template <typename O, typename LM> WindowActivatedEventHandler::WindowActivatedEventHandler(std::weak_ptr<O>&& object, LM&& lambda_or_method) :
        WindowActivatedEventHandler([o = std::move(object), lm = std::forward<LM>(lambda_or_method)](auto&&... args) { if (auto s = o.lock()) {
            if constexpr (std::is_member_function_pointer_v<LM>) ((*s).*(lm))(args...);
            else lm(args...);
        } })
    {
    ...
    template <typename O, typename LM> WindowClosedEventHandler::WindowClosedEventHandler(weak_ref<O>&& object, LM&& lambda_or_method) :
        WindowClosedEventHandler([o = std::move(object), lm = std::forward<LM>(lambda_or_method)](auto&&... args) { if (auto s = o.get()) {
            if constexpr (std::is_member_function_pointer_v<LM>) ((*s).*(lm))(args...);
            else lm(args...);
        } })
    {
    }
    template <typename O, typename M> WindowClosedEventHandler::WindowClosedEventHandler(std::shared_ptr<O>&& object, M method) :
        WindowClosedEventHandler([o = std::move(object), method](auto&&... args) { return ((*o).*(method))(args...); })
    {
    }
    template <typename O, typename LM> WindowClosedEventHandler::WindowClosedEventHandler(std::weak_ptr<O>&& object, LM&& lambda_or_method) :
        WindowClosedEventHandler([o = std::move(object), lm = std::forward<LM>(lambda_or_method)](auto&&... args) { if (auto s = o.lock()) {
            if constexpr (std::is_member_function_pointer_v<LM>) ((*s).*(lm))(args...);
            else lm(args...);
        } })
    {
    ...
    template <typename O, typename LM> WindowSizeChangedEventHandler::WindowSizeChangedEventHandler(weak_ref<O>&& object, LM&& lambda_or_method) :
        WindowSizeChangedEventHandler([o = std::move(object), lm = std::forward<LM>(lambda_or_method)](auto&&... args) { if (auto s = o.get()) {
            if constexpr (std::is_member_function_pointer_v<LM>) ((*s).*(lm))(args...);
            else lm(args...);
        } })
    {
    }
    template <typename O, typename M> WindowSizeChangedEventHandler::WindowSizeChangedEventHandler(std::shared_ptr<O>&& object, M method) :
        WindowSizeChangedEventHandler([o = std::move(object), method](auto&&... args) { return ((*o).*(method))(args...); })
    {
    }
    template <typename O, typename LM> WindowSizeChangedEventHandler::WindowSizeChangedEventHandler(std::weak_ptr<O>&& object, LM&& lambda_or_method) :
        WindowSizeChangedEventHandler([o = std::move(object), lm = std::forward<LM>(lambda_or_method)](auto&&... args) { if (auto s = o.lock()) {
            if constexpr (std::is_member_function_pointer_v<LM>) ((*s).*(lm))(args...);
            else lm(args...);
        } })
    {
    ...
    template <typename O, typename LM> WindowVisibilityChangedEventHandler::WindowVisibilityChangedEventHandler(weak_ref<O>&& object, LM&& lambda_or_method) :
        WindowVisibilityChangedEventHandler([o = std::move(object), lm = std::forward<LM>(lambda_or_method)](auto&&... args) { if (auto s = o.get()) {
            if constexpr (std::is_member_function_pointer_v<LM>) ((*s).*(lm))(args...);
            else lm(args...);
        } })
    {
    }
    template <typename O, typename M> WindowVisibilityChangedEventHandler::WindowVisibilityChangedEventHandler(std::shared_ptr<O>&& object, M method) :
        WindowVisibilityChangedEventHandler([o = std::move(object), method](auto&&... args) { return ((*o).*(method))(args...); })
    {
    }
    template <typename O, typename LM> WindowVisibilityChangedEventHandler::WindowVisibilityChangedEventHandler(std::weak_ptr<O>&& object, LM&& lambda_or_method) :
        WindowVisibilityChangedEventHandler([o = std::move(object), lm = std::forward<LM>(lambda_or_method)](auto&&... args) { if (auto s = o.lock()) {
            if constexpr (std::is_member_function_pointer_v<LM>) ((*s).*(lm))(args...);
            else lm(args...);
        } })
    {
    ...
    struct AdaptiveTriggerT :
        ...
        impl::require<D, winrt::Windows::UI::Xaml::IAdaptiveTrigger, winrt::Windows::UI::Xaml::IStateTriggerBase, winrt::Windows::UI::Xaml::IDependencyObject, winrt::Windows::UI::Xaml::IDependencyObject2>,
        protected impl::require<D, winrt::Windows::UI::Xaml::IStateTriggerBaseProtected>,
        impl::base<D, AdaptiveTrigger, winrt::Windows::UI::Xaml::StateTriggerBase, winrt::Windows::UI::Xaml::DependencyObject>
    {
        ...
        friend impl::consume_t<D, winrt::Windows::UI::Xaml::IStateTriggerBaseProtected>;
        friend impl::require_one<D, winrt::Windows::UI::Xaml::IStateTriggerBaseProtected>;
    protected:
        AdaptiveTriggerT()
        {
    ...
    struct StateTriggerBaseT :
        implements<D, winrt::Windows::Foundation::IInspectable, composing, Interfaces...>,
        impl::require<D, winrt::Windows::UI::Xaml::IStateTriggerBase, winrt::Windows::UI::Xaml::IDependencyObject, winrt::Windows::UI::Xaml::IDependencyObject2>,
        protected impl::require<D, winrt::Windows::UI::Xaml::IStateTriggerBaseProtected>,
    ...
    struct VisualStateManagerT :
        ...
        impl::require<D, winrt::Windows::UI::Xaml::IVisualStateManager, winrt::Windows::UI::Xaml::IDependencyObject, winrt::Windows::UI::Xaml::IDependencyObject2>,
        protected impl::require<D, winrt::Windows::UI::Xaml::IVisualStateManagerProtected>,
        ...
        winrt::Windows::UI::Xaml::IVisualStateManagerOverridesT<D>
    {
        ...
        friend impl::consume_t<D, winrt::Windows::UI::Xaml::IVisualStateManagerProtected>;
        friend impl::require_one<D, winrt::Windows::UI::Xaml::IVisualStateManagerProtected>;
    protected:
        VisualStateManagerT()
        {

...
namespace winrt::impl
{
    ...
    {
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::Windows::AI::Foundation::IEmbeddingVector)->GetValues(values.size(), put_abi(values)));
    }
    template <typename D> auto consume_Microsoft_Windows_AI_Foundation_IEmbeddingVector<D>::Size() const
    {
        uint32_t value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::Windows::AI::Foundation::IEmbeddingVector)->get_Size(&value));
        return value;
    }
    template <typename D> auto consume_Microsoft_Windows_AI_Foundation_IEmbeddingVector<D>::VectorSpaceId() const
    {
        winrt::guid value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::Windows::AI::Foundation::IEmbeddingVector)->get_VectorSpaceId(put_abi(value)));
        return value;
    }
    ...
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::Windows::AI::Foundation::IEmbeddingVectorFactory)->CreateInstance(data.size(), get_abi(data), impl::bind_in(vectorSpaceID), &value));

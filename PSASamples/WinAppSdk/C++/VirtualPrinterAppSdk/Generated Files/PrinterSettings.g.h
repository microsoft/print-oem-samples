...
namespace winrt::VirtualPrinterAppSdk::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES PrinterSettings_base : implements<D, VirtualPrinterAppSdk::PrinterSettings, composing, winrt::Microsoft::UI::Xaml::Controls::IPageOverrides, winrt::Microsoft::UI::Xaml::Controls::IControlOverrides, winrt::Microsoft::UI::Xaml::IFrameworkElementOverrides, winrt::Microsoft::UI::Xaml::IUIElementOverrides, I...>,
    ...
    {
        using base_type = PrinterSettings_base;
        using class_type = VirtualPrinterAppSdk::PrinterSettings;
        using implements_type = typename PrinterSettings_base::implements_type;
        ...
        {
            return L"VirtualPrinterAppSdk.PrinterSettings";
        }
        PrinterSettings_base()
        {
...
namespace winrt::VirtualPrinterAppSdk::factory_implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES PrinterSettingsT : implements<D, winrt::Windows::Foundation::IActivationFactory, winrt::VirtualPrinterAppSdk::IPrinterSettingsFactory, I...>
    {
        using instance_type = VirtualPrinterAppSdk::PrinterSettings;

        hstring GetRuntimeClassName() const
        {
            return L"VirtualPrinterAppSdk.PrinterSettings";
        }
        auto CreateInstance(winrt::Windows::Graphics::Printing::PrintSupport::PrintSupportSettingsActivatedEventArgs const& args)
        {
            return make<T>(args);
        }
...
#if defined(WINRT_FORCE_INCLUDE_PRINTERSETTINGS_XAML_G_H) || __has_include("PrinterSettings.xaml.g.h")

#include "PrinterSettings.xaml.g.h"
...
{
    template <typename D, typename... I>
    using PrinterSettingsT = PrinterSettings_base<D, I...>;
}

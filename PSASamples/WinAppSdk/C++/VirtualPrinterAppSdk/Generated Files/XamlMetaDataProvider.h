...
/*
    ...
    namespace VirtualPrinterAppSdk
    {
...
namespace winrt::VirtualPrinterAppSdk::implementation
{
    ...
    struct XamlMetaDataProvider : public ::winrt::VirtualPrinterAppSdk::implementation::XamlMetaDataProvider_base<XamlMetaDataProvider>
    {

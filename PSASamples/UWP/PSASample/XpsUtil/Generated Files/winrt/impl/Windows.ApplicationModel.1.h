...
WINRT_EXPORT namespace winrt::Windows::ApplicationModel
{
        ...
        impl::consume_t<IAppInstallerInfo2>
    {
        ...
        IAppInstallerInfo2(IAppInstallerInfo2 const&) noexcept = default;
        IAppInstallerInfo2(IAppInstallerInfo2&&) noexcept = default;
        IAppInstallerInfo2& operator=(IAppInstallerInfo2 const&) & noexcept = default;
        IAppInstallerInfo2& operator=(IAppInstallerInfo2&&) & noexcept = default;
    };
        ...
        impl::consume_t<IFindRelatedPackagesOptions>
    {
        ...
        IFindRelatedPackagesOptions(void* ptr, take_ownership_from_abi_t) noexcept : Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
        IFindRelatedPackagesOptions(IFindRelatedPackagesOptions const&) noexcept = default;
        IFindRelatedPackagesOptions(IFindRelatedPackagesOptions&&) noexcept = default;
        IFindRelatedPackagesOptions& operator=(IFindRelatedPackagesOptions const&) & noexcept = default;
        IFindRelatedPackagesOptions& operator=(IFindRelatedPackagesOptions&&) & noexcept = default;
    };
        ...
        impl::consume_t<IFindRelatedPackagesOptionsFactory>
    {
        ...
        IFindRelatedPackagesOptionsFactory(void* ptr, take_ownership_from_abi_t) noexcept : Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
        IFindRelatedPackagesOptionsFactory(IFindRelatedPackagesOptionsFactory const&) noexcept = default;
        IFindRelatedPackagesOptionsFactory(IFindRelatedPackagesOptionsFactory&&) noexcept = default;
        IFindRelatedPackagesOptionsFactory& operator=(IFindRelatedPackagesOptionsFactory const&) & noexcept = default;
        IFindRelatedPackagesOptionsFactory& operator=(IFindRelatedPackagesOptionsFactory&&) & noexcept = default;
    };
        ...
        impl::consume_t<IPackage9>
    {
        ...
        IPackage9(IPackage9 const&) noexcept = default;
        IPackage9(IPackage9&&) noexcept = default;
        IPackage9& operator=(IPackage9 const&) & noexcept = default;
        IPackage9& operator=(IPackage9&&) & noexcept = default;
    };
        ...
        impl::consume_t<IPackageCatalogStatics2>
    {
        ...
        IPackageCatalogStatics2(void* ptr, take_ownership_from_abi_t) noexcept : Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
        IPackageCatalogStatics2(IPackageCatalogStatics2 const&) noexcept = default;
        IPackageCatalogStatics2(IPackageCatalogStatics2&&) noexcept = default;
        IPackageCatalogStatics2& operator=(IPackageCatalogStatics2 const&) & noexcept = default;
        IPackageCatalogStatics2& operator=(IPackageCatalogStatics2&&) & noexcept = default;
    };

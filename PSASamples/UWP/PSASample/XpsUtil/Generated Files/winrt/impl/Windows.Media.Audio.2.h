...
WINRT_EXPORT namespace winrt::Windows::Media::Audio
{
    ...
    struct __declspec(empty_bases) AudioEffectsPackConfiguration : Windows::Media::Audio::IAudioEffectsPackConfiguration
    {
        AudioEffectsPackConfiguration(std::nullptr_t) noexcept {}
        AudioEffectsPackConfiguration(void* ptr, take_ownership_from_abi_t) noexcept : Windows::Media::Audio::IAudioEffectsPackConfiguration(ptr, take_ownership_from_abi) {}
        AudioEffectsPackConfiguration(AudioEffectsPackConfiguration const&) noexcept = default;
        AudioEffectsPackConfiguration(AudioEffectsPackConfiguration&&) noexcept = default;
        AudioEffectsPackConfiguration& operator=(AudioEffectsPackConfiguration const&) & noexcept = default;
        AudioEffectsPackConfiguration& operator=(AudioEffectsPackConfiguration&&) & noexcept = default;

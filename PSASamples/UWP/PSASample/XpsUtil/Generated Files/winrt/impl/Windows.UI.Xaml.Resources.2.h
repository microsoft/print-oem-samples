...
WINRT_EXPORT namespace winrt::Windows::UI::Xaml::Resources
{
        ...
        impl::require<CustomXamlResourceLoader, Windows::UI::Xaml::Resources::ICustomXamlResourceLoaderOverrides>
    {
        ...
        CustomXamlResourceLoader(CustomXamlResourceLoader const&) noexcept = default;
        CustomXamlResourceLoader(CustomXamlResourceLoader&&) noexcept = default;
        CustomXamlResourceLoader& operator=(CustomXamlResourceLoader const&) & noexcept = default;
        CustomXamlResourceLoader& operator=(CustomXamlResourceLoader&&) & noexcept = default;

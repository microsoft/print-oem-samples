...
WINRT_EXPORT namespace winrt::Windows::Gaming::Input::Custom
{
    ...
    struct __declspec(empty_bases) GipFirmwareUpdateResult : Windows::Gaming::Input::Custom::IGipFirmwareUpdateResult
    {
        ...
        GipFirmwareUpdateResult(GipFirmwareUpdateResult const&) noexcept = default;
        GipFirmwareUpdateResult(GipFirmwareUpdateResult&&) noexcept = default;
        GipFirmwareUpdateResult& operator=(GipFirmwareUpdateResult const&) & noexcept = default;
        GipFirmwareUpdateResult& operator=(GipFirmwareUpdateResult&&) & noexcept = default;
    };
    struct __declspec(empty_bases) GipGameControllerProvider : Windows::Gaming::Input::Custom::IGipGameControllerProvider
    {
        ...
        GipGameControllerProvider(GipGameControllerProvider const&) noexcept = default;
        GipGameControllerProvider(GipGameControllerProvider&&) noexcept = default;
        GipGameControllerProvider& operator=(GipGameControllerProvider const&) & noexcept = default;
        GipGameControllerProvider& operator=(GipGameControllerProvider&&) & noexcept = default;
    };
    struct __declspec(empty_bases) HidGameControllerProvider : Windows::Gaming::Input::Custom::IHidGameControllerProvider
    {
        ...
        HidGameControllerProvider(HidGameControllerProvider const&) noexcept = default;
        HidGameControllerProvider(HidGameControllerProvider&&) noexcept = default;
        HidGameControllerProvider& operator=(HidGameControllerProvider const&) & noexcept = default;
        HidGameControllerProvider& operator=(HidGameControllerProvider&&) & noexcept = default;
    };
    struct __declspec(empty_bases) XusbGameControllerProvider : Windows::Gaming::Input::Custom::IXusbGameControllerProvider
    {
        ...
        XusbGameControllerProvider(XusbGameControllerProvider const&) noexcept = default;
        XusbGameControllerProvider(XusbGameControllerProvider&&) noexcept = default;
        XusbGameControllerProvider& operator=(XusbGameControllerProvider const&) & noexcept = default;
        XusbGameControllerProvider& operator=(XusbGameControllerProvider&&) & noexcept = default;
    };
}
#endif

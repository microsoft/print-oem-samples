...
WINRT_EXPORT namespace winrt::Windows::Graphics::Display
{
    ...
    struct __declspec(empty_bases) LogicalDisplayReference : Windows::Graphics::Display::ILogicalDisplayReference
    {
        ...
        LogicalDisplayReference(LogicalDisplayReference const&) noexcept = default;
        LogicalDisplayReference(LogicalDisplayReference&&) noexcept = default;
        LogicalDisplayReference& operator=(LogicalDisplayReference const&) & noexcept = default;
        LogicalDisplayReference& operator=(LogicalDisplayReference&&) & noexcept = default;
        static auto FindAll();

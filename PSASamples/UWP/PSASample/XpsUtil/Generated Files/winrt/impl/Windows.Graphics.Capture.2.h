...
WINRT_EXPORT namespace winrt::Windows::Graphics::Capture
{
    struct __declspec(empty_bases) Direct3D11CaptureFrame : Windows::Graphics::Capture::IDirect3D11CaptureFrame,
        impl::require<Direct3D11CaptureFrame, Windows::Graphics::Capture::IDirect3D11CaptureFrame2, Windows::Foundation::IClosable>
    {
    ...
    struct __declspec(empty_bases) GraphicsCaptureSession : Windows::Graphics::Capture::IGraphicsCaptureSession,
        impl::require<GraphicsCaptureSession, Windows::Graphics::Capture::IGraphicsCaptureSession2, Windows::Graphics::Capture::IGraphicsCaptureSession3, Windows::Graphics::Capture::IGraphicsCaptureSession4, Windows::Graphics::Capture::IGraphicsCaptureSession5, Windows::Graphics::Capture::IGraphicsCaptureSession6, Windows::Foundation::IClosable>
    {

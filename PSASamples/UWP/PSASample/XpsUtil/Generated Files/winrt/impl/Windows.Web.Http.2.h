...
WINRT_EXPORT namespace winrt::Windows::Web::Http
{
    ...
    struct __declspec(empty_bases) HttpClient : Windows::Web::Http::IHttpClient,
        impl::require<HttpClient, Windows::Web::Http::IHttpClient2, Windows::Web::Http::IHttpClient3, Windows::Foundation::IClosable, Windows::Foundation::IStringable>
    {
    ...
    struct __declspec(empty_bases) HttpRequestMessage : Windows::Web::Http::IHttpRequestMessage,
        impl::require<HttpRequestMessage, Windows::Web::Http::IHttpRequestMessage2, Windows::Foundation::IClosable, Windows::Foundation::IStringable>
    {

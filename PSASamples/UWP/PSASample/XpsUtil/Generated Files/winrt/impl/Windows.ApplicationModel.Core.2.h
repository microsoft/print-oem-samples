...
WINRT_EXPORT namespace winrt::Windows::ApplicationModel::Core
{
        ...
        impl::require<AppListEntry, Windows::ApplicationModel::Core::IAppListEntry2, Windows::ApplicationModel::Core::IAppListEntry3, Windows::ApplicationModel::Core::IAppListEntry4>
    {
        ...
        AppListEntry(AppListEntry const&) noexcept = default;
        AppListEntry(AppListEntry&&) noexcept = default;
        AppListEntry& operator=(AppListEntry const&) & noexcept = default;
        AppListEntry& operator=(AppListEntry&&) & noexcept = default;
    };
        ...
        impl::require<CoreApplicationView, Windows::ApplicationModel::Core::ICoreApplicationView2, Windows::ApplicationModel::Core::ICoreApplicationView3, Windows::ApplicationModel::Core::ICoreApplicationView5, Windows::ApplicationModel::Core::ICoreApplicationView6>
    {
        ...
        CoreApplicationView(CoreApplicationView const&) noexcept = default;
        CoreApplicationView(CoreApplicationView&&) noexcept = default;
        CoreApplicationView& operator=(CoreApplicationView const&) & noexcept = default;
        CoreApplicationView& operator=(CoreApplicationView&&) & noexcept = default;
    };
    struct __declspec(empty_bases) CoreApplicationViewTitleBar : Windows::ApplicationModel::Core::ICoreApplicationViewTitleBar
    {
        ...
        CoreApplicationViewTitleBar(CoreApplicationViewTitleBar const&) noexcept = default;
        CoreApplicationViewTitleBar(CoreApplicationViewTitleBar&&) noexcept = default;
        CoreApplicationViewTitleBar& operator=(CoreApplicationViewTitleBar const&) & noexcept = default;
        CoreApplicationViewTitleBar& operator=(CoreApplicationViewTitleBar&&) & noexcept = default;
    };
    struct __declspec(empty_bases) HostedViewClosingEventArgs : Windows::ApplicationModel::Core::IHostedViewClosingEventArgs
    {
        ...
        HostedViewClosingEventArgs(HostedViewClosingEventArgs const&) noexcept = default;
        HostedViewClosingEventArgs(HostedViewClosingEventArgs&&) noexcept = default;
        HostedViewClosingEventArgs& operator=(HostedViewClosingEventArgs const&) & noexcept = default;
        HostedViewClosingEventArgs& operator=(HostedViewClosingEventArgs&&) & noexcept = default;
    };
    struct __declspec(empty_bases) UnhandledError : Windows::ApplicationModel::Core::IUnhandledError
    {
        ...
        UnhandledError(UnhandledError const&) noexcept = default;
        UnhandledError(UnhandledError&&) noexcept = default;
        UnhandledError& operator=(UnhandledError const&) & noexcept = default;
        UnhandledError& operator=(UnhandledError&&) & noexcept = default;
    };
    struct __declspec(empty_bases) UnhandledErrorDetectedEventArgs : Windows::ApplicationModel::Core::IUnhandledErrorDetectedEventArgs
    {
        ...
        UnhandledErrorDetectedEventArgs(UnhandledErrorDetectedEventArgs const&) noexcept = default;
        UnhandledErrorDetectedEventArgs(UnhandledErrorDetectedEventArgs&&) noexcept = default;
        UnhandledErrorDetectedEventArgs& operator=(UnhandledErrorDetectedEventArgs const&) & noexcept = default;
        UnhandledErrorDetectedEventArgs& operator=(UnhandledErrorDetectedEventArgs&&) & noexcept = default;
    };
}
#endif

...
WINRT_EXPORT namespace winrt::Windows::AI::MachineLearning
{
        ...
        impl::consume_t<IImageFeatureDescriptor2>
    {
        ...
        IImageFeatureDescriptor2(IImageFeatureDescriptor2 const&) noexcept = default;
        IImageFeatureDescriptor2(IImageFeatureDescriptor2&&) noexcept = default;
        IImageFeatureDescriptor2& operator=(IImageFeatureDescriptor2 const&) & noexcept = default;
        IImageFeatureDescriptor2& operator=(IImageFeatureDescriptor2&&) & noexcept = default;
    };

...
namespace winrt::impl
{
    ...
    template <> struct category<Windows::Media::Audio::IAudioEffectsPackConfiguration>{ using type = interface_category; };
    template <> struct category<Windows::Media::Audio::IAudioEffectsPackConfigurationStatics>{ using type = interface_category; };
    ...
    template <> struct category<Windows::Media::Audio::AudioEffectsPackConfiguration>{ using type = class_category; };
    ...
    template <> struct category<Windows::Media::Audio::AudioEffectsPackStatus>{ using type = enum_category; };
    ...
    template <> inline constexpr auto& name_v<Windows::Media::Audio::AudioEffectsPackConfiguration> = L"Windows.Media.Audio.AudioEffectsPackConfiguration";
    ...
    template <> inline constexpr auto& name_v<Windows::Media::Audio::AudioEffectsPackStatus> = L"Windows.Media.Audio.AudioEffectsPackStatus";
    ...
    template <> inline constexpr auto& name_v<Windows::Media::Audio::IAudioEffectsPackConfiguration> = L"Windows.Media.Audio.IAudioEffectsPackConfiguration";
    template <> inline constexpr auto& name_v<Windows::Media::Audio::IAudioEffectsPackConfigurationStatics> = L"Windows.Media.Audio.IAudioEffectsPackConfigurationStatics";
    ...
    template <> inline constexpr guid guid_v<Windows::Media::Audio::IAudioEffectsPackConfiguration>{ 0x71D7627D,0x70C1,0x536C,{ 0xA8,0xF8,0x6F,0x98,0x01,0x5A,0x7F,0x06 } }; // 71D7627D-70C1-536C-A8F8-6F98015A7F06
    template <> inline constexpr guid guid_v<Windows::Media::Audio::IAudioEffectsPackConfigurationStatics>{ 0x61C20413,0x530C,0x55FF,{ 0xBA,0x2B,0x8E,0x68,0xA9,0xB5,0x6A,0x04 } }; // 61C20413-530C-55FF-BA2B-8E68A9B56A04
    ...
    template <> struct default_interface<Windows::Media::Audio::AudioEffectsPackConfiguration>{ using type = Windows::Media::Audio::IAudioEffectsPackConfiguration; };
    ...
    template <> struct abi<Windows::Media::Audio::IAudioEffectsPackConfiguration>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::Media::Audio::IAudioEffectsPackConfigurationStatics>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    struct consume_Windows_Media_Audio_IAudioEffectsPackConfiguration
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Media::Audio::AudioEffectsPackStatus) Status() const;
        WINRT_IMPL_AUTO(winrt::event_token) StatusChanged(Windows::Foundation::TypedEventHandler<Windows::Media::Audio::AudioEffectsPackConfiguration, Windows::Foundation::IInspectable> const& handler) const;
        using StatusChanged_revoker = impl::event_revoker<Windows::Media::Audio::IAudioEffectsPackConfiguration, &impl::abi_t<Windows::Media::Audio::IAudioEffectsPackConfiguration>::remove_StatusChanged>;
        [[nodiscard]] StatusChanged_revoker StatusChanged(auto_revoke_t, Windows::Foundation::TypedEventHandler<Windows::Media::Audio::AudioEffectsPackConfiguration, Windows::Foundation::IInspectable> const& handler) const;
        WINRT_IMPL_AUTO(void) StatusChanged(winrt::event_token const& token) const noexcept;
    };
    template <> struct consume<Windows::Media::Audio::IAudioEffectsPackConfiguration>
    {
    ...
    {
        WINRT_IMPL_AUTO(Windows::Media::Audio::AudioEffectsPackConfiguration) GetForDeviceId(param::hstring const& effectsPackId, param::hstring const& deviceId) const;
        WINRT_IMPL_AUTO(bool) IsDeviceIdSupported(param::hstring const& effectsPackId, param::hstring const& deviceId) const;
    };
    template <> struct consume<Windows::Media::Audio::IAudioEffectsPackConfigurationStatics>
    {

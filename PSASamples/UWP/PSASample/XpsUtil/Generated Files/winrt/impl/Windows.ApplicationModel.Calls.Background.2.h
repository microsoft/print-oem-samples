...
WINRT_EXPORT namespace winrt::Windows::ApplicationModel::Calls::Background
{
    struct __declspec(empty_bases) PhoneCallBlockedTriggerDetails : Windows::ApplicationModel::Calls::Background::IPhoneCallBlockedTriggerDetails
    {
        ...
        PhoneCallBlockedTriggerDetails(PhoneCallBlockedTriggerDetails const&) noexcept = default;
        PhoneCallBlockedTriggerDetails(PhoneCallBlockedTriggerDetails&&) noexcept = default;
        PhoneCallBlockedTriggerDetails& operator=(PhoneCallBlockedTriggerDetails const&) & noexcept = default;
        PhoneCallBlockedTriggerDetails& operator=(PhoneCallBlockedTriggerDetails&&) & noexcept = default;
    };
    struct __declspec(empty_bases) PhoneCallOriginDataRequestTriggerDetails : Windows::ApplicationModel::Calls::Background::IPhoneCallOriginDataRequestTriggerDetails
    {
        ...
        PhoneCallOriginDataRequestTriggerDetails(PhoneCallOriginDataRequestTriggerDetails const&) noexcept = default;
        PhoneCallOriginDataRequestTriggerDetails(PhoneCallOriginDataRequestTriggerDetails&&) noexcept = default;
        PhoneCallOriginDataRequestTriggerDetails& operator=(PhoneCallOriginDataRequestTriggerDetails const&) & noexcept = default;
        PhoneCallOriginDataRequestTriggerDetails& operator=(PhoneCallOriginDataRequestTriggerDetails&&) & noexcept = default;
    };
    struct __declspec(empty_bases) PhoneIncomingCallDismissedTriggerDetails : Windows::ApplicationModel::Calls::Background::IPhoneIncomingCallDismissedTriggerDetails
    {
        ...
        PhoneIncomingCallDismissedTriggerDetails(PhoneIncomingCallDismissedTriggerDetails const&) noexcept = default;
        PhoneIncomingCallDismissedTriggerDetails(PhoneIncomingCallDismissedTriggerDetails&&) noexcept = default;
        PhoneIncomingCallDismissedTriggerDetails& operator=(PhoneIncomingCallDismissedTriggerDetails const&) & noexcept = default;
        PhoneIncomingCallDismissedTriggerDetails& operator=(PhoneIncomingCallDismissedTriggerDetails&&) & noexcept = default;
    };
    struct __declspec(empty_bases) PhoneIncomingCallNotificationTriggerDetails : Windows::ApplicationModel::Calls::Background::IPhoneIncomingCallNotificationTriggerDetails
    {
        ...
        PhoneIncomingCallNotificationTriggerDetails(PhoneIncomingCallNotificationTriggerDetails const&) noexcept = default;
        PhoneIncomingCallNotificationTriggerDetails(PhoneIncomingCallNotificationTriggerDetails&&) noexcept = default;
        PhoneIncomingCallNotificationTriggerDetails& operator=(PhoneIncomingCallNotificationTriggerDetails const&) & noexcept = default;
        PhoneIncomingCallNotificationTriggerDetails& operator=(PhoneIncomingCallNotificationTriggerDetails&&) & noexcept = default;
    };
    struct __declspec(empty_bases) PhoneLineChangedTriggerDetails : Windows::ApplicationModel::Calls::Background::IPhoneLineChangedTriggerDetails
    {
        ...
        PhoneLineChangedTriggerDetails(PhoneLineChangedTriggerDetails const&) noexcept = default;
        PhoneLineChangedTriggerDetails(PhoneLineChangedTriggerDetails&&) noexcept = default;
        PhoneLineChangedTriggerDetails& operator=(PhoneLineChangedTriggerDetails const&) & noexcept = default;
        PhoneLineChangedTriggerDetails& operator=(PhoneLineChangedTriggerDetails&&) & noexcept = default;
    };
    struct __declspec(empty_bases) PhoneNewVoicemailMessageTriggerDetails : Windows::ApplicationModel::Calls::Background::IPhoneNewVoicemailMessageTriggerDetails
    {
        ...
        PhoneNewVoicemailMessageTriggerDetails(PhoneNewVoicemailMessageTriggerDetails const&) noexcept = default;
        PhoneNewVoicemailMessageTriggerDetails(PhoneNewVoicemailMessageTriggerDetails&&) noexcept = default;
        PhoneNewVoicemailMessageTriggerDetails& operator=(PhoneNewVoicemailMessageTriggerDetails const&) & noexcept = default;
        PhoneNewVoicemailMessageTriggerDetails& operator=(PhoneNewVoicemailMessageTriggerDetails&&) & noexcept = default;
    };
}
#endif

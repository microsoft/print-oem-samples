...
WINRT_EXPORT namespace winrt::Windows::System::RemoteDesktop
{
        ...
        impl::consume_t<IInteractiveSessionStatics>
    {
        ...
        IInteractiveSessionStatics(IInteractiveSessionStatics const&) noexcept = default;
        IInteractiveSessionStatics(IInteractiveSessionStatics&&) noexcept = default;
        IInteractiveSessionStatics& operator=(IInteractiveSessionStatics const&) & noexcept = default;
        IInteractiveSessionStatics& operator=(IInteractiveSessionStatics&&) & noexcept = default;
    };
}
#endif

...
WINRT_EXPORT namespace winrt::Windows::Security::ExchangeActiveSyncProvisioning
{
        ...
        impl::require<EasClientDeviceInformation, Windows::Security::ExchangeActiveSyncProvisioning::IEasClientDeviceInformation2>
    {
        ...
        EasClientDeviceInformation(EasClientDeviceInformation const&) noexcept = default;
        EasClientDeviceInformation(EasClientDeviceInformation&&) noexcept = default;
        EasClientDeviceInformation& operator=(EasClientDeviceInformation const&) & noexcept = default;
        EasClientDeviceInformation& operator=(EasClientDeviceInformation&&) & noexcept = default;
    };
}
#endif

...
WINRT_EXPORT namespace winrt::Windows::Web::Http
{
        ...
        impl::consume_t<IHttpClient3>
    {
        ...
        IHttpClient3(void* ptr, take_ownership_from_abi_t) noexcept : Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
        IHttpClient3(IHttpClient3 const&) noexcept = default;
        IHttpClient3(IHttpClient3&&) noexcept = default;
        IHttpClient3& operator=(IHttpClient3 const&) & noexcept = default;
        IHttpClient3& operator=(IHttpClient3&&) & noexcept = default;
    };
        ...
        impl::consume_t<IHttpRequestMessage2>
    {
        ...
        IHttpRequestMessage2(void* ptr, take_ownership_from_abi_t) noexcept : Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
        IHttpRequestMessage2(IHttpRequestMessage2 const&) noexcept = default;
        IHttpRequestMessage2(IHttpRequestMessage2&&) noexcept = default;
        IHttpRequestMessage2& operator=(IHttpRequestMessage2 const&) & noexcept = default;
        IHttpRequestMessage2& operator=(IHttpRequestMessage2&&) & noexcept = default;
    };

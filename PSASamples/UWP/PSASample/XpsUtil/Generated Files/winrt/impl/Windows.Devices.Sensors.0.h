...
namespace winrt::impl
{
    ...
    template <> struct category<Windows::Devices::Sensors::IAdaptiveDimmingOptions>{ using type = interface_category; };
    ...
    template <> struct category<Windows::Devices::Sensors::IDetectedPerson>{ using type = interface_category; };
    ...
    template <> struct category<Windows::Devices::Sensors::IHeadOrientation>{ using type = interface_category; };
    template <> struct category<Windows::Devices::Sensors::IHeadPosition>{ using type = interface_category; };
    ...
    template <> struct category<Windows::Devices::Sensors::IHumanPresenceFeatures>{ using type = interface_category; };
    template <> struct category<Windows::Devices::Sensors::IHumanPresenceFeatures2>{ using type = interface_category; };
    template <> struct category<Windows::Devices::Sensors::IHumanPresenceFeatures3>{ using type = interface_category; };
    template <> struct category<Windows::Devices::Sensors::IHumanPresenceSensor>{ using type = interface_category; };
    template <> struct category<Windows::Devices::Sensors::IHumanPresenceSensor2>{ using type = interface_category; };
    template <> struct category<Windows::Devices::Sensors::IHumanPresenceSensor3>{ using type = interface_category; };
    template <> struct category<Windows::Devices::Sensors::IHumanPresenceSensorExtension>{ using type = interface_category; };
    template <> struct category<Windows::Devices::Sensors::IHumanPresenceSensorReading>{ using type = interface_category; };
    template <> struct category<Windows::Devices::Sensors::IHumanPresenceSensorReading2>{ using type = interface_category; };
    template <> struct category<Windows::Devices::Sensors::IHumanPresenceSensorReading3>{ using type = interface_category; };
    template <> struct category<Windows::Devices::Sensors::IHumanPresenceSensorReadingChangedEventArgs>{ using type = interface_category; };
    template <> struct category<Windows::Devices::Sensors::IHumanPresenceSensorReadingUpdate>{ using type = interface_category; };
    template <> struct category<Windows::Devices::Sensors::IHumanPresenceSensorReadingUpdate2>{ using type = interface_category; };
    template <> struct category<Windows::Devices::Sensors::IHumanPresenceSensorStatics>{ using type = interface_category; };
    template <> struct category<Windows::Devices::Sensors::IHumanPresenceSensorStatics2>{ using type = interface_category; };
    template <> struct category<Windows::Devices::Sensors::IHumanPresenceSettings>{ using type = interface_category; };
    template <> struct category<Windows::Devices::Sensors::IHumanPresenceSettings2>{ using type = interface_category; };
    template <> struct category<Windows::Devices::Sensors::IHumanPresenceSettings3>{ using type = interface_category; };
    template <> struct category<Windows::Devices::Sensors::IHumanPresenceSettingsStatics>{ using type = interface_category; };
    ...
    template <> struct category<Windows::Devices::Sensors::ILightSensor4>{ using type = interface_category; };
    template <> struct category<Windows::Devices::Sensors::ILightSensorDataThreshold>{ using type = interface_category; };
    template <> struct category<Windows::Devices::Sensors::ILightSensorDataThreshold2>{ using type = interface_category; };
    ...
    template <> struct category<Windows::Devices::Sensors::ILightSensorReading3>{ using type = interface_category; };
    ...
    template <> struct category<Windows::Devices::Sensors::ILockOnLeaveOptions>{ using type = interface_category; };
    ...
    template <> struct category<Windows::Devices::Sensors::IOnlookerDetectionOptions>{ using type = interface_category; };
    ...
    template <> struct category<Windows::Devices::Sensors::IWakeOnApproachOptions>{ using type = interface_category; };
    ...
    template <> struct category<Windows::Devices::Sensors::AdaptiveDimmingOptions>{ using type = class_category; };
    ...
    template <> struct category<Windows::Devices::Sensors::DetectedPerson>{ using type = class_category; };
    ...
    template <> struct category<Windows::Devices::Sensors::HeadOrientation>{ using type = class_category; };
    template <> struct category<Windows::Devices::Sensors::HeadPosition>{ using type = class_category; };
    ...
    template <> struct category<Windows::Devices::Sensors::HumanPresenceFeatures>{ using type = class_category; };
    template <> struct category<Windows::Devices::Sensors::HumanPresenceSensor>{ using type = class_category; };
    template <> struct category<Windows::Devices::Sensors::HumanPresenceSensorReading>{ using type = class_category; };
    template <> struct category<Windows::Devices::Sensors::HumanPresenceSensorReadingChangedEventArgs>{ using type = class_category; };
    template <> struct category<Windows::Devices::Sensors::HumanPresenceSensorReadingUpdate>{ using type = class_category; };
    template <> struct category<Windows::Devices::Sensors::HumanPresenceSettings>{ using type = class_category; };
    ...
    template <> struct category<Windows::Devices::Sensors::LockOnLeaveOptions>{ using type = class_category; };
    ...
    template <> struct category<Windows::Devices::Sensors::OnlookerDetectionOptions>{ using type = class_category; };
    ...
    template <> struct category<Windows::Devices::Sensors::WakeOnApproachOptions>{ using type = class_category; };
    ...
    template <> struct category<Windows::Devices::Sensors::HumanEngagement>{ using type = enum_category; };
    template <> struct category<Windows::Devices::Sensors::HumanPresence>{ using type = enum_category; };
    template <> struct category<Windows::Devices::Sensors::MagnetometerAccuracy>{ using type = enum_category; };
    template <> struct category<Windows::Devices::Sensors::OnlookerDetectionAction>{ using type = enum_category; };
    template <> struct category<Windows::Devices::Sensors::OnlookerDetectionBackOnMode>{ using type = enum_category; };
    ...
    template <> struct category<Windows::Devices::Sensors::LightSensorChromaticity>{ using type = struct_category<double, double>; };
    ...
    template <> inline constexpr auto& name_v<Windows::Devices::Sensors::AdaptiveDimmingOptions> = L"Windows.Devices.Sensors.AdaptiveDimmingOptions";
    ...
    template <> inline constexpr auto& name_v<Windows::Devices::Sensors::DetectedPerson> = L"Windows.Devices.Sensors.DetectedPerson";
    ...
    template <> inline constexpr auto& name_v<Windows::Devices::Sensors::HeadOrientation> = L"Windows.Devices.Sensors.HeadOrientation";
    template <> inline constexpr auto& name_v<Windows::Devices::Sensors::HeadPosition> = L"Windows.Devices.Sensors.HeadPosition";
    ...
    template <> inline constexpr auto& name_v<Windows::Devices::Sensors::HumanPresenceFeatures> = L"Windows.Devices.Sensors.HumanPresenceFeatures";
    template <> inline constexpr auto& name_v<Windows::Devices::Sensors::HumanPresenceSensor> = L"Windows.Devices.Sensors.HumanPresenceSensor";
    template <> inline constexpr auto& name_v<Windows::Devices::Sensors::HumanPresenceSensorReading> = L"Windows.Devices.Sensors.HumanPresenceSensorReading";
    template <> inline constexpr auto& name_v<Windows::Devices::Sensors::HumanPresenceSensorReadingChangedEventArgs> = L"Windows.Devices.Sensors.HumanPresenceSensorReadingChangedEventArgs";
    template <> inline constexpr auto& name_v<Windows::Devices::Sensors::HumanPresenceSensorReadingUpdate> = L"Windows.Devices.Sensors.HumanPresenceSensorReadingUpdate";
    template <> inline constexpr auto& name_v<Windows::Devices::Sensors::HumanPresenceSettings> = L"Windows.Devices.Sensors.HumanPresenceSettings";
    ...
    template <> inline constexpr auto& name_v<Windows::Devices::Sensors::LockOnLeaveOptions> = L"Windows.Devices.Sensors.LockOnLeaveOptions";
    ...
    template <> inline constexpr auto& name_v<Windows::Devices::Sensors::OnlookerDetectionOptions> = L"Windows.Devices.Sensors.OnlookerDetectionOptions";
    ...
    template <> inline constexpr auto& name_v<Windows::Devices::Sensors::WakeOnApproachOptions> = L"Windows.Devices.Sensors.WakeOnApproachOptions";
    ...
    template <> inline constexpr auto& name_v<Windows::Devices::Sensors::HumanEngagement> = L"Windows.Devices.Sensors.HumanEngagement";
    template <> inline constexpr auto& name_v<Windows::Devices::Sensors::HumanPresence> = L"Windows.Devices.Sensors.HumanPresence";
    ...
    template <> inline constexpr auto& name_v<Windows::Devices::Sensors::OnlookerDetectionAction> = L"Windows.Devices.Sensors.OnlookerDetectionAction";
    template <> inline constexpr auto& name_v<Windows::Devices::Sensors::OnlookerDetectionBackOnMode> = L"Windows.Devices.Sensors.OnlookerDetectionBackOnMode";
    ...
    template <> inline constexpr auto& name_v<Windows::Devices::Sensors::LightSensorChromaticity> = L"Windows.Devices.Sensors.LightSensorChromaticity";
    ...
    template <> inline constexpr auto& name_v<Windows::Devices::Sensors::IAdaptiveDimmingOptions> = L"Windows.Devices.Sensors.IAdaptiveDimmingOptions";
    ...
    template <> inline constexpr auto& name_v<Windows::Devices::Sensors::IDetectedPerson> = L"Windows.Devices.Sensors.IDetectedPerson";
    ...
    template <> inline constexpr auto& name_v<Windows::Devices::Sensors::IHeadOrientation> = L"Windows.Devices.Sensors.IHeadOrientation";
    template <> inline constexpr auto& name_v<Windows::Devices::Sensors::IHeadPosition> = L"Windows.Devices.Sensors.IHeadPosition";
    ...
    template <> inline constexpr auto& name_v<Windows::Devices::Sensors::IHumanPresenceFeatures> = L"Windows.Devices.Sensors.IHumanPresenceFeatures";
    template <> inline constexpr auto& name_v<Windows::Devices::Sensors::IHumanPresenceFeatures2> = L"Windows.Devices.Sensors.IHumanPresenceFeatures2";
    template <> inline constexpr auto& name_v<Windows::Devices::Sensors::IHumanPresenceFeatures3> = L"Windows.Devices.Sensors.IHumanPresenceFeatures3";
    template <> inline constexpr auto& name_v<Windows::Devices::Sensors::IHumanPresenceSensor> = L"Windows.Devices.Sensors.IHumanPresenceSensor";
    template <> inline constexpr auto& name_v<Windows::Devices::Sensors::IHumanPresenceSensor2> = L"Windows.Devices.Sensors.IHumanPresenceSensor2";
    template <> inline constexpr auto& name_v<Windows::Devices::Sensors::IHumanPresenceSensor3> = L"Windows.Devices.Sensors.IHumanPresenceSensor3";
    template <> inline constexpr auto& name_v<Windows::Devices::Sensors::IHumanPresenceSensorExtension> = L"Windows.Devices.Sensors.IHumanPresenceSensorExtension";
    template <> inline constexpr auto& name_v<Windows::Devices::Sensors::IHumanPresenceSensorReading> = L"Windows.Devices.Sensors.IHumanPresenceSensorReading";
    template <> inline constexpr auto& name_v<Windows::Devices::Sensors::IHumanPresenceSensorReading2> = L"Windows.Devices.Sensors.IHumanPresenceSensorReading2";
    template <> inline constexpr auto& name_v<Windows::Devices::Sensors::IHumanPresenceSensorReading3> = L"Windows.Devices.Sensors.IHumanPresenceSensorReading3";
    template <> inline constexpr auto& name_v<Windows::Devices::Sensors::IHumanPresenceSensorReadingChangedEventArgs> = L"Windows.Devices.Sensors.IHumanPresenceSensorReadingChangedEventArgs";
    template <> inline constexpr auto& name_v<Windows::Devices::Sensors::IHumanPresenceSensorReadingUpdate> = L"Windows.Devices.Sensors.IHumanPresenceSensorReadingUpdate";
    template <> inline constexpr auto& name_v<Windows::Devices::Sensors::IHumanPresenceSensorReadingUpdate2> = L"Windows.Devices.Sensors.IHumanPresenceSensorReadingUpdate2";
    template <> inline constexpr auto& name_v<Windows::Devices::Sensors::IHumanPresenceSensorStatics> = L"Windows.Devices.Sensors.IHumanPresenceSensorStatics";
    template <> inline constexpr auto& name_v<Windows::Devices::Sensors::IHumanPresenceSensorStatics2> = L"Windows.Devices.Sensors.IHumanPresenceSensorStatics2";
    template <> inline constexpr auto& name_v<Windows::Devices::Sensors::IHumanPresenceSettings> = L"Windows.Devices.Sensors.IHumanPresenceSettings";
    template <> inline constexpr auto& name_v<Windows::Devices::Sensors::IHumanPresenceSettings2> = L"Windows.Devices.Sensors.IHumanPresenceSettings2";
    template <> inline constexpr auto& name_v<Windows::Devices::Sensors::IHumanPresenceSettings3> = L"Windows.Devices.Sensors.IHumanPresenceSettings3";
    template <> inline constexpr auto& name_v<Windows::Devices::Sensors::IHumanPresenceSettingsStatics> = L"Windows.Devices.Sensors.IHumanPresenceSettingsStatics";
    ...
    template <> inline constexpr auto& name_v<Windows::Devices::Sensors::ILightSensor4> = L"Windows.Devices.Sensors.ILightSensor4";
    ...
    template <> inline constexpr auto& name_v<Windows::Devices::Sensors::ILightSensorDataThreshold2> = L"Windows.Devices.Sensors.ILightSensorDataThreshold2";
    ...
    template <> inline constexpr auto& name_v<Windows::Devices::Sensors::ILightSensorReading3> = L"Windows.Devices.Sensors.ILightSensorReading3";
    ...
    template <> inline constexpr auto& name_v<Windows::Devices::Sensors::ILockOnLeaveOptions> = L"Windows.Devices.Sensors.ILockOnLeaveOptions";
    ...
    template <> inline constexpr auto& name_v<Windows::Devices::Sensors::IOnlookerDetectionOptions> = L"Windows.Devices.Sensors.IOnlookerDetectionOptions";
    ...
    template <> inline constexpr auto& name_v<Windows::Devices::Sensors::IWakeOnApproachOptions> = L"Windows.Devices.Sensors.IWakeOnApproachOptions";
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IAccelerometer>{ 0xDF184548,0x2711,0x4DA7,{ 0x80,0x98,0x4B,0x82,0x20,0x5D,0x3C,0x7D } }; // DF184548-2711-4DA7-8098-4B82205D3C7D
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IAccelerometer2>{ 0xE8F092EE,0x4964,0x401A,{ 0xB6,0x02,0x22,0x0D,0x71,0x53,0xC6,0x0A } }; // E8F092EE-4964-401A-B602-220D7153C60A
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IAccelerometer3>{ 0x87E0022A,0xED80,0x49EB,{ 0xBF,0x8A,0xA4,0xEA,0x31,0xE5,0xCD,0x84 } }; // 87E0022A-ED80-49EB-BF8A-A4EA31E5CD84
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IAccelerometer4>{ 0x1D373C4F,0x42D3,0x45B2,{ 0x81,0x44,0xAB,0x7F,0xB6,0x65,0xEB,0x59 } }; // 1D373C4F-42D3-45B2-8144-AB7FB665EB59
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IAccelerometer5>{ 0x7E7E7021,0xDEF4,0x53A6,{ 0xAF,0x43,0x80,0x6F,0xD5,0x38,0xED,0xF6 } }; // 7E7E7021-DEF4-53A6-AF43-806FD538EDF6
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IAccelerometerDataThreshold>{ 0xF92C1B68,0x6320,0x5577,{ 0x87,0x9E,0x99,0x42,0x62,0x1C,0x3D,0xD9 } }; // F92C1B68-6320-5577-879E-9942621C3DD9
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IAccelerometerDeviceId>{ 0x7EAC64A9,0x97D5,0x446D,{ 0xAB,0x5A,0x91,0x7D,0xF9,0xB9,0x6A,0x2C } }; // 7EAC64A9-97D5-446D-AB5A-917DF9B96A2C
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IAccelerometerReading>{ 0xB9FE7ACB,0xD351,0x40AF,{ 0x8B,0xB6,0x7A,0xA9,0xAE,0x64,0x1F,0xB7 } }; // B9FE7ACB-D351-40AF-8BB6-7AA9AE641FB7
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IAccelerometerReading2>{ 0x0A864AA2,0x15AE,0x4A40,{ 0xBE,0x55,0xDB,0x58,0xD7,0xDE,0x73,0x89 } }; // 0A864AA2-15AE-4A40-BE55-DB58D7DE7389
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IAccelerometerReadingChangedEventArgs>{ 0x0095C65B,0xB6AC,0x475A,{ 0x9F,0x44,0x8B,0x32,0xD3,0x5A,0x3F,0x25 } }; // 0095C65B-B6AC-475A-9F44-8B32D35A3F25
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IAccelerometerShakenEventArgs>{ 0x95FF01D1,0x4A28,0x4F35,{ 0x98,0xE8,0x81,0x78,0xAA,0xE4,0x08,0x4A } }; // 95FF01D1-4A28-4F35-98E8-8178AAE4084A
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IAccelerometerStatics>{ 0xA5E28B74,0x5A87,0x4A2D,{ 0xBE,0xCC,0x0F,0x90,0x6E,0xA0,0x61,0xDD } }; // A5E28B74-5A87-4A2D-BECC-0F906EA061DD
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IAccelerometerStatics2>{ 0xC4C4842F,0xD86B,0x4685,{ 0xB2,0xD7,0x33,0x96,0xF7,0x98,0xD5,0x7B } }; // C4C4842F-D86B-4685-B2D7-3396F798D57B
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IAccelerometerStatics3>{ 0x9DE218CF,0x455D,0x4CF3,{ 0x82,0x00,0x70,0xE1,0x41,0x03,0x40,0xF8 } }; // 9DE218CF-455D-4CF3-8200-70E1410340F8
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IActivitySensor>{ 0xCD7A630C,0xFB5F,0x48EB,{ 0xB0,0x9B,0xA2,0x70,0x8D,0x1C,0x61,0xEF } }; // CD7A630C-FB5F-48EB-B09B-A2708D1C61EF
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IActivitySensorReading>{ 0x85125A96,0x1472,0x40A2,{ 0xB2,0xAE,0xE1,0xEF,0x29,0x22,0x6C,0x78 } }; // 85125A96-1472-40A2-B2AE-E1EF29226C78
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IActivitySensorReadingChangeReport>{ 0x4F3C2915,0xD93B,0x47BD,{ 0x96,0x0A,0xF2,0x0F,0xB2,0xF3,0x22,0xB9 } }; // 4F3C2915-D93B-47BD-960A-F20FB2F322B9
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IActivitySensorReadingChangedEventArgs>{ 0xDE386717,0xAEB6,0x4EC7,{ 0x94,0x6A,0xD9,0xCC,0x19,0xB9,0x51,0xEC } }; // DE386717-AEB6-4EC7-946A-D9CC19B951EC
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IActivitySensorStatics>{ 0xA71E0E9D,0xEE8B,0x45D1,{ 0xB2,0x5B,0x08,0xCC,0x0D,0xF9,0x2A,0xB6 } }; // A71E0E9D-EE8B-45D1-B25B-08CC0DF92AB6
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IActivitySensorTriggerDetails>{ 0x2C9E6612,0xB9CA,0x4677,{ 0xB2,0x63,0x24,0x32,0x97,0xF7,0x9D,0x3A } }; // 2C9E6612-B9CA-4677-B263-243297F79D3A
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IAdaptiveDimmingOptions>{ 0xD3213CF7,0x89B5,0x5732,{ 0xB2,0xA0,0xAE,0xFE,0x32,0x4F,0x54,0xE6 } }; // D3213CF7-89B5-5732-B2A0-AEFE324F54E6
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IAltimeter>{ 0x72F057FD,0x8F04,0x49F1,{ 0xB4,0xA7,0xF4,0xE3,0x63,0xB7,0x01,0xA2 } }; // 72F057FD-8F04-49F1-B4A7-F4E363B701A2
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IAltimeter2>{ 0xC9471BF9,0x2ADD,0x48F5,{ 0x9F,0x08,0x3D,0x0C,0x76,0x60,0xD9,0x38 } }; // C9471BF9-2ADD-48F5-9F08-3D0C7660D938
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IAltimeterReading>{ 0xFBE8EF73,0x7F5E,0x48C8,{ 0xAA,0x1A,0xF1,0xF3,0xBE,0xFC,0x11,0x44 } }; // FBE8EF73-7F5E-48C8-AA1A-F1F3BEFC1144
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IAltimeterReading2>{ 0x543A1BD9,0x6D0B,0x42B2,{ 0xBD,0x69,0xBC,0x8F,0xAE,0x0F,0x78,0x2C } }; // 543A1BD9-6D0B-42B2-BD69-BC8FAE0F782C
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IAltimeterReadingChangedEventArgs>{ 0x7069D077,0x446D,0x47F7,{ 0x99,0x8C,0xEB,0xC2,0x3B,0x45,0xE4,0xA2 } }; // 7069D077-446D-47F7-998C-EBC23B45E4A2
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IAltimeterStatics>{ 0x9EB4D7C3,0xE5AC,0x47CE,{ 0x8E,0xEF,0xD3,0x71,0x81,0x68,0xC0,0x1F } }; // 9EB4D7C3-E5AC-47CE-8EEF-D3718168C01F
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IBarometer>{ 0x934475A8,0x78BF,0x452F,{ 0xB0,0x17,0xF0,0x20,0x9C,0xE6,0xDA,0xB4 } }; // 934475A8-78BF-452F-B017-F0209CE6DAB4
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IBarometer2>{ 0x32BCC418,0x3EEB,0x4D04,{ 0x95,0x74,0x76,0x33,0xA8,0x78,0x1F,0x9F } }; // 32BCC418-3EEB-4D04-9574-7633A8781F9F
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IBarometer3>{ 0x0E35F0EA,0x02B5,0x5A04,{ 0xB0,0x3D,0x82,0x20,0x84,0x86,0x3A,0x54 } }; // 0E35F0EA-02B5-5A04-B03D-822084863A54
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IBarometerDataThreshold>{ 0x076B952C,0xCB62,0x5A90,{ 0xA0,0xD1,0xF8,0x5E,0x4A,0x93,0x63,0x94 } }; // 076B952C-CB62-5A90-A0D1-F85E4A936394
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IBarometerReading>{ 0xF5B9D2E6,0x1DF6,0x4A1A,{ 0xA7,0xAD,0x32,0x1D,0x4F,0x5D,0xB2,0x47 } }; // F5B9D2E6-1DF6-4A1A-A7AD-321D4F5DB247
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IBarometerReading2>{ 0x85A244EB,0x90C5,0x4875,{ 0x89,0x1C,0x38,0x65,0xB4,0xC3,0x57,0xE7 } }; // 85A244EB-90C5-4875-891C-3865B4C357E7
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IBarometerReadingChangedEventArgs>{ 0x3D84945F,0x037B,0x404F,{ 0x9B,0xBB,0x62,0x32,0xD6,0x95,0x43,0xC3 } }; // 3D84945F-037B-404F-9BBB-6232D69543C3
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IBarometerStatics>{ 0x286B270A,0x02E3,0x4F86,{ 0x84,0xFC,0xFD,0xD8,0x92,0xB5,0x94,0x0F } }; // 286B270A-02E3-4F86-84FC-FDD892B5940F
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IBarometerStatics2>{ 0x8FC6B1E7,0x95FF,0x44AC,{ 0x87,0x8E,0xD6,0x5C,0x83,0x08,0xC3,0x4C } }; // 8FC6B1E7-95FF-44AC-878E-D65C8308C34C
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::ICompass>{ 0x292FFA94,0x1B45,0x403C,{ 0xBA,0x06,0xB1,0x06,0xDB,0xA6,0x9A,0x64 } }; // 292FFA94-1B45-403C-BA06-B106DBA69A64
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::ICompass2>{ 0x36F26D09,0xC7D7,0x434F,{ 0xB4,0x61,0x97,0x9D,0xDF,0xC2,0x32,0x2F } }; // 36F26D09-C7D7-434F-B461-979DDFC2322F
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::ICompass3>{ 0xA424801B,0xC5EA,0x4D45,{ 0xA0,0xEC,0x4B,0x79,0x1F,0x04,0x1A,0x89 } }; // A424801B-C5EA-4D45-A0EC-4B791F041A89
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::ICompass4>{ 0x291E7F11,0xEC32,0x5DCC,{ 0xBF,0xCB,0x0B,0xB3,0x9E,0xBA,0x57,0x74 } }; // 291E7F11-EC32-5DCC-BFCB-0BB39EBA5774
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::ICompassDataThreshold>{ 0xD15B52B3,0xD39D,0x5EC8,{ 0xB2,0xE4,0xF1,0x93,0xE6,0xAB,0x34,0xED } }; // D15B52B3-D39D-5EC8-B2E4-F193E6AB34ED
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::ICompassDeviceId>{ 0xD181CA29,0xB085,0x4B1D,{ 0x87,0x0A,0x4F,0xF5,0x7B,0xA7,0x4F,0xD4 } }; // D181CA29-B085-4B1D-870A-4FF57BA74FD4
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::ICompassReading>{ 0x82911128,0x513D,0x4DC9,{ 0xB7,0x81,0x5E,0xED,0xFB,0xF0,0x2D,0x0C } }; // 82911128-513D-4DC9-B781-5EEDFBF02D0C
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::ICompassReading2>{ 0xB13A661E,0x51BB,0x4A12,{ 0xBE,0xDD,0xAD,0x47,0xFF,0x87,0xD2,0xE8 } }; // B13A661E-51BB-4A12-BEDD-AD47FF87D2E8
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::ICompassReadingChangedEventArgs>{ 0x8F1549B0,0xE8BC,0x4C7E,{ 0xB0,0x09,0x4E,0x41,0xDF,0x13,0x70,0x72 } }; // 8F1549B0-E8BC-4C7E-B009-4E41DF137072
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::ICompassReadingHeadingAccuracy>{ 0xE761354E,0x8911,0x40F7,{ 0x9E,0x16,0x6E,0xCC,0x7D,0xAE,0xC5,0xDE } }; // E761354E-8911-40F7-9E16-6ECC7DAEC5DE
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::ICompassStatics>{ 0x9ABC97DF,0x56EC,0x4C25,{ 0xB5,0x4D,0x40,0xA6,0x8B,0xB5,0xB2,0x69 } }; // 9ABC97DF-56EC-4C25-B54D-40A68BB5B269
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::ICompassStatics2>{ 0x0ACE0EAD,0x3BAA,0x4990,{ 0x9C,0xE4,0xBE,0x09,0x13,0x75,0x4E,0xD2 } }; // 0ACE0EAD-3BAA-4990-9CE4-BE0913754ED2
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IDetectedPerson>{ 0x168CC0D9,0x3F05,0x5029,{ 0xA0,0xBF,0xCD,0xCA,0xB4,0xBE,0x3F,0x9E } }; // 168CC0D9-3F05-5029-A0BF-CDCAB4BE3F9E
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IGyrometer>{ 0xFDB9A9C4,0x84B1,0x4CA2,{ 0x97,0x63,0x9B,0x58,0x95,0x06,0xC7,0x0C } }; // FDB9A9C4-84B1-4CA2-9763-9B589506C70C
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IGyrometer2>{ 0x63DF2443,0x8CE8,0x41C3,{ 0xAC,0x44,0x86,0x98,0x81,0x0B,0x55,0x7F } }; // 63DF2443-8CE8-41C3-AC44-8698810B557F
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IGyrometer3>{ 0x5D6F88D5,0x8FBC,0x4484,{ 0x91,0x4B,0x52,0x8A,0xDF,0xD9,0x47,0xB1 } }; // 5D6F88D5-8FBC-4484-914B-528ADFD947B1
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IGyrometer4>{ 0x0628A60C,0x4C4B,0x5096,{ 0x94,0xE6,0xC3,0x56,0xDF,0x68,0xBE,0xF7 } }; // 0628A60C-4C4B-5096-94E6-C356DF68BEF7
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IGyrometerDataThreshold>{ 0x8648B31E,0x6E52,0x5259,{ 0xBB,0xAD,0x24,0x2A,0x69,0xDC,0x38,0xC8 } }; // 8648B31E-6E52-5259-BBAD-242A69DC38C8
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IGyrometerDeviceId>{ 0x1EE5E978,0x89A2,0x4275,{ 0x9E,0x95,0x71,0x26,0xF4,0x70,0x87,0x60 } }; // 1EE5E978-89A2-4275-9E95-7126F4708760
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IGyrometerReading>{ 0xB3D6DE5C,0x1EE4,0x456F,{ 0x9D,0xE7,0xE2,0x49,0x3B,0x5C,0x8E,0x03 } }; // B3D6DE5C-1EE4-456F-9DE7-E2493B5C8E03
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IGyrometerReading2>{ 0x16AFE13C,0x2B89,0x44BB,{ 0x82,0x2B,0xD1,0xE1,0x55,0x6F,0xF0,0x9B } }; // 16AFE13C-2B89-44BB-822B-D1E1556FF09B
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IGyrometerReadingChangedEventArgs>{ 0x0FDF1895,0x6F9E,0x42CE,{ 0x8D,0x58,0x38,0x8C,0x0A,0xB8,0x35,0x6D } }; // 0FDF1895-6F9E-42CE-8D58-388C0AB8356D
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IGyrometerStatics>{ 0x83B6E7C9,0xE49D,0x4B39,{ 0x86,0xE6,0xCD,0x55,0x4B,0xE4,0xC5,0xC1 } }; // 83B6E7C9-E49D-4B39-86E6-CD554BE4C5C1
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IGyrometerStatics2>{ 0xEF83F7A1,0xD700,0x4204,{ 0x96,0x13,0x79,0xC6,0xB1,0x61,0xDF,0x4E } }; // EF83F7A1-D700-4204-9613-79C6B161DF4E
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IHeadOrientation>{ 0x519F54A9,0x513E,0x55E8,{ 0x9C,0x35,0x3E,0x8D,0xA2,0x1D,0xEE,0x69 } }; // 519F54A9-513E-55E8-9C35-3E8DA21DEE69
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IHeadPosition>{ 0x585AEB65,0xCF35,0x5E6D,{ 0xA7,0x6A,0x37,0xDB,0x13,0x1E,0x17,0xDE } }; // 585AEB65-CF35-5E6D-A76A-37DB131E17DE
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IHingeAngleReading>{ 0xA3CD45B9,0x1BF1,0x4F65,{ 0xA7,0x04,0xE2,0xDA,0x04,0xF1,0x82,0xC0 } }; // A3CD45B9-1BF1-4F65-A704-E2DA04F182C0
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IHingeAngleSensor>{ 0xE9D3BE02,0xBFDF,0x437F,{ 0x8C,0x29,0x88,0xC7,0x73,0x93,0xD3,0x09 } }; // E9D3BE02-BFDF-437F-8C29-88C77393D309
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IHingeAngleSensorReadingChangedEventArgs>{ 0x24D9558B,0xFAD0,0x42B8,{ 0xA8,0x54,0x78,0x92,0x30,0x49,0xA1,0xBA } }; // 24D9558B-FAD0-42B8-A854-78923049A1BA
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IHingeAngleSensorStatics>{ 0xB7B63910,0xFBB1,0x4123,{ 0x89,0xCE,0x4E,0xA3,0x4E,0xB0,0xDF,0xCA } }; // B7B63910-FBB1-4123-89CE-4EA34EB0DFCA
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IHumanPresenceFeatures>{ 0xBDB09FDA,0x3244,0x557A,{ 0xBD,0x29,0x8B,0x00,0x4F,0x59,0xF2,0xCC } }; // BDB09FDA-3244-557A-BD29-8B004F59F2CC
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IHumanPresenceFeatures2>{ 0x08A9CDDA,0xD929,0x5EC2,{ 0x81,0xE2,0x94,0x0B,0xAF,0xA0,0x89,0xCF } }; // 08A9CDDA-D929-5EC2-81E2-940BAFA089CF
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IHumanPresenceFeatures3>{ 0xED4E03AA,0x5CA2,0x5C02,{ 0xB7,0x83,0x26,0x2E,0x91,0x29,0x56,0x19 } }; // ED4E03AA-5CA2-5C02-B783-262E91295619
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IHumanPresenceSensor>{ 0x2116788B,0xE389,0x5CC3,{ 0x9A,0x97,0xCB,0x17,0xBE,0x10,0x08,0xBD } }; // 2116788B-E389-5CC3-9A97-CB17BE1008BD
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IHumanPresenceSensor2>{ 0xF8833779,0x65FE,0x541A,{ 0xB9,0xD6,0x1E,0x47,0x4A,0x48,0x5E,0x7A } }; // F8833779-65FE-541A-B9D6-1E474A485E7A
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IHumanPresenceSensor3>{ 0x963F006D,0x090D,0x532C,{ 0x9E,0xAF,0x80,0x3A,0x9F,0x69,0x28,0x5B } }; // 963F006D-090D-532C-9EAF-803A9F69285B
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IHumanPresenceSensorExtension>{ 0x3E526A71,0x2D1D,0x5D43,{ 0x8A,0x8E,0xA4,0x34,0xA8,0x24,0x2E,0xF0 } }; // 3E526A71-2D1D-5D43-8A8E-A434A8242EF0
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IHumanPresenceSensorReading>{ 0x83533BF5,0xA85A,0x5D50,{ 0x8B,0xE4,0x60,0x72,0xD7,0x45,0xA3,0xBB } }; // 83533BF5-A85A-5D50-8BE4-6072D745A3BB
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IHumanPresenceSensorReading2>{ 0xC4F0E950,0x3BFF,0x53D6,{ 0xA0,0xF8,0x51,0x4E,0xA3,0x70,0x5C,0x66 } }; // C4F0E950-3BFF-53D6-A0F8-514EA3705C66
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IHumanPresenceSensorReading3>{ 0xB876D918,0xF069,0x586F,{ 0x90,0xE3,0x7C,0x6F,0xA5,0xC5,0xD3,0x3A } }; // B876D918-F069-586F-90E3-7C6FA5C5D33A
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IHumanPresenceSensorReadingChangedEventArgs>{ 0xA9DC4583,0xFD69,0x5C5E,{ 0xAB,0x1F,0x94,0x22,0x04,0xEA,0xE2,0xDB } }; // A9DC4583-FD69-5C5E-AB1F-942204EAE2DB
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IHumanPresenceSensorReadingUpdate>{ 0x42419C77,0x6D2F,0x55A0,{ 0x9E,0x01,0xC9,0xCB,0xE7,0xB2,0xD6,0xDF } }; // 42419C77-6D2F-55A0-9E01-C9CBE7B2D6DF
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IHumanPresenceSensorReadingUpdate2>{ 0xBB95A033,0xC688,0x546A,{ 0x8E,0x2D,0xB1,0x26,0x42,0xE7,0xEF,0xEB } }; // BB95A033-C688-546A-8E2D-B12642E7EFEB
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IHumanPresenceSensorStatics>{ 0x2AE89842,0xDBA9,0x56B2,{ 0x9F,0x27,0xEA,0xC6,0x9D,0x62,0x10,0x04 } }; // 2AE89842-DBA9-56B2-9F27-EAC69D621004
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IHumanPresenceSensorStatics2>{ 0x5DE35843,0xD260,0x5A87,{ 0x99,0x5E,0xAC,0xE9,0x13,0x26,0xE1,0xC4 } }; // 5DE35843-D260-5A87-995E-ACE91326E1C4
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IHumanPresenceSettings>{ 0xEF4DAF5B,0x07B7,0x5EB6,{ 0x86,0xBB,0xB7,0xFF,0x49,0xCE,0x44,0xFB } }; // EF4DAF5B-07B7-5EB6-86BB-B7FF49CE44FB
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IHumanPresenceSettings2>{ 0xA26F705E,0x8696,0x5EB4,{ 0xB9,0xE1,0x26,0xA5,0x08,0xDE,0x1C,0xD4 } }; // A26F705E-8696-5EB4-B9E1-26A508DE1CD4
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IHumanPresenceSettings3>{ 0x89757226,0xACC1,0x4F58,{ 0x81,0xDF,0x47,0xF1,0xD6,0x95,0x37,0xF2 } }; // 89757226-ACC1-4F58-81DF-47F1D69537F2
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IHumanPresenceSettingsStatics>{ 0x7F343202,0xE010,0x52C4,{ 0xAF,0x0C,0x04,0xA8,0xF1,0xE0,0x33,0xDA } }; // 7F343202-E010-52C4-AF0C-04A8F1E033DA
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IInclinometer>{ 0x2648CA6F,0x2286,0x406F,{ 0x91,0x61,0xF0,0xC4,0xBD,0x80,0x6E,0xBF } }; // 2648CA6F-2286-406F-9161-F0C4BD806EBF
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IInclinometer2>{ 0x029F3393,0x28B2,0x45F8,{ 0xBB,0x16,0x61,0xE8,0x6A,0x7F,0xAE,0x6E } }; // 029F3393-28B2-45F8-BB16-61E86A7FAE6E
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IInclinometer3>{ 0x3A095004,0xD765,0x4384,{ 0xA3,0xD7,0x02,0x83,0xF3,0xAB,0xE6,0xAE } }; // 3A095004-D765-4384-A3D7-0283F3ABE6AE
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IInclinometer4>{ 0x43852618,0x8FCA,0x548E,{ 0xBB,0xF5,0x5C,0x50,0x41,0x2B,0x6A,0xA4 } }; // 43852618-8FCA-548E-BBF5-5C50412B6AA4
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IInclinometerDataThreshold>{ 0xF80A4783,0x7BFE,0x545E,{ 0xBB,0x60,0xA0,0xEB,0xC4,0x7B,0xD2,0xFB } }; // F80A4783-7BFE-545E-BB60-A0EBC47BD2FB
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IInclinometerDeviceId>{ 0x01E91982,0x41FF,0x4406,{ 0xAE,0x83,0x62,0x21,0x0F,0xF1,0x6F,0xE3 } }; // 01E91982-41FF-4406-AE83-62210FF16FE3
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IInclinometerReading>{ 0x9F44F055,0xB6F6,0x497F,{ 0xB1,0x27,0x1A,0x77,0x5E,0x50,0x14,0x58 } }; // 9F44F055-B6F6-497F-B127-1A775E501458
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IInclinometerReading2>{ 0x4F164781,0xE90B,0x4658,{ 0x89,0x15,0x01,0x03,0xE0,0x8A,0x80,0x5A } }; // 4F164781-E90B-4658-8915-0103E08A805A
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IInclinometerReadingChangedEventArgs>{ 0x4AE91DC1,0xE7EB,0x4938,{ 0x85,0x11,0xAE,0x0D,0x6B,0x44,0x04,0x38 } }; // 4AE91DC1-E7EB-4938-8511-AE0D6B440438
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IInclinometerReadingYawAccuracy>{ 0xB453E880,0x1FE3,0x4986,{ 0xA2,0x57,0xE6,0xEC,0xE2,0x72,0x39,0x49 } }; // B453E880-1FE3-4986-A257-E6ECE2723949
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IInclinometerStatics>{ 0xF22EC551,0x9C30,0x453A,{ 0x8B,0x49,0x3C,0x3E,0xEB,0x33,0xCB,0x61 } }; // F22EC551-9C30-453A-8B49-3C3EEB33CB61
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IInclinometerStatics2>{ 0x043F9775,0x6A1E,0x499C,{ 0x86,0xE0,0x63,0x8C,0x1A,0x86,0x4B,0x00 } }; // 043F9775-6A1E-499C-86E0-638C1A864B00
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IInclinometerStatics3>{ 0xBD9A4280,0xB91A,0x4829,{ 0x93,0x92,0xAB,0xC0,0xB6,0xBD,0xF2,0xB4 } }; // BD9A4280-B91A-4829-9392-ABC0B6BDF2B4
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IInclinometerStatics4>{ 0xE8BA96F9,0x6E85,0x4A83,{ 0xAE,0xD0,0xD7,0xCD,0xCC,0x98,0x56,0xC8 } }; // E8BA96F9-6E85-4A83-AED0-D7CDCC9856C8
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::ILightSensor>{ 0xF84C0718,0x0C54,0x47AE,{ 0x92,0x2E,0x78,0x9F,0x57,0xFB,0x03,0xA0 } }; // F84C0718-0C54-47AE-922E-789F57FB03A0
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::ILightSensor2>{ 0x486B24E8,0xA94C,0x4090,{ 0x8F,0x48,0x09,0xF7,0x82,0xA9,0xF7,0xD5 } }; // 486B24E8-A94C-4090-8F48-09F782A9F7D5
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::ILightSensor3>{ 0x4876D0FF,0x9F4C,0x5F72,{ 0xAD,0xBD,0xA3,0x47,0x1B,0x06,0x3C,0x00 } }; // 4876D0FF-9F4C-5F72-ADBD-A3471B063C00
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::ILightSensor4>{ 0x6167BE97,0x6390,0x404C,{ 0x9C,0x19,0x44,0x53,0x11,0xC6,0xA1,0xD3 } }; // 6167BE97-6390-404C-9C19-445311C6A1D3
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::ILightSensorDataThreshold>{ 0xB160AFD1,0x878F,0x5492,{ 0x9F,0x2C,0x33,0xDC,0x3A,0xE5,0x84,0xA3 } }; // B160AFD1-878F-5492-9F2C-33DC3AE584A3
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::ILightSensorDataThreshold2>{ 0x6F040FBD,0xE08B,0x5B97,{ 0x8F,0x61,0xDD,0x4E,0xE6,0x6B,0x17,0x33 } }; // 6F040FBD-E08B-5B97-8F61-DD4EE66B1733
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::ILightSensorDeviceId>{ 0x7FEE49F8,0x0AFB,0x4F51,{ 0x87,0xF0,0x6C,0x26,0x37,0x5C,0xE9,0x4F } }; // 7FEE49F8-0AFB-4F51-87F0-6C26375CE94F
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::ILightSensorReading>{ 0xFFDF6300,0x227C,0x4D2B,{ 0xB3,0x02,0xFC,0x01,0x42,0x48,0x5C,0x68 } }; // FFDF6300-227C-4D2B-B302-FC0142485C68
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::ILightSensorReading2>{ 0xB7512185,0x44A3,0x44C9,{ 0x81,0x90,0x9E,0xF6,0xDE,0x0A,0x8A,0x74 } }; // B7512185-44A3-44C9-8190-9EF6DE0A8A74
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::ILightSensorReading3>{ 0xF338EE06,0x96AF,0x4029,{ 0xB5,0x30,0x61,0xAC,0xC0,0x5B,0x7C,0xFE } }; // F338EE06-96AF-4029-B530-61ACC05B7CFE
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::ILightSensorReadingChangedEventArgs>{ 0xA3A2F4CF,0x258B,0x420C,{ 0xB8,0xAB,0x8E,0xDD,0x60,0x1E,0xCF,0x50 } }; // A3A2F4CF-258B-420C-B8AB-8EDD601ECF50
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::ILightSensorStatics>{ 0x45DB8C84,0xC3A8,0x471E,{ 0x9A,0x53,0x64,0x57,0xFA,0xD8,0x7C,0x0E } }; // 45DB8C84-C3A8-471E-9A53-6457FAD87C0E
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::ILightSensorStatics2>{ 0x0EC0A650,0xDDC6,0x40AB,{ 0xAC,0xE3,0xEC,0x33,0x59,0xD4,0x2C,0x51 } }; // 0EC0A650-DDC6-40AB-ACE3-EC3359D42C51
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::ILockOnLeaveOptions>{ 0x3C6BF8BD,0x04C1,0x5829,{ 0x8D,0x4E,0x70,0x52,0x17,0x55,0xB8,0xBE } }; // 3C6BF8BD-04C1-5829-8D4E-70521755B8BE
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IMagnetometer>{ 0x484F626E,0xD3C9,0x4111,{ 0xB3,0xF6,0x2C,0xF1,0xFA,0xA4,0x18,0xD5 } }; // 484F626E-D3C9-4111-B3F6-2CF1FAA418D5
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IMagnetometer2>{ 0xB4656C85,0x26F6,0x444B,{ 0xA9,0xE2,0xA2,0x3F,0x96,0x6C,0xD3,0x68 } }; // B4656C85-26F6-444B-A9E2-A23F966CD368
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IMagnetometer3>{ 0xBE93DB7C,0xA625,0x48EF,{ 0xAC,0xF7,0xFA,0xC1,0x04,0x83,0x26,0x71 } }; // BE93DB7C-A625-48EF-ACF7-FAC104832671
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IMagnetometer4>{ 0xDFB17901,0x3E0F,0x508F,{ 0xB2,0x4B,0xF2,0xBB,0x75,0x01,0x5F,0x40 } }; // DFB17901-3E0F-508F-B24B-F2BB75015F40
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IMagnetometerDataThreshold>{ 0xD177CB01,0x9063,0x5FA5,{ 0xB5,0x96,0xB4,0x45,0xE9,0xDC,0x34,0x01 } }; // D177CB01-9063-5FA5-B596-B445E9DC3401
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IMagnetometerDeviceId>{ 0x58B498C2,0x7E4B,0x404C,{ 0x9F,0xC5,0x5D,0xE8,0xB4,0x0E,0xBA,0xE3 } }; // 58B498C2-7E4B-404C-9FC5-5DE8B40EBAE3
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IMagnetometerReading>{ 0x0C2CC40D,0xEBFD,0x4E5C,{ 0xBB,0x11,0xAF,0xC2,0x9B,0x3C,0xAE,0x61 } }; // 0C2CC40D-EBFD-4E5C-BB11-AFC29B3CAE61
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IMagnetometerReading2>{ 0xD4C95C61,0x61D9,0x404B,{ 0xA3,0x28,0x06,0x6F,0x17,0x7A,0x14,0x09 } }; // D4C95C61-61D9-404B-A328-066F177A1409
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IMagnetometerReadingChangedEventArgs>{ 0x17EAE872,0x2EB9,0x4EE7,{ 0x8A,0xD0,0x31,0x27,0x53,0x7D,0x94,0x9B } }; // 17EAE872-2EB9-4EE7-8AD0-3127537D949B
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IMagnetometerStatics>{ 0x853C64CC,0x0698,0x4DDA,{ 0xA6,0xDF,0x9C,0xB9,0xCC,0x4A,0xB4,0x0A } }; // 853C64CC-0698-4DDA-A6DF-9CB9CC4AB40A
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IMagnetometerStatics2>{ 0x2C0819F0,0xFFC6,0x4F89,{ 0xA0,0x6F,0x18,0xFA,0x10,0x79,0x29,0x33 } }; // 2C0819F0-FFC6-4F89-A06F-18FA10792933
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IOnlookerDetectionOptions>{ 0x0412B36F,0x36E6,0x51E2,{ 0x87,0x6E,0x65,0x19,0x7C,0xC5,0x3C,0x12 } }; // 0412B36F-36E6-51E2-876E-65197CC53C12
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IOrientationSensor>{ 0x5E354635,0xCF6B,0x4C63,{ 0xAB,0xD8,0x10,0x25,0x2B,0x0B,0xF6,0xEC } }; // 5E354635-CF6B-4C63-ABD8-10252B0BF6EC
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IOrientationSensor2>{ 0x0D924CF9,0x2F1F,0x49C9,{ 0x80,0x42,0x4A,0x18,0x13,0xD6,0x77,0x60 } }; // 0D924CF9-2F1F-49C9-8042-4A1813D67760
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IOrientationSensor3>{ 0x2CCE578D,0x646B,0x48C5,{ 0xB7,0xEE,0x44,0xFD,0xC4,0xC6,0xAA,0xFD } }; // 2CCE578D-646B-48C5-B7EE-44FDC4C6AAFD
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IOrientationSensorDeviceId>{ 0x5A69B648,0x4C29,0x49EC,{ 0xB2,0x8F,0xEA,0x1D,0x11,0x7B,0x66,0xF0 } }; // 5A69B648-4C29-49EC-B28F-EA1D117B66F0
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IOrientationSensorReading>{ 0x4756C993,0x6595,0x4897,{ 0xBC,0xC6,0xD5,0x37,0xEE,0x75,0x75,0x64 } }; // 4756C993-6595-4897-BCC6-D537EE757564
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IOrientationSensorReading2>{ 0x00576E5F,0x49F8,0x4C05,{ 0x9E,0x07,0x24,0xFA,0xC7,0x94,0x08,0xC3 } }; // 00576E5F-49F8-4C05-9E07-24FAC79408C3
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IOrientationSensorReadingChangedEventArgs>{ 0x012C1186,0xC3BA,0x46BC,{ 0xAE,0x65,0x7A,0x98,0x99,0x6C,0xBF,0xB8 } }; // 012C1186-C3BA-46BC-AE65-7A98996CBFB8
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IOrientationSensorReadingYawAccuracy>{ 0xD1AC9824,0x3F5A,0x49A2,{ 0xBC,0x7B,0x11,0x80,0xBC,0x38,0xCD,0x2B } }; // D1AC9824-3F5A-49A2-BC7B-1180BC38CD2B
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IOrientationSensorStatics>{ 0x10EF8712,0xFB4C,0x428A,{ 0x89,0x8B,0x27,0x65,0xE4,0x09,0xE6,0x69 } }; // 10EF8712-FB4C-428A-898B-2765E409E669
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IOrientationSensorStatics2>{ 0x59DA0D0B,0xD40A,0x4C71,{ 0x92,0x76,0x8A,0x27,0x2A,0x0A,0x66,0x19 } }; // 59DA0D0B-D40A-4C71-9276-8A272A0A6619
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IOrientationSensorStatics3>{ 0xD82CE920,0x2777,0x40FF,{ 0x9F,0x59,0xD6,0x54,0xB0,0x85,0xF1,0x2F } }; // D82CE920-2777-40FF-9F59-D654B085F12F
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IOrientationSensorStatics4>{ 0xA67FEB55,0x2C85,0x4B28,{ 0xA0,0xFE,0x58,0xC4,0xB2,0x04,0x95,0xF5 } }; // A67FEB55-2C85-4B28-A0FE-58C4B20495F5
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IPedometer>{ 0x9A1E013D,0x3D98,0x45F8,{ 0x89,0x20,0x8E,0x4E,0xCA,0xCA,0x5F,0x97 } }; // 9A1E013D-3D98-45F8-8920-8E4ECACA5F97
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IPedometer2>{ 0xE5A406DF,0x2B81,0x4ADD,{ 0xB2,0xFF,0x77,0xAB,0x6C,0x98,0xBA,0x19 } }; // E5A406DF-2B81-4ADD-B2FF-77AB6C98BA19
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IPedometerDataThresholdFactory>{ 0xCBAD8F50,0x7A54,0x466B,{ 0x90,0x10,0x77,0xA1,0x62,0xFC,0xA5,0xD7 } }; // CBAD8F50-7A54-466B-9010-77A162FCA5D7
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IPedometerReading>{ 0x2245DCF4,0xA8E1,0x432F,{ 0x89,0x6A,0xBE,0x0D,0xD9,0xB0,0x2D,0x24 } }; // 2245DCF4-A8E1-432F-896A-BE0DD9B02D24
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IPedometerReadingChangedEventArgs>{ 0xF855E47E,0xABBC,0x4456,{ 0x86,0xA8,0x25,0xCF,0x2B,0x33,0x37,0x42 } }; // F855E47E-ABBC-4456-86A8-25CF2B333742
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IPedometerStatics>{ 0x82980A2F,0x4083,0x4DFB,{ 0xB4,0x11,0x93,0x8E,0xA0,0xF4,0xB9,0x46 } }; // 82980A2F-4083-4DFB-B411-938EA0F4B946
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IPedometerStatics2>{ 0x79F5C6BB,0xCE0E,0x4133,{ 0xB4,0x7E,0x86,0x27,0xEA,0x72,0xF6,0x77 } }; // 79F5C6BB-CE0E-4133-B47E-8627EA72F677
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IProximitySensor>{ 0x54C076B8,0xECFB,0x4944,{ 0xB9,0x28,0x74,0xFC,0x50,0x4D,0x47,0xEE } }; // 54C076B8-ECFB-4944-B928-74FC504D47EE
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IProximitySensorDataThresholdFactory>{ 0x905AC121,0x6D27,0x4AD3,{ 0x9D,0xB5,0x64,0x67,0xF2,0xA5,0xAD,0x9D } }; // 905AC121-6D27-4AD3-9DB5-6467F2A5AD9D
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IProximitySensorReading>{ 0x71228D59,0x132D,0x4D5F,{ 0x8F,0xF9,0x2F,0x0D,0xB8,0x75,0x1C,0xED } }; // 71228D59-132D-4D5F-8FF9-2F0DB8751CED
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IProximitySensorReadingChangedEventArgs>{ 0xCFC2F366,0xC3E8,0x40FD,{ 0x8C,0xC3,0x67,0xE2,0x89,0x00,0x49,0x38 } }; // CFC2F366-C3E8-40FD-8CC3-67E289004938
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IProximitySensorStatics>{ 0x29186649,0x6269,0x4E57,{ 0xA5,0xAD,0x82,0xBE,0x80,0x81,0x33,0x92 } }; // 29186649-6269-4E57-A5AD-82BE80813392
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IProximitySensorStatics2>{ 0xCBF473AE,0xE9CA,0x422F,{ 0xAD,0x67,0x4C,0x3D,0x25,0xDF,0x35,0x0C } }; // CBF473AE-E9CA-422F-AD67-4C3D25DF350C
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::ISensorDataThreshold>{ 0x54DAEC61,0xFE4B,0x4E07,{ 0xB2,0x60,0x3A,0x4C,0xDF,0xBE,0x39,0x6E } }; // 54DAEC61-FE4B-4E07-B260-3A4CDFBE396E
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::ISensorDataThresholdTriggerDetails>{ 0x9106F1B7,0xE88D,0x48B1,{ 0xBC,0x90,0x61,0x9C,0x7B,0x34,0x93,0x91 } }; // 9106F1B7-E88D-48B1-BC90-619C7B349391
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::ISensorQuaternion>{ 0xC9C5C827,0xC71C,0x46E7,{ 0x9D,0xA3,0x36,0xA1,0x93,0xB2,0x32,0xBC } }; // C9C5C827-C71C-46E7-9DA3-36A193B232BC
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::ISensorRotationMatrix>{ 0x0A3D5A67,0x22F4,0x4392,{ 0x95,0x38,0x65,0xD0,0xBD,0x06,0x4A,0xA6 } }; // 0A3D5A67-22F4-4392-9538-65D0BD064AA6
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::ISimpleOrientationSensor>{ 0x5FF53856,0x214A,0x4DEE,{ 0xA3,0xF9,0x61,0x6F,0x1A,0xB0,0x6F,0xFD } }; // 5FF53856-214A-4DEE-A3F9-616F1AB06FFD
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::ISimpleOrientationSensor2>{ 0xA277A798,0x8870,0x453E,{ 0x8B,0xD6,0xB8,0xF5,0xD8,0xD7,0x94,0x1B } }; // A277A798-8870-453E-8BD6-B8F5D8D7941B
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::ISimpleOrientationSensorDeviceId>{ 0xFBC00ACB,0x3B76,0x41F6,{ 0x80,0x91,0x30,0xEF,0xE6,0x46,0xD3,0xCF } }; // FBC00ACB-3B76-41F6-8091-30EFE646D3CF
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::ISimpleOrientationSensorOrientationChangedEventArgs>{ 0xBCD5C660,0x23D4,0x4B4C,{ 0xA2,0x2E,0xBA,0x81,0xAD,0xE0,0xC6,0x01 } }; // BCD5C660-23D4-4B4C-A22E-BA81ADE0C601
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::ISimpleOrientationSensorStatics>{ 0x72ED066F,0x70AA,0x40C6,{ 0x9B,0x1B,0x34,0x33,0xF7,0x45,0x9B,0x4E } }; // 72ED066F-70AA-40C6-9B1B-3433F7459B4E
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::ISimpleOrientationSensorStatics2>{ 0x848F9C7F,0xB138,0x4E11,{ 0x89,0x10,0xA2,0xA2,0xA3,0xB5,0x6D,0x83 } }; // 848F9C7F-B138-4E11-8910-A2A2A3B56D83
    template <> inline constexpr guid guid_v<Windows::Devices::Sensors::IWakeOnApproachOptions>{ 0xF0B87AE7,0x7E1F,0x5EA5,{ 0x81,0x4D,0x6B,0x7E,0x07,0xDE,0xFC,0x2B } }; // F0B87AE7-7E1F-5EA5-814D-6B7E07DEFC2B
    ...
    template <> struct default_interface<Windows::Devices::Sensors::AdaptiveDimmingOptions>{ using type = Windows::Devices::Sensors::IAdaptiveDimmingOptions; };
    ...
    template <> struct default_interface<Windows::Devices::Sensors::DetectedPerson>{ using type = Windows::Devices::Sensors::IDetectedPerson; };
    ...
    template <> struct default_interface<Windows::Devices::Sensors::HeadOrientation>{ using type = Windows::Devices::Sensors::IHeadOrientation; };
    template <> struct default_interface<Windows::Devices::Sensors::HeadPosition>{ using type = Windows::Devices::Sensors::IHeadPosition; };
    ...
    template <> struct default_interface<Windows::Devices::Sensors::HumanPresenceFeatures>{ using type = Windows::Devices::Sensors::IHumanPresenceFeatures; };
    template <> struct default_interface<Windows::Devices::Sensors::HumanPresenceSensor>{ using type = Windows::Devices::Sensors::IHumanPresenceSensor; };
    template <> struct default_interface<Windows::Devices::Sensors::HumanPresenceSensorReading>{ using type = Windows::Devices::Sensors::IHumanPresenceSensorReading; };
    template <> struct default_interface<Windows::Devices::Sensors::HumanPresenceSensorReadingChangedEventArgs>{ using type = Windows::Devices::Sensors::IHumanPresenceSensorReadingChangedEventArgs; };
    template <> struct default_interface<Windows::Devices::Sensors::HumanPresenceSensorReadingUpdate>{ using type = Windows::Devices::Sensors::IHumanPresenceSensorReadingUpdate; };
    template <> struct default_interface<Windows::Devices::Sensors::HumanPresenceSettings>{ using type = Windows::Devices::Sensors::IHumanPresenceSettings; };
    ...
    template <> struct default_interface<Windows::Devices::Sensors::LockOnLeaveOptions>{ using type = Windows::Devices::Sensors::ILockOnLeaveOptions; };
    ...
    template <> struct default_interface<Windows::Devices::Sensors::OnlookerDetectionOptions>{ using type = Windows::Devices::Sensors::IOnlookerDetectionOptions; };
    ...
    template <> struct default_interface<Windows::Devices::Sensors::WakeOnApproachOptions>{ using type = Windows::Devices::Sensors::IWakeOnApproachOptions; };
    ...
    template <> struct abi<Windows::Devices::Sensors::IAdaptiveDimmingOptions>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::Devices::Sensors::IDetectedPerson>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::Devices::Sensors::IHeadOrientation>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::Devices::Sensors::IHeadPosition>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::Devices::Sensors::IHumanPresenceFeatures>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::Devices::Sensors::IHumanPresenceFeatures2>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::Devices::Sensors::IHumanPresenceFeatures3>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::Devices::Sensors::IHumanPresenceSensor>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
            virtual int32_t __stdcall get_DeviceId(void**) noexcept = 0;
    ...
    template <> struct abi<Windows::Devices::Sensors::IHumanPresenceSensor2>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::Devices::Sensors::IHumanPresenceSensor3>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::Devices::Sensors::IHumanPresenceSensorExtension>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::Devices::Sensors::IHumanPresenceSensorReading>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
            virtual int32_t __stdcall get_Timestamp(int64_t*) noexcept = 0;
    ...
    template <> struct abi<Windows::Devices::Sensors::IHumanPresenceSensorReading2>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
            virtual int32_t __stdcall get_Properties(void**) noexcept = 0;
    ...
    template <> struct abi<Windows::Devices::Sensors::IHumanPresenceSensorReading3>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::Devices::Sensors::IHumanPresenceSensorReadingChangedEventArgs>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
            virtual int32_t __stdcall get_Reading(void**) noexcept = 0;
    ...
    template <> struct abi<Windows::Devices::Sensors::IHumanPresenceSensorReadingUpdate>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::Devices::Sensors::IHumanPresenceSensorReadingUpdate2>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::Devices::Sensors::IHumanPresenceSensorStatics>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
            virtual int32_t __stdcall GetDeviceSelector(void**) noexcept = 0;
    ...
    template <> struct abi<Windows::Devices::Sensors::IHumanPresenceSensorStatics2>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::Devices::Sensors::IHumanPresenceSettings>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
            virtual int32_t __stdcall get_SensorId(void**) noexcept = 0;
    ...
    template <> struct abi<Windows::Devices::Sensors::IHumanPresenceSettings2>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::Devices::Sensors::IHumanPresenceSettings3>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::Devices::Sensors::IHumanPresenceSettingsStatics>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::Devices::Sensors::ILightSensor4>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::Devices::Sensors::ILightSensorDataThreshold2>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::Devices::Sensors::ILightSensorReading3>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
            virtual int32_t __stdcall get_Chromaticity(struct struct_Windows_Devices_Sensors_LightSensorChromaticity*) noexcept = 0;
    ...
    template <> struct abi<Windows::Devices::Sensors::ILockOnLeaveOptions>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
            virtual int32_t __stdcall get_AllowWhenExternalDisplayConnected(bool*) noexcept = 0;
    ...
    template <> struct abi<Windows::Devices::Sensors::IOnlookerDetectionOptions>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::Devices::Sensors::IWakeOnApproachOptions>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
            virtual int32_t __stdcall get_AllowWhenExternalDisplayConnected(bool*) noexcept = 0;
    ...
    template <> struct consume<Windows::Devices::Sensors::IAdaptiveDimmingOptions>
    {
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Devices::Sensors::HumanEngagement) Engagement() const;
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Foundation::IReference<uint32_t>) DistanceInMillimeters() const;
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Devices::Sensors::HeadOrientation) HeadOrientation() const;
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Devices::Sensors::HeadPosition) HeadPosition() const;
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Foundation::IReference<int32_t>) PersonId() const;
    };
    template <> struct consume<Windows::Devices::Sensors::IDetectedPerson>
    {
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Foundation::IReference<double>) RollInDegrees() const;
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Foundation::IReference<double>) PitchInDegrees() const;
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Foundation::IReference<double>) YawInDegrees() const;
    };
    template <> struct consume<Windows::Devices::Sensors::IHeadOrientation>
    {
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Foundation::IReference<double>) AzimuthInDegrees() const;
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Foundation::IReference<double>) AltitudeInDegrees() const;
    };
    template <> struct consume<Windows::Devices::Sensors::IHeadPosition>
    {
    ...
    struct consume_Windows_Devices_Sensors_IHumanPresenceFeatures
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Foundation::Collections::IVectorView<uint32_t>) SupportedWakeOrLockDistancesInMillimeters() const;
    ...
    template <> struct consume<Windows::Devices::Sensors::IHumanPresenceFeatures>
    {
    ...
    template <> struct consume<Windows::Devices::Sensors::IHumanPresenceFeatures2>
    {
    ...
    template <> struct consume<Windows::Devices::Sensors::IHumanPresenceFeatures3>
    {
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) DeviceId() const;
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Foundation::IReference<uint32_t>) MaxDetectableDistanceInMillimeters() const;
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Foundation::IReference<uint32_t>) MinDetectableDistanceInMillimeters() const;
        WINRT_IMPL_AUTO(Windows::Devices::Sensors::HumanPresenceSensorReading) GetCurrentReading() const;
        WINRT_IMPL_AUTO(winrt::event_token) ReadingChanged(Windows::Foundation::TypedEventHandler<Windows::Devices::Sensors::HumanPresenceSensor, Windows::Devices::Sensors::HumanPresenceSensorReadingChangedEventArgs> const& handler) const;
        using ReadingChanged_revoker = impl::event_revoker<Windows::Devices::Sensors::IHumanPresenceSensor, &impl::abi_t<Windows::Devices::Sensors::IHumanPresenceSensor>::remove_ReadingChanged>;
        [[nodiscard]] ReadingChanged_revoker ReadingChanged(auto_revoke_t, Windows::Foundation::TypedEventHandler<Windows::Devices::Sensors::HumanPresenceSensor, Windows::Devices::Sensors::HumanPresenceSensorReadingChangedEventArgs> const& handler) const;
        WINRT_IMPL_AUTO(void) ReadingChanged(winrt::event_token const& token) const noexcept;
    };
    template <> struct consume<Windows::Devices::Sensors::IHumanPresenceSensor>
    {
    ...
    template <> struct consume<Windows::Devices::Sensors::IHumanPresenceSensor2>
    {
    ...
    struct consume_Windows_Devices_Sensors_IHumanPresenceSensor3
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Foundation::IReference<double>) MinDetectableAzimuthInDegrees() const;
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Foundation::IReference<double>) MaxDetectableAzimuthInDegrees() const;
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Foundation::IReference<double>) MinDetectableAltitudeInDegrees() const;
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Foundation::IReference<double>) MaxDetectableAltitudeInDegrees() const;
    };
    template <> struct consume<Windows::Devices::Sensors::IHumanPresenceSensor3>
    {
    ...
    struct consume_Windows_Devices_Sensors_IHumanPresenceSensorExtension
    {
        ...
        WINRT_IMPL_AUTO(Windows::Devices::Sensors::HumanPresenceSensorReadingUpdate) ProcessReading(Windows::Devices::Sensors::HumanPresenceSensorReading const& reading) const;
        WINRT_IMPL_AUTO(void) ProcessReadingTimeoutExpired(Windows::Devices::Sensors::HumanPresenceSensorReading const& reading) const;
        WINRT_IMPL_AUTO(void) Stop() const;
        WINRT_IMPL_AUTO(void) Uninitialize() const;
        WINRT_IMPL_AUTO(void) Reset() const;
    };
    template <> struct consume<Windows::Devices::Sensors::IHumanPresenceSensorExtension>
    {
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Foundation::DateTime) Timestamp() const;
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Devices::Sensors::HumanPresence) Presence() const;
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Devices::Sensors::HumanEngagement) Engagement() const;
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Foundation::IReference<uint32_t>) DistanceInMillimeters() const;
    };
    template <> struct consume<Windows::Devices::Sensors::IHumanPresenceSensorReading>
    {
    ...
    template <> struct consume<Windows::Devices::Sensors::IHumanPresenceSensorReading2>
    {
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Devices::Sensors::HumanPresence) OnlookerPresence() const;
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Foundation::Collections::IVectorView<Windows::Devices::Sensors::DetectedPerson>) DetectedPersons() const;
    };
    template <> struct consume<Windows::Devices::Sensors::IHumanPresenceSensorReading3>
    {
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Devices::Sensors::HumanPresenceSensorReading) Reading() const;
    };
    template <> struct consume<Windows::Devices::Sensors::IHumanPresenceSensorReadingChangedEventArgs>
    {
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Foundation::IReference<Windows::Foundation::DateTime>) Timestamp() const;
        WINRT_IMPL_AUTO(void) Timestamp(Windows::Foundation::IReference<Windows::Foundation::DateTime> const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Foundation::IReference<Windows::Devices::Sensors::HumanPresence>) Presence() const;
        WINRT_IMPL_AUTO(void) Presence(Windows::Foundation::IReference<Windows::Devices::Sensors::HumanPresence> const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Foundation::IReference<Windows::Devices::Sensors::HumanEngagement>) Engagement() const;
        WINRT_IMPL_AUTO(void) Engagement(Windows::Foundation::IReference<Windows::Devices::Sensors::HumanEngagement> const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Foundation::IReference<uint32_t>) DistanceInMillimeters() const;
        WINRT_IMPL_AUTO(void) DistanceInMillimeters(Windows::Foundation::IReference<uint32_t> const& value) const;
    };
    template <> struct consume<Windows::Devices::Sensors::IHumanPresenceSensorReadingUpdate>
    {
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Foundation::IReference<Windows::Devices::Sensors::HumanPresence>) OnlookerPresence() const;
        WINRT_IMPL_AUTO(void) OnlookerPresence(Windows::Foundation::IReference<Windows::Devices::Sensors::HumanPresence> const& value) const;
    };
    template <> struct consume<Windows::Devices::Sensors::IHumanPresenceSensorReadingUpdate2>
    {
    ...
    {
        WINRT_IMPL_AUTO(hstring) GetDeviceSelector() const;
        WINRT_IMPL_AUTO(Windows::Foundation::IAsyncOperation<Windows::Devices::Sensors::HumanPresenceSensor>) FromIdAsync(param::hstring const& sensorId) const;
        WINRT_IMPL_AUTO(Windows::Foundation::IAsyncOperation<Windows::Devices::Sensors::HumanPresenceSensor>) GetDefaultAsync() const;
    };
    template <> struct consume<Windows::Devices::Sensors::IHumanPresenceSensorStatics>
    {
    ...
    {
        WINRT_IMPL_AUTO(Windows::Devices::Sensors::HumanPresenceSensor) FromId(param::hstring const& sensorId) const;
        WINRT_IMPL_AUTO(Windows::Devices::Sensors::HumanPresenceSensor) GetDefault() const;
    };
    template <> struct consume<Windows::Devices::Sensors::IHumanPresenceSensorStatics2>
    {
    ...
    struct consume_Windows_Devices_Sensors_IHumanPresenceSettings
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Foundation::IReference<uint32_t>) WakeOnApproachDistanceInMillimeters() const;
        WINRT_IMPL_AUTO(void) WakeOnApproachDistanceInMillimeters(Windows::Foundation::IReference<uint32_t> const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) IsLockOnLeaveEnabled() const;
        WINRT_IMPL_AUTO(void) IsLockOnLeaveEnabled(bool value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Foundation::IReference<uint32_t>) LockOnLeaveDistanceInMillimeters() const;
        WINRT_IMPL_AUTO(void) LockOnLeaveDistanceInMillimeters(Windows::Foundation::IReference<uint32_t> const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Foundation::TimeSpan) LockOnLeaveTimeout() const;
        WINRT_IMPL_AUTO(void) LockOnLeaveTimeout(Windows::Foundation::TimeSpan const& value) const;
    ...
    template <> struct consume<Windows::Devices::Sensors::IHumanPresenceSettings>
    {
    ...
    struct consume_Windows_Devices_Sensors_IHumanPresenceSettings2
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Devices::Sensors::WakeOnApproachOptions) WakeOptions() const;
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Devices::Sensors::AdaptiveDimmingOptions) DimmingOptions() const;
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Devices::Sensors::LockOnLeaveOptions) LockOptions() const;
    };
    template <> struct consume<Windows::Devices::Sensors::IHumanPresenceSettings2>
    {
    ...
    struct consume_Windows_Devices_Sensors_IHumanPresenceSettings3
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Devices::Sensors::OnlookerDetectionOptions) OnlookerDetectionOptions() const;
    };
    template <> struct consume<Windows::Devices::Sensors::IHumanPresenceSettings3>
    {
    ...
    {
        WINRT_IMPL_AUTO(Windows::Foundation::IAsyncOperation<Windows::Devices::Sensors::HumanPresenceSettings>) GetCurrentSettingsAsync() const;
        WINRT_IMPL_AUTO(Windows::Devices::Sensors::HumanPresenceSettings) GetCurrentSettings() const;
        WINRT_IMPL_AUTO(Windows::Foundation::IAsyncAction) UpdateSettingsAsync(Windows::Devices::Sensors::HumanPresenceSettings const& settings) const;
        WINRT_IMPL_AUTO(void) UpdateSettings(Windows::Devices::Sensors::HumanPresenceSettings const& settings) const;
        WINRT_IMPL_AUTO(Windows::Foundation::IAsyncOperation<Windows::Devices::Sensors::HumanPresenceFeatures>) GetSupportedFeaturesForSensorIdAsync(param::hstring const& sensorId) const;
        WINRT_IMPL_AUTO(Windows::Devices::Sensors::HumanPresenceFeatures) GetSupportedFeaturesForSensorId(param::hstring const& sensorId) const;
        WINRT_IMPL_AUTO(Windows::Foundation::Collections::IVectorView<Windows::Foundation::TimeSpan>) GetSupportedLockOnLeaveTimeouts() const;
        WINRT_IMPL_AUTO(winrt::event_token) SettingsChanged(Windows::Foundation::EventHandler<Windows::Foundation::IInspectable> const& handler) const;
        using SettingsChanged_revoker = impl::event_revoker<Windows::Devices::Sensors::IHumanPresenceSettingsStatics, &impl::abi_t<Windows::Devices::Sensors::IHumanPresenceSettingsStatics>::remove_SettingsChanged>;
        [[nodiscard]] SettingsChanged_revoker SettingsChanged(auto_revoke_t, Windows::Foundation::EventHandler<Windows::Foundation::IInspectable> const& handler) const;
        WINRT_IMPL_AUTO(void) SettingsChanged(winrt::event_token const& token) const noexcept;
    };
    template <> struct consume<Windows::Devices::Sensors::IHumanPresenceSettingsStatics>
    {
    ...
    template <> struct consume<Windows::Devices::Sensors::ILightSensor4>
    {
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Devices::Sensors::LightSensorChromaticity) Chromaticity() const;
        WINRT_IMPL_AUTO(void) Chromaticity(Windows::Devices::Sensors::LightSensorChromaticity const& value) const;
    };
    template <> struct consume<Windows::Devices::Sensors::ILightSensorDataThreshold2>
    {
    ...
    template <> struct consume<Windows::Devices::Sensors::ILightSensorReading3>
    {
    ...
    template <> struct consume<Windows::Devices::Sensors::ILockOnLeaveOptions>
    {
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Devices::Sensors::OnlookerDetectionAction) Action() const;
        WINRT_IMPL_AUTO(void) Action(Windows::Devices::Sensors::OnlookerDetectionAction const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Devices::Sensors::OnlookerDetectionBackOnMode) BackOnMode() const;
        WINRT_IMPL_AUTO(void) BackOnMode(Windows::Devices::Sensors::OnlookerDetectionBackOnMode const& value) const;
    };
    template <> struct consume<Windows::Devices::Sensors::IOnlookerDetectionOptions>
    {
    ...
    template <> struct consume<Windows::Devices::Sensors::IWakeOnApproachOptions>
    {

...
namespace winrt::impl
{
    ...
    template <> struct category<Windows::Storage::Provider::IStorageProviderQueryResult>{ using type = interface_category; };
    template <> struct category<Windows::Storage::Provider::IStorageProviderQueryResultSet>{ using type = interface_category; };
    template <> struct category<Windows::Storage::Provider::IStorageProviderQueryResultSetFactory>{ using type = interface_category; };
    template <> struct category<Windows::Storage::Provider::IStorageProviderQuotaUI>{ using type = interface_category; };
    template <> struct category<Windows::Storage::Provider::IStorageProviderSearchHandler>{ using type = interface_category; };
    template <> struct category<Windows::Storage::Provider::IStorageProviderSearchHandlerFactory>{ using type = interface_category; };
    template <> struct category<Windows::Storage::Provider::IStorageProviderSearchQueryOptions>{ using type = interface_category; };
    template <> struct category<Windows::Storage::Provider::IStorageProviderSearchResult>{ using type = interface_category; };
    template <> struct category<Windows::Storage::Provider::IStorageProviderShareLinkSource>{ using type = interface_category; };
    ...
    template <> struct category<Windows::Storage::Provider::IStorageProviderSuggestionsHandler>{ using type = interface_category; };
    template <> struct category<Windows::Storage::Provider::IStorageProviderSuggestionsHandlerFactory>{ using type = interface_category; };
    template <> struct category<Windows::Storage::Provider::IStorageProviderSuggestionsQueryOptions>{ using type = interface_category; };
    ...
    template <> struct category<Windows::Storage::Provider::StorageProviderQueryResultSet>{ using type = class_category; };
    template <> struct category<Windows::Storage::Provider::StorageProviderQuotaUI>{ using type = class_category; };
    template <> struct category<Windows::Storage::Provider::StorageProviderSearchQueryOptions>{ using type = class_category; };
    template <> struct category<Windows::Storage::Provider::StorageProviderSearchResult>{ using type = class_category; };
    template <> struct category<Windows::Storage::Provider::StorageProviderStatusUI>{ using type = class_category; };
    template <> struct category<Windows::Storage::Provider::StorageProviderSuggestionResult>{ using type = class_category; };
    template <> struct category<Windows::Storage::Provider::StorageProviderSuggestionsQueryOptions>{ using type = class_category; };
    ...
    template <> struct category<Windows::Storage::Provider::StorageProviderResultKind>{ using type = enum_category; };
    template <> struct category<Windows::Storage::Provider::StorageProviderResultUsageKind>{ using type = enum_category; };
    template <> struct category<Windows::Storage::Provider::StorageProviderSearchMatchKind>{ using type = enum_category; };
    template <> struct category<Windows::Storage::Provider::StorageProviderSearchQueryStatus>{ using type = enum_category; };
    template <> struct category<Windows::Storage::Provider::StorageProviderShareLinkState>{ using type = enum_category; };
    ...
    template <> inline constexpr auto& name_v<Windows::Storage::Provider::StorageProviderQueryResultSet> = L"Windows.Storage.Provider.StorageProviderQueryResultSet";
    ...
    template <> inline constexpr auto& name_v<Windows::Storage::Provider::StorageProviderSearchQueryOptions> = L"Windows.Storage.Provider.StorageProviderSearchQueryOptions";
    template <> inline constexpr auto& name_v<Windows::Storage::Provider::StorageProviderSearchResult> = L"Windows.Storage.Provider.StorageProviderSearchResult";
    ...
    template <> inline constexpr auto& name_v<Windows::Storage::Provider::StorageProviderSuggestionResult> = L"Windows.Storage.Provider.StorageProviderSuggestionResult";
    template <> inline constexpr auto& name_v<Windows::Storage::Provider::StorageProviderSuggestionsQueryOptions> = L"Windows.Storage.Provider.StorageProviderSuggestionsQueryOptions";
    ...
    template <> inline constexpr auto& name_v<Windows::Storage::Provider::StorageProviderResultKind> = L"Windows.Storage.Provider.StorageProviderResultKind";
    template <> inline constexpr auto& name_v<Windows::Storage::Provider::StorageProviderResultUsageKind> = L"Windows.Storage.Provider.StorageProviderResultUsageKind";
    template <> inline constexpr auto& name_v<Windows::Storage::Provider::StorageProviderSearchMatchKind> = L"Windows.Storage.Provider.StorageProviderSearchMatchKind";
    template <> inline constexpr auto& name_v<Windows::Storage::Provider::StorageProviderSearchQueryStatus> = L"Windows.Storage.Provider.StorageProviderSearchQueryStatus";
    template <> inline constexpr auto& name_v<Windows::Storage::Provider::StorageProviderShareLinkState> = L"Windows.Storage.Provider.StorageProviderShareLinkState";
    ...
    template <> inline constexpr auto& name_v<Windows::Storage::Provider::IStorageProviderQueryResult> = L"Windows.Storage.Provider.IStorageProviderQueryResult";
    template <> inline constexpr auto& name_v<Windows::Storage::Provider::IStorageProviderQueryResultSet> = L"Windows.Storage.Provider.IStorageProviderQueryResultSet";
    template <> inline constexpr auto& name_v<Windows::Storage::Provider::IStorageProviderQueryResultSetFactory> = L"Windows.Storage.Provider.IStorageProviderQueryResultSetFactory";
    ...
    template <> inline constexpr auto& name_v<Windows::Storage::Provider::IStorageProviderSearchHandler> = L"Windows.Storage.Provider.IStorageProviderSearchHandler";
    template <> inline constexpr auto& name_v<Windows::Storage::Provider::IStorageProviderSearchHandlerFactory> = L"Windows.Storage.Provider.IStorageProviderSearchHandlerFactory";
    template <> inline constexpr auto& name_v<Windows::Storage::Provider::IStorageProviderSearchQueryOptions> = L"Windows.Storage.Provider.IStorageProviderSearchQueryOptions";
    template <> inline constexpr auto& name_v<Windows::Storage::Provider::IStorageProviderSearchResult> = L"Windows.Storage.Provider.IStorageProviderSearchResult";
    template <> inline constexpr auto& name_v<Windows::Storage::Provider::IStorageProviderShareLinkSource> = L"Windows.Storage.Provider.IStorageProviderShareLinkSource";
    ...
    template <> inline constexpr auto& name_v<Windows::Storage::Provider::IStorageProviderSuggestionsHandler> = L"Windows.Storage.Provider.IStorageProviderSuggestionsHandler";
    template <> inline constexpr auto& name_v<Windows::Storage::Provider::IStorageProviderSuggestionsHandlerFactory> = L"Windows.Storage.Provider.IStorageProviderSuggestionsHandlerFactory";
    template <> inline constexpr auto& name_v<Windows::Storage::Provider::IStorageProviderSuggestionsQueryOptions> = L"Windows.Storage.Provider.IStorageProviderSuggestionsQueryOptions";
    ...
    template <> inline constexpr guid guid_v<Windows::Storage::Provider::IStorageProviderKnownFolderEntry>{ 0xEFFA7DB0,0x1D44,0x596B,{ 0x84,0x64,0x92,0x88,0x00,0xC5,0xE2,0xD8 } }; // EFFA7DB0-1D44-596B-8464-928800C5E2D8
    template <> inline constexpr guid guid_v<Windows::Storage::Provider::IStorageProviderKnownFolderSyncInfo>{ 0x98B017CE,0xFFC1,0x5B11,{ 0xAE,0x77,0xCC,0x17,0xAF,0xEC,0x10,0x49 } }; // 98B017CE-FFC1-5B11-AE77-CC17AFEC1049
    template <> inline constexpr guid guid_v<Windows::Storage::Provider::IStorageProviderKnownFolderSyncInfoSource>{ 0x51359342,0xF7C0,0x53D0,{ 0xBB,0xB6,0x1C,0xDC,0x09,0x8E,0xBD,0xA9 } }; // 51359342-F7C0-53D0-BBB6-1CDC098EBDA9
    template <> inline constexpr guid guid_v<Windows::Storage::Provider::IStorageProviderKnownFolderSyncInfoSourceFactory>{ 0xAAEE03A7,0xA7F6,0x50BE,{ 0xA9,0xB0,0x8E,0x82,0xD0,0xC8,0x10,0x82 } }; // AAEE03A7-A7F6-50BE-A9B0-8E82D0C81082
    template <> inline constexpr guid guid_v<Windows::Storage::Provider::IStorageProviderKnownFolderSyncRequestArgs>{ 0xEDA6D569,0xB4E8,0x542F,{ 0xAB,0x8D,0xF3,0x61,0x3F,0x25,0x0A,0x4A } }; // EDA6D569-B4E8-542F-AB8D-F3613F250A4A
    template <> inline constexpr guid guid_v<Windows::Storage::Provider::IStorageProviderMoreInfoUI>{ 0xEF38E591,0xA7CB,0x5E7D,{ 0x9B,0x5E,0x22,0x74,0x98,0x42,0x69,0x7C } }; // EF38E591-A7CB-5E7D-9B5E-22749842697C
    ...
    template <> inline constexpr guid guid_v<Windows::Storage::Provider::IStorageProviderQueryResult>{ 0xF1CD00AE,0xB4A9,0x5D20,{ 0xA5,0x98,0x3E,0xB4,0xDD,0x8F,0xF8,0xF4 } }; // F1CD00AE-B4A9-5D20-A598-3EB4DD8FF8F4
    template <> inline constexpr guid guid_v<Windows::Storage::Provider::IStorageProviderQueryResultSet>{ 0x57C28407,0x7D21,0x5F98,{ 0xAC,0x52,0x09,0x26,0xA9,0x7F,0x32,0x59 } }; // 57C28407-7D21-5F98-AC52-0926A97F3259
    template <> inline constexpr guid guid_v<Windows::Storage::Provider::IStorageProviderQueryResultSetFactory>{ 0x301974C2,0x9B0A,0x51D1,{ 0x84,0xB5,0x32,0x57,0x8E,0xE3,0x08,0x3D } }; // 301974C2-9B0A-51D1-84B5-32578EE3083D
    template <> inline constexpr guid guid_v<Windows::Storage::Provider::IStorageProviderQuotaUI>{ 0xBA6295C3,0x312E,0x544F,{ 0x9F,0xD5,0x1F,0x81,0xB2,0x1F,0x36,0x49 } }; // BA6295C3-312E-544F-9FD5-1F81B21F3649
    template <> inline constexpr guid guid_v<Windows::Storage::Provider::IStorageProviderSearchHandler>{ 0x69CC977D,0xADAD,0x59C9,{ 0x8F,0xD1,0xF3,0x0B,0x6F,0xAE,0x0F,0xD9 } }; // 69CC977D-ADAD-59C9-8FD1-F30B6FAE0FD9
    template <> inline constexpr guid guid_v<Windows::Storage::Provider::IStorageProviderSearchHandlerFactory>{ 0xB0DCAD80,0xF3F5,0x516B,{ 0x8A,0xCE,0x4E,0x77,0x02,0x2C,0x95,0x98 } }; // B0DCAD80-F3F5-516B-8ACE-4E77022C9598
    template <> inline constexpr guid guid_v<Windows::Storage::Provider::IStorageProviderSearchQueryOptions>{ 0x93D854EB,0x1007,0x563C,{ 0xB2,0x13,0xCC,0x44,0xBD,0x88,0xFE,0xF2 } }; // 93D854EB-1007-563C-B213-CC44BD88FEF2
    template <> inline constexpr guid guid_v<Windows::Storage::Provider::IStorageProviderSearchResult>{ 0xFC161049,0x0995,0x535F,{ 0x99,0xB7,0xFE,0x29,0x2C,0xBA,0xBA,0xF5 } }; // FC161049-0995-535F-99B7-FE292CBABAF5
    template <> inline constexpr guid guid_v<Windows::Storage::Provider::IStorageProviderShareLinkSource>{ 0x4C6055E2,0x029C,0x5539,{ 0x8E,0x51,0xA1,0xAF,0xC8,0x38,0xB5,0xCB } }; // 4C6055E2-029C-5539-8E51-A1AFC838B5CB
    template <> inline constexpr guid guid_v<Windows::Storage::Provider::IStorageProviderStatusUI>{ 0xD6B6A758,0x198D,0x5B80,{ 0x97,0x7F,0x5F,0xF7,0x3D,0xA3,0x31,0x18 } }; // D6B6A758-198D-5B80-977F-5FF73DA33118
    template <> inline constexpr guid guid_v<Windows::Storage::Provider::IStorageProviderStatusUISource>{ 0xA306C249,0x3D66,0x5E70,{ 0x90,0x07,0xE4,0x3D,0xF9,0x60,0x51,0xFF } }; // A306C249-3D66-5E70-9007-E43DF96051FF
    template <> inline constexpr guid guid_v<Windows::Storage::Provider::IStorageProviderStatusUISourceFactory>{ 0x12E46B74,0x4E5A,0x58D1,{ 0xA6,0x2F,0x03,0x76,0xE8,0xEE,0x7D,0xD8 } }; // 12E46B74-4E5A-58D1-A62F-0376E8EE7DD8
    template <> inline constexpr guid guid_v<Windows::Storage::Provider::IStorageProviderSuggestionsHandler>{ 0xAFF493F6,0xE1FD,0x5D03,{ 0xB4,0x80,0xF1,0x84,0x9C,0x83,0xEF,0x4A } }; // AFF493F6-E1FD-5D03-B480-F1849C83EF4A
    template <> inline constexpr guid guid_v<Windows::Storage::Provider::IStorageProviderSuggestionsHandlerFactory>{ 0xDC7B35D8,0xA25B,0x58A3,{ 0xAC,0xE7,0xB3,0x54,0x31,0x06,0xA2,0xAA } }; // DC7B35D8-A25B-58A3-ACE7-B3543106A2AA
    template <> inline constexpr guid guid_v<Windows::Storage::Provider::IStorageProviderSuggestionsQueryOptions>{ 0xEFB8B74D,0x0D84,0x579C,{ 0xB1,0x37,0xEA,0x73,0x06,0x35,0xD9,0xBB } }; // EFB8B74D-0D84-579C-B137-EA730635D9BB
    ...
    template <> inline constexpr guid guid_v<Windows::Storage::Provider::IStorageProviderUICommand>{ 0x0C3E0760,0xD846,0x568F,{ 0x94,0x84,0x10,0x5C,0xC5,0x7B,0x50,0x2B } }; // 0C3E0760-D846-568F-9484-105CC57B502B
    ...
    template <> inline constexpr guid guid_v<Windows::Storage::Provider::StorageProviderKnownFolderSyncRequestedHandler>{ 0xC4CBB4F5,0x13DD,0x5C8E,{ 0x8B,0x96,0x33,0x6F,0xC3,0x0C,0x62,0x9B } }; // C4CBB4F5-13DD-5C8E-8B96-336FC30C629B
    ...
    template <> struct default_interface<Windows::Storage::Provider::StorageProviderQueryResultSet>{ using type = Windows::Storage::Provider::IStorageProviderQueryResultSet; };
    ...
    template <> struct default_interface<Windows::Storage::Provider::StorageProviderSearchQueryOptions>{ using type = Windows::Storage::Provider::IStorageProviderSearchQueryOptions; };
    template <> struct default_interface<Windows::Storage::Provider::StorageProviderSearchResult>{ using type = Windows::Storage::Provider::IStorageProviderSearchResult; };
    ...
    template <> struct default_interface<Windows::Storage::Provider::StorageProviderSuggestionResult>{ using type = Windows::Storage::Provider::IStorageProviderQueryResult; };
    template <> struct default_interface<Windows::Storage::Provider::StorageProviderSuggestionsQueryOptions>{ using type = Windows::Storage::Provider::IStorageProviderSuggestionsQueryOptions; };
    ...
    template <> struct abi<Windows::Storage::Provider::IStorageProviderQueryResult>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::Storage::Provider::IStorageProviderQueryResultSet>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::Storage::Provider::IStorageProviderQueryResultSetFactory>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::Storage::Provider::IStorageProviderSearchHandler>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::Storage::Provider::IStorageProviderSearchHandlerFactory>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::Storage::Provider::IStorageProviderSearchQueryOptions>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::Storage::Provider::IStorageProviderSearchResult>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::Storage::Provider::IStorageProviderShareLinkSource>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::Storage::Provider::IStorageProviderSuggestionsHandler>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::Storage::Provider::IStorageProviderSuggestionsHandlerFactory>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::Storage::Provider::IStorageProviderSuggestionsQueryOptions>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Storage::Provider::StorageProviderResultKind) Kind() const;
        WINRT_IMPL_AUTO(void) Kind(Windows::Storage::Provider::StorageProviderResultKind const& value) const;
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Foundation::Collections::PropertySet) RequestedProperties() const;
    };
    template <> struct consume<Windows::Storage::Provider::IStorageProviderQueryResult>
    {
    ...
    {
        WINRT_IMPL_AUTO(com_array<Windows::Storage::Provider::IStorageProviderQueryResult>) GetResults() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) QueryResultId() const;
        WINRT_IMPL_AUTO(void) QueryResultId(param::hstring const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Storage::Provider::StorageProviderSearchQueryStatus) Status() const;
        WINRT_IMPL_AUTO(void) Status(Windows::Storage::Provider::StorageProviderSearchQueryStatus const& value) const;
    };
    template <> struct consume<Windows::Storage::Provider::IStorageProviderQueryResultSet>
    {
    ...
    {
        WINRT_IMPL_AUTO(Windows::Storage::Provider::StorageProviderQueryResultSet) CreateInstance(array_view<Windows::Storage::Provider::IStorageProviderQueryResult const> results) const;
    };
    template <> struct consume<Windows::Storage::Provider::IStorageProviderQueryResultSetFactory>
    {
    ...
    {
        WINRT_IMPL_AUTO(Windows::Storage::Provider::StorageProviderQueryResultSet) Find(Windows::Storage::Provider::StorageProviderSearchQueryOptions const& options) const;
        WINRT_IMPL_AUTO(void) ReportUsage(Windows::Storage::Provider::StorageProviderResultUsageKind const& resultUsageKind, param::hstring const& remoteFileId, param::hstring const& resultId, Windows::Foundation::TimeSpan const& latency) const;
    };
    template <> struct consume<Windows::Storage::Provider::IStorageProviderSearchHandler>
    {
    ...
    {
        WINRT_IMPL_AUTO(Windows::Storage::Provider::IStorageProviderSearchHandler) CreateSearchHandler(param::hstring const& cloudProviderId) const;
    };
    template <> struct consume<Windows::Storage::Provider::IStorageProviderSearchHandlerFactory>
    {
    ...
    struct consume_Windows_Storage_Provider_IStorageProviderSearchQueryOptions
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Foundation::Collections::IVectorView<Windows::Storage::Search::SortEntry>) SortOrder() const;
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Foundation::Collections::IVectorView<hstring>) PropertiesToFetch() const;
    };
    template <> struct consume<Windows::Storage::Provider::IStorageProviderSearchQueryOptions>
    {
    ...
    struct consume_Windows_Storage_Provider_IStorageProviderSearchResult
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Storage::Provider::StorageProviderSearchMatchKind) MatchKind() const;
        WINRT_IMPL_AUTO(void) MatchKind(Windows::Storage::Provider::StorageProviderSearchMatchKind const& value) const;
    ...
    template <> struct consume<Windows::Storage::Provider::IStorageProviderSearchResult>
    {
    ...
    {
        WINRT_IMPL_AUTO(Windows::Foundation::IAsyncOperation<Windows::Foundation::Uri>) CreateLinkAsync(param::async_vector_view<Windows::Storage::IStorageItem> const& storageItemList) const;
        WINRT_IMPL_AUTO(Windows::Foundation::IAsyncOperation<hstring>) GetDefaultAccessControlStringAsync(param::async_vector_view<Windows::Storage::IStorageItem> const& storageItemList) const;
        WINRT_IMPL_AUTO(Windows::Foundation::IAsyncOperation<Windows::Storage::Provider::StorageProviderShareLinkState>) GetState(param::async_vector_view<Windows::Storage::IStorageItem> const& storageItemList) const;
    };
    template <> struct consume<Windows::Storage::Provider::IStorageProviderShareLinkSource>
    {
    ...
    {
        WINRT_IMPL_AUTO(Windows::Storage::Provider::StorageProviderQueryResultSet) GetSuggestions(Windows::Storage::Provider::StorageProviderSuggestionsQueryOptions const& options) const;
        WINRT_IMPL_AUTO(void) Add(Windows::Storage::Provider::StorageProviderResultKind const& kind, param::hstring const& remoteFileId) const;
        WINRT_IMPL_AUTO(void) Remove(Windows::Storage::Provider::StorageProviderResultKind const& kind, param::hstring const& remoteFileId) const;
        WINRT_IMPL_AUTO(Windows::Storage::Provider::StorageProviderSuggestionResult) GetDetails(param::hstring const& remoteFileId, array_view<hstring const> propertiesToFetch, param::hstring const& queryId) const;
        WINRT_IMPL_AUTO(void) ReportUsage(Windows::Storage::Provider::StorageProviderResultUsageKind const& resultUsageKind, param::hstring const& remoteFileId, param::hstring const& resultId, Windows::Foundation::TimeSpan const& latency) const;
    };
    template <> struct consume<Windows::Storage::Provider::IStorageProviderSuggestionsHandler>
    {
    ...
    {
        WINRT_IMPL_AUTO(Windows::Storage::Provider::IStorageProviderSuggestionsHandler) CreateSuggestionsHandler(param::hstring const& cloudProviderId) const;
    };
    template <> struct consume<Windows::Storage::Provider::IStorageProviderSuggestionsHandlerFactory>
    {
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Storage::Provider::StorageProviderResultKind) SuggestionsKind() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) RemoteFileId() const;
        [[nodiscard]] WINRT_IMPL_AUTO(uint32_t) MaxResults() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) QueryId() const;
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Foundation::Collections::IVectorView<hstring>) PropertiesToFetch() const;
    };
    template <> struct consume<Windows::Storage::Provider::IStorageProviderSuggestionsQueryOptions>
    {

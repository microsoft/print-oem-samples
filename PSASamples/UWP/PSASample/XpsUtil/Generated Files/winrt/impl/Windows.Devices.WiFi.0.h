...
namespace winrt::impl
{
    ...
    template <> struct category<Windows::Devices::WiFi::IWiFiOnDemandHotspotConnectTriggerDetails>{ using type = interface_category; };
    template <> struct category<Windows::Devices::WiFi::IWiFiOnDemandHotspotConnectionResult>{ using type = interface_category; };
    template <> struct category<Windows::Devices::WiFi::IWiFiOnDemandHotspotNetwork>{ using type = interface_category; };
    template <> struct category<Windows::Devices::WiFi::IWiFiOnDemandHotspotNetworkProperties>{ using type = interface_category; };
    template <> struct category<Windows::Devices::WiFi::IWiFiOnDemandHotspotNetworkStatics>{ using type = interface_category; };
    ...
    template <> struct category<Windows::Devices::WiFi::WiFiOnDemandHotspotConnectTriggerDetails>{ using type = class_category; };
    template <> struct category<Windows::Devices::WiFi::WiFiOnDemandHotspotConnectionResult>{ using type = class_category; };
    template <> struct category<Windows::Devices::WiFi::WiFiOnDemandHotspotNetwork>{ using type = class_category; };
    template <> struct category<Windows::Devices::WiFi::WiFiOnDemandHotspotNetworkProperties>{ using type = class_category; };
    ...
    template <> struct category<Windows::Devices::WiFi::WiFiOnDemandHotspotAvailability>{ using type = enum_category; };
    template <> struct category<Windows::Devices::WiFi::WiFiOnDemandHotspotCellularBars>{ using type = enum_category; };
    template <> struct category<Windows::Devices::WiFi::WiFiOnDemandHotspotConnectStatus>{ using type = enum_category; };
    ...
    template <> inline constexpr auto& name_v<Windows::Devices::WiFi::WiFiOnDemandHotspotConnectTriggerDetails> = L"Windows.Devices.WiFi.WiFiOnDemandHotspotConnectTriggerDetails";
    template <> inline constexpr auto& name_v<Windows::Devices::WiFi::WiFiOnDemandHotspotConnectionResult> = L"Windows.Devices.WiFi.WiFiOnDemandHotspotConnectionResult";
    template <> inline constexpr auto& name_v<Windows::Devices::WiFi::WiFiOnDemandHotspotNetwork> = L"Windows.Devices.WiFi.WiFiOnDemandHotspotNetwork";
    template <> inline constexpr auto& name_v<Windows::Devices::WiFi::WiFiOnDemandHotspotNetworkProperties> = L"Windows.Devices.WiFi.WiFiOnDemandHotspotNetworkProperties";
    ...
    template <> inline constexpr auto& name_v<Windows::Devices::WiFi::WiFiOnDemandHotspotAvailability> = L"Windows.Devices.WiFi.WiFiOnDemandHotspotAvailability";
    template <> inline constexpr auto& name_v<Windows::Devices::WiFi::WiFiOnDemandHotspotCellularBars> = L"Windows.Devices.WiFi.WiFiOnDemandHotspotCellularBars";
    template <> inline constexpr auto& name_v<Windows::Devices::WiFi::WiFiOnDemandHotspotConnectStatus> = L"Windows.Devices.WiFi.WiFiOnDemandHotspotConnectStatus";
    ...
    template <> inline constexpr auto& name_v<Windows::Devices::WiFi::IWiFiOnDemandHotspotConnectTriggerDetails> = L"Windows.Devices.WiFi.IWiFiOnDemandHotspotConnectTriggerDetails";
    template <> inline constexpr auto& name_v<Windows::Devices::WiFi::IWiFiOnDemandHotspotConnectionResult> = L"Windows.Devices.WiFi.IWiFiOnDemandHotspotConnectionResult";
    template <> inline constexpr auto& name_v<Windows::Devices::WiFi::IWiFiOnDemandHotspotNetwork> = L"Windows.Devices.WiFi.IWiFiOnDemandHotspotNetwork";
    template <> inline constexpr auto& name_v<Windows::Devices::WiFi::IWiFiOnDemandHotspotNetworkProperties> = L"Windows.Devices.WiFi.IWiFiOnDemandHotspotNetworkProperties";
    template <> inline constexpr auto& name_v<Windows::Devices::WiFi::IWiFiOnDemandHotspotNetworkStatics> = L"Windows.Devices.WiFi.IWiFiOnDemandHotspotNetworkStatics";
    ...
    template <> inline constexpr guid guid_v<Windows::Devices::WiFi::IWiFiOnDemandHotspotConnectTriggerDetails>{ 0xA268EB58,0x68F5,0x59CF,{ 0x8D,0x38,0x35,0xBF,0x44,0xB0,0x97,0xEF } }; // A268EB58-68F5-59CF-8D38-35BF44B097EF
    template <> inline constexpr guid guid_v<Windows::Devices::WiFi::IWiFiOnDemandHotspotConnectionResult>{ 0x911794A1,0x6C82,0x5DE3,{ 0x8A,0x4A,0xF9,0xFF,0x22,0xA4,0x95,0x7A } }; // 911794A1-6C82-5DE3-8A4A-F9FF22A4957A
    template <> inline constexpr guid guid_v<Windows::Devices::WiFi::IWiFiOnDemandHotspotNetwork>{ 0x18DC7115,0xA04E,0x507C,{ 0xBB,0xAF,0xB7,0x83,0x69,0xD2,0x9F,0xA7 } }; // 18DC7115-A04E-507C-BBAF-B78369D29FA7
    template <> inline constexpr guid guid_v<Windows::Devices::WiFi::IWiFiOnDemandHotspotNetworkProperties>{ 0xC810A1F2,0xC81D,0x5852,{ 0xBE,0x50,0xE4,0xBD,0x4D,0x81,0xE9,0x8D } }; // C810A1F2-C81D-5852-BE50-E4BD4D81E98D
    template <> inline constexpr guid guid_v<Windows::Devices::WiFi::IWiFiOnDemandHotspotNetworkStatics>{ 0x00F5B8AC,0x80E7,0x5054,{ 0x87,0x1C,0x87,0x39,0xF3,0x74,0xE3,0xC9 } }; // 00F5B8AC-80E7-5054-871C-8739F374E3C9
    ...
    template <> struct default_interface<Windows::Devices::WiFi::WiFiOnDemandHotspotConnectTriggerDetails>{ using type = Windows::Devices::WiFi::IWiFiOnDemandHotspotConnectTriggerDetails; };
    template <> struct default_interface<Windows::Devices::WiFi::WiFiOnDemandHotspotConnectionResult>{ using type = Windows::Devices::WiFi::IWiFiOnDemandHotspotConnectionResult; };
    template <> struct default_interface<Windows::Devices::WiFi::WiFiOnDemandHotspotNetwork>{ using type = Windows::Devices::WiFi::IWiFiOnDemandHotspotNetwork; };
    template <> struct default_interface<Windows::Devices::WiFi::WiFiOnDemandHotspotNetworkProperties>{ using type = Windows::Devices::WiFi::IWiFiOnDemandHotspotNetworkProperties; };
    ...
    template <> struct abi<Windows::Devices::WiFi::IWiFiOnDemandHotspotConnectTriggerDetails>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::Devices::WiFi::IWiFiOnDemandHotspotConnectionResult>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::Devices::WiFi::IWiFiOnDemandHotspotNetwork>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::Devices::WiFi::IWiFiOnDemandHotspotNetworkProperties>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::Devices::WiFi::IWiFiOnDemandHotspotNetworkStatics>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Devices::WiFi::WiFiOnDemandHotspotNetwork) RequestedNetwork() const;
        WINRT_IMPL_AUTO(void) ReportError(Windows::Devices::WiFi::WiFiOnDemandHotspotConnectStatus const& status) const;
        WINRT_IMPL_AUTO(Windows::Foundation::IAsyncOperation<Windows::Devices::WiFi::WiFiOnDemandHotspotConnectionResult>) ConnectAsync() const;
        WINRT_IMPL_AUTO(Windows::Devices::WiFi::WiFiOnDemandHotspotConnectionResult) Connect() const;
    };
    template <> struct consume<Windows::Devices::WiFi::IWiFiOnDemandHotspotConnectTriggerDetails>
    {
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Devices::WiFi::WiFiOnDemandHotspotConnectStatus) Status() const;
    };
    template <> struct consume<Windows::Devices::WiFi::IWiFiOnDemandHotspotConnectionResult>
    {
    ...
    {
        WINRT_IMPL_AUTO(Windows::Devices::WiFi::WiFiOnDemandHotspotNetworkProperties) GetProperties() const;
        WINRT_IMPL_AUTO(void) UpdateProperties(Windows::Devices::WiFi::WiFiOnDemandHotspotNetworkProperties const& newProperties) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::guid) Id() const;
    };
    template <> struct consume<Windows::Devices::WiFi::IWiFiOnDemandHotspotNetwork>
    {
    ...
    struct consume_Windows_Devices_WiFi_IWiFiOnDemandHotspotNetworkProperties
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Devices::WiFi::WiFiOnDemandHotspotAvailability) Availability() const;
        WINRT_IMPL_AUTO(void) Availability(Windows::Devices::WiFi::WiFiOnDemandHotspotAvailability const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Foundation::IReference<uint32_t>) RemainingBatteryPercent() const;
        WINRT_IMPL_AUTO(void) RemainingBatteryPercent(Windows::Foundation::IReference<uint32_t> const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Foundation::IReference<Windows::Devices::WiFi::WiFiOnDemandHotspotCellularBars>) CellularBars() const;
        WINRT_IMPL_AUTO(void) CellularBars(Windows::Foundation::IReference<Windows::Devices::WiFi::WiFiOnDemandHotspotCellularBars> const& value) const;
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Security::Credentials::PasswordCredential) Password() const;
        WINRT_IMPL_AUTO(void) Password(Windows::Security::Credentials::PasswordCredential const& value) const;
    };
    template <> struct consume<Windows::Devices::WiFi::IWiFiOnDemandHotspotNetworkProperties>
    {
    ...
    {
        WINRT_IMPL_AUTO(Windows::Devices::WiFi::WiFiOnDemandHotspotNetwork) GetOrCreateById(winrt::guid const& networkId) const;
    };
    template <> struct consume<Windows::Devices::WiFi::IWiFiOnDemandHotspotNetworkStatics>
    {

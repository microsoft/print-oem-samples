...
WINRT_EXPORT namespace winrt::Windows::Devices::Display::Core
{
    ...
    struct __declspec(empty_bases) DisplayAdapter : Windows::Devices::Display::Core::IDisplayAdapter,
        impl::require<DisplayAdapter, Windows::Devices::Display::Core::IDisplayAdapter2>
    {
    ...
    struct __declspec(empty_bases) DisplayDevice : Windows::Devices::Display::Core::IDisplayDevice,
        impl::require<DisplayDevice, Windows::Devices::Display::Core::IDisplayDevice2, Windows::Devices::Display::Core::IDisplayDeviceRenderAdapter>
    {
    ...
    struct __declspec(empty_bases) DisplayManager : Windows::Devices::Display::Core::IDisplayManager,
        impl::require<DisplayManager, Windows::Devices::Display::Core::IDisplayManager2, Windows::Devices::Display::Core::IDisplayManager3, Windows::Foundation::IClosable>
    {
    ...
    struct __declspec(empty_bases) DisplayMuxDevice : Windows::Devices::Display::Core::IDisplayMuxDevice,
        impl::require<DisplayMuxDevice, Windows::Foundation::IClosable>
    {
        DisplayMuxDevice(std::nullptr_t) noexcept {}
        DisplayMuxDevice(void* ptr, take_ownership_from_abi_t) noexcept : Windows::Devices::Display::Core::IDisplayMuxDevice(ptr, take_ownership_from_abi) {}

...
WINRT_EXPORT namespace winrt::Windows::Networking::Connectivity
{
        ...
        impl::consume_t<IConnectionProfile6>
    {
        ...
        IConnectionProfile6(IConnectionProfile6 const&) noexcept = default;
        IConnectionProfile6(IConnectionProfile6&&) noexcept = default;
        IConnectionProfile6& operator=(IConnectionProfile6 const&) & noexcept = default;
        IConnectionProfile6& operator=(IConnectionProfile6&&) & noexcept = default;
    };

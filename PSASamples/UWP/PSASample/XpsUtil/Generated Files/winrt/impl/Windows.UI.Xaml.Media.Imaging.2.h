...
WINRT_EXPORT namespace winrt::Windows::UI::Xaml::Media::Imaging
{
    struct DownloadProgressEventHandler : Windows::Foundation::IUnknown
    {
        ...
        DownloadProgressEventHandler(DownloadProgressEventHandler const&) noexcept = default;
        DownloadProgressEventHandler(DownloadProgressEventHandler&&) noexcept = default;
        DownloadProgressEventHandler& operator=(DownloadProgressEventHandler const&) & noexcept = default;
        DownloadProgressEventHandler& operator=(DownloadProgressEventHandler&&) & noexcept = default;
        ...
        impl::require<BitmapImage, Windows::UI::Xaml::Media::Imaging::IBitmapImage2, Windows::UI::Xaml::Media::Imaging::IBitmapImage3, Windows::UI::Xaml::Media::Imaging::IBitmapSource, Windows::UI::Xaml::Media::IImageSource, Windows::UI::Xaml::IDependencyObject, Windows::UI::Xaml::IDependencyObject2>
    {
        ...
        BitmapImage(BitmapImage const&) noexcept = default;
        BitmapImage(BitmapImage&&) noexcept = default;
        BitmapImage& operator=(BitmapImage const&) & noexcept = default;
        ...
        impl::require<BitmapSource, Windows::UI::Xaml::Media::IImageSource, Windows::UI::Xaml::IDependencyObject, Windows::UI::Xaml::IDependencyObject2>
    {
        ...
        BitmapSource(BitmapSource const&) noexcept = default;
        BitmapSource(BitmapSource&&) noexcept = default;
        BitmapSource& operator=(BitmapSource const&) & noexcept = default;
        BitmapSource& operator=(BitmapSource&&) & noexcept = default;
    ...
    struct __declspec(empty_bases) DownloadProgressEventArgs : Windows::UI::Xaml::Media::Imaging::IDownloadProgressEventArgs
    {
        ...
        DownloadProgressEventArgs(DownloadProgressEventArgs const&) noexcept = default;
        DownloadProgressEventArgs(DownloadProgressEventArgs&&) noexcept = default;
        DownloadProgressEventArgs& operator=(DownloadProgressEventArgs const&) & noexcept = default;
        DownloadProgressEventArgs& operator=(DownloadProgressEventArgs&&) & noexcept = default;
    };
        ...
        impl::require<RenderTargetBitmap, Windows::UI::Xaml::Media::IImageSource, Windows::UI::Xaml::IDependencyObject, Windows::UI::Xaml::IDependencyObject2>
    {
        ...
        RenderTargetBitmap();
        RenderTargetBitmap(RenderTargetBitmap const&) noexcept = default;
        RenderTargetBitmap(RenderTargetBitmap&&) noexcept = default;
        RenderTargetBitmap& operator=(RenderTargetBitmap const&) & noexcept = default;
        RenderTargetBitmap& operator=(RenderTargetBitmap&&) & noexcept = default;
        [[nodiscard]] static auto PixelWidthProperty();
        [[nodiscard]] static auto PixelHeightProperty();
    };
        ...
        impl::require<SoftwareBitmapSource, Windows::Foundation::IClosable, Windows::UI::Xaml::Media::IImageSource, Windows::UI::Xaml::IDependencyObject, Windows::UI::Xaml::IDependencyObject2>
    {
        ...
        SoftwareBitmapSource(SoftwareBitmapSource const&) noexcept = default;
        SoftwareBitmapSource(SoftwareBitmapSource&&) noexcept = default;
        SoftwareBitmapSource& operator=(SoftwareBitmapSource const&) & noexcept = default;
        SoftwareBitmapSource& operator=(SoftwareBitmapSource&&) & noexcept = default;
    };
        ...
        impl::require<SurfaceImageSource, Windows::UI::Xaml::Media::IImageSource, Windows::UI::Xaml::IDependencyObject, Windows::UI::Xaml::IDependencyObject2>
    {
        ...
        SurfaceImageSource(SurfaceImageSource const&) noexcept = default;
        SurfaceImageSource(SurfaceImageSource&&) noexcept = default;
        SurfaceImageSource& operator=(SurfaceImageSource const&) & noexcept = default;
        SurfaceImageSource& operator=(SurfaceImageSource&&) & noexcept = default;
    };
        ...
        impl::require<SvgImageSource, Windows::UI::Xaml::Media::IImageSource, Windows::UI::Xaml::IDependencyObject, Windows::UI::Xaml::IDependencyObject2>
    {
        ...
        SvgImageSource(SvgImageSource const&) noexcept = default;
        SvgImageSource(SvgImageSource&&) noexcept = default;
        SvgImageSource& operator=(SvgImageSource const&) & noexcept = default;
        SvgImageSource& operator=(SvgImageSource&&) & noexcept = default;
        [[nodiscard]] static auto UriSourceProperty();
    ...
    struct __declspec(empty_bases) SvgImageSourceFailedEventArgs : Windows::UI::Xaml::Media::Imaging::ISvgImageSourceFailedEventArgs
    {
        ...
        SvgImageSourceFailedEventArgs(SvgImageSourceFailedEventArgs const&) noexcept = default;
        SvgImageSourceFailedEventArgs(SvgImageSourceFailedEventArgs&&) noexcept = default;
        SvgImageSourceFailedEventArgs& operator=(SvgImageSourceFailedEventArgs const&) & noexcept = default;
        SvgImageSourceFailedEventArgs& operator=(SvgImageSourceFailedEventArgs&&) & noexcept = default;
    };
    struct __declspec(empty_bases) SvgImageSourceOpenedEventArgs : Windows::UI::Xaml::Media::Imaging::ISvgImageSourceOpenedEventArgs
    {
        ...
        SvgImageSourceOpenedEventArgs(SvgImageSourceOpenedEventArgs const&) noexcept = default;
        SvgImageSourceOpenedEventArgs(SvgImageSourceOpenedEventArgs&&) noexcept = default;
        SvgImageSourceOpenedEventArgs& operator=(SvgImageSourceOpenedEventArgs const&) & noexcept = default;
        SvgImageSourceOpenedEventArgs& operator=(SvgImageSourceOpenedEventArgs&&) & noexcept = default;
    };
        ...
        impl::require<VirtualSurfaceImageSource, Windows::UI::Xaml::Media::Imaging::ISurfaceImageSource, Windows::UI::Xaml::Media::IImageSource, Windows::UI::Xaml::IDependencyObject, Windows::UI::Xaml::IDependencyObject2>
    {
        ...
        VirtualSurfaceImageSource(VirtualSurfaceImageSource const&) noexcept = default;
        VirtualSurfaceImageSource(VirtualSurfaceImageSource&&) noexcept = default;
        VirtualSurfaceImageSource& operator=(VirtualSurfaceImageSource const&) & noexcept = default;
        VirtualSurfaceImageSource& operator=(VirtualSurfaceImageSource&&) & noexcept = default;
    };
        ...
        impl::require<WriteableBitmap, Windows::UI::Xaml::Media::Imaging::IBitmapSource, Windows::UI::Xaml::Media::IImageSource, Windows::UI::Xaml::IDependencyObject, Windows::UI::Xaml::IDependencyObject2>
    {
        ...
        WriteableBitmap(WriteableBitmap const&) noexcept = default;
        WriteableBitmap(WriteableBitmap&&) noexcept = default;
        WriteableBitmap& operator=(WriteableBitmap const&) & noexcept = default;
        WriteableBitmap& operator=(WriteableBitmap&&) & noexcept = default;
    };
        ...
        impl::require<XamlRenderingBackgroundTask, Windows::UI::Xaml::Media::Imaging::IXamlRenderingBackgroundTaskOverrides>
    {
        ...
        XamlRenderingBackgroundTask(XamlRenderingBackgroundTask const&) noexcept = default;
        XamlRenderingBackgroundTask(XamlRenderingBackgroundTask&&) noexcept = default;
        XamlRenderingBackgroundTask& operator=(XamlRenderingBackgroundTask const&) & noexcept = default;
        XamlRenderingBackgroundTask& operator=(XamlRenderingBackgroundTask&&) & noexcept = default;
    };
    template <typename D>

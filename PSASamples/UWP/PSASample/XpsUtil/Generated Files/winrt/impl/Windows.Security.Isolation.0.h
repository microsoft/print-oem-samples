...
namespace winrt::impl
{
    ...
    template <> struct category<Windows::Security::Isolation::IIsolatedWindowsEnvironment4>{ using type = interface_category; };
    ...
    template <> struct category<Windows::Security::Isolation::IIsolatedWindowsEnvironmentCreateResult2>{ using type = interface_category; };
    ...
    template <> struct category<Windows::Security::Isolation::IIsolatedWindowsEnvironmentOptions3>{ using type = interface_category; };
    ...
    template <> struct category<Windows::Security::Isolation::IIsolatedWindowsEnvironmentUserInfo2>{ using type = interface_category; };
    ...
    template <> struct category<Windows::Security::Isolation::IsolatedWindowsEnvironmentCreationPriority>{ using type = enum_category; };
    ...
    template <> struct category<Windows::Security::Isolation::IsolatedWindowsEnvironmentSignInProgress>{ using type = enum_category; };
    ...
    template <> inline constexpr auto& name_v<Windows::Security::Isolation::IsolatedWindowsEnvironmentCreationPriority> = L"Windows.Security.Isolation.IsolatedWindowsEnvironmentCreationPriority";
    ...
    template <> inline constexpr auto& name_v<Windows::Security::Isolation::IsolatedWindowsEnvironmentSignInProgress> = L"Windows.Security.Isolation.IsolatedWindowsEnvironmentSignInProgress";
    ...
    template <> inline constexpr auto& name_v<Windows::Security::Isolation::IIsolatedWindowsEnvironment4> = L"Windows.Security.Isolation.IIsolatedWindowsEnvironment4";
    ...
    template <> inline constexpr auto& name_v<Windows::Security::Isolation::IIsolatedWindowsEnvironmentCreateResult2> = L"Windows.Security.Isolation.IIsolatedWindowsEnvironmentCreateResult2";
    ...
    template <> inline constexpr auto& name_v<Windows::Security::Isolation::IIsolatedWindowsEnvironmentOptions3> = L"Windows.Security.Isolation.IIsolatedWindowsEnvironmentOptions3";
    ...
    template <> inline constexpr auto& name_v<Windows::Security::Isolation::IIsolatedWindowsEnvironmentUserInfo2> = L"Windows.Security.Isolation.IIsolatedWindowsEnvironmentUserInfo2";
    ...
    template <> inline constexpr guid guid_v<Windows::Security::Isolation::IIsolatedWindowsEnvironment4>{ 0x11E3701A,0xDD9E,0x4F1B,{ 0x81,0x2C,0x40,0x20,0xF3,0x07,0xF9,0x3C } }; // 11E3701A-DD9E-4F1B-812C-4020F307F93C
    ...
    template <> inline constexpr guid guid_v<Windows::Security::Isolation::IIsolatedWindowsEnvironmentCreateResult2>{ 0xA547DBC7,0x61D4,0x4FB8,{ 0xAB,0x5C,0xED,0xEF,0xA3,0xD3,0x88,0xAD } }; // A547DBC7-61D4-4FB8-AB5C-EDEFA3D388AD
    ...
    template <> inline constexpr guid guid_v<Windows::Security::Isolation::IIsolatedWindowsEnvironmentOptions3>{ 0x98D5AA23,0x161F,0x4CD9,{ 0x8A,0x9C,0x26,0x9B,0x30,0x12,0x2B,0x0D } }; // 98D5AA23-161F-4CD9-8A9C-269B30122B0D
    ...
    template <> inline constexpr guid guid_v<Windows::Security::Isolation::IIsolatedWindowsEnvironmentUserInfo2>{ 0xB0BDD5DD,0x91D7,0x481E,{ 0x94,0xF2,0x2A,0x5A,0x6B,0xDF,0x93,0x83 } }; // B0BDD5DD-91D7-481E-94F2-2A5A6BDF9383
    ...
    template <> struct abi<Windows::Security::Isolation::IIsolatedWindowsEnvironment4>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::Security::Isolation::IIsolatedWindowsEnvironmentCreateResult2>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::Security::Isolation::IIsolatedWindowsEnvironmentOptions3>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::Security::Isolation::IIsolatedWindowsEnvironmentUserInfo2>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    {
        WINRT_IMPL_AUTO(void) ChangePriority(Windows::Security::Isolation::IsolatedWindowsEnvironmentCreationPriority const& Priority) const;
    };
    template <> struct consume<Windows::Security::Isolation::IIsolatedWindowsEnvironment4>
    {
    ...
    {
        WINRT_IMPL_AUTO(void) ChangeCreationPriority(Windows::Security::Isolation::IsolatedWindowsEnvironmentCreationPriority const& priority) const;
    };
    template <> struct consume<Windows::Security::Isolation::IIsolatedWindowsEnvironmentCreateResult2>
    {
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Security::Isolation::IsolatedWindowsEnvironmentAllowedClipboardFormats) AllowedClipboardFormatsToEnvironment() const;
        WINRT_IMPL_AUTO(void) AllowedClipboardFormatsToEnvironment(Windows::Security::Isolation::IsolatedWindowsEnvironmentAllowedClipboardFormats const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Security::Isolation::IsolatedWindowsEnvironmentAllowedClipboardFormats) AllowedClipboardFormatsToHost() const;
        WINRT_IMPL_AUTO(void) AllowedClipboardFormatsToHost(Windows::Security::Isolation::IsolatedWindowsEnvironmentAllowedClipboardFormats const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Security::Isolation::IsolatedWindowsEnvironmentCreationPriority) CreationPriority() const;
        WINRT_IMPL_AUTO(void) CreationPriority(Windows::Security::Isolation::IsolatedWindowsEnvironmentCreationPriority const& value) const;
    };
    template <> struct consume<Windows::Security::Isolation::IIsolatedWindowsEnvironmentOptions3>
    {
    ...
    {
        WINRT_IMPL_AUTO(Windows::Foundation::IAsyncOperationWithProgress<bool, Windows::Security::Isolation::IsolatedWindowsEnvironmentSignInProgress>) TryWaitForSignInWithProgressAsync() const;
    };
    template <> struct consume<Windows::Security::Isolation::IIsolatedWindowsEnvironmentUserInfo2>
    {

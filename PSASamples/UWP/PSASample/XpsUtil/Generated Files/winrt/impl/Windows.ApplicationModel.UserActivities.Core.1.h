...
WINRT_EXPORT namespace winrt::Windows::ApplicationModel::UserActivities::Core
{
        ...
        impl::consume_t<ICoreUserActivityManagerStatics>
    {
        ...
        ICoreUserActivityManagerStatics(ICoreUserActivityManagerStatics const&) noexcept = default;
        ICoreUserActivityManagerStatics(ICoreUserActivityManagerStatics&&) noexcept = default;
        ICoreUserActivityManagerStatics& operator=(ICoreUserActivityManagerStatics const&) & noexcept = default;
        ICoreUserActivityManagerStatics& operator=(ICoreUserActivityManagerStatics&&) & noexcept = default;
    };
}
#endif

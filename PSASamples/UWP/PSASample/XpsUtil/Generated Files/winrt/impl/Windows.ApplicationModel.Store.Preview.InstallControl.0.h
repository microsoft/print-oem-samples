...
namespace winrt::impl
{
    ...
    template <> struct category<Windows::ApplicationModel::Store::Preview::InstallControl::IGetEntitlementResult2>{ using type = interface_category; };
    ...
    template <> inline constexpr auto& name_v<Windows::ApplicationModel::Store::Preview::InstallControl::IGetEntitlementResult2> = L"Windows.ApplicationModel.Store.Preview.InstallControl.IGetEntitlementResult2";
    ...
    template <> inline constexpr guid guid_v<Windows::ApplicationModel::Store::Preview::InstallControl::IGetEntitlementResult2>{ 0xE3906641,0xA981,0x4302,{ 0x8C,0x68,0xFF,0x83,0x66,0x66,0xBB,0x3B } }; // E3906641-A981-4302-8C68-FF836666BB3B
    ...
    template <> struct abi<Windows::ApplicationModel::Store::Preview::InstallControl::IGetEntitlementResult2>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct consume<Windows::ApplicationModel::Store::Preview::InstallControl::IGetEntitlementResult2>
    {

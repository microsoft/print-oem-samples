...
WINRT_EXPORT namespace winrt::Windows::UI::Xaml::Markup
{
        ...
        impl::require<MarkupExtension, Windows::UI::Xaml::Markup::IMarkupExtensionOverrides>
    {
        ...
        MarkupExtension();
        MarkupExtension(MarkupExtension const&) noexcept = default;
        MarkupExtension(MarkupExtension&&) noexcept = default;
        MarkupExtension& operator=(MarkupExtension const&) & noexcept = default;
        MarkupExtension& operator=(MarkupExtension&&) & noexcept = default;
    };
    struct __declspec(empty_bases) XamlBinaryWriter : Windows::UI::Xaml::Markup::IXamlBinaryWriter
    {
        ...
        XamlBinaryWriter(XamlBinaryWriter const&) noexcept = default;
        XamlBinaryWriter(XamlBinaryWriter&&) noexcept = default;
        XamlBinaryWriter& operator=(XamlBinaryWriter const&) & noexcept = default;
        XamlBinaryWriter& operator=(XamlBinaryWriter&&) & noexcept = default;
    ...
    struct __declspec(empty_bases) XamlBindingHelper : Windows::UI::Xaml::Markup::IXamlBindingHelper
    {
        ...
        XamlBindingHelper(XamlBindingHelper const&) noexcept = default;
        XamlBindingHelper(XamlBindingHelper&&) noexcept = default;
        XamlBindingHelper& operator=(XamlBindingHelper const&) & noexcept = default;
        XamlBindingHelper& operator=(XamlBindingHelper&&) & noexcept = default;
    ...
    struct __declspec(empty_bases) XamlMarkupHelper : Windows::UI::Xaml::Markup::IXamlMarkupHelper
    {
        ...
        XamlMarkupHelper(XamlMarkupHelper const&) noexcept = default;
        XamlMarkupHelper(XamlMarkupHelper&&) noexcept = default;
        XamlMarkupHelper& operator=(XamlMarkupHelper const&) & noexcept = default;
        XamlMarkupHelper& operator=(XamlMarkupHelper&&) & noexcept = default;
    ...
    struct __declspec(empty_bases) XamlReader : Windows::UI::Xaml::Markup::IXamlReader
    {
        ...
        XamlReader(XamlReader const&) noexcept = default;
        XamlReader(XamlReader&&) noexcept = default;
        XamlReader& operator=(XamlReader const&) & noexcept = default;
        XamlReader& operator=(XamlReader&&) & noexcept = default;

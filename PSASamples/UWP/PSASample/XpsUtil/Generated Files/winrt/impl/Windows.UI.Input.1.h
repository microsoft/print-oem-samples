...
WINRT_EXPORT namespace winrt::Windows::UI::Input
{
        ...
        impl::consume_t<IPhysicalGestureRecognizer>
    {
        ...
        IPhysicalGestureRecognizer(void* ptr, take_ownership_from_abi_t) noexcept : Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
        IPhysicalGestureRecognizer(IPhysicalGestureRecognizer const&) noexcept = default;
        IPhysicalGestureRecognizer(IPhysicalGestureRecognizer&&) noexcept = default;
        IPhysicalGestureRecognizer& operator=(IPhysicalGestureRecognizer const&) & noexcept = default;
        IPhysicalGestureRecognizer& operator=(IPhysicalGestureRecognizer&&) & noexcept = default;
    };
        ...
        impl::consume_t<IPointerPointPhysicalPosition>
    {
        ...
        IPointerPointPhysicalPosition(void* ptr, take_ownership_from_abi_t) noexcept : Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
        IPointerPointPhysicalPosition(IPointerPointPhysicalPosition const&) noexcept = default;
        IPointerPointPhysicalPosition(IPointerPointPhysicalPosition&&) noexcept = default;
        IPointerPointPhysicalPosition& operator=(IPointerPointPhysicalPosition const&) & noexcept = default;
        IPointerPointPhysicalPosition& operator=(IPointerPointPhysicalPosition&&) & noexcept = default;
    };
        ...
        impl::consume_t<ITouchpadGesturesController>
    {
        ...
        ITouchpadGesturesController(void* ptr, take_ownership_from_abi_t) noexcept : Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
        ITouchpadGesturesController(ITouchpadGesturesController const&) noexcept = default;
        ITouchpadGesturesController(ITouchpadGesturesController&&) noexcept = default;
        ITouchpadGesturesController& operator=(ITouchpadGesturesController const&) & noexcept = default;
        ITouchpadGesturesController& operator=(ITouchpadGesturesController&&) & noexcept = default;
    };
        ...
        impl::consume_t<ITouchpadGesturesControllerStatics>
    {
        ...
        ITouchpadGesturesControllerStatics(void* ptr, take_ownership_from_abi_t) noexcept : Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
        ITouchpadGesturesControllerStatics(ITouchpadGesturesControllerStatics const&) noexcept = default;
        ITouchpadGesturesControllerStatics(ITouchpadGesturesControllerStatics&&) noexcept = default;
        ITouchpadGesturesControllerStatics& operator=(ITouchpadGesturesControllerStatics const&) & noexcept = default;
        ITouchpadGesturesControllerStatics& operator=(ITouchpadGesturesControllerStatics&&) & noexcept = default;
    };
        ...
        impl::consume_t<ITouchpadGlobalActionEventArgs>
    {
        ...
        ITouchpadGlobalActionEventArgs(void* ptr, take_ownership_from_abi_t) noexcept : Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
        ITouchpadGlobalActionEventArgs(ITouchpadGlobalActionEventArgs const&) noexcept = default;
        ITouchpadGlobalActionEventArgs(ITouchpadGlobalActionEventArgs&&) noexcept = default;
        ITouchpadGlobalActionEventArgs& operator=(ITouchpadGlobalActionEventArgs const&) & noexcept = default;
        ITouchpadGlobalActionEventArgs& operator=(ITouchpadGlobalActionEventArgs&&) & noexcept = default;
    };
}
#endif

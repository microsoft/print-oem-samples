...
namespace winrt::impl
{
    ...
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::ApplicationModel::Resources::IResourceLoaderStatics4)->GetDefaultPriPath(*(void**)(&packageFullName), &value));
        return hstring{ value, take_ownership_from_abi };
    }
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, Windows::ApplicationModel::Resources::IResourceLoaderStatics4> : produce_base<D, Windows::ApplicationModel::Resources::IResourceLoaderStatics4>
    {

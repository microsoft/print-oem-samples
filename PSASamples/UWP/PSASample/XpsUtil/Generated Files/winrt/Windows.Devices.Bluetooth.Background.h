...
namespace winrt::impl
{
    ...
    template <typename D> WINRT_IMPL_AUTO(Windows::Foundation::IReference<int16_t>) consume_Windows_Devices_Bluetooth_Background_IBluetoothLEAdvertisementPublisherTriggerDetails2<D>::SelectedTransmitPowerLevelInDBm() const
    {
        void* value{};
    ...
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_Devices_Bluetooth_Background_IGattServiceProviderConnection2<D>::UpdateAdvertisingParameters(Windows::Devices::Bluetooth::GenericAttributeProfile::GattServiceProviderAdvertisingParameters const& parameters) const
    {
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Bluetooth::Background::IGattServiceProviderConnection2)->UpdateAdvertisingParameters(*(void**)(&parameters)));
    }
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, Windows::Devices::Bluetooth::Background::IGattServiceProviderConnection2> : produce_base<D, Windows::Devices::Bluetooth::Background::IGattServiceProviderConnection2>
    {

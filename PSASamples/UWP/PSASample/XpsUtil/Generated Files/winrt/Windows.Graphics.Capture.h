...
namespace winrt::impl
{
    ...
    template <typename D> WINRT_IMPL_AUTO(Windows::Foundation::Collections::IVectorView<Windows::Graphics::RectInt32>) consume_Windows_Graphics_Capture_IDirect3D11CaptureFrame2<D>::DirtyRegions() const
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Graphics::Capture::IDirect3D11CaptureFrame2)->get_DirtyRegions(&value));
        return Windows::Foundation::Collections::IVectorView<Windows::Graphics::RectInt32>{ value, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Graphics::Capture::GraphicsCaptureDirtyRegionMode) consume_Windows_Graphics_Capture_IDirect3D11CaptureFrame2<D>::DirtyRegionMode() const
    {
        Windows::Graphics::Capture::GraphicsCaptureDirtyRegionMode value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Graphics::Capture::IDirect3D11CaptureFrame2)->get_DirtyRegionMode(reinterpret_cast<int32_t*>(&value)));
        return value;
    }
    ...
    template <typename D> WINRT_IMPL_AUTO(Windows::Graphics::Capture::GraphicsCaptureDirtyRegionMode) consume_Windows_Graphics_Capture_IGraphicsCaptureSession4<D>::DirtyRegionMode() const
    {
        Windows::Graphics::Capture::GraphicsCaptureDirtyRegionMode value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Graphics::Capture::IGraphicsCaptureSession4)->get_DirtyRegionMode(reinterpret_cast<int32_t*>(&value)));
        return value;
    }
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_Graphics_Capture_IGraphicsCaptureSession4<D>::DirtyRegionMode(Windows::Graphics::Capture::GraphicsCaptureDirtyRegionMode const& value) const
    {
        check_hresult(WINRT_IMPL_SHIM(Windows::Graphics::Capture::IGraphicsCaptureSession4)->put_DirtyRegionMode(static_cast<int32_t>(value)));
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Foundation::TimeSpan) consume_Windows_Graphics_Capture_IGraphicsCaptureSession5<D>::MinUpdateInterval() const
    {
        Windows::Foundation::TimeSpan value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Graphics::Capture::IGraphicsCaptureSession5)->get_MinUpdateInterval(put_abi(value)));
        return value;
    }
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_Graphics_Capture_IGraphicsCaptureSession5<D>::MinUpdateInterval(Windows::Foundation::TimeSpan const& value) const
    {
        check_hresult(WINRT_IMPL_SHIM(Windows::Graphics::Capture::IGraphicsCaptureSession5)->put_MinUpdateInterval(impl::bind_in(value)));
    }
    ...
    {
        bool value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Graphics::Capture::IGraphicsCaptureSession6)->get_IncludeSecondaryWindows(&value));
        return value;
    }
    ...
    {
        check_hresult(WINRT_IMPL_SHIM(Windows::Graphics::Capture::IGraphicsCaptureSession6)->put_IncludeSecondaryWindows(value));
    }
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, Windows::Graphics::Capture::IDirect3D11CaptureFrame2> : produce_base<D, Windows::Graphics::Capture::IDirect3D11CaptureFrame2>
    {
        int32_t __stdcall get_DirtyRegions(void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
            *value = detach_from<Windows::Foundation::Collections::IVectorView<Windows::Graphics::RectInt32>>(this->shim().DirtyRegions());
            return 0;
        }
        catch (...) { return to_hresult(); }
        ...
        {
            typename D::abi_guard guard(this->shim());
            *value = detach_from<Windows::Graphics::Capture::GraphicsCaptureDirtyRegionMode>(this->shim().DirtyRegionMode());
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, Windows::Graphics::Capture::IGraphicsCaptureSession4> : produce_base<D, Windows::Graphics::Capture::IGraphicsCaptureSession4>
    {
        int32_t __stdcall get_DirtyRegionMode(int32_t* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        {
            typename D::abi_guard guard(this->shim());
            this->shim().DirtyRegionMode(*reinterpret_cast<Windows::Graphics::Capture::GraphicsCaptureDirtyRegionMode const*>(&value));
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, Windows::Graphics::Capture::IGraphicsCaptureSession5> : produce_base<D, Windows::Graphics::Capture::IGraphicsCaptureSession5>
    {
        ...
        {
            typename D::abi_guard guard(this->shim());
            this->shim().MinUpdateInterval(*reinterpret_cast<Windows::Foundation::TimeSpan const*>(&value));
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, Windows::Graphics::Capture::IGraphicsCaptureSession6> : produce_base<D, Windows::Graphics::Capture::IGraphicsCaptureSession6>
    {

...
void* __stdcall winrt_get_activation_factory([[maybe_unused]] std::wstring_view const& name)
{
    ...
    if (requal(name, L"XpsUtil.XpsPageWatermarker"))
    {
        return winrt_make_XpsUtil_XpsPageWatermarker();
    }

    if (requal(name, L"XpsUtil.XpsSequentialDocument"))
    {
        return winrt_make_XpsUtil_XpsSequentialDocument();
    }

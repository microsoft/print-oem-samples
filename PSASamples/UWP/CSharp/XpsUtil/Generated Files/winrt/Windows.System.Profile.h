...
namespace winrt::impl
{
    ...
    {
        bool value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::System::Profile::ISmartAppControlPolicyStatics)->get_IsEnabled(&value));
        return value;
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::event_token) consume_Windows_System_Profile_ISmartAppControlPolicyStatics<D>::Changed(Windows::Foundation::EventHandler<Windows::Foundation::IInspectable> const& handler) const
    {
        winrt::event_token token{};
        check_hresult(WINRT_IMPL_SHIM(Windows::System::Profile::ISmartAppControlPolicyStatics)->add_Changed(*(void**)(&handler), put_abi(token)));
        return token;
    }
    template <typename D> typename consume_Windows_System_Profile_ISmartAppControlPolicyStatics<D>::Changed_revoker consume_Windows_System_Profile_ISmartAppControlPolicyStatics<D>::Changed(auto_revoke_t, Windows::Foundation::EventHandler<Windows::Foundation::IInspectable> const& handler) const
    {
    ...
    {
        WINRT_VERIFY_(0, WINRT_IMPL_SHIM(Windows::System::Profile::ISmartAppControlPolicyStatics)->remove_Changed(impl::bind_in(token)));
    }
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, Windows::System::Profile::ISmartAppControlPolicyStatics> : produce_base<D, Windows::System::Profile::ISmartAppControlPolicyStatics>
    {
        int32_t __stdcall get_IsEnabled(bool* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        int32_t __stdcall add_Changed(void* handler, winrt::event_token* token) noexcept final try
        {
            zero_abi<winrt::event_token>(token);
            typename D::abi_guard guard(this->shim());
            *token = detach_from<winrt::event_token>(this->shim().Changed(*reinterpret_cast<Windows::Foundation::EventHandler<Windows::Foundation::IInspectable> const*>(&handler)));
            return 0;
        }
        catch (...) { return to_hresult(); }
...
WINRT_EXPORT namespace winrt::Windows::System::Profile
{
    ...
    inline auto SmartAppControlPolicy::Changed(Windows::Foundation::EventHandler<Windows::Foundation::IInspectable> const& handler)
    {
    ...
    inline SmartAppControlPolicy::Changed_revoker SmartAppControlPolicy::Changed(auto_revoke_t, Windows::Foundation::EventHandler<Windows::Foundation::IInspectable> const& handler)
    {
        auto f = get_activation_factory<SmartAppControlPolicy, Windows::System::Profile::ISmartAppControlPolicyStatics>();

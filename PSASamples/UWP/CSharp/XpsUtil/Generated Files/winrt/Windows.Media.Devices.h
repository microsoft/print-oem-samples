...
namespace winrt::impl
{
    ...
    template <typename D> WINRT_IMPL_AUTO(bool) consume_Windows_Media_Devices_IAdvancedVideoCaptureDeviceController11<D>::TryAcquireExclusiveControl(param::hstring const& deviceId, Windows::Media::Capture::MediaCaptureDeviceExclusiveControlReleaseMode const& mode) const
    {
        bool result{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Media::Devices::IAdvancedVideoCaptureDeviceController11)->TryAcquireExclusiveControl(*(void**)(&deviceId), static_cast<int32_t>(mode), &result));
        return result;
    }
    ...
    template <typename D> WINRT_IMPL_AUTO(Windows::Media::Effects::AudioCaptureEffectsManager) consume_Windows_Media_Devices_IAudioDeviceController2<D>::AudioCaptureEffectsManager() const
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Media::Devices::IAudioDeviceController2)->get_AudioCaptureEffectsManager(&value));
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, Windows::Media::Devices::IAdvancedVideoCaptureDeviceController11> : produce_base<D, Windows::Media::Devices::IAdvancedVideoCaptureDeviceController11>
    {
        int32_t __stdcall TryAcquireExclusiveControl(void* deviceId, int32_t mode, bool* result) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            *result = detach_from<bool>(this->shim().TryAcquireExclusiveControl(*reinterpret_cast<hstring const*>(&deviceId), *reinterpret_cast<Windows::Media::Capture::MediaCaptureDeviceExclusiveControlReleaseMode const*>(&mode)));
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
    ...
    struct produce<D, Windows::Media::Devices::IAdvancedVideoCaptureDeviceController8> : produce_base<D, Windows::Media::Devices::IAdvancedVideoCaptureDeviceController8>
    {
        int32_t __stdcall get_PanelBasedOptimizationControl(void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
            *value = detach_from<Windows::Media::Devices::PanelBasedOptimizationControl>(this->shim().PanelBasedOptimizationControl());
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, Windows::Media::Devices::IAudioDeviceController2> : produce_base<D, Windows::Media::Devices::IAudioDeviceController2>
    {
        int32_t __stdcall get_AudioCaptureEffectsManager(void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
            *value = detach_from<Windows::Media::Effects::AudioCaptureEffectsManager>(this->shim().AudioCaptureEffectsManager());
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
    ...
    struct produce<D, Windows::Media::Devices::IPanelBasedOptimizationControl> : produce_base<D, Windows::Media::Devices::IPanelBasedOptimizationControl>
    {
        ...
        {
            typename D::abi_guard guard(this->shim());
            this->shim().Panel(*reinterpret_cast<Windows::Devices::Enumeration::Panel const*>(&value));
            return 0;
        }
        catch (...) { return to_hresult(); }
    };

...
namespace winrt::impl
{
    ...
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_System_RemoteDesktop_Input_IRemoteTextConnection2<D>::ReportPredictedKeyEvent(uint16_t scanCode, Windows::System::RemoteDesktop::Input::RemoteKeyEventAttributes const& attributes) const
    {
        check_hresult(WINRT_IMPL_SHIM(Windows::System::RemoteDesktop::Input::IRemoteTextConnection2)->ReportPredictedKeyEvent(scanCode, static_cast<uint32_t>(attributes)));
    }
    ...
    template <typename D> WINRT_IMPL_AUTO(Windows::System::RemoteDesktop::Input::RemoteTextConnection) consume_Windows_System_RemoteDesktop_Input_IRemoteTextConnectionFactory2<D>::CreateInstance(winrt::guid const& connectionId, Windows::System::RemoteDesktop::Input::RemoteTextConnectionDataHandler const& pduForwarder, Windows::System::RemoteDesktop::Input::RemoteTextConnectionOptions const& options) const
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::System::RemoteDesktop::Input::IRemoteTextConnectionFactory2)->CreateInstance(impl::bind_in(connectionId), *(void**)(&pduForwarder), static_cast<uint32_t>(options), &value));
        return Windows::System::RemoteDesktop::Input::RemoteTextConnection{ value, take_ownership_from_abi };
    }
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, Windows::System::RemoteDesktop::Input::IRemoteTextConnection2> : produce_base<D, Windows::System::RemoteDesktop::Input::IRemoteTextConnection2>
    {
        int32_t __stdcall ReportPredictedKeyEvent(uint16_t scanCode, uint32_t attributes) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            this->shim().ReportPredictedKeyEvent(scanCode, *reinterpret_cast<Windows::System::RemoteDesktop::Input::RemoteKeyEventAttributes const*>(&attributes));
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, Windows::System::RemoteDesktop::Input::IRemoteTextConnectionFactory2> : produce_base<D, Windows::System::RemoteDesktop::Input::IRemoteTextConnectionFactory2>
    {
        int32_t __stdcall CreateInstance(winrt::guid connectionId, void* pduForwarder, uint32_t options, void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
            *value = detach_from<Windows::System::RemoteDesktop::Input::RemoteTextConnection>(this->shim().CreateInstance(*reinterpret_cast<winrt::guid const*>(&connectionId), *reinterpret_cast<Windows::System::RemoteDesktop::Input::RemoteTextConnectionDataHandler const*>(&pduForwarder), *reinterpret_cast<Windows::System::RemoteDesktop::Input::RemoteTextConnectionOptions const*>(&options)));
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
...
WINRT_EXPORT namespace winrt::Windows::System::RemoteDesktop::Input
{
    ...
    inline RemoteTextConnection::RemoteTextConnection(winrt::guid const& connectionId, Windows::System::RemoteDesktop::Input::RemoteTextConnectionDataHandler const& pduForwarder, Windows::System::RemoteDesktop::Input::RemoteTextConnectionOptions const& options) :

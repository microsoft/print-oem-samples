...
namespace winrt::impl
{
    ...
    {
        uint64_t result{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IIppPrintDevice2)->GetMaxSupportedPdfSize(&result));
        return result;
    }
    ...
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IIppPrintDevice2)->GetMaxSupportedPdfVersion(&result));
    ...
    {
        bool result{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IIppPrintDevice2)->IsPdlPassthroughSupported(*(void**)(&pdlContentType), &result));
        return result;
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Devices::Printers::PdlPassthroughProvider) consume_Windows_Devices_Printers_IIppPrintDevice2<D>::GetPdlPassthroughProvider() const
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IIppPrintDevice2)->GetPdlPassthroughProvider(&result));
        return Windows::Devices::Printers::PdlPassthroughProvider{ result, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(bool) consume_Windows_Devices_Printers_IIppPrintDevice3<D>::IsIppFaxOutPrinter() const
    {
        bool value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IIppPrintDevice3)->get_IsIppFaxOutPrinter(&value));
        return value;
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Devices::Printers::IppPrintDeviceKind) consume_Windows_Devices_Printers_IIppPrintDevice4<D>::DeviceKind() const
    {
        Windows::Devices::Printers::IppPrintDeviceKind value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IIppPrintDevice4)->get_DeviceKind(reinterpret_cast<int32_t*>(&value)));
        return value;
    }
    ...
    {
        bool value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IIppPrintDevice4)->get_CanModifyUserDefaultPrintTicket(&value));
        return value;
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Graphics::Printing::PrintTicket::WorkflowPrintTicket) consume_Windows_Devices_Printers_IIppPrintDevice4<D>::UserDefaultPrintTicket() const
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IIppPrintDevice4)->get_UserDefaultPrintTicket(&value));
        return Windows::Graphics::Printing::PrintTicket::WorkflowPrintTicket{ value, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_Devices_Printers_IIppPrintDevice4<D>::UserDefaultPrintTicket(Windows::Graphics::Printing::PrintTicket::WorkflowPrintTicket const& value) const
    {
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IIppPrintDevice4)->put_UserDefaultPrintTicket(*(void**)(&value)));
    }
    ...
    {
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IIppPrintDevice4)->RefreshPrintDeviceCapabilities());
    }
    ...
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IIppPrintDevice4)->GetMaxSupportedPdlVersion(*(void**)(&pdlContentType), &result));
        return hstring{ result, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Foundation::Collections::ValueSet) consume_Windows_Devices_Printers_IIppPrintDevice5<D>::GetDeviceProperties() const
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IIppPrintDevice5)->GetDeviceProperties(&result));
        return Windows::Foundation::Collections::ValueSet{ result, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Devices::Printers::ReplaceDevicePropertiesResult) consume_Windows_Devices_Printers_IIppPrintDevice5<D>::ReplaceDeviceProperties(param::iterable<Windows::Foundation::Collections::IKeyValuePair<hstring, Windows::Foundation::IInspectable>> const& deviceProperties) const
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IIppPrintDevice5)->ReplaceDeviceProperties(*(void**)(&deviceProperties), &result));
        return Windows::Devices::Printers::ReplaceDevicePropertiesResult{ result, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Devices::Printers::IppPrintDeviceInstallationStatus) consume_Windows_Devices_Printers_IIppPrintDeviceInstallationResult<D>::Status() const
    {
        Windows::Devices::Printers::IppPrintDeviceInstallationStatus value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IIppPrintDeviceInstallationResult)->get_Status(reinterpret_cast<int32_t*>(&value)));
        return value;
    }
    ...
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IIppPrintDeviceInstallationResult)->get_InstalledPrinterName(&value));
        return hstring{ value, take_ownership_from_abi };
    }
    ...
    {
        winrt::hresult value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IIppPrintDeviceInstallationResult)->get_ExtendedError(put_abi(value)));
        return value;
    }
    ...
    {
        bool result{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IIppPrintDeviceManagerStatics)->CanInstallIppPrintDevice(&result));
        return result;
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Foundation::IAsyncOperation<Windows::Devices::Printers::IppPrintDeviceInstallationResult>) consume_Windows_Devices_Printers_IIppPrintDeviceManagerStatics<D>::InstallIppPrintDeviceAsync(Windows::Foundation::Uri const& printerUri, param::hstring const& printerName) const
    {
        void* operation{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IIppPrintDeviceManagerStatics)->InstallIppPrintDeviceAsync(*(void**)(&printerUri), *(void**)(&printerName), &operation));
        return Windows::Foundation::IAsyncOperation<Windows::Devices::Printers::IppPrintDeviceInstallationResult>{ operation, take_ownership_from_abi };
    }
    ...
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IIppPrintDeviceStatics)->GetDeviceSelector(&result));
        return hstring{ result, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Devices::Printers::IppPrintDevice) consume_Windows_Devices_Printers_IIppPrintDeviceStatics<D>::FromId(param::hstring const& deviceId) const
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IIppPrintDeviceStatics)->FromId(*(void**)(&deviceId), &result));
        return Windows::Devices::Printers::IppPrintDevice{ result, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Devices::Printers::IppPrintDevice) consume_Windows_Devices_Printers_IIppPrintDeviceStatics<D>::FromPrinterName(param::hstring const& printerName) const
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IIppPrintDeviceStatics)->FromPrinterName(*(void**)(&printerName), &result));
        return Windows::Devices::Printers::IppPrintDevice{ result, take_ownership_from_abi };
    }
    ...
    {
        bool result{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IIppPrintDeviceStatics)->IsIppPrinter(*(void**)(&printerName), &result));
        return result;
    }
    ...
    template <typename D> WINRT_IMPL_AUTO(Windows::Devices::Printers::PageConfigurationSource) consume_Windows_Devices_Printers_IPageConfigurationSettings<D>::OrientationSource() const
    {
        Windows::Devices::Printers::PageConfigurationSource value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IPageConfigurationSettings)->get_OrientationSource(reinterpret_cast<int32_t*>(&value)));
        return value;
    }
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_Devices_Printers_IPageConfigurationSettings<D>::OrientationSource(Windows::Devices::Printers::PageConfigurationSource const& value) const
    {
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IPageConfigurationSettings)->put_OrientationSource(static_cast<int32_t>(value)));
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Devices::Printers::PageConfigurationSource) consume_Windows_Devices_Printers_IPageConfigurationSettings<D>::SizeSource() const
    {
        Windows::Devices::Printers::PageConfigurationSource value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IPageConfigurationSettings)->get_SizeSource(reinterpret_cast<int32_t*>(&value)));
        return value;
    }
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_Devices_Printers_IPageConfigurationSettings<D>::SizeSource(Windows::Devices::Printers::PageConfigurationSource const& value) const
    {
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IPageConfigurationSettings)->put_SizeSource(static_cast<int32_t>(value)));
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Foundation::Collections::IVectorView<hstring>) consume_Windows_Devices_Printers_IPdlPassthroughProvider<D>::SupportedPdlContentTypes() const
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IPdlPassthroughProvider)->get_SupportedPdlContentTypes(&value));
        return Windows::Foundation::Collections::IVectorView<hstring>{ value, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Devices::Printers::PdlPassthroughTarget) consume_Windows_Devices_Printers_IPdlPassthroughProvider<D>::StartPrintJobWithTaskOptions(param::hstring const& jobName, param::hstring const& pdlContentType, Windows::Graphics::Printing::PrintTaskOptions const& taskOptions, Windows::Devices::Printers::PageConfigurationSettings const& pageConfigurationSettings) const
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IPdlPassthroughProvider)->StartPrintJobWithTaskOptions(*(void**)(&jobName), *(void**)(&pdlContentType), *(void**)(&taskOptions), *(void**)(&pageConfigurationSettings), &result));
        return Windows::Devices::Printers::PdlPassthroughTarget{ result, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Devices::Printers::PdlPassthroughTarget) consume_Windows_Devices_Printers_IPdlPassthroughProvider<D>::StartPrintJobWithPrintTicket(param::hstring const& jobName, param::hstring const& pdlContentType, Windows::Storage::Streams::IInputStream const& printTicket, Windows::Devices::Printers::PageConfigurationSettings const& pageConfigurationSettings) const
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IPdlPassthroughProvider)->StartPrintJobWithPrintTicket(*(void**)(&jobName), *(void**)(&pdlContentType), *(void**)(&printTicket), *(void**)(&pageConfigurationSettings), &result));
        return Windows::Devices::Printers::PdlPassthroughTarget{ result, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(int32_t) consume_Windows_Devices_Printers_IPdlPassthroughTarget<D>::PrintJobId() const
    {
        int32_t value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IPdlPassthroughTarget)->get_PrintJobId(&value));
        return value;
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Storage::Streams::IOutputStream) consume_Windows_Devices_Printers_IPdlPassthroughTarget<D>::GetOutputStream() const
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IPdlPassthroughTarget)->GetOutputStream(&result));
    ...
    {
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IPdlPassthroughTarget)->Submit());
    }
    ...
    template <typename D> WINRT_IMPL_AUTO(Windows::Devices::Printers::ReplaceDevicePropertiesStatus) consume_Windows_Devices_Printers_IReplaceDevicePropertiesResult<D>::Status() const
    {
        Windows::Devices::Printers::ReplaceDevicePropertiesStatus value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IReplaceDevicePropertiesResult)->get_Status(reinterpret_cast<int32_t*>(&value)));
        return value;
    }
    ...
    {
        winrt::hresult value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IReplaceDevicePropertiesResult)->get_ExtendedError(put_abi(value)));
        return value;
    }
    ...
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IVirtualPrinterInstallationParameters)->get_PrinterName(&value));
        return hstring{ value, take_ownership_from_abi };
    }
    ...
    {
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IVirtualPrinterInstallationParameters)->put_PrinterName(*(void**)(&value)));
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Foundation::Collections::IVector<hstring>) consume_Windows_Devices_Printers_IVirtualPrinterInstallationParameters<D>::OutputFileExtensions() const
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IVirtualPrinterInstallationParameters)->get_OutputFileExtensions(&value));
        return Windows::Foundation::Collections::IVector<hstring>{ value, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Foundation::Collections::IVector<Windows::Devices::Printers::VirtualPrinterSupportedFormat>) consume_Windows_Devices_Printers_IVirtualPrinterInstallationParameters<D>::SupportedInputFormats() const
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IVirtualPrinterInstallationParameters)->get_SupportedInputFormats(&value));
        return Windows::Foundation::Collections::IVector<Windows::Devices::Printers::VirtualPrinterSupportedFormat>{ value, take_ownership_from_abi };
    }
    ...
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IVirtualPrinterInstallationParameters)->get_PrintDeviceCapabilitiesPackageRelativeFilePath(&value));
        return hstring{ value, take_ownership_from_abi };
    }
    ...
    {
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IVirtualPrinterInstallationParameters)->put_PrintDeviceCapabilitiesPackageRelativeFilePath(*(void**)(&value)));
    }
    ...
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IVirtualPrinterInstallationParameters)->get_PrintDeviceResourcesPackageRelativeFilePath(&value));
        return hstring{ value, take_ownership_from_abi };
    }
    ...
    {
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IVirtualPrinterInstallationParameters)->put_PrintDeviceResourcesPackageRelativeFilePath(*(void**)(&value)));
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Devices::Printers::VirtualPrinterPreferredInputFormat) consume_Windows_Devices_Printers_IVirtualPrinterInstallationParameters<D>::PreferredInputFormat() const
    {
        Windows::Devices::Printers::VirtualPrinterPreferredInputFormat value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IVirtualPrinterInstallationParameters)->get_PreferredInputFormat(reinterpret_cast<int32_t*>(&value)));
        return value;
    }
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_Devices_Printers_IVirtualPrinterInstallationParameters<D>::PreferredInputFormat(Windows::Devices::Printers::VirtualPrinterPreferredInputFormat const& value) const
    {
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IVirtualPrinterInstallationParameters)->put_PreferredInputFormat(static_cast<int32_t>(value)));
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Foundation::Uri) consume_Windows_Devices_Printers_IVirtualPrinterInstallationParameters<D>::PrinterUri() const
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IVirtualPrinterInstallationParameters)->get_PrinterUri(&value));
        return Windows::Foundation::Uri{ value, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_Devices_Printers_IVirtualPrinterInstallationParameters<D>::PrinterUri(Windows::Foundation::Uri const& value) const
    {
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IVirtualPrinterInstallationParameters)->put_PrinterUri(*(void**)(&value)));
    }
    ...
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IVirtualPrinterInstallationParameters)->get_EntryPoint(&value));
        return hstring{ value, take_ownership_from_abi };
    }
    ...
    {
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IVirtualPrinterInstallationParameters)->put_EntryPoint(*(void**)(&value)));
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Devices::Printers::VirtualPrinterInstallationStatus) consume_Windows_Devices_Printers_IVirtualPrinterInstallationResult<D>::Status() const
    {
        Windows::Devices::Printers::VirtualPrinterInstallationStatus value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IVirtualPrinterInstallationResult)->get_Status(reinterpret_cast<int32_t*>(&value)));
        return value;
    }
    ...
    {
        winrt::hresult value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IVirtualPrinterInstallationResult)->get_ExtendedError(put_abi(value)));
        return value;
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Foundation::IAsyncOperation<Windows::Devices::Printers::VirtualPrinterInstallationResult>) consume_Windows_Devices_Printers_IVirtualPrinterManagerStatics<D>::InstallVirtualPrinterAsync(Windows::Devices::Printers::VirtualPrinterInstallationParameters const& parameters) const
    {
        void* operation{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IVirtualPrinterManagerStatics)->InstallVirtualPrinterAsync(*(void**)(&parameters), &operation));
        return Windows::Foundation::IAsyncOperation<Windows::Devices::Printers::VirtualPrinterInstallationResult>{ operation, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Foundation::IAsyncOperation<Windows::Devices::Printers::VirtualPrinterInstallationResult>) consume_Windows_Devices_Printers_IVirtualPrinterManagerStatics<D>::InstallVirtualPrinterAsync(Windows::Devices::Printers::VirtualPrinterInstallationParameters const& parameters, param::hstring const& appPackageFamilyName) const
    {
        void* operation{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IVirtualPrinterManagerStatics)->InstallVirtualPrinterAsync2(*(void**)(&parameters), *(void**)(&appPackageFamilyName), &operation));
        return Windows::Foundation::IAsyncOperation<Windows::Devices::Printers::VirtualPrinterInstallationResult>{ operation, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Foundation::IAsyncOperation<Windows::Devices::Printers::VirtualPrinterInstallationResult>) consume_Windows_Devices_Printers_IVirtualPrinterManagerStatics<D>::InstallVirtualPrinterForAllUsersAsync(Windows::Devices::Printers::VirtualPrinterInstallationParameters const& parameters) const
    {
        void* operation{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IVirtualPrinterManagerStatics)->InstallVirtualPrinterForAllUsersAsync(*(void**)(&parameters), &operation));
        return Windows::Foundation::IAsyncOperation<Windows::Devices::Printers::VirtualPrinterInstallationResult>{ operation, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Foundation::IAsyncOperation<Windows::Devices::Printers::VirtualPrinterInstallationResult>) consume_Windows_Devices_Printers_IVirtualPrinterManagerStatics<D>::InstallVirtualPrinterForAllUsersAsync(Windows::Devices::Printers::VirtualPrinterInstallationParameters const& parameters, param::hstring const& appPackageFamilyName) const
    {
        void* operation{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IVirtualPrinterManagerStatics)->InstallVirtualPrinterForAllUsersAsync2(*(void**)(&parameters), *(void**)(&appPackageFamilyName), &operation));
        return Windows::Foundation::IAsyncOperation<Windows::Devices::Printers::VirtualPrinterInstallationResult>{ operation, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Foundation::Collections::IVectorView<hstring>) consume_Windows_Devices_Printers_IVirtualPrinterManagerStatics<D>::FindAllVirtualPrinters() const
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IVirtualPrinterManagerStatics)->FindAllVirtualPrinters(&result));
        return Windows::Foundation::Collections::IVectorView<hstring>{ result, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Foundation::Collections::IVectorView<hstring>) consume_Windows_Devices_Printers_IVirtualPrinterManagerStatics<D>::FindAllVirtualPrinters(param::hstring const& appPackageFamilyName) const
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IVirtualPrinterManagerStatics)->FindAllVirtualPrinters2(*(void**)(&appPackageFamilyName), &result));
        return Windows::Foundation::Collections::IVectorView<hstring>{ result, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Foundation::IAsyncOperation<bool>) consume_Windows_Devices_Printers_IVirtualPrinterManagerStatics<D>::RemoveVirtualPrinterAsync(param::hstring const& printerName) const
    {
        void* operation{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IVirtualPrinterManagerStatics)->RemoveVirtualPrinterAsync(*(void**)(&printerName), &operation));
        return Windows::Foundation::IAsyncOperation<bool>{ operation, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Foundation::IAsyncOperation<bool>) consume_Windows_Devices_Printers_IVirtualPrinterManagerStatics<D>::RemoveVirtualPrinterForAllUsersAsync(param::hstring const& printerName) const
    {
        void* operation{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IVirtualPrinterManagerStatics)->RemoveVirtualPrinterForAllUsersAsync(*(void**)(&printerName), &operation));
        return Windows::Foundation::IAsyncOperation<bool>{ operation, take_ownership_from_abi };
    }
    ...
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IVirtualPrinterSupportedFormat)->get_ContentType(&value));
        return hstring{ value, take_ownership_from_abi };
    }
    ...
    {
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IVirtualPrinterSupportedFormat)->put_ContentType(*(void**)(&value)));
    }
    ...
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IVirtualPrinterSupportedFormat)->get_MaxSupportedVersion(&value));
        return hstring{ value, take_ownership_from_abi };
    }
    ...
    {
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IVirtualPrinterSupportedFormat)->put_MaxSupportedVersion(*(void**)(&value)));
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Devices::Printers::VirtualPrinterSupportedFormat) consume_Windows_Devices_Printers_IVirtualPrinterSupportedFormatFactory<D>::CreateInstance(param::hstring const& contentType, param::hstring const& maxSupportedVersion) const
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Printers::IVirtualPrinterSupportedFormatFactory)->CreateInstance(*(void**)(&contentType), *(void**)(&maxSupportedVersion), &value));
        return Windows::Devices::Printers::VirtualPrinterSupportedFormat{ value, take_ownership_from_abi };
    }
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, Windows::Devices::Printers::IIppPrintDevice2> : produce_base<D, Windows::Devices::Printers::IIppPrintDevice2>
    {
        ...
        int32_t __stdcall GetPdlPassthroughProvider(void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
            *result = detach_from<Windows::Devices::Printers::PdlPassthroughProvider>(this->shim().GetPdlPassthroughProvider());
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, Windows::Devices::Printers::IIppPrintDevice3> : produce_base<D, Windows::Devices::Printers::IIppPrintDevice3>
    {
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, Windows::Devices::Printers::IIppPrintDevice4> : produce_base<D, Windows::Devices::Printers::IIppPrintDevice4>
    {
        int32_t __stdcall get_DeviceKind(int32_t* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            *value = detach_from<Windows::Devices::Printers::IppPrintDeviceKind>(this->shim().DeviceKind());
            return 0;
        }
        catch (...) { return to_hresult(); }
        ...
        int32_t __stdcall get_UserDefaultPrintTicket(void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
            *value = detach_from<Windows::Graphics::Printing::PrintTicket::WorkflowPrintTicket>(this->shim().UserDefaultPrintTicket());
            return 0;
        }
        catch (...) { return to_hresult(); }
        ...
        {
            typename D::abi_guard guard(this->shim());
            this->shim().UserDefaultPrintTicket(*reinterpret_cast<Windows::Graphics::Printing::PrintTicket::WorkflowPrintTicket const*>(&value));
            return 0;
        }
        catch (...) { return to_hresult(); }
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, Windows::Devices::Printers::IIppPrintDevice5> : produce_base<D, Windows::Devices::Printers::IIppPrintDevice5>
    {
        int32_t __stdcall GetDeviceProperties(void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
            *result = detach_from<Windows::Foundation::Collections::ValueSet>(this->shim().GetDeviceProperties());
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall ReplaceDeviceProperties(void* deviceProperties, void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
            *result = detach_from<Windows::Devices::Printers::ReplaceDevicePropertiesResult>(this->shim().ReplaceDeviceProperties(*reinterpret_cast<Windows::Foundation::Collections::IIterable<Windows::Foundation::Collections::IKeyValuePair<hstring, Windows::Foundation::IInspectable>> const*>(&deviceProperties)));
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, Windows::Devices::Printers::IIppPrintDeviceInstallationResult> : produce_base<D, Windows::Devices::Printers::IIppPrintDeviceInstallationResult>
    {
        int32_t __stdcall get_Status(int32_t* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            *value = detach_from<Windows::Devices::Printers::IppPrintDeviceInstallationStatus>(this->shim().Status());
            return 0;
        }
        catch (...) { return to_hresult(); }
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, Windows::Devices::Printers::IIppPrintDeviceManagerStatics> : produce_base<D, Windows::Devices::Printers::IIppPrintDeviceManagerStatics>
    {
        ...
        int32_t __stdcall InstallIppPrintDeviceAsync(void* printerUri, void* printerName, void** operation) noexcept final try
        {
            clear_abi(operation);
            typename D::abi_guard guard(this->shim());
            *operation = detach_from<Windows::Foundation::IAsyncOperation<Windows::Devices::Printers::IppPrintDeviceInstallationResult>>(this->shim().InstallIppPrintDeviceAsync(*reinterpret_cast<Windows::Foundation::Uri const*>(&printerUri), *reinterpret_cast<hstring const*>(&printerName)));
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, Windows::Devices::Printers::IIppPrintDeviceStatics> : produce_base<D, Windows::Devices::Printers::IIppPrintDeviceStatics>
    {
        ...
        int32_t __stdcall FromId(void* deviceId, void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
            *result = detach_from<Windows::Devices::Printers::IppPrintDevice>(this->shim().FromId(*reinterpret_cast<hstring const*>(&deviceId)));
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall FromPrinterName(void* printerName, void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
            *result = detach_from<Windows::Devices::Printers::IppPrintDevice>(this->shim().FromPrinterName(*reinterpret_cast<hstring const*>(&printerName)));
            return 0;
        }
        catch (...) { return to_hresult(); }
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, Windows::Devices::Printers::IPageConfigurationSettings> : produce_base<D, Windows::Devices::Printers::IPageConfigurationSettings>
    {
        int32_t __stdcall get_OrientationSource(int32_t* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            *value = detach_from<Windows::Devices::Printers::PageConfigurationSource>(this->shim().OrientationSource());
            return 0;
        }
        catch (...) { return to_hresult(); }
        ...
        {
            typename D::abi_guard guard(this->shim());
            this->shim().OrientationSource(*reinterpret_cast<Windows::Devices::Printers::PageConfigurationSource const*>(&value));
            return 0;
        }
        catch (...) { return to_hresult(); }
        ...
        {
            typename D::abi_guard guard(this->shim());
            *value = detach_from<Windows::Devices::Printers::PageConfigurationSource>(this->shim().SizeSource());
            return 0;
        }
        catch (...) { return to_hresult(); }
        ...
        {
            typename D::abi_guard guard(this->shim());
            this->shim().SizeSource(*reinterpret_cast<Windows::Devices::Printers::PageConfigurationSource const*>(&value));
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, Windows::Devices::Printers::IPdlPassthroughProvider> : produce_base<D, Windows::Devices::Printers::IPdlPassthroughProvider>
    {
        int32_t __stdcall get_SupportedPdlContentTypes(void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
            *value = detach_from<Windows::Foundation::Collections::IVectorView<hstring>>(this->shim().SupportedPdlContentTypes());
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall StartPrintJobWithTaskOptions(void* jobName, void* pdlContentType, void* taskOptions, void* pageConfigurationSettings, void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
            *result = detach_from<Windows::Devices::Printers::PdlPassthroughTarget>(this->shim().StartPrintJobWithTaskOptions(*reinterpret_cast<hstring const*>(&jobName), *reinterpret_cast<hstring const*>(&pdlContentType), *reinterpret_cast<Windows::Graphics::Printing::PrintTaskOptions const*>(&taskOptions), *reinterpret_cast<Windows::Devices::Printers::PageConfigurationSettings const*>(&pageConfigurationSettings)));
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall StartPrintJobWithPrintTicket(void* jobName, void* pdlContentType, void* printTicket, void* pageConfigurationSettings, void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
            *result = detach_from<Windows::Devices::Printers::PdlPassthroughTarget>(this->shim().StartPrintJobWithPrintTicket(*reinterpret_cast<hstring const*>(&jobName), *reinterpret_cast<hstring const*>(&pdlContentType), *reinterpret_cast<Windows::Storage::Streams::IInputStream const*>(&printTicket), *reinterpret_cast<Windows::Devices::Printers::PageConfigurationSettings const*>(&pageConfigurationSettings)));
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, Windows::Devices::Printers::IPdlPassthroughTarget> : produce_base<D, Windows::Devices::Printers::IPdlPassthroughTarget>
    {
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, Windows::Devices::Printers::IReplaceDevicePropertiesResult> : produce_base<D, Windows::Devices::Printers::IReplaceDevicePropertiesResult>
    {
        int32_t __stdcall get_Status(int32_t* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            *value = detach_from<Windows::Devices::Printers::ReplaceDevicePropertiesStatus>(this->shim().Status());
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall get_ExtendedError(winrt::hresult* value) noexcept final try
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, Windows::Devices::Printers::IVirtualPrinterInstallationParameters> : produce_base<D, Windows::Devices::Printers::IVirtualPrinterInstallationParameters>
    {
        int32_t __stdcall get_PrinterName(void** value) noexcept final try
        {
            clear_abi(value);
        ...
        int32_t __stdcall get_OutputFileExtensions(void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
            *value = detach_from<Windows::Foundation::Collections::IVector<hstring>>(this->shim().OutputFileExtensions());
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall get_SupportedInputFormats(void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
            *value = detach_from<Windows::Foundation::Collections::IVector<Windows::Devices::Printers::VirtualPrinterSupportedFormat>>(this->shim().SupportedInputFormats());
            return 0;
        }
        catch (...) { return to_hresult(); }
        ...
        {
            typename D::abi_guard guard(this->shim());
            *value = detach_from<Windows::Devices::Printers::VirtualPrinterPreferredInputFormat>(this->shim().PreferredInputFormat());
            return 0;
        }
        catch (...) { return to_hresult(); }
        ...
        {
            typename D::abi_guard guard(this->shim());
            this->shim().PreferredInputFormat(*reinterpret_cast<Windows::Devices::Printers::VirtualPrinterPreferredInputFormat const*>(&value));
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall get_PrinterUri(void** value) noexcept final try
        ...
        {
            typename D::abi_guard guard(this->shim());
            this->shim().PrinterUri(*reinterpret_cast<Windows::Foundation::Uri const*>(&value));
            return 0;
        }
        catch (...) { return to_hresult(); }
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, Windows::Devices::Printers::IVirtualPrinterInstallationResult> : produce_base<D, Windows::Devices::Printers::IVirtualPrinterInstallationResult>
    {
        int32_t __stdcall get_Status(int32_t* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            *value = detach_from<Windows::Devices::Printers::VirtualPrinterInstallationStatus>(this->shim().Status());
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall get_ExtendedError(winrt::hresult* value) noexcept final try
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, Windows::Devices::Printers::IVirtualPrinterManagerStatics> : produce_base<D, Windows::Devices::Printers::IVirtualPrinterManagerStatics>
    {
        int32_t __stdcall InstallVirtualPrinterAsync(void* parameters, void** operation) noexcept final try
        {
            clear_abi(operation);
            typename D::abi_guard guard(this->shim());
            *operation = detach_from<Windows::Foundation::IAsyncOperation<Windows::Devices::Printers::VirtualPrinterInstallationResult>>(this->shim().InstallVirtualPrinterAsync(*reinterpret_cast<Windows::Devices::Printers::VirtualPrinterInstallationParameters const*>(&parameters)));
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall InstallVirtualPrinterAsync2(void* parameters, void* appPackageFamilyName, void** operation) noexcept final try
        {
            clear_abi(operation);
            typename D::abi_guard guard(this->shim());
            *operation = detach_from<Windows::Foundation::IAsyncOperation<Windows::Devices::Printers::VirtualPrinterInstallationResult>>(this->shim().InstallVirtualPrinterAsync(*reinterpret_cast<Windows::Devices::Printers::VirtualPrinterInstallationParameters const*>(&parameters), *reinterpret_cast<hstring const*>(&appPackageFamilyName)));
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall InstallVirtualPrinterForAllUsersAsync(void* parameters, void** operation) noexcept final try
        {
            clear_abi(operation);
            typename D::abi_guard guard(this->shim());
            *operation = detach_from<Windows::Foundation::IAsyncOperation<Windows::Devices::Printers::VirtualPrinterInstallationResult>>(this->shim().InstallVirtualPrinterForAllUsersAsync(*reinterpret_cast<Windows::Devices::Printers::VirtualPrinterInstallationParameters const*>(&parameters)));
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall InstallVirtualPrinterForAllUsersAsync2(void* parameters, void* appPackageFamilyName, void** operation) noexcept final try
        {
            clear_abi(operation);
            typename D::abi_guard guard(this->shim());
            *operation = detach_from<Windows::Foundation::IAsyncOperation<Windows::Devices::Printers::VirtualPrinterInstallationResult>>(this->shim().InstallVirtualPrinterForAllUsersAsync(*reinterpret_cast<Windows::Devices::Printers::VirtualPrinterInstallationParameters const*>(&parameters), *reinterpret_cast<hstring const*>(&appPackageFamilyName)));
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall FindAllVirtualPrinters(void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
            *result = detach_from<Windows::Foundation::Collections::IVectorView<hstring>>(this->shim().FindAllVirtualPrinters());
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall FindAllVirtualPrinters2(void* appPackageFamilyName, void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
            *result = detach_from<Windows::Foundation::Collections::IVectorView<hstring>>(this->shim().FindAllVirtualPrinters(*reinterpret_cast<hstring const*>(&appPackageFamilyName)));
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall RemoveVirtualPrinterAsync(void* printerName, void** operation) noexcept final try
        {
            clear_abi(operation);
            typename D::abi_guard guard(this->shim());
            *operation = detach_from<Windows::Foundation::IAsyncOperation<bool>>(this->shim().RemoveVirtualPrinterAsync(*reinterpret_cast<hstring const*>(&printerName)));
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall RemoveVirtualPrinterForAllUsersAsync(void* printerName, void** operation) noexcept final try
        {
            clear_abi(operation);
            typename D::abi_guard guard(this->shim());
            *operation = detach_from<Windows::Foundation::IAsyncOperation<bool>>(this->shim().RemoveVirtualPrinterForAllUsersAsync(*reinterpret_cast<hstring const*>(&printerName)));
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, Windows::Devices::Printers::IVirtualPrinterSupportedFormat> : produce_base<D, Windows::Devices::Printers::IVirtualPrinterSupportedFormat>
    {
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, Windows::Devices::Printers::IVirtualPrinterSupportedFormatFactory> : produce_base<D, Windows::Devices::Printers::IVirtualPrinterSupportedFormatFactory>
    {
        int32_t __stdcall CreateInstance(void* contentType, void* maxSupportedVersion, void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
            *value = detach_from<Windows::Devices::Printers::VirtualPrinterSupportedFormat>(this->shim().CreateInstance(*reinterpret_cast<hstring const*>(&contentType), *reinterpret_cast<hstring const*>(&maxSupportedVersion)));
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
...
WINRT_EXPORT namespace winrt::Windows::Devices::Printers
{
    ...
    inline auto IppPrintDeviceManager::InstallIppPrintDeviceAsync(Windows::Foundation::Uri const& printerUri, param::hstring const& printerName)
    {
    ...
    inline PageConfigurationSettings::PageConfigurationSettings() :
        PageConfigurationSettings(impl::call_factory_cast<PageConfigurationSettings(*)(Windows::Foundation::IActivationFactory const&), PageConfigurationSettings>([](Windows::Foundation::IActivationFactory const& f) { return f.template ActivateInstance<PageConfigurationSettings>(); }))
    {
    }
    ...
    inline VirtualPrinterInstallationParameters::VirtualPrinterInstallationParameters() :
        VirtualPrinterInstallationParameters(impl::call_factory_cast<VirtualPrinterInstallationParameters(*)(Windows::Foundation::IActivationFactory const&), VirtualPrinterInstallationParameters>([](Windows::Foundation::IActivationFactory const& f) { return f.template ActivateInstance<VirtualPrinterInstallationParameters>(); }))
    {
    }
    inline auto VirtualPrinterManager::InstallVirtualPrinterAsync(Windows::Devices::Printers::VirtualPrinterInstallationParameters const& parameters)
    {
    ...
    inline auto VirtualPrinterManager::InstallVirtualPrinterAsync(Windows::Devices::Printers::VirtualPrinterInstallationParameters const& parameters, param::hstring const& appPackageFamilyName)
    {
    ...
    inline auto VirtualPrinterManager::InstallVirtualPrinterForAllUsersAsync(Windows::Devices::Printers::VirtualPrinterInstallationParameters const& parameters)
    {
    ...
    inline auto VirtualPrinterManager::InstallVirtualPrinterForAllUsersAsync(Windows::Devices::Printers::VirtualPrinterInstallationParameters const& parameters, param::hstring const& appPackageFamilyName)
    {
    ...
    {
        return impl::call_factory_cast<Windows::Foundation::Collections::IVectorView<hstring>(*)(IVirtualPrinterManagerStatics const&), VirtualPrinterManager, IVirtualPrinterManagerStatics>([](IVirtualPrinterManagerStatics const& f) { return f.FindAllVirtualPrinters(); });
    }

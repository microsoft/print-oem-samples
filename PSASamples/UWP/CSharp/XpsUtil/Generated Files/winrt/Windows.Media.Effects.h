...
namespace winrt::impl
{
    ...
    {
        check_hresult(WINRT_IMPL_SHIM(Windows::Media::Effects::IAcousticEchoCancellationConfiguration)->SetEchoCancellationRenderEndpoint(*(void**)(&deviceId)));
    }
    ...
    template <typename D> WINRT_IMPL_AUTO(Windows::Media::Effects::AcousticEchoCancellationConfiguration) consume_Windows_Media_Effects_IAudioEffect2<D>::AcousticEchoCancellationConfiguration() const
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Media::Effects::IAudioEffect2)->get_AcousticEchoCancellationConfiguration(&value));
        return Windows::Media::Effects::AcousticEchoCancellationConfiguration{ value, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(bool) consume_Windows_Media_Effects_IAudioEffect2<D>::CanSetState() const
    {
        bool value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Media::Effects::IAudioEffect2)->get_CanSetState(&value));
        return value;
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Media::Effects::AudioEffectState) consume_Windows_Media_Effects_IAudioEffect2<D>::State() const
    {
        Windows::Media::Effects::AudioEffectState value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Media::Effects::IAudioEffect2)->get_State(reinterpret_cast<int32_t*>(&value)));
        return value;
    }
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_Media_Effects_IAudioEffect2<D>::SetState(Windows::Media::Effects::AudioEffectState const& newState) const
    {
        check_hresult(WINRT_IMPL_SHIM(Windows::Media::Effects::IAudioEffect2)->SetState(static_cast<int32_t>(newState)));
    }
    ...
    template <typename D>
    struct produce<D, Windows::Media::Effects::IAcousticEchoCancellationConfiguration> : produce_base<D, Windows::Media::Effects::IAcousticEchoCancellationConfiguration>
    {
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, Windows::Media::Effects::IAudioEffect2> : produce_base<D, Windows::Media::Effects::IAudioEffect2>
    {
        int32_t __stdcall get_AcousticEchoCancellationConfiguration(void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
            *value = detach_from<Windows::Media::Effects::AcousticEchoCancellationConfiguration>(this->shim().AcousticEchoCancellationConfiguration());
            return 0;
        }
        catch (...) { return to_hresult(); }
        ...
        {
            typename D::abi_guard guard(this->shim());
            *value = detach_from<Windows::Media::Effects::AudioEffectState>(this->shim().State());
            return 0;
        }
        catch (...) { return to_hresult(); }
        ...
        {
            typename D::abi_guard guard(this->shim());
            this->shim().SetState(*reinterpret_cast<Windows::Media::Effects::AudioEffectState const*>(&newState));
            return 0;
        }
        catch (...) { return to_hresult(); }
    };

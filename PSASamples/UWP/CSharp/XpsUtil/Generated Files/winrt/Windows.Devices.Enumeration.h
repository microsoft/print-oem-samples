...
namespace winrt::impl
{
    ...
    {
        bool value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Enumeration::IDeviceAccessChangedEventArgs3)->get_UserPromptRequired(&value));
        return value;
    }
    ...
    {
        bool value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Enumeration::IDeviceAccessInformation2)->get_UserPromptRequired(&value));
        return value;
    }
    ...
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_Devices_Enumeration_IDeviceInformationCustomPairing2<D>::AddPairingSetMember(Windows::Devices::Enumeration::DeviceInformation const& device) const
    {
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Enumeration::IDeviceInformationCustomPairing2)->AddPairingSetMember(*(void**)(&device)));
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::event_token) consume_Windows_Devices_Enumeration_IDeviceInformationCustomPairing2<D>::PairingSetMembersRequested(Windows::Foundation::TypedEventHandler<Windows::Devices::Enumeration::DeviceInformationCustomPairing, Windows::Devices::Enumeration::DevicePairingSetMembersRequestedEventArgs> const& handler) const
    {
        winrt::event_token token{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Enumeration::IDeviceInformationCustomPairing2)->add_PairingSetMembersRequested(*(void**)(&handler), put_abi(token)));
        return token;
    }
    template <typename D> typename consume_Windows_Devices_Enumeration_IDeviceInformationCustomPairing2<D>::PairingSetMembersRequested_revoker consume_Windows_Devices_Enumeration_IDeviceInformationCustomPairing2<D>::PairingSetMembersRequested(auto_revoke_t, Windows::Foundation::TypedEventHandler<Windows::Devices::Enumeration::DeviceInformationCustomPairing, Windows::Devices::Enumeration::DevicePairingSetMembersRequestedEventArgs> const& handler) const
    {
    ...
    {
        WINRT_VERIFY_(0, WINRT_IMPL_SHIM(Windows::Devices::Enumeration::IDeviceInformationCustomPairing2)->remove_PairingSetMembersRequested(impl::bind_in(token)));
    }
    ...
    template <typename D> WINRT_IMPL_AUTO(Windows::Foundation::IAsyncOperation<Windows::Devices::Enumeration::DeviceInformation>) consume_Windows_Devices_Enumeration_IDeviceInformationStatics3<D>::CreateFromIdAsync(param::hstring const& deviceId, param::async_iterable<hstring> const& additionalProperties, Windows::Devices::Enumeration::DeviceInformationKind const& kind, Windows::Devices::Enumeration::IDeviceEnumerationSettings const& settings) const
    {
        void* operation{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Enumeration::IDeviceInformationStatics3)->CreateFromIdAsyncWithAdditionalPropertiesKindAndSettings(*(void**)(&deviceId), *(void**)(&additionalProperties), static_cast<int32_t>(kind), *(void**)(&settings), &operation));
    ...
    template <typename D> WINRT_IMPL_AUTO(Windows::Foundation::IAsyncOperation<Windows::Devices::Enumeration::DeviceInformationCollection>) consume_Windows_Devices_Enumeration_IDeviceInformationStatics3<D>::FindAllAsync(param::hstring const& aqsFilter, param::async_iterable<hstring> const& additionalProperties, Windows::Devices::Enumeration::DeviceInformationKind const& kind, Windows::Devices::Enumeration::IDeviceEnumerationSettings const& settings) const
    {
        void* operation{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Enumeration::IDeviceInformationStatics3)->FindAllAsyncWithAqsFilterAdditionalPropertiesKindAndSettings(*(void**)(&aqsFilter), *(void**)(&additionalProperties), static_cast<int32_t>(kind), *(void**)(&settings), &operation));
        return Windows::Foundation::IAsyncOperation<Windows::Devices::Enumeration::DeviceInformationCollection>{ operation, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Devices::Enumeration::DeviceWatcher) consume_Windows_Devices_Enumeration_IDeviceInformationStatics3<D>::CreateWatcher(param::hstring const& aqsFilter, param::iterable<hstring> const& additionalProperties, Windows::Devices::Enumeration::DeviceInformationKind const& kind, Windows::Devices::Enumeration::IDeviceEnumerationSettings const& settings) const
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Enumeration::IDeviceInformationStatics3)->CreateWatcherWithAqsFilterAdditionalPropertiesKindAndSettings(*(void**)(&aqsFilter), *(void**)(&additionalProperties), static_cast<int32_t>(kind), *(void**)(&settings), &result));
        return Windows::Devices::Enumeration::DeviceWatcher{ result, take_ownership_from_abi };
    }
    ...
    {
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Enumeration::IDevicePairingRequestedEventArgs3)->AcceptWithAddress(*(void**)(&address)));
    }
    ...
    template <typename D> WINRT_IMPL_AUTO(Windows::Devices::Enumeration::DevicePairingAddPairingSetMemberStatus) consume_Windows_Devices_Enumeration_IDevicePairingSetMembersRequestedEventArgs<D>::Status() const
    {
        Windows::Devices::Enumeration::DevicePairingAddPairingSetMemberStatus value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Enumeration::IDevicePairingSetMembersRequestedEventArgs)->get_Status(reinterpret_cast<int32_t*>(&value)));
        return value;
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Devices::Enumeration::DeviceInformation) consume_Windows_Devices_Enumeration_IDevicePairingSetMembersRequestedEventArgs<D>::ParentDeviceInformation() const
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Enumeration::IDevicePairingSetMembersRequestedEventArgs)->get_ParentDeviceInformation(&value));
        return Windows::Devices::Enumeration::DeviceInformation{ value, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Foundation::Collections::IVectorView<Windows::Devices::Enumeration::DeviceInformation>) consume_Windows_Devices_Enumeration_IDevicePairingSetMembersRequestedEventArgs<D>::PairingSetMembers() const
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Enumeration::IDevicePairingSetMembersRequestedEventArgs)->get_PairingSetMembers(&value));
        return Windows::Foundation::Collections::IVectorView<Windows::Devices::Enumeration::DeviceInformation>{ value, take_ownership_from_abi };
    }
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, Windows::Devices::Enumeration::IDeviceAccessChangedEventArgs3> : produce_base<D, Windows::Devices::Enumeration::IDeviceAccessChangedEventArgs3>
    {
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, Windows::Devices::Enumeration::IDeviceAccessInformation2> : produce_base<D, Windows::Devices::Enumeration::IDeviceAccessInformation2>
    {
        int32_t __stdcall get_UserPromptRequired(bool* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
...
#endif
    template <typename D>
    struct produce<D, Windows::Devices::Enumeration::IDeviceEnumerationSettings> : produce_base<D, Windows::Devices::Enumeration::IDeviceEnumerationSettings>
    {
    };
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, Windows::Devices::Enumeration::IDeviceInformationCustomPairing2> : produce_base<D, Windows::Devices::Enumeration::IDeviceInformationCustomPairing2>
    {
        int32_t __stdcall AddPairingSetMember(void* device) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            this->shim().AddPairingSetMember(*reinterpret_cast<Windows::Devices::Enumeration::DeviceInformation const*>(&device));
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall add_PairingSetMembersRequested(void* handler, winrt::event_token* token) noexcept final try
        {
            zero_abi<winrt::event_token>(token);
            typename D::abi_guard guard(this->shim());
            *token = detach_from<winrt::event_token>(this->shim().PairingSetMembersRequested(*reinterpret_cast<Windows::Foundation::TypedEventHandler<Windows::Devices::Enumeration::DeviceInformationCustomPairing, Windows::Devices::Enumeration::DevicePairingSetMembersRequestedEventArgs> const*>(&handler)));
            return 0;
        }
        catch (...) { return to_hresult(); }
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, Windows::Devices::Enumeration::IDeviceInformationStatics3> : produce_base<D, Windows::Devices::Enumeration::IDeviceInformationStatics3>
    {
        int32_t __stdcall CreateFromIdAsyncWithAdditionalPropertiesKindAndSettings(void* deviceId, void* additionalProperties, int32_t kind, void* settings, void** operation) noexcept final try
        {
            clear_abi(operation);
            typename D::abi_guard guard(this->shim());
            *operation = detach_from<Windows::Foundation::IAsyncOperation<Windows::Devices::Enumeration::DeviceInformation>>(this->shim().CreateFromIdAsync(*reinterpret_cast<hstring const*>(&deviceId), *reinterpret_cast<Windows::Foundation::Collections::IIterable<hstring> const*>(&additionalProperties), *reinterpret_cast<Windows::Devices::Enumeration::DeviceInformationKind const*>(&kind), *reinterpret_cast<Windows::Devices::Enumeration::IDeviceEnumerationSettings const*>(&settings)));
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall FindAllAsyncWithAqsFilterAdditionalPropertiesKindAndSettings(void* aqsFilter, void* additionalProperties, int32_t kind, void* settings, void** operation) noexcept final try
        {
            clear_abi(operation);
            typename D::abi_guard guard(this->shim());
            *operation = detach_from<Windows::Foundation::IAsyncOperation<Windows::Devices::Enumeration::DeviceInformationCollection>>(this->shim().FindAllAsync(*reinterpret_cast<hstring const*>(&aqsFilter), *reinterpret_cast<Windows::Foundation::Collections::IIterable<hstring> const*>(&additionalProperties), *reinterpret_cast<Windows::Devices::Enumeration::DeviceInformationKind const*>(&kind), *reinterpret_cast<Windows::Devices::Enumeration::IDeviceEnumerationSettings const*>(&settings)));
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall CreateWatcherWithAqsFilterAdditionalPropertiesKindAndSettings(void* aqsFilter, void* additionalProperties, int32_t kind, void* settings, void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
            *result = detach_from<Windows::Devices::Enumeration::DeviceWatcher>(this->shim().CreateWatcher(*reinterpret_cast<hstring const*>(&aqsFilter), *reinterpret_cast<Windows::Foundation::Collections::IIterable<hstring> const*>(&additionalProperties), *reinterpret_cast<Windows::Devices::Enumeration::DeviceInformationKind const*>(&kind), *reinterpret_cast<Windows::Devices::Enumeration::IDeviceEnumerationSettings const*>(&settings)));
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, Windows::Devices::Enumeration::IDevicePairingRequestedEventArgs3> : produce_base<D, Windows::Devices::Enumeration::IDevicePairingRequestedEventArgs3>
    {
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, Windows::Devices::Enumeration::IDevicePairingSetMembersRequestedEventArgs> : produce_base<D, Windows::Devices::Enumeration::IDevicePairingSetMembersRequestedEventArgs>
    {
        int32_t __stdcall get_Status(int32_t* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            *value = detach_from<Windows::Devices::Enumeration::DevicePairingAddPairingSetMemberStatus>(this->shim().Status());
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall get_ParentDeviceInformation(void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
            *value = detach_from<Windows::Devices::Enumeration::DeviceInformation>(this->shim().ParentDeviceInformation());
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall get_PairingSetMembers(void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
            *value = detach_from<Windows::Foundation::Collections::IVectorView<Windows::Devices::Enumeration::DeviceInformation>>(this->shim().PairingSetMembers());
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
...
WINRT_EXPORT namespace winrt::Windows::Devices::Enumeration
{
    ...
    inline auto DeviceInformation::CreateFromIdAsync(param::hstring const& deviceId, param::async_iterable<hstring> const& additionalProperties, Windows::Devices::Enumeration::DeviceInformationKind const& kind, Windows::Devices::Enumeration::IDeviceEnumerationSettings const& settings)
    {
    ...
    inline auto DeviceInformation::FindAllAsync(param::hstring const& aqsFilter, param::async_iterable<hstring> const& additionalProperties, Windows::Devices::Enumeration::DeviceInformationKind const& kind, Windows::Devices::Enumeration::IDeviceEnumerationSettings const& settings)
    {
    ...
    inline auto DeviceInformation::CreateWatcher(param::hstring const& aqsFilter, param::iterable<hstring> const& additionalProperties, Windows::Devices::Enumeration::DeviceInformationKind const& kind, Windows::Devices::Enumeration::IDeviceEnumerationSettings const& settings)
    {

...
namespace winrt::impl
{
    ...
    template <typename D> WINRT_IMPL_AUTO(bool) consume_Windows_Networking_Connectivity_IConnectionProfile6<D>::IsDomainAuthenticatedBy(Windows::Networking::Connectivity::DomainAuthenticationKind const& kind) const
    {
        bool result{};

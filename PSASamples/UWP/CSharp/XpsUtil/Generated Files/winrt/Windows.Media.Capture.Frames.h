...
namespace winrt::impl
{
    ...
    {
        bool value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Media::Capture::Frames::IMediaFrameSourceInfo4)->get_IsShareable(&value));
        return value;
    }
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, Windows::Media::Capture::Frames::IMediaFrameSourceInfo4> : produce_base<D, Windows::Media::Capture::Frames::IMediaFrameSourceInfo4>
    {

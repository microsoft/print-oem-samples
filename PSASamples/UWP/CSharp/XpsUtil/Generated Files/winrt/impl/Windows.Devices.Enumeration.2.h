...
WINRT_EXPORT namespace winrt::Windows::Devices::Enumeration
{
    struct __declspec(empty_bases) DeviceAccessChangedEventArgs : Windows::Devices::Enumeration::IDeviceAccessChangedEventArgs,
        impl::require<DeviceAccessChangedEventArgs, Windows::Devices::Enumeration::IDeviceAccessChangedEventArgs2, Windows::Devices::Enumeration::IDeviceAccessChangedEventArgs3>
    {
    ...
    struct __declspec(empty_bases) DeviceAccessInformation : Windows::Devices::Enumeration::IDeviceAccessInformation,
        impl::require<DeviceAccessInformation, Windows::Devices::Enumeration::IDeviceAccessInformation2>
    {
        ...
        impl::require<DeviceInformation, Windows::Devices::Enumeration::IDeviceInformation2>
    {
        ...
        static auto CreateFromIdAsync(param::hstring const& deviceId, param::async_iterable<hstring> const& additionalProperties, Windows::Devices::Enumeration::DeviceInformationKind const& kind, Windows::Devices::Enumeration::IDeviceEnumerationSettings const& settings);
        static auto FindAllAsync(param::hstring const& aqsFilter, param::async_iterable<hstring> const& additionalProperties, Windows::Devices::Enumeration::DeviceInformationKind const& kind, Windows::Devices::Enumeration::IDeviceEnumerationSettings const& settings);
        static auto CreateWatcher(param::hstring const& aqsFilter, param::iterable<hstring> const& additionalProperties, Windows::Devices::Enumeration::DeviceInformationKind const& kind, Windows::Devices::Enumeration::IDeviceEnumerationSettings const& settings);
    };
    ...
    struct __declspec(empty_bases) DeviceInformationCustomPairing : Windows::Devices::Enumeration::IDeviceInformationCustomPairing,
        impl::require<DeviceInformationCustomPairing, Windows::Devices::Enumeration::IDeviceInformationCustomPairing2>
    {
    ...
    struct __declspec(empty_bases) DevicePairingRequestedEventArgs : Windows::Devices::Enumeration::IDevicePairingRequestedEventArgs,
        impl::require<DevicePairingRequestedEventArgs, Windows::Devices::Enumeration::IDevicePairingRequestedEventArgs2, Windows::Devices::Enumeration::IDevicePairingRequestedEventArgs3>
    {
    ...
    struct __declspec(empty_bases) DevicePairingSetMembersRequestedEventArgs : Windows::Devices::Enumeration::IDevicePairingSetMembersRequestedEventArgs
    {
        DevicePairingSetMembersRequestedEventArgs(std::nullptr_t) noexcept {}
        DevicePairingSetMembersRequestedEventArgs(void* ptr, take_ownership_from_abi_t) noexcept : Windows::Devices::Enumeration::IDevicePairingSetMembersRequestedEventArgs(ptr, take_ownership_from_abi) {}
        DevicePairingSetMembersRequestedEventArgs(DevicePairingSetMembersRequestedEventArgs const&) noexcept = default;
        DevicePairingSetMembersRequestedEventArgs(DevicePairingSetMembersRequestedEventArgs&&) noexcept = default;
        DevicePairingSetMembersRequestedEventArgs& operator=(DevicePairingSetMembersRequestedEventArgs const&) & noexcept = default;
        DevicePairingSetMembersRequestedEventArgs& operator=(DevicePairingSetMembersRequestedEventArgs&&) & noexcept = default;
    };

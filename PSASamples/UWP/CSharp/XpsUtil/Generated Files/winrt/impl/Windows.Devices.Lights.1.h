...
WINRT_EXPORT namespace winrt::Windows::Devices::Lights
{
        ...
        impl::consume_t<ILampArray2>
    {
        ...
        ILampArray2(void* ptr, take_ownership_from_abi_t) noexcept : Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
        ILampArray2(ILampArray2 const&) noexcept = default;
        ILampArray2(ILampArray2&&) noexcept = default;
        ILampArray2& operator=(ILampArray2 const&) & noexcept = default;
        ILampArray2& operator=(ILampArray2&&) & noexcept = default;
    };

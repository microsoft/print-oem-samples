...
namespace winrt::impl
{
    ...
    template <> struct category<Windows::Graphics::Printing::PrintTicket::IWorkflowPrintTicketFactory>{ using type = interface_category; };
    ...
    template <> inline constexpr auto& name_v<Windows::Graphics::Printing::PrintTicket::IWorkflowPrintTicketFactory> = L"Windows.Graphics.Printing.PrintTicket.IWorkflowPrintTicketFactory";
    ...
    template <> inline constexpr guid guid_v<Windows::Graphics::Printing::PrintTicket::IWorkflowPrintTicketFactory>{ 0x966D1166,0xD9C7,0x569E,{ 0xB7,0xD8,0xF2,0xB3,0x41,0xC8,0xF9,0x76 } }; // 966D1166-D9C7-569E-B7D8-F2B341C8F976
    ...
    template <> struct abi<Windows::Graphics::Printing::PrintTicket::IWorkflowPrintTicketFactory>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    {
        WINRT_IMPL_AUTO(Windows::Graphics::Printing::PrintTicket::WorkflowPrintTicket) CreateInstance(param::hstring const& printerName, Windows::Storage::Streams::IInputStream const& printTicketStream) const;
    };
    template <> struct consume<Windows::Graphics::Printing::PrintTicket::IWorkflowPrintTicketFactory>
    {

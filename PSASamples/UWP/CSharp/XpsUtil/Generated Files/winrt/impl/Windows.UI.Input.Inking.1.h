...
WINRT_EXPORT namespace winrt::Windows::UI::Input::Inking
{
        ...
        impl::consume_t<IInkInputConfiguration2>
    {
        ...
        IInkInputConfiguration2(IInkInputConfiguration2 const&) noexcept = default;
        IInkInputConfiguration2(IInkInputConfiguration2&&) noexcept = default;
        IInkInputConfiguration2& operator=(IInkInputConfiguration2 const&) & noexcept = default;
        IInkInputConfiguration2& operator=(IInkInputConfiguration2&&) & noexcept = default;
    };
        ...
        impl::consume_t<IInkStroke4>
    {
        ...
        IInkStroke4(IInkStroke4 const&) noexcept = default;
        IInkStroke4(IInkStroke4&&) noexcept = default;
        IInkStroke4& operator=(IInkStroke4 const&) & noexcept = default;
        IInkStroke4& operator=(IInkStroke4&&) & noexcept = default;
    };

...
WINRT_EXPORT namespace winrt::Windows::Globalization
{
        ...
        impl::require<Calendar, Windows::Globalization::ITimeZoneOnCalendar>
    {
        ...
        Calendar(Calendar const&) noexcept = default;
        Calendar(Calendar&&) noexcept = default;
        Calendar& operator=(Calendar const&) & noexcept = default;
    ...
    struct __declspec(empty_bases) CurrencyAmount : Windows::Globalization::ICurrencyAmount
    {
        ...
        CurrencyAmount(CurrencyAmount const&) noexcept = default;
        CurrencyAmount(CurrencyAmount&&) noexcept = default;
        CurrencyAmount& operator=(CurrencyAmount const&) & noexcept = default;
        CurrencyAmount& operator=(CurrencyAmount&&) & noexcept = default;
    };
    ...
    struct __declspec(empty_bases) GeographicRegion : Windows::Globalization::IGeographicRegion
    {
        ...
        GeographicRegion(GeographicRegion const&) noexcept = default;
        GeographicRegion(GeographicRegion&&) noexcept = default;
        GeographicRegion& operator=(GeographicRegion const&) & noexcept = default;
        GeographicRegion& operator=(GeographicRegion&&) & noexcept = default;
        ...
        impl::require<Language, Windows::Globalization::ILanguageExtensionSubtags, Windows::Globalization::ILanguage2, Windows::Globalization::ILanguage3>
    {
        ...
        Language(Language const&) noexcept = default;
        Language(Language&&) noexcept = default;
        Language& operator=(Language const&) & noexcept = default;

...
WINRT_EXPORT namespace winrt::Windows::Devices::Gpio::Provider
{
    struct __declspec(empty_bases) GpioPinProviderValueChangedEventArgs : Windows::Devices::Gpio::Provider::IGpioPinProviderValueChangedEventArgs
    {
        ...
        GpioPinProviderValueChangedEventArgs(GpioPinProviderValueChangedEventArgs const&) noexcept = default;
        GpioPinProviderValueChangedEventArgs(GpioPinProviderValueChangedEventArgs&&) noexcept = default;
        GpioPinProviderValueChangedEventArgs& operator=(GpioPinProviderValueChangedEventArgs const&) & noexcept = default;
        GpioPinProviderValueChangedEventArgs& operator=(GpioPinProviderValueChangedEventArgs&&) & noexcept = default;
    };
}
#endif

...
WINRT_EXPORT namespace winrt::Windows::Storage::Streams
{
        ...
        impl::consume_t<IPropertySetSerializer>
    {
        ...
        IPropertySetSerializer(IPropertySetSerializer const&) noexcept = default;
        IPropertySetSerializer(IPropertySetSerializer&&) noexcept = default;
        IPropertySetSerializer& operator=(IPropertySetSerializer const&) & noexcept = default;
        IPropertySetSerializer& operator=(IPropertySetSerializer&&) & noexcept = default;
    };

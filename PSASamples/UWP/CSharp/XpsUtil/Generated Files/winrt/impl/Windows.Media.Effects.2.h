...
{
    struct __declspec(empty_bases) AcousticEchoCancellationConfiguration : Windows::Media::Effects::IAcousticEchoCancellationConfiguration
    {
        AcousticEchoCancellationConfiguration(std::nullptr_t) noexcept {}
        AcousticEchoCancellationConfiguration(void* ptr, take_ownership_from_abi_t) noexcept : Windows::Media::Effects::IAcousticEchoCancellationConfiguration(ptr, take_ownership_from_abi) {}
        AcousticEchoCancellationConfiguration(AcousticEchoCancellationConfiguration const&) noexcept = default;
        AcousticEchoCancellationConfiguration(AcousticEchoCancellationConfiguration&&) noexcept = default;
        AcousticEchoCancellationConfiguration& operator=(AcousticEchoCancellationConfiguration const&) & noexcept = default;
        AcousticEchoCancellationConfiguration& operator=(AcousticEchoCancellationConfiguration&&) & noexcept = default;
    };
    ...
    struct __declspec(empty_bases) AudioEffect : Windows::Media::Effects::IAudioEffect,
        impl::require<AudioEffect, Windows::Media::Effects::IAudioEffect2>
    {

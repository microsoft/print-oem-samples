...
WINRT_EXPORT namespace winrt::Windows::Media::Audio
{
        ...
        impl::consume_t<IAudioEffectsPackConfiguration>
    {
        ...
        IAudioEffectsPackConfiguration(void* ptr, take_ownership_from_abi_t) noexcept : Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
        IAudioEffectsPackConfiguration(IAudioEffectsPackConfiguration const&) noexcept = default;
        IAudioEffectsPackConfiguration(IAudioEffectsPackConfiguration&&) noexcept = default;
        IAudioEffectsPackConfiguration& operator=(IAudioEffectsPackConfiguration const&) & noexcept = default;
        IAudioEffectsPackConfiguration& operator=(IAudioEffectsPackConfiguration&&) & noexcept = default;
    };
        ...
        impl::consume_t<IAudioEffectsPackConfigurationStatics>
    {
        ...
        IAudioEffectsPackConfigurationStatics(void* ptr, take_ownership_from_abi_t) noexcept : Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
        IAudioEffectsPackConfigurationStatics(IAudioEffectsPackConfigurationStatics const&) noexcept = default;
        IAudioEffectsPackConfigurationStatics(IAudioEffectsPackConfigurationStatics&&) noexcept = default;
        IAudioEffectsPackConfigurationStatics& operator=(IAudioEffectsPackConfigurationStatics const&) & noexcept = default;
        IAudioEffectsPackConfigurationStatics& operator=(IAudioEffectsPackConfigurationStatics&&) & noexcept = default;
    };

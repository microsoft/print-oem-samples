...
{
    template <> struct category<Windows::UI::UIAutomation::IAutomationConnection>{ using type = interface_category; };
    template <> struct category<Windows::UI::UIAutomation::IAutomationConnectionBoundObject>{ using type = interface_category; };
    ...
    template <> struct category<Windows::UI::UIAutomation::AutomationConnection>{ using type = class_category; };
    template <> struct category<Windows::UI::UIAutomation::AutomationConnectionBoundObject>{ using type = class_category; };
    ...
    template <> inline constexpr auto& name_v<Windows::UI::UIAutomation::AutomationConnection> = L"Windows.UI.UIAutomation.AutomationConnection";
    template <> inline constexpr auto& name_v<Windows::UI::UIAutomation::AutomationConnectionBoundObject> = L"Windows.UI.UIAutomation.AutomationConnectionBoundObject";
    ...
    template <> inline constexpr auto& name_v<Windows::UI::UIAutomation::IAutomationConnection> = L"Windows.UI.UIAutomation.IAutomationConnection";
    template <> inline constexpr auto& name_v<Windows::UI::UIAutomation::IAutomationConnectionBoundObject> = L"Windows.UI.UIAutomation.IAutomationConnectionBoundObject";
    ...
    template <> inline constexpr guid guid_v<Windows::UI::UIAutomation::IAutomationConnection>{ 0xAAD262ED,0x0EF4,0x5D43,{ 0x97,0xBE,0xA8,0x34,0xE2,0x7B,0x65,0xB9 } }; // AAD262ED-0EF4-5D43-97BE-A834E27B65B9
    template <> inline constexpr guid guid_v<Windows::UI::UIAutomation::IAutomationConnectionBoundObject>{ 0x5E8558FB,0xCA52,0x5B65,{ 0x98,0x30,0xDD,0x29,0x05,0x81,0x60,0x93 } }; // 5E8558FB-CA52-5B65-9830-DD2905816093
    ...
    template <> struct default_interface<Windows::UI::UIAutomation::AutomationConnection>{ using type = Windows::UI::UIAutomation::IAutomationConnection; };
    template <> struct default_interface<Windows::UI::UIAutomation::AutomationConnectionBoundObject>{ using type = Windows::UI::UIAutomation::IAutomationConnectionBoundObject; };
    ...
    template <> struct abi<Windows::UI::UIAutomation::IAutomationConnection>
    {
    ...
    template <> struct abi<Windows::UI::UIAutomation::IAutomationConnectionBoundObject>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct consume<Windows::UI::UIAutomation::IAutomationConnection>
    {
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::UI::UIAutomation::AutomationConnection) Connection() const;
    };
    template <> struct consume<Windows::UI::UIAutomation::IAutomationConnectionBoundObject>
    {

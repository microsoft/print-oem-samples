...
WINRT_EXPORT namespace winrt::Windows::Security::Credentials::UI
{
        ...
        impl::consume_t<ICredentialPickerOptions>
    {
        ...
        ICredentialPickerOptions(ICredentialPickerOptions const&) noexcept = default;
        ICredentialPickerOptions(ICredentialPickerOptions&&) noexcept = default;
        ICredentialPickerOptions& operator=(ICredentialPickerOptions const&) & noexcept = default;
        ICredentialPickerOptions& operator=(ICredentialPickerOptions&&) & noexcept = default;
    };
        ...
        impl::consume_t<ICredentialPickerResults>
    {
        ...
        ICredentialPickerResults(ICredentialPickerResults const&) noexcept = default;
        ICredentialPickerResults(ICredentialPickerResults&&) noexcept = default;
        ICredentialPickerResults& operator=(ICredentialPickerResults const&) & noexcept = default;
        ICredentialPickerResults& operator=(ICredentialPickerResults&&) & noexcept = default;
    };
        ...
        impl::consume_t<ICredentialPickerStatics>
    {
        ...
        ICredentialPickerStatics(ICredentialPickerStatics const&) noexcept = default;
        ICredentialPickerStatics(ICredentialPickerStatics&&) noexcept = default;
        ICredentialPickerStatics& operator=(ICredentialPickerStatics const&) & noexcept = default;
        ICredentialPickerStatics& operator=(ICredentialPickerStatics&&) & noexcept = default;
    };
        ...
        impl::consume_t<IUserConsentVerifierStatics>
    {
        ...
        IUserConsentVerifierStatics(IUserConsentVerifierStatics const&) noexcept = default;
        IUserConsentVerifierStatics(IUserConsentVerifierStatics&&) noexcept = default;
        IUserConsentVerifierStatics& operator=(IUserConsentVerifierStatics const&) & noexcept = default;
        IUserConsentVerifierStatics& operator=(IUserConsentVerifierStatics&&) & noexcept = default;
    };
}
#endif

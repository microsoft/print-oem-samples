...
WINRT_EXPORT namespace winrt::Windows::UI::Input
{
    ...
    struct __declspec(empty_bases) PhysicalGestureRecognizer : Windows::UI::Input::IPhysicalGestureRecognizer
    {
        PhysicalGestureRecognizer(std::nullptr_t) noexcept {}
        PhysicalGestureRecognizer(void* ptr, take_ownership_from_abi_t) noexcept : Windows::UI::Input::IPhysicalGestureRecognizer(ptr, take_ownership_from_abi) {}
        PhysicalGestureRecognizer();
        PhysicalGestureRecognizer(PhysicalGestureRecognizer const&) noexcept = default;
        PhysicalGestureRecognizer(PhysicalGestureRecognizer&&) noexcept = default;
        PhysicalGestureRecognizer& operator=(PhysicalGestureRecognizer const&) & noexcept = default;
        PhysicalGestureRecognizer& operator=(PhysicalGestureRecognizer&&) & noexcept = default;
    };
    struct __declspec(empty_bases) PointerPoint : Windows::UI::Input::IPointerPoint,
        impl::require<PointerPoint, Windows::UI::Input::IPointerPointPhysicalPosition>
    {
    ...
    struct __declspec(empty_bases) TouchpadGesturesController : Windows::UI::Input::ITouchpadGesturesController
    {
        TouchpadGesturesController(std::nullptr_t) noexcept {}
        TouchpadGesturesController(void* ptr, take_ownership_from_abi_t) noexcept : Windows::UI::Input::ITouchpadGesturesController(ptr, take_ownership_from_abi) {}
        TouchpadGesturesController(TouchpadGesturesController const&) noexcept = default;
        TouchpadGesturesController(TouchpadGesturesController&&) noexcept = default;
        TouchpadGesturesController& operator=(TouchpadGesturesController const&) & noexcept = default;
        TouchpadGesturesController& operator=(TouchpadGesturesController&&) & noexcept = default;
        static auto IsSupported();
        static auto CreateForProcess();
    };
    struct __declspec(empty_bases) TouchpadGlobalActionEventArgs : Windows::UI::Input::ITouchpadGlobalActionEventArgs
    {
        TouchpadGlobalActionEventArgs(std::nullptr_t) noexcept {}
        TouchpadGlobalActionEventArgs(void* ptr, take_ownership_from_abi_t) noexcept : Windows::UI::Input::ITouchpadGlobalActionEventArgs(ptr, take_ownership_from_abi) {}
        TouchpadGlobalActionEventArgs(TouchpadGlobalActionEventArgs const&) noexcept = default;
        TouchpadGlobalActionEventArgs(TouchpadGlobalActionEventArgs&&) noexcept = default;
        TouchpadGlobalActionEventArgs& operator=(TouchpadGlobalActionEventArgs const&) & noexcept = default;
        TouchpadGlobalActionEventArgs& operator=(TouchpadGlobalActionEventArgs&&) & noexcept = default;
    };
}
#endif

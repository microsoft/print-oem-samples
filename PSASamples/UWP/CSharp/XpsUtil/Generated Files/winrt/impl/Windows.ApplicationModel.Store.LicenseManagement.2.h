...
WINRT_EXPORT namespace winrt::Windows::ApplicationModel::Store::LicenseManagement
{
    ...
    struct __declspec(empty_bases) LicenseSatisfactionInfo : Windows::ApplicationModel::Store::LicenseManagement::ILicenseSatisfactionInfo
    {
        ...
        LicenseSatisfactionInfo(LicenseSatisfactionInfo const&) noexcept = default;
        LicenseSatisfactionInfo(LicenseSatisfactionInfo&&) noexcept = default;
        LicenseSatisfactionInfo& operator=(LicenseSatisfactionInfo const&) & noexcept = default;
        LicenseSatisfactionInfo& operator=(LicenseSatisfactionInfo&&) & noexcept = default;
    };
    struct __declspec(empty_bases) LicenseSatisfactionResult : Windows::ApplicationModel::Store::LicenseManagement::ILicenseSatisfactionResult
    {
        ...
        LicenseSatisfactionResult(LicenseSatisfactionResult const&) noexcept = default;
        LicenseSatisfactionResult(LicenseSatisfactionResult&&) noexcept = default;
        LicenseSatisfactionResult& operator=(LicenseSatisfactionResult const&) & noexcept = default;
        LicenseSatisfactionResult& operator=(LicenseSatisfactionResult&&) & noexcept = default;
    };
}
#endif

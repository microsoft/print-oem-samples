...
WINRT_EXPORT namespace winrt::Windows::Management
{
        ...
        impl::consume_t<IMdmAlert>
    {
        ...
        IMdmAlert(IMdmAlert const&) noexcept = default;
        IMdmAlert(IMdmAlert&&) noexcept = default;
        IMdmAlert& operator=(IMdmAlert const&) & noexcept = default;
        IMdmAlert& operator=(IMdmAlert&&) & noexcept = default;
    };
        ...
        impl::consume_t<IMdmSession>
    {
        ...
        IMdmSession(IMdmSession const&) noexcept = default;
        IMdmSession(IMdmSession&&) noexcept = default;
        IMdmSession& operator=(IMdmSession const&) & noexcept = default;
        IMdmSession& operator=(IMdmSession&&) & noexcept = default;
    };
        ...
        impl::consume_t<IMdmSessionManagerStatics>
    {
        ...
        IMdmSessionManagerStatics(IMdmSessionManagerStatics const&) noexcept = default;
        IMdmSessionManagerStatics(IMdmSessionManagerStatics&&) noexcept = default;
        IMdmSessionManagerStatics& operator=(IMdmSessionManagerStatics const&) & noexcept = default;
        IMdmSessionManagerStatics& operator=(IMdmSessionManagerStatics&&) & noexcept = default;
    };
}
#endif

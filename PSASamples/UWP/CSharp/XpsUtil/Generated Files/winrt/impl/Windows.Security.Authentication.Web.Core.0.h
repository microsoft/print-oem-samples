...
namespace winrt::impl
{
    ...
    template <> struct category<Windows::Security::Authentication::Web::Core::IWebAccountMonitor2>{ using type = interface_category; };
    template <> struct category<Windows::Security::Authentication::Web::Core::IWebAuthenticationAddAccountResponse>{ using type = interface_category; };
    template <> struct category<Windows::Security::Authentication::Web::Core::IWebAuthenticationAddAccountResponseFactory>{ using type = interface_category; };
    template <> struct category<Windows::Security::Authentication::Web::Core::IWebAuthenticationAddAccountResult>{ using type = interface_category; };
    ...
    template <> struct category<Windows::Security::Authentication::Web::Core::IWebAuthenticationCoreManagerStatics5>{ using type = interface_category; };
    template <> struct category<Windows::Security::Authentication::Web::Core::IWebAuthenticationTransferTokenRequest>{ using type = interface_category; };
    template <> struct category<Windows::Security::Authentication::Web::Core::IWebAuthenticationTransferTokenRequestFactory>{ using type = interface_category; };
    ...
    template <> struct category<Windows::Security::Authentication::Web::Core::WebAuthenticationAddAccountResponse>{ using type = class_category; };
    template <> struct category<Windows::Security::Authentication::Web::Core::WebAuthenticationAddAccountResult>{ using type = class_category; };
    template <> struct category<Windows::Security::Authentication::Web::Core::WebAuthenticationCoreManager>{ using type = class_category; };
    template <> struct category<Windows::Security::Authentication::Web::Core::WebAuthenticationTransferTokenRequest>{ using type = class_category; };
    ...
    template <> struct category<Windows::Security::Authentication::Web::Core::WebAuthenticationAddAccountStatus>{ using type = enum_category; };
    ...
    template <> inline constexpr auto& name_v<Windows::Security::Authentication::Web::Core::WebAuthenticationAddAccountResponse> = L"Windows.Security.Authentication.Web.Core.WebAuthenticationAddAccountResponse";
    template <> inline constexpr auto& name_v<Windows::Security::Authentication::Web::Core::WebAuthenticationAddAccountResult> = L"Windows.Security.Authentication.Web.Core.WebAuthenticationAddAccountResult";
    ...
    template <> inline constexpr auto& name_v<Windows::Security::Authentication::Web::Core::WebAuthenticationTransferTokenRequest> = L"Windows.Security.Authentication.Web.Core.WebAuthenticationTransferTokenRequest";
    ...
    template <> inline constexpr auto& name_v<Windows::Security::Authentication::Web::Core::WebAuthenticationAddAccountStatus> = L"Windows.Security.Authentication.Web.Core.WebAuthenticationAddAccountStatus";
    ...
    template <> inline constexpr auto& name_v<Windows::Security::Authentication::Web::Core::IWebAuthenticationAddAccountResponse> = L"Windows.Security.Authentication.Web.Core.IWebAuthenticationAddAccountResponse";
    template <> inline constexpr auto& name_v<Windows::Security::Authentication::Web::Core::IWebAuthenticationAddAccountResponseFactory> = L"Windows.Security.Authentication.Web.Core.IWebAuthenticationAddAccountResponseFactory";
    template <> inline constexpr auto& name_v<Windows::Security::Authentication::Web::Core::IWebAuthenticationAddAccountResult> = L"Windows.Security.Authentication.Web.Core.IWebAuthenticationAddAccountResult";
    ...
    template <> inline constexpr auto& name_v<Windows::Security::Authentication::Web::Core::IWebAuthenticationCoreManagerStatics5> = L"Windows.Security.Authentication.Web.Core.IWebAuthenticationCoreManagerStatics5";
    template <> inline constexpr auto& name_v<Windows::Security::Authentication::Web::Core::IWebAuthenticationTransferTokenRequest> = L"Windows.Security.Authentication.Web.Core.IWebAuthenticationTransferTokenRequest";
    template <> inline constexpr auto& name_v<Windows::Security::Authentication::Web::Core::IWebAuthenticationTransferTokenRequestFactory> = L"Windows.Security.Authentication.Web.Core.IWebAuthenticationTransferTokenRequestFactory";
    ...
    template <> inline constexpr guid guid_v<Windows::Security::Authentication::Web::Core::IWebAuthenticationAddAccountResponse>{ 0x7FB013E8,0x0BD8,0x542B,{ 0xB4,0x86,0x83,0x23,0x16,0x3A,0x4B,0x85 } }; // 7FB013E8-0BD8-542B-B486-8323163A4B85
    template <> inline constexpr guid guid_v<Windows::Security::Authentication::Web::Core::IWebAuthenticationAddAccountResponseFactory>{ 0x325F903E,0x77BE,0x5365,{ 0x81,0xD9,0x03,0x21,0xCD,0xD8,0x21,0x95 } }; // 325F903E-77BE-5365-81D9-0321CDD82195
    template <> inline constexpr guid guid_v<Windows::Security::Authentication::Web::Core::IWebAuthenticationAddAccountResult>{ 0x88FAD03C,0x901D,0x5FFA,{ 0x92,0x59,0x70,0x1D,0x3C,0xA0,0x8E,0xF2 } }; // 88FAD03C-901D-5FFA-9259-701D3CA08EF2
    ...
    template <> inline constexpr guid guid_v<Windows::Security::Authentication::Web::Core::IWebAuthenticationCoreManagerStatics5>{ 0xD07C1DED,0x270F,0x4554,{ 0x99,0x66,0x27,0xB7,0xDF,0x05,0xB9,0x65 } }; // D07C1DED-270F-4554-9966-27B7DF05B965
    template <> inline constexpr guid guid_v<Windows::Security::Authentication::Web::Core::IWebAuthenticationTransferTokenRequest>{ 0x7ACFA5B6,0x529D,0x5E76,{ 0x98,0x46,0xF3,0xFD,0x99,0x93,0x04,0xD0 } }; // 7ACFA5B6-529D-5E76-9846-F3FD999304D0
    template <> inline constexpr guid guid_v<Windows::Security::Authentication::Web::Core::IWebAuthenticationTransferTokenRequestFactory>{ 0x5F16B627,0x04C4,0x5F0B,{ 0x86,0x83,0x8B,0xAB,0x58,0x96,0x56,0x56 } }; // 5F16B627-04C4-5F0B-8683-8BAB58965656
    ...
    template <> struct default_interface<Windows::Security::Authentication::Web::Core::WebAuthenticationAddAccountResponse>{ using type = Windows::Security::Authentication::Web::Core::IWebAuthenticationAddAccountResponse; };
    template <> struct default_interface<Windows::Security::Authentication::Web::Core::WebAuthenticationAddAccountResult>{ using type = Windows::Security::Authentication::Web::Core::IWebAuthenticationAddAccountResult; };
    template <> struct default_interface<Windows::Security::Authentication::Web::Core::WebAuthenticationTransferTokenRequest>{ using type = Windows::Security::Authentication::Web::Core::IWebAuthenticationTransferTokenRequest; };
    ...
    template <> struct abi<Windows::Security::Authentication::Web::Core::IWebAuthenticationAddAccountResponse>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::Security::Authentication::Web::Core::IWebAuthenticationAddAccountResponseFactory>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::Security::Authentication::Web::Core::IWebAuthenticationAddAccountResult>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::Security::Authentication::Web::Core::IWebAuthenticationCoreManagerStatics5>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::Security::Authentication::Web::Core::IWebAuthenticationTransferTokenRequest>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::Security::Authentication::Web::Core::IWebAuthenticationTransferTokenRequestFactory>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct consume<Windows::Security::Authentication::Web::Core::IWebAuthenticationAddAccountResponse>
    {
    ...
    {
        WINRT_IMPL_AUTO(Windows::Security::Authentication::Web::Core::WebAuthenticationAddAccountResponse) CreateWithAccount(Windows::Security::Credentials::WebAccount const& webAccount) const;
    };
    template <> struct consume<Windows::Security::Authentication::Web::Core::IWebAuthenticationAddAccountResponseFactory>
    {
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Security::Authentication::Web::Core::WebAuthenticationAddAccountResponse) ResponseData() const;
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Security::Authentication::Web::Core::WebAuthenticationAddAccountStatus) ResponseStatus() const;
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Security::Authentication::Web::Core::WebProviderError) ResponseError() const;
    };
    template <> struct consume<Windows::Security::Authentication::Web::Core::IWebAuthenticationAddAccountResult>
    {
    ...
    {
        WINRT_IMPL_AUTO(Windows::Foundation::IAsyncOperation<Windows::Security::Authentication::Web::Core::WebAuthenticationAddAccountResult>) AddAccountWithTransferTokenAsync(Windows::Security::Authentication::Web::Core::WebAuthenticationTransferTokenRequest const& request) const;
    };
    template <> struct consume<Windows::Security::Authentication::Web::Core::IWebAuthenticationCoreManagerStatics5>
    {
    ...
    template <> struct consume<Windows::Security::Authentication::Web::Core::IWebAuthenticationTransferTokenRequest>
    {
    ...
    {
        WINRT_IMPL_AUTO(Windows::Security::Authentication::Web::Core::WebAuthenticationTransferTokenRequest) Create(Windows::Security::Credentials::WebAccountProvider const& provider, param::hstring const& transferToken) const;
        WINRT_IMPL_AUTO(Windows::Security::Authentication::Web::Core::WebAuthenticationTransferTokenRequest) CreateWithCorrelationId(Windows::Security::Credentials::WebAccountProvider const& provider, param::hstring const& transferToken, param::hstring const& correlationId) const;
    };
    template <> struct consume<Windows::Security::Authentication::Web::Core::IWebAuthenticationTransferTokenRequestFactory>
    {

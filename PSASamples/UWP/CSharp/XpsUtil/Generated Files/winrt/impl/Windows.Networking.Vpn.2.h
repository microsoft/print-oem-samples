...
WINRT_EXPORT namespace winrt::Windows::Networking::Vpn
{
        ...
        impl::require<VpnForegroundActivatedEventArgs, Windows::ApplicationModel::Activation::IActivatedEventArgs, Windows::ApplicationModel::Activation::IActivatedEventArgsWithUser>
    {
        ...
        VpnForegroundActivatedEventArgs(VpnForegroundActivatedEventArgs const&) noexcept = default;
        VpnForegroundActivatedEventArgs(VpnForegroundActivatedEventArgs&&) noexcept = default;
        VpnForegroundActivatedEventArgs& operator=(VpnForegroundActivatedEventArgs const&) & noexcept = default;
        VpnForegroundActivatedEventArgs& operator=(VpnForegroundActivatedEventArgs&&) & noexcept = default;
    };
    struct __declspec(empty_bases) VpnForegroundActivationOperation : Windows::Networking::Vpn::IVpnForegroundActivationOperation
    {
        ...
        VpnForegroundActivationOperation(VpnForegroundActivationOperation const&) noexcept = default;
        VpnForegroundActivationOperation(VpnForegroundActivationOperation&&) noexcept = default;
        VpnForegroundActivationOperation& operator=(VpnForegroundActivationOperation const&) & noexcept = default;
        VpnForegroundActivationOperation& operator=(VpnForegroundActivationOperation&&) & noexcept = default;
    };

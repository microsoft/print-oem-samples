...
WINRT_EXPORT namespace winrt::Windows::Media::Effects
{
        ...
        impl::consume_t<IAcousticEchoCancellationConfiguration>
    {
        ...
        IAcousticEchoCancellationConfiguration(void* ptr, take_ownership_from_abi_t) noexcept : Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
        IAcousticEchoCancellationConfiguration(IAcousticEchoCancellationConfiguration const&) noexcept = default;
        IAcousticEchoCancellationConfiguration(IAcousticEchoCancellationConfiguration&&) noexcept = default;
        IAcousticEchoCancellationConfiguration& operator=(IAcousticEchoCancellationConfiguration const&) & noexcept = default;
        IAcousticEchoCancellationConfiguration& operator=(IAcousticEchoCancellationConfiguration&&) & noexcept = default;
    };
        ...
        impl::consume_t<IAudioEffect2>
    {
        ...
        IAudioEffect2(void* ptr, take_ownership_from_abi_t) noexcept : Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
        IAudioEffect2(IAudioEffect2 const&) noexcept = default;
        IAudioEffect2(IAudioEffect2&&) noexcept = default;
        IAudioEffect2& operator=(IAudioEffect2 const&) & noexcept = default;
        IAudioEffect2& operator=(IAudioEffect2&&) & noexcept = default;
    };

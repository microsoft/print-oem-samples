...
WINRT_EXPORT namespace winrt::Windows::Perception::People
{
    ...
    struct __declspec(empty_bases) EyesPose : Windows::Perception::People::IEyesPose
    {
        ...
        EyesPose(EyesPose const&) noexcept = default;
        EyesPose(EyesPose&&) noexcept = default;
        EyesPose& operator=(EyesPose const&) & noexcept = default;
        EyesPose& operator=(EyesPose&&) & noexcept = default;
    ...
    struct __declspec(empty_bases) HandMeshObserver : Windows::Perception::People::IHandMeshObserver
    {
        ...
        HandMeshObserver(HandMeshObserver const&) noexcept = default;
        HandMeshObserver(HandMeshObserver&&) noexcept = default;
        HandMeshObserver& operator=(HandMeshObserver const&) & noexcept = default;
        HandMeshObserver& operator=(HandMeshObserver&&) & noexcept = default;
    };
    struct __declspec(empty_bases) HandMeshVertexState : Windows::Perception::People::IHandMeshVertexState
    {
        ...
        HandMeshVertexState(HandMeshVertexState const&) noexcept = default;
        HandMeshVertexState(HandMeshVertexState&&) noexcept = default;
        HandMeshVertexState& operator=(HandMeshVertexState const&) & noexcept = default;
        HandMeshVertexState& operator=(HandMeshVertexState&&) & noexcept = default;
    };
    struct __declspec(empty_bases) HandPose : Windows::Perception::People::IHandPose
    {
        ...
        HandPose(HandPose const&) noexcept = default;
        HandPose(HandPose&&) noexcept = default;
        HandPose& operator=(HandPose const&) & noexcept = default;
        HandPose& operator=(HandPose&&) & noexcept = default;
    };
    struct __declspec(empty_bases) HeadPose : Windows::Perception::People::IHeadPose
    {
        ...
        HeadPose(HeadPose const&) noexcept = default;
        HeadPose(HeadPose&&) noexcept = default;
        HeadPose& operator=(HeadPose const&) & noexcept = default;
        HeadPose& operator=(HeadPose&&) & noexcept = default;
    };
}
#endif

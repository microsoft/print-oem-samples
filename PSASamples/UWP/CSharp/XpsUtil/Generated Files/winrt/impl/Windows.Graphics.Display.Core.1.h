...
WINRT_EXPORT namespace winrt::Windows::Graphics::Display::Core
{
        ...
        impl::consume_t<IHdmiDisplayInformation>
    {
        ...
        IHdmiDisplayInformation(IHdmiDisplayInformation const&) noexcept = default;
        IHdmiDisplayInformation(IHdmiDisplayInformation&&) noexcept = default;
        IHdmiDisplayInformation& operator=(IHdmiDisplayInformation const&) & noexcept = default;
        IHdmiDisplayInformation& operator=(IHdmiDisplayInformation&&) & noexcept = default;
    };
        ...
        impl::consume_t<IHdmiDisplayInformationStatics>
    {
        ...
        IHdmiDisplayInformationStatics(IHdmiDisplayInformationStatics const&) noexcept = default;
        IHdmiDisplayInformationStatics(IHdmiDisplayInformationStatics&&) noexcept = default;
        IHdmiDisplayInformationStatics& operator=(IHdmiDisplayInformationStatics const&) & noexcept = default;
        IHdmiDisplayInformationStatics& operator=(IHdmiDisplayInformationStatics&&) & noexcept = default;
    };
        ...
        impl::consume_t<IHdmiDisplayMode>
    {
        ...
        IHdmiDisplayMode(IHdmiDisplayMode const&) noexcept = default;
        IHdmiDisplayMode(IHdmiDisplayMode&&) noexcept = default;
        IHdmiDisplayMode& operator=(IHdmiDisplayMode const&) & noexcept = default;
        IHdmiDisplayMode& operator=(IHdmiDisplayMode&&) & noexcept = default;
    };
        ...
        impl::consume_t<IHdmiDisplayMode2>
    {
        ...
        IHdmiDisplayMode2(IHdmiDisplayMode2 const&) noexcept = default;
        IHdmiDisplayMode2(IHdmiDisplayMode2&&) noexcept = default;
        IHdmiDisplayMode2& operator=(IHdmiDisplayMode2 const&) & noexcept = default;
        IHdmiDisplayMode2& operator=(IHdmiDisplayMode2&&) & noexcept = default;
    };
}
#endif

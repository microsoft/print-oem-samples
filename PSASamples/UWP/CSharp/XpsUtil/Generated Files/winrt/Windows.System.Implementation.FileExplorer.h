...
namespace winrt::impl
{
    ...
    template <typename D> WINRT_IMPL_AUTO(Windows::System::Implementation::FileExplorer::SysStorageProviderEventReceivedEventArgs) consume_Windows_System_Implementation_FileExplorer_ISysStorageProviderEventReceivedEventArgsFactory<D>::CreateInstance(param::hstring const& json) const
    {
        void* value{};
    ...
    template <typename D> WINRT_IMPL_AUTO(Windows::System::Implementation::FileExplorer::ISysStorageProviderHttpRequestProvider) consume_Windows_System_Implementation_FileExplorer_ISysStorageProviderHandlerFactory<D>::GetHttpRequestProvider(param::hstring const& syncRootId) const
    {
        void* result{};
    ...
    template <typename D> WINRT_IMPL_AUTO(Windows::System::Implementation::FileExplorer::ISysStorageProviderEventSource) consume_Windows_System_Implementation_FileExplorer_ISysStorageProviderHandlerFactory<D>::GetEventSource(param::hstring const& syncRootId, param::hstring const& eventName) const
    {
        void* result{};
    ...
    template <typename D> WINRT_IMPL_AUTO(Windows::Foundation::IAsyncOperation<Windows::Web::Http::HttpResponseMessage>) consume_Windows_System_Implementation_FileExplorer_ISysStorageProviderHttpRequestProvider<D>::SendRequestAsync(Windows::Web::Http::HttpRequestMessage const& request) const
    {
        void* operation{};
